 ...
 */
package org.silverpeas.persistence.repository.basicjpa;
...
import org.silverpeas.persistence.repository.basicjpa.model.AnimalCustomEntity;
import org.silverpeas.persistence.repository.basicjpa.model.AnimalTypeCustomEntity;
...
public class SilverpeasJpaCustomEntityManagerTest {
  ...
  public static final String TABLES_CREATION =
      "/org/silverpeas/persistence/basicjpa/create_table.sql";
  ...
  public static Archive<?> createTestArchive() {
    return WarBuilder4LibCore.onWarFor(SilverpeasJpaCustomEntityManagerTest.class)
        .addJpaPersistenceFeatures().testFocusedOn((warBuilder) -> {
          ...
          warBuilder.addAsResource("org/silverpeas/persistence/basicjpa/create_table.sql");
        }).build();
  }
