...
public class DelayedNotificationFactory {
  ...
  private static DelayedNotificationFactory getInstance() {
    synchronized (DelayedNotificationFactory.class) {
      if (DelayedNotificationFactory.instance == null) {
        DelayedNotificationFactory.instance = new DelayedNotificationFactory();
      }
    }
    return DelayedNotificationFactory.instance;
  }

  /**
   * Delayed Notification Manager accessor
   * @return
   */
