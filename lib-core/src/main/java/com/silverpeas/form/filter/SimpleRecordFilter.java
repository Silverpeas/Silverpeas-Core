...
/**
 * A simple record filter built from a list of fieldFilter
 * whose criteria must all match to accept a DataRecord.
 */
public class SimpleRecordFilter implements RecordFilter
{
   ...
   * Builds a SimpleRecordFilter.
	*
	* Before any call to the match method,
	* you must use the addFieldFilter method to add each needed field
	* filter.
	*/
  ...
  /**
   * Returns true if the fields of the specified record match all
	* the field filter of this Filter.
   */
