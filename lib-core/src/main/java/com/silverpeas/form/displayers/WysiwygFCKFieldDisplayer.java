...
public class WysiwygFCKFieldDisplayer extends AbstractFieldDisplayer<TextField> {
  ...
  public void display(PrintWriter out, TextField field, FieldTemplate template,
    ...
    if (template.isDisabled() || template.isReadOnly()) {
      ...
      builder.append("baseHref : '").append(URLManager.getApplicationURL()).append(
          "/wysiwyg/jsp/ckeditor/").append("',\n");
      builder.append("filebrowserImageBrowseUrl : '").append(Util.getPath()).
          append("/wysiwyg/jsp/uploadFile.jsp?ComponentId=").append(pageContext.getComponentId()).
