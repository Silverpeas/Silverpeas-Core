...
public class MapFieldDisplayer extends AbstractTextFieldDisplayer<TextField> {
  ...
  public void display(PrintWriter out, TextField field, FieldTemplate template,
    ...
    if (template.isReadOnly() && !template.isHidden()) {
      ...
      src.append("layer=c&amp;");
      src.append("t=").append(getParameterValue(parameters, PARAM_KIND, KIND_NORMAL)).append("&amp;");
      ...
      boolean enlarge = StringUtil.getBooleanValue(getParameterValue(parameters, PARAM_ENLARGE, "false"));
