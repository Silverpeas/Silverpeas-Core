...
public class HtmlForm extends AbstractForm
{
	...
	private void closeHtmlFile() throws IOException
	{
		if( m_HtmlFile != null)
		{
			...
			{
				SilverTrace.error("form", "HtmlForm.closeHtmlFile", "form.EX_CANT_CLOSE_FILE", "fileName = ["+m_FileName+"]" , e);
				throw e;
			}
		}
	}
	...
	*/
	public void display(JspWriter jw, PagesContext PagesContext, DataRecord record)
	{
		...
		{
			SilverTrace.error("form", "HtmlForm.display", "form.EX_CANT_OPEN_FILE", null, fe);
		}
