...
/**
 * Defines the frequencey forResourceBundle cache invalidation.
 * The default period is 4 Hours.
 * You can specify a period with the System property <code>silverpeas.refresh.configuration</code> and
