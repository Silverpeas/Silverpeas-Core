...
public class Variant
{
    ...
    public String  getDefaultType()  { return m_type; }

    public String[] getValueStringArray()  { return m_asValue; }
    public String  getValueString()  { return m_sValue; }
    public int     getValueInteger() { return m_iValue; }
    public long    getValueLong() { return m_lValue; }
    public boolean getValueBoolean() { return m_bValue; }
    public float   getValueFloat()   { return m_fValue; }
    public Date    getValueDate()    { return m_dValue; }
    ...
    protected int setValueInteger(String value) throws UtilException
    {
        ...
        {
            throw new UtilException("Variant.setValueInteger",SilverpeasException.ERROR,"root.EX_INVALID_ARG","Value="+value+" Type="+m_type,e);
        }
        return m_iValue;
    }
    ...
    protected long setValueLong(String value) throws UtilException
    {
        ...
        {
            throw new UtilException("Variant.setValueLong",SilverpeasException.ERROR,"root.EX_INVALID_ARG","Value="+value+" Type="+m_type,e);
        }
        return m_lValue;
    }
    ...
    protected boolean setValueBoolean(String value) throws UtilException
    {
        ...
        if (error)
        {
            throw new UtilException("Variant.setValueBoolean",SilverpeasException.ERROR,"root.EX_INVALID_ARG","Value="+value+" Type="+m_type);
        }
        return m_bValue;
    }
    ...
    protected float setValueFloat(String value) throws UtilException
    {
        ...
        {
            throw new UtilException("Variant.setValueFloat",SilverpeasException.ERROR,"root.EX_INVALID_ARG","Value="+value+" Type="+m_type,e);
        }
        return m_fValue;
    }
    ...
    protected Date setValueDate(String value) throws UtilException
    {
        ...
        {
            throw new UtilException("Variant.setValueDate",SilverpeasException.ERROR,"root.EX_INVALID_ARG","Value="+value+" Type="+m_type,e);
        }
        return m_dValue;
    }
}
