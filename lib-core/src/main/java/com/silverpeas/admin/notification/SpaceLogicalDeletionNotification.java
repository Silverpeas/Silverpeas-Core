 ...
 */
public class SpaceLogicalDeletionNotification extends SilverpeasNotification {

  private static final long serialVersionUID = -5651929204480502420L;

  protected SpaceLogicalDeletionNotification(String spaceId, String userId) {
    super(new NotificationSource().withUserId(userId), spaceId);
  }
