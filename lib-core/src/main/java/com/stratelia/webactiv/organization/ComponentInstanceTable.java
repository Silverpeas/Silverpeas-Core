...
public class ComponentInstanceTable extends Table
{
       ...
       throws SQLException
   {
       ...
       if (rs.wasNull()) i.createdBy = -1;

       i.orderNum = rs.getInt(7);
       if (rs.wasNull()) i.orderNum = -1;
       ...
       if (rs.wasNull()) i.updatedBy = -1;
       
       i.removedBy = rs.getInt(13);
       if (rs.wasNull()) i.removedBy = -1;
   ...
   {
       return (ComponentInstanceRow) getUniqueRow(
           SELECT_INSTANCE_BY_ID, id);
   }
   ...
   {
       return (ComponentInstanceRow) getUniqueRow(
           SELECT_USERROLE_INSTANCE, userRoleId);
   }

   static final private String SELECT_USERROLE_INSTANCE
      = "select "+aliasColumns("i", INSTANCE_COLUMNS)
       ...
       throws AdminPersistenceException
   {
       return (ComponentInstanceRow[])
           getRows(SELECT_ALL_SPACE_INSTANCES, spaceId)
           .toArray(new ComponentInstanceRow[0]);
   }
   
   static final private String SELECT_ALL_COMPO_IDS_IN_SPACE 
	   = "SELECT subSetId" 
    ...
    */ 
   public String[] getAllCompoIdsInSpace(int spaceId) throws AdminPersistenceException 
   { 
	   return (String[]) getIds(SELECT_ALL_COMPO_IDS_IN_SPACE, spaceId).toArray(new String[0]);
   } 

   static final private String SELECT_ALL_SPACE_INSTANCES
   ...
   {
       return (String[])
           getIds(SELECT_ALL_SPACE_INSTANCE_IDS, spaceId)
   ...
   {
       return (ComponentInstanceRow[]) getRows(SELECT_REMOVED_COMPONENTS).toArray(new ComponentInstanceRow[0]);
   }

   static final private String SELECT_REMOVED_COMPONENTS
      = "select "+INSTANCE_COLUMNS+" from ST_ComponentInstance"
    ...
    */
   /*public String[] getAvailCompoIdsInSpace(int spaceId, int userId)
       throws AdminPersistenceException
   {
		int[] ids = new int[2];
		ids[0] = spaceId;
		ids[1] = userId;
		return (String[])
				getIds(SELECT_AVAIL_COMPO_IDS_IN_SPACE, ids)
				.toArray(new String[0]);
   }
       ...
       throws AdminPersistenceException
   {
		...
		ids[2] = spaceId;
		return (ComponentInstanceRow[])
				getRows(SELECT_AVAIL_COMPO_IN_SPACE, ids)
				.toArray(new ComponentInstanceRow[0]);
   }
   ...
   static final private String IS_COMPONENT_AVAILABLE
      = "SELECT userSetId"
	  + " FROM ST_UserSet_User_Rel"
	  + " WHERE userSetId = ? AND userSetType='I'"
	  + " AND userId = ? "
   	  + " UNION"
   	  + " SELECT C.id"
   	  + " FROM ST_ComponentInstance C"
   	  + " WHERE C.componentStatus is null"
   	  + " AND C.id = ? AND C.isPublic = 1";

   /**
    * Returns available components for given user in given space
    */
   public ComponentInstanceRow[] getAvailComposInSpaceAtRoot(int spaceId, int userId)
       throws AdminPersistenceException
   {
		int[] ids = new int[4];
		ids[0] = spaceId;
		...
		ids[3] = spaceId;
		return (ComponentInstanceRow[])
				getRows(SELECT_AVAIL_COMPO_IN_SPACE_AT_ROOT, ids)
				.toArray(new ComponentInstanceRow[0]);
   }
   ...
   /*static final private String SELECT_AVAIL_COMPO_IDS_IN_SPACE_AT_ROOT
	  ...
	  + " AND subSetId = userSetId AND subSetType='I' AND userSetType='I'"
	  + " AND userId = ?"
	  + " AND ST_ComponentInstance.spaceid = ?"
      + " order by ST_ComponentInstance.orderNum";*/
    ...
    */
   public String[] getAvailCompoIds(int userId)
       throws AdminPersistenceException
   {
   ...
   static final private String SELECT_AVAIL_COMPO_IDS
      = "SELECT "+INSTANCE_COLUMNS
   ...
   public List getAvailableComponents(int userId, String componentName) throws AdminPersistenceException
   {
	   	int[] ids = new int[1];
		ids[0] = userId;
   ...
   static final private String SELECT_AVAIL_COMPO_BY_NAME
   	  = "SELECT "+ INSTANCE_COLUMNS
	  + " FROM ST_UserSet_User_Rel U, ST_ComponentInstance C"
	  + " WHERE U.userSetType='I' AND C.id = userSetId"
	  + " AND U.userId = ?"
	  + " AND C.componentName = ?"
	  + " AND C.componentStatus is null"
	  + " UNION"
   ...
   /*public String[] getAvailableComponentIds(int userId, String componentName) throws AdminPersistenceException
   {
	   	int[] ids = new int[1];
		ids[0] = userId;
		String[] params = new String[1];
		params[0] = componentName;
		return (String[]) getIds(SELECT_AVAIL_COMPO_IDS_BY_NAME, ids, params).toArray(new String[0]);
   }
    ...
    * whose fields match those of the given sample instance fields.
    */
   public ComponentInstanceRow[] getAllMatchingComponentInstances(
       ComponentInstanceRow sampleInstance)
       throws AdminPersistenceException
   {
	   ...
	   String[] values = new String[] {
	       sampleInstance.componentName,
	       sampleInstance.name,
		   sampleInstance.description};

       return (ComponentInstanceRow[]) getMatchingRows(
	       INSTANCE_COLUMNS, columns, values)
       .toArray(new ComponentInstanceRow[0]);
   }
       ...
       throws AdminPersistenceException
   {
	  ...
	  if (space == null)
	  {
         throw new AdminPersistenceException("ComponentInstanceTable.createComponentInstance", SilverpeasException.ERROR, "admin.EX_ERR_SPACE_NOT_FOUND");
	  }

      insertRow(INSERT_INSTANCE, instance);
      organization.userSet.createUserSet("I", instance.id);
      organization.userSet.addUserSetInUserSet("I", instance.id,
	                                           "S", instance.spaceId);

      CallBackManager.invoke(CallBackManager.ACTION_AFTER_CREATE_COMPONENT, instance.id, null, null);
   }
       ...
       throws SQLException
   {
       ...
       if (i.createdBy == -1) insert.setNull(6, Types.INTEGER);
       else                   insert.setInt(6, i.createdBy);
   ...
   static final private String UPDATE_COMPONENT_ORDER
      = "update ST_ComponentInstance set"
      + " orderNum = ?"
      + " where id = ?";
   ...
   static final private String UPDATE_INSTANCE
      = "update ST_ComponentInstance set"
      + " name = ?,"
      + " description = ?,"
      + " createdBy = ?,"
...
//    + " createTime = ?,"
   ...
   public void sendComponentToBasket(int id, String tempLabel, String userId) throws AdminPersistenceException
   {
       ...
       {
 		  throw new AdminPersistenceException("ComponentInstanceTable.sendComponentToBasket", SilverpeasException.ERROR, "admin.EX_ERR_UPDATE", e);
       }
       finally
       {
       ...
       throws AdminPersistenceException
   {
       ...
       {
		  throw new AdminPersistenceException("ComponentInstanceTable.restoreComponentFromBasket", SilverpeasException.ERROR, "admin.EX_ERR_UPDATE", e);
       }
       finally
       {
    	   organization.releaseStatement(statement);
...
//NEWF DLE
       ...
       throws SQLException
   {
       ...
       if (i.createdBy == -1) update.setNull(3, Types.INTEGER);
       else                   update.setInt(3, i.createdBy);
       update.setInt(4, i.orderNum);
       
       update.setString(5, String.valueOf(new Date().getTime()));
       if (i.updatedBy == -1) update.setNull(6, Types.INTEGER);
       else                   update.setInt(6, i.updatedBy);
   ...
   public void removeComponentInstance(int id)
       throws AdminPersistenceException
   {
       CallBackManager.invoke(CallBackManager.ACTION_BEFORE_REMOVE_COMPONENT, id, null, null);
       ComponentInstanceRow instance = getComponentInstance(id);
	   if (instance == null) return;

	   // delete component roles
       UserRoleRow[] roles
           = organization.userRole.getAllUserRolesOfInstance(id);
	   ...
	   organization.userSet.removeUserSetFromUserSet("I", id,
	                                                 "S", instance.spaceId);
   ...
   static final private String DELETE_INSTANCE
      = "delete from ST_ComponentInstance where id = ?";
