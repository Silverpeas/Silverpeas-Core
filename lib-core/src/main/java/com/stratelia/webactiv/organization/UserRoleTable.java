...
public class UserRoleTable extends Table
{
   ...
   static final private String SELECT_USERROLE_BY_ID
      = "select "+USERROLE_COLUMNS+" from ST_UserRole where id = ?";
   ...
   public UserRoleRow getUserRole(int instanceId, String roleName)
       throws AdminPersistenceException
   {
       UserRoleRow[] userRoles
           =(UserRoleRow[]) getRows(SELECT_USERROLE_BY_ROLENAME,
                                   new int[]{instanceId},
                                   new String[]{roleName})
                           .toArray(new UserRoleRow[0]);

       if (userRoles.length == 0) return null;
       else if (userRoles.length == 1) return userRoles[0];
       else
       {
		  throw new AdminPersistenceException("UserRoleTable.getUserRole", SilverpeasException.ERROR, "admin.EX_ERR_USERROLE_NAME_INSTANCEID_FOUND_TWICE", "instance id : '" + instanceId + "', userrole name: '" + roleName + "'");
       }
   }

   static final private String SELECT_USERROLE_BY_ROLENAME
      = "select "+USERROLE_COLUMNS
      + " from ST_UserRole where instanceId = ? and name = ? and objectId is null";

   /**
    * Returns all the UserRoles.
    */
   public UserRoleRow[] getAllUserRoles()
       throws AdminPersistenceException
   {
       return (UserRoleRow[]) getRows(SELECT_ALL_USERROLES)
           .toArray(new UserRoleRow[0]);
   }

   static final private String SELECT_ALL_USERROLES
      = "select "+USERROLE_COLUMNS+" from ST_UserRole";
   ...
   static final private String SELECT_ALL_INSTANCE_USERROLES
      = "select "+USERROLE_COLUMNS+" from ST_UserRole where instanceId = ? ";
    ...
    */
   public String[] getAllUserRoleIdsOfObject(int objectId, String objectType, int instanceId)
       throws AdminPersistenceException
   {
	   int[] 	params 	= new int[] {instanceId, objectId};
	   String[] sParams = new String[] {objectType};
       return (String[]) getIds(SELECT_ALL_OBJECT_USERROLE_IDS, params, sParams).toArray(new String[0]);
   }

   static final private String SELECT_ALL_OBJECT_USERROLE_IDS = "select id from ST_UserRole where instanceId = ? and objectId = ? and objectType = ? ";
   
   /**
    * Returns all the role names of a user for an object in a given instance.
    */
   public UserRoleRow[] getRolesOfUserAndObject(int objectId, String objectType, int instanceId, int userId) throws AdminPersistenceException
   {
	   int[] 	params 	= new int[] {instanceId, objectId, userId};
	   String[] sParams = new String[] {objectType};
       return (UserRoleRow[]) getRows(SELECT_ALL_USER_USERROLE_NAMES, params, sParams).toArray(new UserRoleRow[0]);
   }
   
   static final private String SELECT_ALL_USER_USERROLE_NAMES
   = "select "+USERROLE_COLUMNS
   + " from ST_UserRole, ST_UserSet_User_Rel"
   + " where id=userSetId and userSetType='"+UserSetRow.RIGHTS+"' and instanceId = ? and objectId=? and userId = ? and objectType = ? ";
   ...
   public UserRoleRow[] getAllUserRolesOfUser(int userId)
       throws AdminPersistenceException
   {
       return (UserRoleRow[]) getRows(SELECT_ALL_USER_USERROLES, userId)
           .toArray(new UserRoleRow[0]);
   }

   static final private String SELECT_ALL_USER_USERROLES
      = "select "+USERROLE_COLUMNS
      + " from ST_UserRole,ST_UserSet_User_Rel"
      + " where id=userSetId and userSetType='"+UserSetRow.RIGHTS+"' and userId=? and objectId is null";
   ...
   public String[] getAllUserRoleIdsOfUser(int userId)
       throws AdminPersistenceException
   {
       return (String[]) getIds(SELECT_ALL_USER_USERROLE_IDS, userId)
           .toArray(new String[0]);
   }
   ...
   public String[] getAllUserRoleIdsOfGroup(int groupId)
       throws AdminPersistenceException
   {
       return (String[]) getIds(SELECT_ALL_GROUP_USERROLE_IDS, groupId)
           .toArray(new String[0]);
   }
   static final private String SELECT_ALL_GROUP_USERROLE_IDS
      = "select id from ST_UserRole,ST_UserSet_UserSet_Rel"
      + " where id = superSetId and superSetType='"+UserSetRow.RIGHTS+"' and subSetType='"+ObjectType.GROUP+"' and subSetId=? and objectId is null";

   /**
    * Returns all the userRole of a given user for a given instance.
    */
   public UserRoleRow[] getAllUserRolesOfUserOfInstance(
       int userId, int instanceId)
       throws AdminPersistenceException
   {
       int[] params = new int[] {instanceId, userId};
       return (UserRoleRow[])
           getRows(SELECT_ALL_USER_USERROLES_IN_INSTANCE, params)
           .toArray(new UserRoleRow[0]);
   }

   static final private String SELECT_ALL_USER_USERROLES_IN_INSTANCE
      = "select "+USERROLE_COLUMNS
      + " from ST_UserRole,ST_UserSet_User_Rel"
      + " where id=userSetId and instanceId=?"
      + " and userSetType='"+UserSetRow.RIGHTS+"' and userId=? and objectId is null";
   ...
   public UserRoleRow[] getDirectUserRolesOfUser(int userId)
       throws AdminPersistenceException
   {
       return (UserRoleRow[]) getRows(SELECT_USER_USERROLES, userId)
           .toArray(new UserRoleRow[0]);
   }

   static final private String SELECT_USER_USERROLES
      = "select "+USERROLE_COLUMNS
      + " from ST_UserRole, ST_UserRole_User_Rel"
      + " where id = userRoleId"
      + " and userId = ? ";
   ...
   public UserRoleRow[] getDirectUserRolesOfGroup(int groupId)
       throws AdminPersistenceException
   {
       return (UserRoleRow[]) getRows(SELECT_GROUP_USERROLES, groupId)
           .toArray(new UserRoleRow[0]);
   }

   static final private String SELECT_GROUP_USERROLES
      = "select "+USERROLE_COLUMNS
      + " from ST_UserRole, ST_UserRole_Group_Rel"
      + " where id = userRoleId"
      + " and groupId = ? ";

   /**
    * Returns the UserRole
    * whose fields match those of the given sample UserRole fields.
    */
   ...
   public void createUserRole(UserRoleRow userRole) throws AdminPersistenceException
   {
       ...
       if (instance == null)
       {
		   throw new AdminPersistenceException("UserRoleTable.createUserRole", SilverpeasException.ERROR, "admin.EX_ERR_INSTANCE_NOT_FOUND", "instance id : '" + userRole.instanceId + "'");
       }
       
       if (userRole.objectId != -1 && !StringUtil.isDefined(userRole.objectType))
       {
    	   throw new AdminPersistenceException("UserRoleTable.createUserRole", SilverpeasException.ERROR, "admin.EX_ERR_OBJECT_TYPE_NOT_SPECIFIED", "objectId = "+userRole.objectId);
       }
      ...
      {
    	  organization.userSet.createUserSet(userRole.objectType, userRole.objectId);
    	  organization.userSet.addUserSetInUserSet(UserSetRow.RIGHTS, userRole.id, userRole.objectType, userRole.objectId);   	  
      }
      else
    	  organization.userSet.addUserSetInUserSet(UserSetRow.RIGHTS, userRole.id, ObjectType.INSTANCE, userRole.instanceId);
   }

   static final private String INSERT_USERROLE
      = "insert into"
   ...
   static final private String UPDATE_USERROLE
      = "update ST_UserRole set"
      + " name = ?,"
      + " description = ?"
      + " where id = ?";
   ...
   static final private String DELETE_USERROLE
      = "delete from ST_UserRole where id = ?";
   ...
   static final private String SELECT_COUNT_USERSET_USER_REL
      ...
      + " where userId = ? and userSetId = ? and userSetType='"+UserSetRow.RIGHTS+"'";
   ...
   public void addUserInUserRole(int userId, int userRoleId)
       throws AdminPersistenceException
   {
       if (isUserDirectlyInRole(userId, userRoleId)) return ;

       UserRow user = organization.user.getUser(userId);
       if (user == null)
       {
		   throw new AdminPersistenceException("UserRoleTable.addUserInUserRole", SilverpeasException.ERROR, "admin.EX_ERR_USER_NOT_FOUND", "user id : '" + userId + "'");
       }

       UserRoleRow userRole = getUserRole(userRoleId);
       if (userRole == null)
       {
		   throw new AdminPersistenceException("UserRoleTable.addUserInUserRole", SilverpeasException.ERROR, "admin.EX_ERR_USERROLE_NOT_FOUND", "user role id : '" + userRoleId + "'");
       }
       ...
       throws AdminPersistenceException
   {
       ...
       {
	       throw new AdminPersistenceException("UserRoleTable.removeUserFromUserRole", SilverpeasException.ERROR, "admin.EX_ERR_USER_NOT_IN_USERROLE", "userrole id: '" + userRoleId +"', user id: '" + userId + "'");
       }

	   SynchroReport.debug("UserRoleTable.removeUserFromUserRole()", "Retrait (ou décrément) de la relation entre l'utilisateur d'ID " + userId + " et le role d'ID " + userRoleId + " dans la table ST_UserSet_User_Rel",null);
       organization.userSet.removeUserFromUserSet(userId, UserSetRow.RIGHTS, userRoleId);
   ...
   static final private String SELECT_COUNT_USERSET_GROUP_REL
      ...
      + " where subSetType='"+ObjectType.GROUP+"' and subSetId=?"
   ...
   public void addGroupInUserRole(int groupId, int userRoleId)
       throws AdminPersistenceException
   {
       if (isGroupDirectlyInRole(groupId, userRoleId)) return ;

       GroupRow group = organization.group.getGroup(groupId);
       if (group == null)
       {
		   throw new AdminPersistenceException("UserRoleTable.addGroupInUserRole", SilverpeasException.ERROR, "admin.EX_ERR_GROUP_NOT_FOUND", "group id : '" + groupId + "'");
       }

       UserRoleRow userRole = getUserRole(userRoleId);
       if (userRole == null)
       {
		   throw new AdminPersistenceException("UserRoleTable.addGroupInUserRole", SilverpeasException.ERROR, "admin.EX_ERR_USERROLE_NOT_FOUND", "user role id : '" + userRoleId + "'");
       }

       int[] params = new int[] {userRoleId,groupId};
       updateRelation(INSERT_A_USERROLE_GROUP_REL, params);

       organization.userSet.addUserSetInUserSet(ObjectType.GROUP, groupId, UserSetRow.RIGHTS, userRoleId);
   }
       ...
       throws AdminPersistenceException
   {
       ...
       {
	       throw new AdminPersistenceException("UserRoleTable.removeGroupFromUserRole", SilverpeasException.ERROR, "admin.EX_ERR_GROUP_NOT_IN_USERROLE", "userrole id: '" + userRoleId +"', group id: '" + groupId + "'");
       }

	   SilverTrace.debug("admin","UserRoleTable.removeGroupFromUserRole()", "Suppression (ou décrément) des relations liant le groupe d'ID " + groupId +" et le role d'ID " + userRoleId + " dans les tables ST_UserSet_UserSet_Rel et ST_UserSet_User_Rel",new AdminPersistenceException("UserRoleTable.removeGroupFromUserRole", SilverpeasException.ERROR, "admin.EX_ERR_GROUP_NOT_IN_USERROLE", "BOB"));
	   SynchroReport.debug("UserRoleTable.removeGroupFromUserRole()", "Suppression (ou décrément) des relations liant le groupe d'ID " + groupId +" et le role d'ID " + userRoleId + " dans les tables ST_UserSet_UserSet_Rel et ST_UserSet_User_Rel",null);
   ...
   public boolean isObjectAvailable(int userId, int componentId, int objectId, String objectType) throws AdminPersistenceException
   {
   ...
   static final private String IS_OBJECT_AVAILABLE
      = "SELECT userSetId"
