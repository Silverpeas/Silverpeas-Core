...
public class GroupTable extends Table<GroupRow> {
  ...
  public String[] searchGroupsIds(boolean isRootGroup, int componentId, int[] aRoleId,
    ...
    concatAndOr =
        addIdToQuery(ids, theQuery, groupModel.domainId, "ST_Group.domainId", concatAndOr,
        andOr);
    ...
    return getIds(theQuery.toString(), idsArray, params.toArray(new String[params.size()]))
        .toArray(
        new String[getIds(theQuery.toString(), idsArray,
  ...
  public GroupRow[] searchGroups(GroupRow groupModel, boolean isAnd) throws
    ...
    return getRows(theQuery.toString(), idsArray, params.toArray(new String[params.size()]))
        .toArray(
