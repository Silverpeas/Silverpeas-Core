...
public class GroupTable extends Table
{
       ...
       throws SQLException
   {
       ...
       if (rs.wasNull()) g.superGroupId = -1;
   ...
   static final private String SELECT_GROUP_BY_ID
      = "select "+GROUP_COLUMNS+" from ST_Group where id = ?";
   ...
   public String[] getManageableSpaceIds(int groupId)
       throws AdminPersistenceException
   {
       return (String[]) getIds(SELECT_ALL_MANAGEABLE_SPACE_IDS, groupId)
       ...
       throws AdminPersistenceException
   {
       ...
       else if (groups.length == 1) return groups[0];
       else
       {
	      throw new AdminPersistenceException("GroupTable.getGroupBySpecificId", SilverpeasException.ERROR, "admin.EX_ERR_GROUP_SPECIFIC_ID_FOUND_TWICE", "domain Id: '" + domainId + "', specific Id: '" + specificId + "'");
       }
   }

   static final private String SELECT_GROUP_BY_SPECIFICID
      = "select "+GROUP_COLUMNS+" from ST_Group where domainId = ? and specificId = ?";
       ...
       throws AdminPersistenceException
   {
       ...
       {
	      throw new AdminPersistenceException("GroupTable.getRootGroup", SilverpeasException.ERROR, "admin.EX_ERR_GROUP_NAME_FOUND_TWICE", "group name: '" + name + "'");
       }
   }

   static final private String SELECT_ROOT_GROUP_BY_NAME
       ...
       throws AdminPersistenceException
   {
       ...
       {
	      throw new AdminPersistenceException("GroupTable.getGroup", SilverpeasException.ERROR, "admin.EX_ERR_GROUP_NAME_ID_FOUND_TWICE", "group name: '" + name + "', father group id: '" + superGroupId +"'");
       }
   }

   static final private String SELECT_GROUP_BY_NAME
      = "select "+GROUP_COLUMNS
      + " from ST_Group"
      + " where superGroupId = ? and name = ?";
   ...
   public GroupRow[] getAllGroups()
       throws AdminPersistenceException
   {
       return (GroupRow[]) getRows(SELECT_ALL_GROUPS)
           .toArray(new GroupRow[0]);
   }

   static final private String SELECT_ALL_GROUPS
      = "select "+GROUP_COLUMNS+" from ST_Group";
   ...
   public GroupRow[] getSynchronizedGroups()
       throws AdminPersistenceException
   {
       return (GroupRow[]) getRows(SELECT_SYNCHRONIZED_GROUPS)
           .toArray(new GroupRow[0]);
   }

   static final private String SELECT_SYNCHRONIZED_GROUPS
      = "select "+GROUP_COLUMNS+" from ST_Group where synchroRule is not null and synchroRule <> ''";
   ...
   public String[] getAllGroupIds()
       throws AdminPersistenceException
   {
       return (String[]) getIds(SELECT_ALL_GROUP_IDS)
           .toArray(new String[0]);
   }

   static final private String SELECT_ALL_GROUP_IDS
      = "select id from ST_Group";
   ...
   static final private String SELECT_ALL_ROOT_GROUPS
      = "select "+GROUP_COLUMNS+" from ST_Group where superGroupId is null";
   ...
   public String[] getAllRootGroupIds()
       throws AdminPersistenceException
   {
       return (String[]) getIds(SELECT_ALL_ROOT_GROUP_IDS)
           .toArray(new String[0]);
   }
   ...
   public GroupRow[] getDirectSubGroups(int superGroupId)
       throws AdminPersistenceException
   {
       return (GroupRow[]) getRows(SELECT_SUBGROUPS, superGroupId)
           .toArray(new GroupRow[0]);
   }
   ...
   public String[] getDirectSubGroupIds(int superGroupId)
       throws AdminPersistenceException
   {
       return (String[]) getIds(SELECT_SUBGROUP_IDS, superGroupId)
           .toArray(new String[0]);
   }
   ...
   public String[] getAllSubGroupIds(int superGroupId)
       throws AdminPersistenceException
   {
       return (String[]) getIds(SELECT_ALL_SUBGROUPS, superGroupId)
           .toArray(new String[0]);
   }

   static final private String SELECT_ALL_SUBGROUPS
      = "select id"
       ...
       throws AdminPersistenceException
   {
       ...
       return (GroupRow[]) getRows(SELECT_ALL_GROUPS_IN_DOMAIN, domainId)
           .toArray(new GroupRow[0]);
   }
   ...
   static final private String SELECT_SUPERGROUP
      = "select "+aliasColumns("sg", GROUP_COLUMNS)
      + " from ST_Group sg, ST_GROUP g"
   ...
   public GroupRow[] getAllSuperGroups(int subGroupId)
       throws AdminPersistenceException
   {
       return (GroupRow[]) getRows(SELECT_ALL_SUPERGROUPS, subGroupId)
           .toArray(new GroupRow[0]);
   }

   static final private String SELECT_ALL_SUPERGROUPS
      = "select "+GROUP_COLUMNS
      + " from ST_Group,ST_UserSet_UserSet_Rel"
   ...
   public GroupRow[] getDirectGroupsOfUser(int userId)
       throws AdminPersistenceException
   {
       return (GroupRow[]) getRows(SELECT_USER_GROUPS, userId)
           .toArray(new GroupRow[0]);
   }

   static final private String SELECT_USER_GROUPS
      = "select "+GROUP_COLUMNS
   ...
   public GroupRow[] getAllGroupsOfUser(int userId)
       throws AdminPersistenceException
   {
       return (GroupRow[]) getRows(SELECT_ALL_USER_GROUPS, userId)
           .toArray(new GroupRow[0]);
   }

   static final private String SELECT_ALL_USER_GROUPS
      = "select "+GROUP_COLUMNS
      + " from ST_Group,ST_UserSet_User_Rel"
   ...
   public GroupRow[] getDirectGroupsInUserRole(int userRoleId)
       throws AdminPersistenceException
   {
       return (GroupRow[]) getRows(SELECT_USERROLE_GROUPS, userRoleId)
           .toArray(new GroupRow[0]);
   }

   static final private String SELECT_USERROLE_GROUPS
      = "select "+GROUP_COLUMNS
   ...
   public String[] getDirectGroupIdsInUserRole(int userRoleId)
       throws AdminPersistenceException
   {
       return (String[]) getIds(SELECT_USERROLE_GROUP_IDS, userRoleId)
           .toArray(new String[0]);
   }
   ...
   static final private String SELECT_ALL_USERROLE_GROUPS
      = "select "+GROUP_COLUMNS
      + " from ST_Group,ST_UserSet_UserSet_Rel"
      + " where id=subSetId and subSetType = 'G'"
   ...
   static final private String SELECT_SPACEUSERROLE_GROUPS
      = "select "+GROUP_COLUMNS
      + " from ST_Group,ST_SpaceUserRole_Group_Rel"
   ...
   public GroupRow[] getAllGroupsInSpaceUserRole(int spaceUserRoleId)
       throws AdminPersistenceException
   {
       return (GroupRow[]) getRows(SELECT_ALL_SPACEUSERROLE_GROUPS, spaceUserRoleId)
           .toArray(new GroupRow[0]);
   }

   static final private String SELECT_ALL_SPACEUSERROLE_GROUPS
      = "select "+GROUP_COLUMNS
      + " from ST_Group,ST_UserSet_UserSet_Rel"
      + " where id=subSetId and subSetType = 'G'"
   ...
   static final private String SELECT_GROUPUSERROLE_GROUPS
      = "select "+GROUP_COLUMNS
      + " from ST_Group,ST_GroupUserRole_Group_Rel"
   ...
   static final private String SELECT_GROUPUSERROLE_GROUP
      = "select "+aliasColumns("i", GROUP_COLUMNS)
	  + " from ST_Group i, ST_GroupUserRole us"
	  + " where i.id = us.groupId"
	  + " and   us.id = ?";
   ...
   /**
    * Returns the Group
    * whose fields match those of the given sample group fields.
    */
    ...
    */
   public String[] searchGroupsIds(boolean isRootGroup, int componentId, int[] aRoleId, GroupRow groupModel)
       throws AdminPersistenceException
   {
       ...
       else if (componentId >= 0)
       {
           ...
           theQuery.append(" WHERE ((ST_UserRole.id = ST_UserRole_Group_Rel.userRoleId) AND (ST_Group.id = ST_UserRole_Group_Rel.groupId) AND (ST_UserRole.instanceId = ?)");
           concatAndOr = true;
       }
       else
       {
       ...
       {
           concatAndOr = addIdToQuery(ids, theQuery, groupModel.superGroupId, "ST_Group.superGroupId", concatAndOr, andOr);
       }
       concatAndOr = addIdToQuery(ids, theQuery, groupModel.id, "ST_Group.id", concatAndOr, andOr);
       concatAndOr = addIdToQuery(ids, theQuery, groupModel.domainId, "ST_Group.domainId", concatAndOr, andOr);
       concatAndOr = addParamToQuery(params, theQuery, groupModel.name, "ST_Group.name", concatAndOr, andOr);
       concatAndOr = addParamToQuery(params, theQuery, groupModel.description, "ST_Group.description", concatAndOr, andOr);
       concatAndOr = addParamToQuery(params, theQuery, groupModel.specificId, "ST_Group.specificId", concatAndOr, andOr);
       if (concatAndOr)
       {
           theQuery.append(")");
       }
       ...
       throws AdminPersistenceException
   {
       ...
       concatAndOr = addIdToQuery(ids, theQuery, groupModel.id, "id", concatAndOr, andOr);
       concatAndOr = addIdToQuery(ids, theQuery, groupModel.domainId, "domainId", concatAndOr, andOr);
       concatAndOr = addIdToQuery(ids, theQuery, groupModel.superGroupId, "superGroupId", concatAndOr, andOr);
       concatAndOr = addParamToQuery(params, theQuery, groupModel.name, "name", concatAndOr, andOr);
       concatAndOr = addParamToQuery(params, theQuery, groupModel.description, "description", concatAndOr, andOr);
       concatAndOr = addParamToQuery(params, theQuery, groupModel.specificId, "specificId", concatAndOr, andOr);
       if (concatAndOr)
       {
           theQuery.append(")");
       }
       ...
       return (GroupRow[]) getRows(theQuery.toString(),idsArray,(String[])params.toArray(new String[0])).toArray(new GroupRow[0]);
   }

   static final private String SELECT_SEARCH_GROUPS
      = "select "+GROUP_COLUMNS+", UPPER(name)"
      + " from ST_Group";
       ...
       throws AdminPersistenceException
   {
      ...
      if (group.superGroupId != -1)
      {
          ...
          if (superGroup == null)
          {
		      throw new AdminPersistenceException("GroupTable.createGroup", SilverpeasException.ERROR, "admin.EX_ERR_GROUP_NOT_FOUND", "father group id: '" + group.superGroupId +"'");
          }
      }

 	  SynchroReport.debug("GroupTable.createGroup()", "Ajout de " + group.name + ", requête : "+INSERT_GROUP,null);
       insertRow(INSERT_GROUP, group);
 	  SynchroReport.debug("GroupTable.createGroup()", "Ajout du groupe " + group.name + " dans la table ST_UserSet",null);
       organization.userSet.createUserSet("G", group.id);

       if (superGroup != null)
       {
 		  SynchroReport.debug("GroupTable.createGroup()", "Ajout (ou incrément) de relations entre le groupe " + group.name + " d'ID " + group.id +" et son groupe père d'ID " + superGroup.id + " dans la table ST_UserSet_UserSet_Rel",null);
           organization.userSet.addUserSetInUserSet("G", group.id,
                                                    "G", superGroup.id);
       }
       ...
       throws SQLException
   {
	   ...
	   if (g.superGroupId == -1) insert.setNull(4, Types.INTEGER);
       else                      insert.setInt(4, g.superGroupId);
       ...
       throws AdminPersistenceException
   {
       ...
       if ((oldGroup != null) && (oldGroup.superGroupId != -1) && (group.superGroupId != oldGroup.superGroupId))
       {
 		  SynchroReport.debug("GroupTable.updateGroup()", "Suppression (ou décrément) des relations liant le groupe " + group.name + " d'ID " + group.id +" et le groupe d'ID " + oldGroup.superGroupId + " dans les tables ST_UserSet_UserSet_Rel et ST_UserSet_User_Rel",null);
           organization.userSet.removeUserSetFromUserSet("G", group.id,
                                                         "G", oldGroup.superGroupId);
       }
       if ((oldGroup != null) && (group.superGroupId != -1) && (group.superGroupId != oldGroup.superGroupId))
       {
 		  SynchroReport.debug("GroupTable.updateGroup()", "Ajout (ou incrément) de relations entre le groupe " + group.name + " d'ID " + group.id +" et le groupe d'ID " + group.superGroupId + " dans les tables ST_UserSet_UserSet_Rel et ST_UserSet_User_Rel",null);
           organization.userSet.addUserSetInUserSet("G", group.id,
                                                    "G", group.superGroupId);
       }
   }

   static final private String UPDATE_GROUP
      = "update ST_Group set"
      + " domainId = ?,"
      + " specificId = ?,"
      + " name = ?,"
       ...
       throws AdminPersistenceException
   {
        ...
        {
           organization.spaceUserRole.removeGroupFromSpaceUserRole(id, spaceRoles[i].id);
        }
   ...
   static final private String DELETE_GROUP
      = "delete from ST_Group where id = ?";
   ...
   public void addUserInGroup(int userId, int groupId)
       throws AdminPersistenceException
   {
       if (isUserDirectlyInGroup(userId, groupId)) return;

       UserRow user = organization.user.getUser(userId);
       if (user == null)
       {
	       throw new AdminPersistenceException("GroupTable.addUserInGroup", SilverpeasException.ERROR, "admin.EX_ERR_USER_NOT_FOUND", "user id: '" + userId +"'");
       }

       GroupRow group = getGroup(groupId);
       if (group == null)
       {
	       throw new AdminPersistenceException("GroupTable.addUserInGroup", SilverpeasException.ERROR, "admin.EX_ERR_GROUP_NOT_FOUND", "group id: '" + groupId +"'");
       }
       ...
       int[] params = new int[] {groupId,userId};
 	   ...
 	   SynchroReport.debug("GroupTable.addUserInGroup()", "Ajout (ou incrément) de relations entre l'utilisateur d'ID " + userId + " et le groupe d'ID : " + groupId + " dans la table ST_UserSet_User_Rel",null);
   ...
   public void addUsersInGroup(String[] userIds, int groupId, boolean checkRelation)
       throws AdminPersistenceException
   {
	   SilverTrace.info("admin", "GroupTable.addUsersInGroup", "root.MSG_GEN_ENTER_METHOD", "groupId = "+groupId+", userIds = "+userIds.toString());
	   
	   GroupRow group = getGroup(groupId);
       if (group == null)
       {
	       throw new AdminPersistenceException("GroupTable.addUsersInGroup", SilverpeasException.ERROR, "admin.EX_ERR_GROUP_NOT_FOUND", "group id: '" + groupId +"'");
       }
       ...
       for (int u=0; u<userIds.length; u++)
       {
    	   ...
    	   if (!userInGroup)
    	   {
	           ...
	           if (user == null)
	           {
	    	       throw new AdminPersistenceException("GroupTable.addUsersInGroup", SilverpeasException.ERROR, "admin.EX_ERR_USER_NOT_FOUND", "user id: '" + userId +"'");
	           }
	           ...
	           int[] params = new int[] {groupId,userId};
	            ...
	            updateRelation(INSERT_A_GROUP_USER_REL, params);
	            SynchroGroupReport.debug("GroupTable.addUsersInGroup()", "Ajout (ou incrément) de relations entre l'utilisateur d'ID " + userId + " et le groupe d'ID : " + groupId + " dans la table ST_UserSet_User_Rel",null);
	           organization.userSet.addUserInUserSet(userId, "G", groupId);
    	   }
       }
   }
       ...
       throws AdminPersistenceException
   {
        ...
        {
 	      throw new AdminPersistenceException("GroupTable.removeUserFromGroup", SilverpeasException.ERROR, "admin.EX_ERR_USER_NOT_IN_GROUP", "group id: '" + groupId +"', user id: '" + userId + "'");
        }
        SynchroReport.debug("GroupTable.removeUserFromGroup()", "Retrait (ou décrément) des relations liant l'utilisateur d'ID " + userId + " et le groupe d'ID : " + groupId + " dans la table ST_UserSet_User_Rel",null);
   ...
   public void removeUsersFromGroup(String[] userIds, int groupId, boolean checkRelation)
       throws AdminPersistenceException
   {
	   SilverTrace.info("admin", "GroupTable.removeUsersFromGroup", "root.MSG_GEN_ENTER_METHOD", "groupId = "+groupId+", userIds = "+userIds.toString());
	   GroupRow group = getGroup(groupId);
       if (group == null)
       {
	       throw new AdminPersistenceException("GroupTable.removeUsersFromGroup()", SilverpeasException.ERROR, "admin.EX_ERR_GROUP_NOT_FOUND", "group id: '" + groupId +"'");
       }
       ...
       for (int u=0; u<userIds.length; u++)
       {
    	   ...
    	   if (userInGroup)
    	   {
    		   SynchroGroupReport.debug("GroupTable.removeUsersFromGroup()", "Retrait (ou décrément) des relations liant l'utilisateur d'ID " + userId + " et le groupe d'ID : " + groupId + " dans la table ST_UserSet_User_Rel",null);
    	       organization.userSet.removeUserFromUserSet(userId, "G", groupId);
    	   ...
    	   {
    		   throw new AdminPersistenceException("GroupTable.removeUsersFromGroup()", SilverpeasException.ERROR, "admin.EX_ERR_USER_NOT_IN_GROUP", "group id: '" + groupId +"', user id: '" + userId + "'");
    	   }
       }
   }
