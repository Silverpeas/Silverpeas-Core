...
public class SpaceI18NTable extends Table
{
   ...
   static final private String COLUMNS
      = "id,spaceId,lang,name,description";
    ...
    */
   public List getTranslations(int spaceId)
       throws AdminPersistenceException
   {
       return getRows(SELECT_TRANSLATIONS, spaceId);
   }

   static final private String SELECT_TRANSLATIONS = "select "+COLUMNS+" from ST_SpaceI18N where spaceId = ?";
   ...
   static final private String DELETE_TRANSLATION
      = "delete from ST_SpaceI18N where id = ?";
   ...
   static final private String DELETE_TRANSLATIONS
      = "delete from ST_SpaceI18N where spaceId = ?";
