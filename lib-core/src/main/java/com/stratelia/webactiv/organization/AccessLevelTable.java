...
public class AccessLevelTable extends Table
{
	...
	static final private String ACCESSLEVEL_COLUMNS
      = "id,name";
   ...
   {
       return (AccessLevelRow[]) getRows(SELECT_ALL_ACCESSLEVELS)
           .toArray(new AccessLevelRow[0]);
   }

   static final private String SELECT_ALL_ACCESSLEVELS
      = "select "+ACCESSLEVEL_COLUMNS+" from ST_AccessLevel";
   ...
   static final private String SELECT_ACCESSLEVEL_BY_ID
      = "select "+ACCESSLEVEL_COLUMNS+" from ST_AccessLevel where id = ?";
