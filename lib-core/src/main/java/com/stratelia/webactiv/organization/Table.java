...
public abstract class Table
{
    ...
    *
    * Returns "u.id,u.firstName,u.lastName" for row alias "u"
    * columns list "id,firstName,lastName".
    */
   ...
   /**
    * Builds a new row object
    * which values are retrieved from the given ResultSet.
    */
   abstract protected Object fetchRow(ResultSet rs)
       throws SQLException;

   /**
    * Set all the parameters of the insert PreparedStatement
    * built from the insertQuery
    * in order to insert the given row.
    */
   ...
   /**
    * Set all the parameters of the update PreparedStatement
    * built from the updateQuery
    * in order to update the given row.
    */
    ...
    *
    * Returns null if no rows match the id.
    * Throws a AdminPersistenceException if more then one row match the id.
    *
    * @return the requiered row or null.
    *
    * @param  query    the sql query string
    *                  must be like "select * from ... where ... id=?"
    *                  where id is an int column.
       ...
       throws AdminPersistenceException
   {
       ...
       {
          throw new AdminPersistenceException("Table.getUniqueRow", SilverpeasException.ERROR, "root.EX_SQL_QUERY_FAILED", e);
       }
       finally
       {
    ...
    */
   protected ArrayList getIds(String query)
       throws AdminPersistenceException
   {
       ResultSet rs = null;
       PreparedStatement select = null;
       ...
       {
          throw new AdminPersistenceException("Table.getIds", SilverpeasException.ERROR, "root.EX_SQL_QUERY_FAILED", e);
       }
       finally
       {
            schema.releaseAll(rs,select);
       ...
       throws AdminPersistenceException
   {
       ResultSet rs = null;
        ...
        try
       {
		  SilverTrace.debug("admin", "Table.getRows", "root.MSG_QUERY", query + "  ids: " + ids);
          select = schema.getStatement(query);
          //synchronized (select)
          //{
   ...
   /**
    * Returns the rows described by the given query
    * with id and String parameters.
    */
       ...
       throws AdminPersistenceException
   {
       ...
       try
       {
		  SilverTrace.debug("admin", "Table.getIds", "root.MSG_QUERY", query + "  id[]: " + ids + "   params[]: " + params);
          select = schema.getStatement(query);
          //synchronized (select)
          //{
              int i,j;
    ...
    */
   protected ArrayList getRows(String query)
       throws AdminPersistenceException
   {
       ResultSet rs = null;
       PreparedStatement select = null;
       ...
       {
          throw new AdminPersistenceException("Table.getRows", SilverpeasException.ERROR, "root.EX_SQL_QUERY_FAILED", e);
       }
       finally
       {
            schema.releaseAll(rs,select);
       ...
       throws AdminPersistenceException
   {
       ...
       try
       {
		  SilverTrace.debug("admin", "Table.getRows", "root.MSG_QUERY", query + "  id[]: " + ids);
          select = schema.getStatement(query);
          //synchronized (select)
          //{
              for (int i=0; i<ids.length ; i++)
       ...
       throws AdminPersistenceException
   {
       ...
       try
       {
		  SilverTrace.debug("admin", "Table.getRows", "root.MSG_QUERY", query + "  params: " + params);
          select = schema.getStatement(query);
          //synchronized (select)
          //{
       ...
       throws AdminPersistenceException
   {
       ...
       try
       {
		  SilverTrace.debug("admin", "Table.getRows", "root.MSG_QUERY", query + "  id[]: " + ids + "   params[]: " + params);
          select = schema.getStatement(query);
          //synchronized (select)
          //{
              int i,j;
       ...
       throws AdminPersistenceException
   {
       ...
       {
          throw new AdminPersistenceException("Table.getCount", SilverpeasException.ERROR, "root.EX_SQL_QUERY_FAILED", e);
       }
       finally
       {
            schema.releaseAll(rs,select);
    ...
    * Returns the nb of rows in the given table agregated on the given column
    */
   protected int getCount(String tableName, String agregateColumn, String whereClause, int id, String param)
       throws AdminPersistenceException
   {
       ResultSet rs = null;
       String    query = "select count(*) as nbResult from " + tableName + " where " + whereClause;
       ...
       throws AdminPersistenceException
   {
       ...
       try
       {
		  SilverTrace.debug("admin", "Table.getCount", "root.MSG_QUERY", query + "  id[]: " + ids);
          select = schema.getStatement(query);
          //synchronized (select)
          //{
             for (int i=0; i<ids.length ; i++)
    ...
    * Returns the nb of rows in the given table agregated on the given column
    */
   protected int getCount(String tableName, String agregateColumn, String whereClause, String[] params)
       throws AdminPersistenceException
   {
       ResultSet rs = null;
       String    query = "select count(*) as nbResult from " + tableName + " where " + whereClause;
       ...
       try
       {
		  SilverTrace.debug("admin", "Table.getCount", "root.MSG_QUERY", query + "  params[]: " + params);
          select = schema.getStatement(query);
          //synchronized (select)
          //{
             for (int i=0; i<params.length ; i++)
    ...
    * Returns the nb of rows in the given table agregated on the given column
    */
   protected int getCount(String tableName, String agregateColumn, String whereClause, int[] ids, String[] params)
       throws AdminPersistenceException
   {
       ResultSet rs = null;
       String    query = "select count(*) as nbResult from " + tableName + " where " + whereClause;
       ...
       try
       {
		  SilverTrace.debug("admin", "Table.getCount", "root.MSG_QUERY", query + "  id[]: " + ids + "   params[]: " + params);
          select = schema.getStatement(query);
          //synchronized (select)
          //{
              int i,j;
    ...
    *
    * The sample is build from a matchColumns names list
    * and a matchValues list of values.
    * For each matchColumn with a non null matchValue
    * is added a criterium : where matchColumn like 'matchValue'
    *
    * The wildcard caracters %, must be set by the caller : so we
    * can choose and do queries as "login like 'exactlogin'"
    * and queries as "lastName like 'Had%'" or "lastName like '%addo%'".
    *
    * The returned rows are given by the returnedColumns parameter which is
    * of the form 'col1, col2, ..., colN'.
    */
    ...
    * returned by the given query with id parameters.
    *
       ...
       throws AdminPersistenceException
   {
       ...
       try
       {
		  SilverTrace.debug("admin", "Table.getInteger", "root.MSG_QUERY", query + "  ids[]: " + ids);
          select = schema.getStatement(query);
          //synchronized (select)
          //{
              for (int i=0; i<ids.length ; i++)
       ...
       {
          throw new AdminPersistenceException("Table.getInteger", SilverpeasException.ERROR, "root.EX_SQL_QUERY_FAILED", e);
       }
       finally
       {
            schema.releaseAll(rs,select);
   ...
   protected Object getUniqueRow(ResultSet rs)
       throws SQLException, AdminPersistenceException
   {
       Object            result = null;
       ...
       {
          // more then one row !
 		  throw new AdminPersistenceException("Table.getUniqueRow", SilverpeasException.ERROR, "admin.EX_ERR_NOT_UNIQUE_ROW");
       }
       return result;
   }

   protected ArrayList getRows(ResultSet rs)
       throws SQLException
   {
   ...
   protected ArrayList getIds(ResultSet rs)
       throws SQLException
   {
       ArrayList result = new ArrayList();
       ...
       throws SQLException, AdminPersistenceException
   {
       ...
       {
          // more then one row !
 		  throw new AdminPersistenceException("Table.getInteger", SilverpeasException.ERROR, "admin.EX_ERR_NOT_UNIQUE_ROW");
       }
       ...
       throws AdminPersistenceException
   {
       ...
       catch (SQLException e)
       {
		  SynchroReport.error("Table.insertRow()", "Exception SQL : " + e.getMessage(),null );
 		  throw new AdminPersistenceException("Table.insertRow", SilverpeasException.ERROR, "root.EX_RECORD_INSERTION_FAILED", e);
       }
       finally
       {
       ...
       throws AdminPersistenceException
   {
       ...
       catch (SQLException e)
       {
		  SynchroReport.error("Table.updateRow()", "Exception SQL : " + e.getMessage(),null );
 		  throw new AdminPersistenceException("Table.updateRow", SilverpeasException.ERROR, "admin.EX_ERR_UPDATE", e);
       }
       finally
       {
            schema.releaseStatement(statement);
       ...
       throws AdminPersistenceException
   {
       ...
       {
 		  throw new AdminPersistenceException("Table.updateRelation", SilverpeasException.ERROR, "admin.EX_ERR_UPDATE", e);
       }
       finally
       {
            schema.releaseStatement(statement);
       ...
       throws AdminPersistenceException
   {
       ...
       try
       {
          ...
          //synchronized (statement)
          //{
              if (param == -1) statement.setNull(1, Types.INTEGER);
              else             statement.setInt(1, param);
              rowsCount = statement.executeUpdate();
          //}
          return rowsCount;
       }
       ...
       throws AdminPersistenceException
   {
       ...
       try
       {
          ...
          //{
              for (int i=0 ; i < ids.length ; i++)
              {
                 if (ids[i] == -1) statement.setNull(i+1, Types.INTEGER);
                 else                statement.setInt(i+1, ids[i]);
              }
              rowsCount = statement.executeUpdate();
          //}
          return rowsCount;
   ...
   private String tableName = null;
    ...
    protected boolean addParamToQuery(Vector theVect, StringBuffer theQuery, String value, String column, boolean concatAndOr, String andOr)
    {
    ...
    protected boolean addIdToQuery(Vector theVect, StringBuffer theQuery, int value, String column, boolean concatAndOr, String andOr)
    {
        boolean valret = concatAndOr;
