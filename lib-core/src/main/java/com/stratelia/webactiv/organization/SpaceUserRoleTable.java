...
public class SpaceUserRoleTable extends Table
{
   ...
   static final private String SELECT_SPACEUSERROLE_BY_ID
      = "select "+SPACEUSERROLE_COLUMNS+" from ST_SpaceUserRole where id = ?";
   ...
   public SpaceUserRoleRow getSpaceUserRole(int spaceId, String RoleName)
       throws AdminPersistenceException
   {
       SpaceUserRoleRow[] spaceUserRoles
           =(SpaceUserRoleRow[]) getRows(SELECT_SPACEUSERROLE_BY_ROLENAME,
                                   new int[]{spaceId},
                                   new String[]{RoleName})
                           .toArray(new SpaceUserRoleRow[0]);

       if (spaceUserRoles.length == 0) return null;
       else if (spaceUserRoles.length == 1) return spaceUserRoles[0];
       else
       {
		  throw new AdminPersistenceException("SpaceUserRoleTable.getSpaceUserRole", SilverpeasException.ERROR, "admin.EX_ERR_SPACEUSERROLE_NAME_SPACEID_FOUND_TWICE", "space id : '" + spaceId + "', space userrole name: '" + RoleName + "'");
       }
   }

   static final private String SELECT_SPACEUSERROLE_BY_ROLENAME
      = "select "+SPACEUSERROLE_COLUMNS
   ...
   public SpaceUserRoleRow[] getAllSpaceUserRoles()
       throws AdminPersistenceException
   {
       return (SpaceUserRoleRow[]) getRows(SELECT_ALL_SPACEUSERROLES)
           .toArray(new SpaceUserRoleRow[0]);
   }

   static final private String SELECT_ALL_SPACEUSERROLES
      = "select "+SPACEUSERROLE_COLUMNS+" from ST_SpaceUserRole";
   ...
   static final private String SELECT_ALL_SPACE_USERROLES
      = "select "+SPACEUSERROLE_COLUMNS+" from ST_SpaceUserRole where spaceId = ?";
   ...
   public String[] getAllSpaceUserRoleIdsOfSpace(int spaceId)
       throws AdminPersistenceException
   {
       return (String[]) getIds(SELECT_ALL_SPACE_USERROLE_IDS, spaceId)
   ...
   /**
    * Returns all the SpaceUserRoles of an user.
    */
   public SpaceUserRoleRow[] getAllSpaceUserRolesOfUser(int userId)
       throws AdminPersistenceException
   {
       return (SpaceUserRoleRow[]) getRows(SELECT_ALL_USER_SPACEUSERROLES, userId)
           .toArray(new SpaceUserRoleRow[0]);
   }

   static final private String SELECT_ALL_USER_SPACEUSERROLES
      = "select "+SPACEUSERROLE_COLUMNS
      + " from ST_SpaceUserRole,ST_UserSet_User_Rel"
      + " where id=userSetId and userSetType='M' and userId=?";

   /**
    * Returns all the SpaceUserRole ids of an user.
    */
   public String[] getAllSpaceUserRoleIdsOfUser(int userId)
       throws AdminPersistenceException
   {
       return (String[]) getRows(SELECT_ALL_USER_SPACEUSERROLE_IDS, userId)
           .toArray(new String[0]);
   }

   static final private String SELECT_ALL_USER_SPACEUSERROLE_IDS
      = "select id from ST_SpaceUserRole,ST_UserSet_User_Rel"
      + " where id=userSetId and userSetType='M' and userId=?";

   /**
    * Returns all the spaceUserRole of a given user for a given space.
    */
   public SpaceUserRoleRow[] getAllSpaceUserRolesOfUserOfSpace(
       int userId, int spaceId)
       throws AdminPersistenceException
   {
       int[] params = new int[] {spaceId, userId};
       return (SpaceUserRoleRow[])
           getRows(SELECT_ALL_USER_SPACEUSERROLES_IN_SPACE, params)
           .toArray(new SpaceUserRoleRow[0]);
   }

   static final private String SELECT_ALL_USER_SPACEUSERROLES_IN_SPACE
      = "select "+SPACEUSERROLE_COLUMNS
      + " from ST_SpaceUserRole,ST_UserSet_User_Rel"
      + " where id=userSetId and spaceId=?"
      + " and userSetType='M' and userId=?";
   ...
   static final private String SELECT_USER_SPACEUSERROLES
      = "select "+SPACEUSERROLE_COLUMNS
      + " from ST_SpaceUserRole, ST_SpaceUserRole_User_Rel"
      + " where id = spaceUserRoleId"
      + " and   userId = ?";
   ...
   static final private String SELECT_GROUP_SPACEUSERROLES
      = "select "+SPACEUSERROLE_COLUMNS
   ...
   /**
    * Returns the SpaceUserRole
    * whose fields match those of the given sample SpaceUserRole fields.
    */
       ...
       throws AdminPersistenceException
   {
	   ...
	   String[] values = new String[] {
	       sampleSpaceUserRole.name,
		   sampleSpaceUserRole.description};

       return (SpaceUserRoleRow[]) getMatchingRows(SPACEUSERROLE_COLUMNS, columns, values)
       .toArray(new SpaceUserRoleRow[0]);
   }
       ...
       throws AdminPersistenceException
   {
       ...
       if (space == null)
       {
		   throw new AdminPersistenceException("SpaceUserRoleTable.createSpaceUserRole", SilverpeasException.ERROR, "admin.EX_ERR_SPACE_NOT_FOUND", "space id : '" + spaceUserRole.spaceId + "'");
       }
       ...
       if (spaceUserRole.roleName.equalsIgnoreCase("manager"))
       {
    	   ...
    	   organization.userSet.addUserSetInUserSet("M", spaceUserRole.id,
                                               		"S", spaceUserRole.spaceId);
       }
       else
       {
    	   organization.userSet.createUserSet("X", spaceUserRole.id);
    	   organization.userSet.addUserSetInUserSet("X", spaceUserRole.id,
                                               		"S", spaceUserRole.spaceId);
       }
   }

   static final private String INSERT_SPACEUSERROLE
      = "insert into"
       ...
       throws SQLException
   {
       ...
       SilverTrace.debug("admin", "SpaceUserRoleTable.prepareInsert", "root.MSG_GEN_ENTER_METHOD", "usr.id = "+usr.id+", usr.spaceId = "+usr.spaceId+", usr.roleName = "+usr.roleName+", usr.isInherited = "+usr.isInherited);
	   if (usr.id == -1)
	   {
          usr.id = getNextId();
	   }
   ...
   static final private String UPDATE_SPACEUSERROLE
      = "update ST_SpaceUserRole set"
      + " name = ?,"
      + " description = ?"
      + " where id = ?";
   ...
   static final private String DELETE_SPACEUSERROLE
      = "delete from ST_SpaceUserRole where id = ?";

   /**
    * Tests if a user has a given role (recursive).
    */
   public boolean isUserInRole(int userId, int spaceUserRoleId)
       throws AdminPersistenceException
   {
   ...
   static final private String SELECT_COUNT_USERSET_USER_REL
      ...
      + " where userId = ? and userSetId = ? and userSetType='M'";
   ...
   public void addUserInSpaceUserRole(int userId, int spaceUserRoleId)
       throws AdminPersistenceException
   {
       if (isUserDirectlyInRole(userId, spaceUserRoleId)) return ;

       UserRow user = organization.user.getUser(userId);
       if (user == null)
       {
		   throw new AdminPersistenceException("SpaceUserRoleTable.addUserInSpaceUserRole", SilverpeasException.ERROR, "admin.EX_ERR_USER_NOT_FOUND", "user id : '" + userId + "'");
       }

       SpaceUserRoleRow spaceUserRole = getSpaceUserRole(spaceUserRoleId);
       if (spaceUserRole == null)
       {
		   throw new AdminPersistenceException("SpaceUserRoleTable.addUserInSpaceUserRole", SilverpeasException.ERROR, "admin.EX_ERR_SPACEUSERROLE_NOT_FOUND", "space user role id : '" + spaceUserRoleId + "'");
       }
       ...
       throws AdminPersistenceException
   {
       ...
       {
	      throw new AdminPersistenceException("SpaceUserRoleTable.removeUserFromSpaceUserRole", SilverpeasException.ERROR, "admin.EX_ERR_USER_NOT_IN_SPACE_USERROLE", "space userrole id: '" + spaceUserRoleId +"', user id: '" + userId + "'");
       }

	   SynchroReport.debug("SpaceUserRoleTable.removeUserFromSpaceUserRole()", "Retrait (ou décrément) de la relation entre l'utilisateur d'ID " + userId + " et l'espace d'ID " + spaceUserRoleId + " dans la table ST_UserSet_User_Rel",null);
	   
	   SpaceUserRoleRow spaceUserRole = getSpaceUserRole(spaceUserRoleId);
       if (spaceUserRole != null)
       {
    	   if (spaceUserRole.roleName.equalsIgnoreCase("manager"))
    		   organization.userSet.removeUserFromUserSet(userId, "M", spaceUserRoleId);
    	   else
    		   organization.userSet.removeUserFromUserSet(userId, "X", spaceUserRoleId);
    	}
    ...
    */
   public boolean isGroupInRole(int groupId, int spaceUserRoleId)
       throws AdminPersistenceException
   {
   ...
   public void addGroupInSpaceUserRole(int groupId, int spaceUserRoleId)
       throws AdminPersistenceException
   {
       if (isGroupDirectlyInRole(groupId, spaceUserRoleId)) return ;

       GroupRow group = organization.group.getGroup(groupId);
       if (group == null)
       {
		   throw new AdminPersistenceException("SpaceUserRoleTable.addGroupInSpaceUserRole", SilverpeasException.ERROR, "admin.EX_ERR_GROUP_NOT_FOUND", "group id : '" + groupId + "'");
       }

       SpaceUserRoleRow spaceUserRole = getSpaceUserRole(spaceUserRoleId);
       if (spaceUserRole == null)
       {
		   throw new AdminPersistenceException("SpaceUserRoleTable.addGroupInSpaceUserRole", SilverpeasException.ERROR, "admin.EX_ERR_SPACEUSERROLE_NOT_FOUND", "space userrole id : '" + spaceUserRoleId + "'");
       }
       ...
       if (spaceUserRole.roleName.equalsIgnoreCase("manager"))
       {
    	   organization.userSet.addUserSetInUserSet("G", groupId, "M", spaceUserRoleId);
       }
       else
       {
       ...
       throws AdminPersistenceException
   {
       ...
       {
	      throw new AdminPersistenceException("SpaceUserRoleTable.removeGroupFromSpaceUserRole", SilverpeasException.ERROR, "admin.EX_ERR_GROUP_NOT_IN_SPACE_USERROLE", "space userrole id: '" + spaceUserRoleId +"', group id: '" + groupId + "'");
       }

	   SynchroReport.debug("SpaceUserRoleTable.removeGroupFromSpaceUserRole()", "Suppression (ou décrément) des relations liant le groupe d'ID " + groupId +" et l'espace d'ID " + spaceUserRoleId + " dans les tables ST_UserSet_UserSet_Rel et ST_UserSet_User_Rel",null);
       ...
       if (spaceUserRole != null)
       {
    	   if (spaceUserRole.roleName.equalsIgnoreCase("manager"))
    	   {
    		   organization.userSet.removeUserSetFromUserSet("G", groupId,
                       										 "M", spaceUserRoleId);
    	   }
    	   else
    	   {
