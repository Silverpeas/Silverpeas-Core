...
public class ComponentInstanceI18NTable extends Table
{
   ...
   static final private String COLUMNS
      = "id,componentId,lang,name,description";
    ...
    */
   public List getTranslations(int componentId)
       throws AdminPersistenceException
   {
       return getRows(SELECT_TRANSLATIONS, componentId);
   }

   static final private String SELECT_TRANSLATIONS = "select "+COLUMNS+" from ST_ComponentInstanceI18N where componentId = ?";
   ...
   static final private String UPDATE_TRANSLATION
      = "update ST_ComponentInstanceI18N set"
      + " name = ?,"
      + " description = ? "
      + " WHERE id = ? ";     
