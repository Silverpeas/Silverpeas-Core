...
public class GroupUserRoleTable extends Table
{
   ...
   static final private String GROUPUSERROLE_COLUMNS
      = "id,groupId,roleName";
   ...
   static final private String SELECT_GROUPUSERROLE_BY_ID
      = "select "+GROUPUSERROLE_COLUMNS+" from ST_GroupUserRole where id = ?";
   ...
   public GroupUserRoleRow getGroupUserRoleByGroupId(int groupId)
       throws AdminPersistenceException
   {
       return (GroupUserRoleRow) getUniqueRow(SELECT_GROUPUSERROLE_BY_GROUPID, groupId);
   }

   static final private String SELECT_GROUPUSERROLE_BY_GROUPID
      = "select "+GROUPUSERROLE_COLUMNS+" from ST_GroupUserRole where groupId = ?";
   ...
   public GroupUserRoleRow getGroupUserRole(int groupId, String roleName)
       throws AdminPersistenceException
   {
       GroupUserRoleRow[] groupUserRoles
           =(GroupUserRoleRow[]) getRows(SELECT_GROUPUSERROLE_BY_ROLENAME,
                                   new int[]{groupId},
                                   new String[]{roleName})
                           .toArray(new GroupUserRoleRow[0]);

       if (groupUserRoles.length == 0) return null;
       else if (groupUserRoles.length == 1) return groupUserRoles[0];
       else
       {
		  throw new AdminPersistenceException("GroupUserRoleTable.getGroupUserRole", SilverpeasException.ERROR, "admin.EX_ERR_GROUPUSERROLE_NAME_GROUPID_FOUND_TWICE", "group id : '" + groupId + "', group userrole name: '" + roleName + "'");
       }
   }

   static final private String SELECT_GROUPUSERROLE_BY_ROLENAME
      = "select "+GROUPUSERROLE_COLUMNS
   ...
   public GroupUserRoleRow[] getAllGroupUserRoles()
       throws AdminPersistenceException
   {
       return (GroupUserRoleRow[]) getRows(SELECT_ALL_GROUPUSERROLES)
           .toArray(new GroupUserRoleRow[0]);
   }

   static final private String SELECT_ALL_GROUPUSERROLES
      = "select "+GROUPUSERROLE_COLUMNS+" from ST_GroupUserRole";
   ...
   static final private String SELECT_ALL_GROUP_USERROLES
      = "select "+GROUPUSERROLE_COLUMNS+" from ST_GroupUserRole where groupId = ?";
   ...
   static final private String SELECT_ALL_USER_GROUPUSERROLES
      = "select "+GROUPUSERROLE_COLUMNS
    ...
    */
   public GroupUserRoleRow[] getAllGroupUserRolesOfUserOfGroup(
       int userId, int groupId)
       throws AdminPersistenceException
   {
       int[] params = new int[] {groupId, userId};
       return (GroupUserRoleRow[])
           getRows(SELECT_ALL_USER_GROUPUSERROLES_IN_GROUP, params)
           .toArray(new GroupUserRoleRow[0]);
   }

   static final private String SELECT_ALL_USER_GROUPUSERROLES_IN_GROUP
      = "select "+GROUPUSERROLE_COLUMNS
      + " from ST_GroupUserRole,ST_UserSet_User_Rel"
   ...
   static final private String SELECT_USER_GROUPUSERROLES
      = "select "+GROUPUSERROLE_COLUMNS
      + " from ST_GroupUserRole, ST_GroupUserRole_User_Rel"
      + " where id = groupUserRoleId"
      + " and   userId = ?";
   ...
   static final private String SELECT_GROUP_GROUPUSERROLES
      = "select "+GROUPUSERROLE_COLUMNS
   ...
   /**
    * Returns the GroupUserRole
    * whose fields match those of the given sample GroupUserRole fields.
    */
       ...
       throws AdminPersistenceException
   {
	   ...
	   String[] values = new String[] {
	       sampleGroupUserRole.name,
		   sampleGroupUserRole.description};
       ...
       throws AdminPersistenceException
   {
       ...
       if (group == null)
       {
		   throw new AdminPersistenceException("GroupUserRoleTable.createGroupUserRole", SilverpeasException.ERROR, "admin.EX_ERR_GROUP_NOT_FOUND", "group id : '" + groupUserRole.groupId + "'");
       }

      insertRow(INSERT_GROUPUSERROLE, groupUserRole);
      organization.userSet.createUserSet("H", groupUserRole.id);
      organization.userSet.addUserSetInUserSet("H", groupUserRole.id,
                                               "G", groupUserRole.groupId);
   }
    ...
    */
   /*public void updateGroupUserRole(GroupUserRoleRow groupUserRole)
       throws AdminPersistenceException
   {
      updateRow(UPDATE_GROUPUSERROLE, groupUserRole);
   }

   static final private String UPDATE_GROUPUSERROLE
      = "update ST_GroupUserRole set"
      + " name = ?,"
      + " description = ?"
      + " where id = ?";*/
   ...
   static final private String DELETE_GROUPUSERROLE
      = "delete from ST_GroupUserRole where id = ?";
   ...
   public void addUserInGroupUserRole(int userId, int groupUserRoleId)
       throws AdminPersistenceException
   {
       if (isUserDirectlyInRole(userId, groupUserRoleId)) return ;

       UserRow user = organization.user.getUser(userId);
       if (user == null)
       {
		   throw new AdminPersistenceException("GroupUserRoleTable.addUserInGroupUserRole", SilverpeasException.ERROR, "admin.EX_ERR_USER_NOT_FOUND", "user id : '" + userId + "'");
       }

       GroupUserRoleRow groupUserRole = getGroupUserRole(groupUserRoleId);
       if (groupUserRole == null)
       {
		   throw new AdminPersistenceException("GroupUserRoleTable.addUserInGroupUserRole", SilverpeasException.ERROR, "admin.EX_ERR_GROUPUSERROLE_NOT_FOUND", "group user role id : '" + groupUserRoleId + "'");
       }
       ...
       throws AdminPersistenceException
   {
       ...
       {
	      throw new AdminPersistenceException("GroupUserRoleTable.removeUserFromGroupUserRole", SilverpeasException.ERROR, "admin.EX_ERR_USER_NOT_IN_GROUP_USERROLE", "group userrole id: '" + groupUserRoleId +"', user id: '" + userId + "'");
       }

	   SynchroReport.debug("GroupUserRoleTable.removeUserFromGroupUserRole()", "Retrait (ou décrément) de la relation entre l'utilisateur d'ID " + userId + " et l'egroup d'ID " + groupUserRoleId + " dans la table ST_UserSet_User_Rel",null);
   ...
   public void addGroupInGroupUserRole(int groupId, int groupUserRoleId)
       throws AdminPersistenceException
   {
       if (isGroupDirectlyInRole(groupId, groupUserRoleId)) return ;

       GroupRow group = organization.group.getGroup(groupId);
       if (group == null)
       {
		   throw new AdminPersistenceException("GroupUserRoleTable.addGroupInGroupUserRole", SilverpeasException.ERROR, "admin.EX_ERR_GROUP_NOT_FOUND", "group id : '" + groupId + "'");
       }

       GroupUserRoleRow groupUserRole = getGroupUserRole(groupUserRoleId);
       if (groupUserRole == null)
       {
		   throw new AdminPersistenceException("GroupUserRoleTable.addGroupInGroupUserRole", SilverpeasException.ERROR, "admin.EX_ERR_GROUPUSERROLE_NOT_FOUND", "group userrole id : '" + groupUserRoleId + "'");
       }
       ...
       throws AdminPersistenceException
   {
       ...
       {
	      throw new AdminPersistenceException("GroupUserRoleTable.removeGroupFromGroupUserRole", SilverpeasException.ERROR, "admin.EX_ERR_GROUP_NOT_IN_GROUP_USERROLE", "group userrole id: '" + groupUserRoleId +"', group id: '" + groupId + "'");
       }

	   SynchroReport.debug("GroupUserRoleTable.removeGroupFromGroupUserRole()", "Suppression (ou décrément) des relations liant le groupe d'ID " + groupId +" et l'egroup d'ID " + groupUserRoleId + " dans les tables ST_UserSet_UserSet_Rel et ST_UserSet_User_Rel",null);
