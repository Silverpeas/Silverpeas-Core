...
public class InstanceDataTable extends Table
{
   ...
   static final private String INSTANCEDATA_COLUMNS
      = "id,componentId,name,label,value";
    ...
    */
   public void createInstanceData(int componentId, SPParameter parameter) throws AdminPersistenceException, SQLException
   {
   ...
   static final private String INSERT_INSTANCEDATA
      = "insert into ST_Instance_Data("+ INSTANCEDATA_COLUMNS +") values (?,?,?,?,?)";
   ...
   {
       return (InstanceDataRow) getUniqueRow(
           SELECT_INSTANCEDATA_BY_ID, id);
   }

   static final private String SELECT_INSTANCEDATA_BY_ID
      = "select "+INSTANCEDATA_COLUMNS+" from ST_Instance_Data where id = ?";
   ...
   static final private String SELECT_ALL_COMPONENT_PARAMETERS
    ...
    */
   public void updateInstanceData(int componentId, SPParameter parameter) throws AdminPersistenceException, SQLException
   {
		InstanceDataRow idr = new InstanceDataRow();
   ...
   static final private String UPDATE_INSTANCEDATA
      = "UPDATE ST_Instance_Data"
      + " SET value = ?"
      + " where componentId = ? and name = ?";
   ...
   static final private String REMOVE_INSTANCEDATA
      = "delete from ST_Instance_Data"
      + " where componentid = ?";
