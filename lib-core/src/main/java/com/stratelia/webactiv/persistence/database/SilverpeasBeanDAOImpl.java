...
public class SilverpeasBeanDAOImpl implements SilverpeasBeanDAO
{
		...
		try
		{
			...
			for (int i = 0; i < properties.length; i++)
			{
				...
				SilverTrace.info(
					...
					"new(" + beanClassName + "), property Name = " + properties[i].getName() + ", type = " + type);
	...
	public void remove(Connection connection, WAPrimaryKey pk) throws PersistenceException
	{
		...
		finally
		{
			try
			{
				...
				if (connection == null) closeConnection(con);
			}
			catch (Exception e)
			{
				throw new PersistenceException(
	...
	/**
	 removeWhere
	 */
	public void removeWhere(Connection connection, WAPrimaryKey pk, String p_WhereClause) throws PersistenceException
	{
		...
		try
		{
			String updateStatement = "delete from " + getTableName(pk) + " where " + p_WhereClause;
			...
			SilverTrace.info(
				...
				"root.MSG_GEN_PARAM_VALUE",
				"queryStr = " + updateStatement + ", id= " + pk.getId() + ", whereClause= " + p_WhereClause);
	...
	/**
	 update
	 */
	public void update(Connection connection, SilverpeasBeanIntf bean) throws PersistenceException
	{
		Connection con = null;
		if (connection == null)
			con = getConnection();
		...
		try
		{
			...
			for (int i = 0; i < properties.length; i++)
			{
				...
				SilverTrace.info(
					...
					"root.MSG_GEN_PARAM_VALUE",
					"property Name = " + properties[i].getName() + ", type = " + type);
	...
	/**
	 add
	 */
	public WAPrimaryKey add(Connection connection, SilverpeasBeanIntf bean) throws PersistenceException
	{
		...
		try
		{
			...
			String insertStatement =
				"insert into " + getTableName(bean.getPK()) + " (" + columns + ") " + " values (" + statement + ")";
	...
	public SilverpeasBeanIntf findByPrimaryKey(WAPrimaryKey pk) throws PersistenceException
	{
	...
	/**
	 findByPrimaryKey
	 */
	public SilverpeasBeanIntf findByPrimaryKey(Connection connection, WAPrimaryKey pk) throws PersistenceException
	{
	...
	public Collection findByWhereClause(WAPrimaryKey pk, String whereClause) throws PersistenceException
	{
	...
	/**
	 findByWhereClause
	 */
	public Collection findByWhereClause(Connection connection, WAPrimaryKey pk, String whereClause)
	...
	*/
	...
	private String getColumnNames() throws Exception
	{
		...
		for (int i = 0; i < properties.length; i++)
		{
			...
			SilverTrace.info(
				"persistence",
				"SilverpeasBeanDAOImpl.getColumnNames()",
				"root.MSG_GEN_PARAM_VALUE",
				"property Name = " + properties[i].getName() + ", type = " + type);
	 ...
	 */
	private SilverpeasBeanIntf getSilverpeasBeanFromResultSet(WAPrimaryKey pk, ResultSet rs) throws Exception
	{

		SilverpeasBeanIntf bean = (SilverpeasBeanIntf) silverpeasBeanClass.newInstance();
		int count = 1;
								...
								if (value != null)
								{
									...
									catch (Exception e)
									{
										SilverTrace.error(
											...
											"property Name = " + properties[i].getName() + ", date= " + value);
										throw e;
									}
									properties[i].getWriteMethod().invoke(bean, parameters);
								}
	 ...
	 */
	private int prepareStatementSetProperties(PreparedStatement prepStmt, SilverpeasBeanIntf bean)
			...
			if ((type.equals("int")) || (type.equals("java.lang.Integer")))
			{
				...
				if ((type.equals("long")) || (type.equals("java.lang.Long")))
				{
					...
					if ((type.equals("boolean")) || (type.equals("java.lang.Boolean")))
					{
						...
						if (type.equals("java.lang.String"))
						{
							String string = (String) properties[i].getReadMethod().invoke(bean, null);
                            if (string == null)
                            {
