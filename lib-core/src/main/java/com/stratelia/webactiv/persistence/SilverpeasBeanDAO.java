 ...
 * To get a SilverpeasBeanDAO instance, use the SilverpeasBeanDAO factory.
 * A SilverpeasBeanDAO instance is linked with a SilverpeasBean specialisation.
 * The code below show you how to build a SilverpeasBeanDAO, enable to create, update... objects for TrainingDetail class.
 * <CODE>
 ...
 * </CODE>
 * Once a dao instance is build, it enables you to create, update, remove and list objects from TrainingDetail.
 * TrainingDetail has to be a SilverpeasBean specialisation. (A SilverpeasBean contains a PK).
 * The persistance mechanism is based on your bean properties.
 * In your bean, you need to have getXXX and setXXX methods for each "column" you want to be persistant.
 * For the moment, SilverpeasBeanDAO is able to work with int, String and Date. This list can grow in the near futur.
 */
public interface SilverpeasBeanDAO {
   ...
   */
  public void update(SilverpeasBeanIntf bean)
   ...
   * @param bean the SilverpeasBeanIntf to update, with a primaryKey initialized with only spaceId and componentId.
   * @return The complete primary key, with the id.
   */
  public WAPrimaryKey add(SilverpeasBeanIntf bean)
    throws PersistenceException;
   ...
   * @param whereClause The where clause to put in select request. If null, all SilverpeasBeanIntfs will be selected (all rows in the table).
  ...
  public Collection findByWhereClause(Connection con, WAPrimaryKey pk, String whereClause)
    throws PersistenceException;
