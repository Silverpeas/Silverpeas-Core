...
public final class SpaceComponentPair implements Serializable
{
  ...
  /**
   * The equals method is re-defined
   * so that a SpaceComponentPair can be added in a Set or used as a Map key.
   */
  ...
  /**
   * The hashCode method is re-defined
   * so that a SpaceComponentPair can be added in a Set or used as a Map key.
   */
  public int hashCode()
  {
  ...
  /**
   * The two parts of an SpaceComponentName are private
