...
/**
 * This class is a scanner generated by <a href="http://www.jflex.de/">JFlex</a> 1.4.1 on 22/02/08
 * 07:43 from the specification file <tt>SilverTokenizerImpl.jflex</tt>
 */
class SilverTokenizerImpl {
   ...
   */
  private static final String ZZ_CMAP_PACKED = "\11\0\1\0\1\16\1\0\1\0\1\15\22\0\1\0\5\0\1\3"
  ...
  private static final String ZZ_ACTION_PACKED_0 = "\1\0\1\1\4\2\1\3\1\1\6\0\2\2\5\0"
      + "\1\4\4\5\2\6\2\0\1\7\3\5\3\7\3\5\1\10\1\11\1\0\1\10\1\11\1\0\2\11\2\10\2\5\1\12";
  ...
  private static final String ZZ_ROWMAP_PACKED_0 = "\0\0\0\17\0\36\0\55\0\74\0\113\0\17\0\132"
  ...
  private static final String ZZ_TRANS_PACKED_0 = "\10\2\1\3\1\4\1\5\1\6\1\7\1\10\1\2"
      ...
      + "\1\22\2\15\1\16\4\42\5\0\1\56\2\0\1\56" + "\2\0\4\65\3\0";
  ...
  private static final String ZZ_ATTRIBUTE_PACKED_0 = "\1\0\1\11\4\1\1\11\1\1\6\0\2\1\5\0"
  ...
  /**
   * <p/>
   * @deprecated this solves a bug where HOSTs that end with '.' are identified as ACRONYMs. It is
   * deprecated and will be removed in the next release.
   */
  public static final int ACRONYM_DEP = 8;
  public static final String[] TOKEN_TYPES = new String[] { "<ALPHANUM>",
      "<APOSTROPHE>", "<ACRONYM>", "<COMPANY>", "<EMAIL>", "<HOST>", "<NUM>",
      "<CJ>", "<ACRONYM_DEP>" };
  ...
  /**
   * Resets the scanner to read from a new input stream. Does not close the old reader. All internal
   * variables are reset, the old input stream <b>cannot</b> be reused (internal buffer is discarded
   * and lost). Lexical state is set to <tt>ZZ_INITIAL</tt>.
  ...
  /**
   * Reports an error that occured while scanning. In a wellformed scanner (no or only correct usage
   * of yypushback(int) and a match-all fallback rule) this method will only be called with things
   * that "Can't Possibly Happen". If this method is called, something is seriously wrong (e.g. a
   * JFlex bug producing a faulty scanner etc.). Usual syntax/scanner level error handling should be
