 ...
 * of various entities. Any change here should also be reflected in the deployment descriptors.
 */
public class JNDINames extends SilverpeasSettings {
	...
	static
    {
		...
		READINGCONTROLBM_EJBHOME	= readString(rs, "READINGCONTROLBM_EJBHOME", "ejb/ReadingControlBm");
		...
		QUESTIONCONTAINERBM_EJBHOME = readString(rs, "QUESTIONCONTAINERBM_EJBHOME", "ejb/QuestionContainerBm");
		...
		SILVERSTATISTICS_JMS_QUEUE	= readString(rs, "SILVERSTATISTICS_JMS_QUEUE", "com.stratelia.silverpeas.silverstatistics.jms.SilverStatisticsJMSQUEUE");
		SILVERSTATISTICS_JMS_FACTORY = readString(rs, "SILVERSTATISTICS_JMS_FACTORY", "com.stratelia.silverpeas.silverstatistics.jms.QueueConnectionFactory");

		SILVERPEAS_DATASOURCE		= readString(rs, "SILVERPEAS_DATASOURCE", "java:comp/env/jdbc/Silverpeas");

		PUBLICATION_DATASOURCE		= readString(rs, "PUBLICATION_DATASOURCE", "java:comp/env/jdbc/Silverpeas");
		INTEREST_CENTER_DATASOURCE	= readString(rs, "INTEREST_CENTER_DATASOURCE", "java:comp/env/jdbc/Silverpeas");
		VERSIONING_DATASOURCE		= readString(rs, "VERSIONING_DATASOURCE", "java:comp/env/jdbc/Silverpeas");
		CONTACT_DATASOURCE			= readString(rs, "CONTACT_DATASOURCE", "java:comp/env/jdbc/Silverpeas");
		NODE_DATASOURCE				= readString(rs, "NODE_DATASOURCE", "java:comp/env/jdbc/Silverpeas");
		FAVORIT_DATASOURCE			= readString(rs, "FAVORIT_DATASOURCE", "java:comp/env/jdbc/Silverpeas");
		SUBSCRIBE_DATASOURCE		= readString(rs, "SUBSCRIBE_DATASOURCE", "java:comp/env/jdbc/Silverpeas");
		STATISTIC_DATASOURCE		= readString(rs, "STATISTIC_DATASOURCE", "java:comp/env/jdbc/Silverpeas");
		CALENDAR_DATASOURCE			= readString(rs, "CALENDAR_DATASOURCE", "java:comp/env/jdbc/Silverpeas");
		ALMANACH_DATASOURCE			= readString(rs, "ALMANACH_DATASOURCE", "java:comp/env/jdbc/Silverpeas");
		FORUMS_DATASOURCE			= readString(rs, "FORUMS_DATASOURCE", "java:comp/env/jdbc/Silverpeas");
		QUESTION_DATASOURCE			= readString(rs, "QUESTION_DATASOURCE", "java:comp/env/jdbc/Silverpeas");
		ANSWER_DATASOURCE			= readString(rs, "ANSWER_DATASOURCE", "java:comp/env/jdbc/Silverpeas");
		SURVEY_DATASOURCE			= readString(rs, "SURVEY_DATASOURCE", "java:comp/env/jdbc/Silverpeas");
		PERSONALIZATION_DATASOURCE	= readString(rs, "PERSONALIZATION_DATASOURCE", "java:comp/env/jdbc/Silverpeas");
		SCORE_DATASOURCE			= readString(rs, "SCORE_DATASOURCE", "java:comp/env/jdbc/Silverpeas");
		QUESTIONCONTAINER_DATASOURCE = readString(rs, "QUESTIONCONTAINER_DATASOURCE", "java:comp/env/jdbc/Silverpeas");
		BOOKMARK_DATASOURCE			= readString(rs, "BOOKMARK_DATASOURCE", "java:comp/env/jdbc/Silverpeas");
		WEBSITES_DATASOURCE			= readString(rs, "WEBSITES_DATASOURCE", "java:comp/env/jdbc/Silverpeas");
		ATTACHMENT_DATASOURCE		= readString(rs, "ATTACHMENT_DATASOURCE", "java:comp/env/jdbc/Silverpeas");
		TASKM_DATASOURCE			= readString(rs, "TASKM_DATASOURCE", "java:comp/env/jdbc/Silverpeas");
		FORMDESIGNER_DATASOURCE		= readString(rs, "FORMDESIGNER_DATASOURCE", "java:comp/env/jdbc/Silverpeas");
		PDC_SUBSCRIPTION_DATASOURCE	= readString(rs, "PDC_SUBSCRIPTION_DATASOURCE", "java:comp/env/jdbc/Silverpeas");
		PUZZLE_DATASOURCE			= readString(rs, "PUZZLE_DATASOURCE", "java:comp/env/jdbc/Silverpeas");
		SILVERSTATISTICS_DATASOURCE	= readString(rs, "SILVERSTATISTICS_DATASOURCE", "java:comp/env/jdbc/Silverpeas");
		CRM_DATASOURCE	            = readString(rs, "CRM_DATASOURCE", "java:comp/env/jdbc/Silverpeas");

		THESAURUS_DATASOURCE		= readString(rs, "THESAURUS_DATASOURCE", "java:comp/env/jdbc/Silverpeas");
		PDC_BUSIHM_DATASOURCE		= readString(rs, "PDC_BUSIHM_DATASOURCE", "java:comp/env/jdbc/Silverpeas");
		FILEBOXPLUS_DATASOURCE		= readString(rs, "FILEBOXPLUS_DATASOURCE", "java:comp/env/jdbc/Silverpeas");
		QUESTIONREPLY_DATASOURCE	= readString(rs, "QUESTIONREPLY_DATASOURCE", "java:comp/env/jdbc/Silverpeas");
		WHITEPAGES_DATASOURCE		= readString(rs, "WHITEPAGES_DATASOURCE", "java:comp/env/jdbc/Silverpeas");
		PERSISTENCE_EJB_DATASOURCE	= readString(rs, "PERSISTENCE_EJB_DATASOURCE", "java:comp/env/jdbc/Silverpeas");
		
		WEBPUBMANAGER_DATASOURCE = readString(rs, "WEBPUBMANAGER_DATASOURCE", "java:comp/env/jdbc/Silverpeas");
		...
		SECURITY_ADAPTER_CLASSNAME	= readString(rs, "SECURITY_ADAPTER_CLASSNAME", "java:comp/env/securityAdapterClassName");
		SEND_CONFIRMATION_MAIL		= readString(rs, "SEND_CONFIRMATION_MAIL", "java:comp/env/sendConfirmationMail");

		JMS_FACTORY					= readString(rs, "JMS_FACTORY", "com.stratelia.silverpeas.notificationserver.jms.QueueConnectionFactory");
