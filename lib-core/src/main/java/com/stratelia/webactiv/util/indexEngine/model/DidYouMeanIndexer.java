...
public class DidYouMeanIndexer {
  ...
  public static void createSpellIndex(String field, String originalIndexDirectory,
    ...
    try {
      ...
      // open original index
      FSDirectory SIDirectory = FSDirectory.getDirectory(file);
      ...
      SpellChecker spellChecker = new SpellChecker(SIDirectory);
      spellChecker.indexDictionary(dictionary);
    } catch (CorruptIndexException e) {
      SilverTrace.error("indexEngine", DidYouMeanIndexer.class.toString(),
  ...
  public static void createSpellIndexForAllLanguage(String field, String originalIndexDirectory) {
    ...
    for (Iterator<String> iterator = I18NHelper.getLanguages(); iterator.hasNext();) {
