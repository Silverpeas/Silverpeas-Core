...
public class PptParserPOI implements Parser
{
    ...
    public Reader getReader(String path, String encoding)
    {
        ...
        {
	        SilverTrace.error("indexEngine", "PptParserPOI", "indexEngine.MSG_IO_ERROR_WHILE_READING", path, e);
        }
        finally
        {
        	try
        	...
        	{
        		SilverTrace.error("indexEngine", "PptParserPOI.getReader()", "indexEngine.MSG_IO_ERROR_WHILE_CLOSING", path, ioe);
        	}
        }
        return reader;
    }
