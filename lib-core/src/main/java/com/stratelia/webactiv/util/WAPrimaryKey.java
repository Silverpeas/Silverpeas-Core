...
public abstract class WAPrimaryKey implements Serializable {
	...
	* @return the database table name where the object is stored : space + componentName + rootTableName (ex : ED1KmeliaPublication)
	* @see #space
	* @see #componentName
	...
	*/
	public String getTableName() {
		/*if ((space == null) || (componentName == null)) {
			Debug.println("WAPrimaryKey.getTableName() : error : some column of the primary key are null: " + toString() + " Impossible to give a table name.");
			throw new EJBException("WAPrimaryKey.getTableName() : error : some column of the primary key are null: " + toString() + " Impossible to give a table name.");
		}*/
