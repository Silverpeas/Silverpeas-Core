...
/**
 * Extends lucene TokenFilter : replaces from each token
 * all the special characters like é or ç.
 */
public final class CharFilter extends TokenFilter
{
  /**
   * Constructs a filter which uses the given CharReplacer to
   * change the token of the stream.
   */
