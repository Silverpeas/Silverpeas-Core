...
public interface WADataPaginator {
  ...
  /**
   * this method returns the previous page of data, or null is there is no such
   * page
   * 
   * @see #getNextPage
   */
  ...
  /**
   * this method returns the first page of data, or null is there is no such
   * page. The next call to getNextPage will thus return the second page.
   * 
   * @see #getNextPage
   * @see #getPreviousPage
   */
  ...
  /**
   * this method returns the current page of data, or null is there is no such
   * page.
   * 
   * @see #getNextPage
   * @see #getPreviousPage
  ...
  /**
   * this method returns the last page of data, or null is there is no such
   * page. T
   * 
   * @see #getNextPage
   * @see #getpreviousPage
  ...
  /**
   * This method retuns the current, 0-base page number, or -1 if there is no
   * current page
   */
  public int getCurrentPageNumber();

  /**
   * This method sets the page size, that is, the count of items that fit on one
   * page. Usually called from the rendering process.
   */
  public void setPageSize(int size);

  /**
   * This method sets the header. The header is used mostly to know how to sort
   * items
   */
