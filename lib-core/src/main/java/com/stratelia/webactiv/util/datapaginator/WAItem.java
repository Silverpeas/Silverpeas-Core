...
public interface WAItem 
{
	 ...
	 * used to represent this item. It has to be held by the WAItem, because
	 * it is the only one to know the meaning of the information it carries,
	 * and thus the only one to know what, for example, needs to be emphasized
