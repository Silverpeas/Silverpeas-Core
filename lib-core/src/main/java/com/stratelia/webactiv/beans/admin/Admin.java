...
public class Admin extends Object
{
    ...
    private static SimpleDateFormat			formatter = new SimpleDateFormat("dd/MM/yyyy HH:mm:ss:S");
	...
	public Admin()
   	{
        if (m_sAdminDBDriver == null)
        {
            ...
            m_bFallbackGroupNames 	= SilverpeasSettings.readBoolean(resources, "FallbackGroupNames", true);
            m_bFallbackUserLogins 	= SilverpeasSettings.readBoolean(resources, "FallbackUserLogins", false);
            m_threadDelay 			= SilverpeasSettings.readLong(resources, "AdminThreadedSynchroDelay", 900);
            m_groupSynchroCron 		= SilverpeasSettings.readString(resources, "GroupSynchroCron", "* 5 * * *");
            m_delUsersOnDiffSynchro = SilverpeasSettings.readBoolean(resources, "DelUsersOnThreadedSynchro", true);
	...
	public String getGeneralSpaceId()
    {
        try
        {
            return getComponentTablePrefix() + m_nEntrepriseClientSpaceId;
        }
        catch(Exception e)
        {
            return "";
	...
	public void createSpaceIndex(SpaceInst spaceInst)
    {
        ...
        SilverTrace.info("admin", "admin.createSpaceIndex", "root.MSG_GEN_PARAM_VALUE", "Space Name : " + spaceInst.getName() + " Space Id : " + spaceInst.getId());

        if (spaceInst != null)
        {
            // Index the space
        	String spaceId = "";
            if (spaceInst.getId().startsWith("WA"))
            	spaceId = spaceInst.getId();
            else
            	spaceId = "WA".concat(spaceInst.getId());
	...
	{
        SilverTrace.info("admin", "admin.deleteSpaceIndex", "root.MSG_GEN_PARAM_VALUE", "Space Name : " + spaceInst.getName() + " Space Id : " + spaceInst.getId());
     // Index the space
    	String spaceId = "";
        if (spaceInst.getId().startsWith("WA"))
        	spaceId = spaceInst.getId();
    ...
    public String addSpaceInst(String userId, SpaceInst spaceInst) throws AdminException
    {
        ...
        try
        {
            SilverTrace.info("admin", "admin.addSpaceInst", "root.MSG_GEN_PARAM_VALUE", "Space Name : " + spaceInst.getName() + " NbCompo: " + spaceInst.getNumComponentInst());
			connectionProd  = openConnection(m_sWaProductionDb, m_sWaProductionUser, m_sWaProductionPswd, false);
            ...
            String sSpaceInstId = m_SpaceInstManager.createSpaceInst(spaceInst, m_DDManager);
            ...
            SilverTrace.info("admin", "admin.addSpaceInst", "root.MSG_GEN_PARAM_VALUE", "Indexation : spaceInst = " + spaceInst.getName());
        ...
        catch(Exception  e)
        {
            ...
            throw new AdminException("Admin.addSpaceInst", SilverpeasException.ERROR, "admin.EX_ERR_ADD_SPACE", "space name : '" + spaceInst.getName() + "'", e);
        }
		finally
		{
			// close connection
     ...
     * The delete is apply recursively to the sub-spaces
	 *
	 ...
	 */
    public String deleteSpaceInstById(String sUserId, String sClientSpaceId, boolean definitive) throws AdminException
	{
		return deleteSpaceInstById(sUserId, sClientSpaceId, true, definitive);
	}

	/**
	 * Delete the given space if it's not the general space
     * The delete is apply recursively to the sub-spaces
	 *
	 * @param	sUserId					Id of user who deletes the space
	 * @param	sClientSpaceId			Id of the space to be deleted
	 * @param   startNewTransaction		Flag : must be true at first call to initialize transaction, then false for recurrents calls
	 * @return	the deleted space id
	 */
    public String deleteSpaceInstById(String sUserId, String sClientSpaceId, boolean startNewTransaction, boolean definitive) throws AdminException
    {
	   	SilverTrace.spy("admin", "Admin.deleteSpaceInstById()",	sClientSpaceId, "ASP", "", sUserId, SilverTrace.SPY_ACTION_DELETE);
		...
		try
		{
			...
			if (!definitive)
			{
	            ...
	            m_SpaceInstManager.sendSpaceToBasket(m_DDManager, sDriverSpaceId, spaceInst.getName()+Admin.basketSuffix, sUserId);
			...
			else
			{
	            ...
	            for(int nI=0; nI < alCompoInst.size(); nI++)
	            {
	                deleteComponentInst(sUserId,getClientComponentId(((ComponentInst)alCompoInst.get(nI)).getId()), true, false);
	            }
        ...
        catch(Exception  e)
        {
			...
			throw new AdminException("Admin.deleteSpaceInstById", SilverpeasException.ERROR, "admin.EX_ERR_DELETE_SPACE", "user Id : '" + sUserId + "', space Id : '" + sClientSpaceId + "'");
        }
    }
    ...
    public void restoreSpaceFromBasket(String sClientSpaceId) throws AdminException
    {
        ...
        {
            rollback();
			throw new AdminException("Admin.restoreSpaceFromBasket", SilverpeasException.ERROR, "admin.EX_ERR_RESTORE_SPACE_FROM_BASKET", "spaceId = " + sClientSpaceId);
        }
    }
    ...
    public SpaceInst getSpaceInstById(String sClientSpaceId) throws AdminException
    {
        ...
        {
			throw new AdminException("Admin.getSpaceInstById", SilverpeasException.ERROR, "admin.EX_ERR_GET_SPACE", " space Id : '" + sClientSpaceId + "'", e);
        }
    }
	 ...
	 * @return Space information as SpaceInst object
	 */
    private SpaceInst getSpaceInstById(String sSpaceId, boolean bDriverSpaceId) throws AdminException
    {
		...
		try
        {
            ...
            {
				// Get space instance
				spaceInst = m_SpaceInstManager.getSpaceInstById(m_DDManager, sDriverSpaceId);
        ...
        {
			throw new AdminException("Admin.getSpaceInstById", SilverpeasException.ERROR, "admin.EX_ERR_GET_SPACE", " space Id : '" + sSpaceId + "'", e);
        }
    }   
	 ...
	 */
    public String[] getAllSubSpaceIds(String sDomainFatherId) throws AdminException
    {
        String[] asDriverSpaceIds = null;
        SilverTrace.debug("admin", "Admin.getAllSubSpaceIds", "root.MSG_GEN_ENTER_METHOD", "father space id: '" + sDomainFatherId + "'");

        try
        {
			// get all sub space ids
			asDriverSpaceIds = m_SpaceInstManager.getAllSubSpaceIds(m_DDManager, getDriverSpaceId(sDomainFatherId));
        ...
        {
			throw new AdminException("Admin.getAllSubSpaceIds", SilverpeasException.ERROR, "admin.EX_ERR_GET_ALL_SUBSPACE_IDS", " father space Id : '" + sDomainFatherId + "'", e);
        }
    }
    
    /**
	 * Updates the space (with the given name) with the given space
     * Updates only the node
	 *
    ...
    public String updateSpaceInst(SpaceInst spaceInstNew) throws AdminException
    {
        try
        {
            ...
            SilverTrace.debug("admin", "Admin.updateSpaceInst", "root.MSG_GEN_ENTER_METHOD", "Before id: '" + spaceInstNew.getId() + "' after Id: "+getDriverSpaceId(spaceInstNew.getId()) );
            // Convert the client id in driver id
            ...
            // indexation de l'espace
            SilverTrace.info("admin", "admin.updateSpaceInst", "root.MSG_GEN_PARAM_VALUE", "Indexation : spaceInst = " + spaceInstNew.getName());
        ...
        {
            rollback();
			throw new AdminException("Admin.updateSpaceInst", SilverpeasException.ERROR, "admin.EX_ERR_UPDATE_SPACE", "space Id : '" + spaceInstNew.getId() + "'", e);
        }
    }
    
    public void updateSpaceOrderNum(String sSpaceId, int orderNum) throws AdminException
    {
        try
        {
            SilverTrace.debug("admin", "Admin.updateSpaceOrderNum", "root.MSG_GEN_ENTER_METHOD", "Space id: '" + sSpaceId + "' New Order num: "+Integer.toString(orderNum) );
            String sDriverSpaceId = getDriverSpaceId(sSpaceId);
            // Update the space in tables
            m_SpaceInstManager.updateSpaceOrder(m_DDManager, sDriverSpaceId, orderNum);
            m_Cache.opUpdateSpace(m_SpaceInstManager.getSpaceInstById(m_DDManager, sDriverSpaceId));
        }
        catch(Exception e)
        {
            throw new AdminException("Admin.updateSpaceOrderNum", SilverpeasException.ERROR, "admin.EX_ERR_UPDATE_SPACE", "space Id : '" + sSpaceId + "'", e);
        }
    }
    
    /**
     * Update the inheritance mode between a subSpace and its space.
     * If inheritanceBlocked is true then all inherited space profiles are removed.
     * If inheritanceBlocked is false then all subSpace profiles are removed and space profiles are inherited.   
     * @param spaceId 
    ...
    private void updateSpaceInheritance(SpaceInst space, boolean inheritanceBlocked) throws AdminException
    {
        ...
        {
            rollback();
			throw new AdminException("Admin.updateComponentInst", SilverpeasException.ERROR, "admin.EX_ERR_UPDATE_SPACE", "spaceId = " + space.getId(), e);
        }
    }
    ...
    public boolean isSpaceInstExist(String sClientSpaceId) throws AdminException
    {
        try
        {
            return m_SpaceInstManager.isSpaceInstExist(m_DDManager, getDriverSpaceId(sClientSpaceId));
        }
        catch(Exception e)
        {
			throw new AdminException("Admin.isSpaceInstExist", SilverpeasException.ERROR, "admin.EX_ERR_IS_SPACE_EXIST", "space Id : '" + sClientSpaceId + "'", e);
        }
    }
    ...
    public String[] getAllRootSpaceIds() throws AdminException
    {
        ...
        {
			throw new AdminException("Admin.getAllSpaceIds", SilverpeasException.ERROR, "admin.EX_ERR_GET_ALL_SPACE_IDS", e);
        }
    }
     ...
     * @throws AdminException
     */
    public List getPathToSpace(String spaceId, boolean includeTarget) throws AdminException
    {
    	List path = new ArrayList();
    ...
    public List getRemovedSpaces() throws AdminException
    {
        ...
        {
			throw new AdminException("Admin.getRemovedSpaces", SilverpeasException.ERROR, "admin.EX_ERR_GET_REMOVED_SPACES", e);
        }
    }
    ...
    public List getRemovedComponents() throws AdminException
    {
        ...
        {
			throw new AdminException("Admin.getRemovedComponents", SilverpeasException.ERROR, "admin.EX_ERR_GET_REMOVED_COMPONENTS", e);
        }
    }
    ...
    public String[] getSpaceNames(String[] asClientSpaceIds) throws AdminException
    {
        ...
        {
			throw new AdminException("Admin.getSpaceNames", SilverpeasException.ERROR, "admin.EX_ERR_GET_SPACE_NAMES", e);
        }
    }
    ...
    public Hashtable getAllComponentsNames() throws AdminException
    {
        ...
        for (Enumeration e = hComponents.keys(); e.hasMoreElements() ;)
        {
            ...
            SilverTrace.debug("admin", "Admin.getAllComponentsNames", "admin.MSG_INFO_COMPONENT_FOUND", sKey + ": " + sLabel);
        }
    ...
    public ComponentInst getComponentInst(String sClientComponentId) throws AdminException
    {
        ...
        {
			throw new AdminException("Admin.getComponentInst", SilverpeasException.ERROR, "admin.EX_ERR_GET_COMPONENT", "component Id: '" + sClientComponentId + "'", e);
        }
    }
    ...
    public ComponentInstLight getComponentInstLight(String sClientComponentId) throws AdminException
    {
        ...
        {
			throw new AdminException("Admin.getComponentInstLight", SilverpeasException.ERROR, "admin.EX_ERR_GET_COMPONENT", "component Id: '" + sClientComponentId + "'", e);
        }
    }
	 ...
	 * return the component Inst corresponding to the given ID
	 */
    private ComponentInst getComponentInst(String sComponentId, boolean bDriverComponentId, String sFatherDriverSpaceId) throws AdminException
    {
        ...
        try
        {
			...
			SilverTrace.info("admin", "Admin.getComponentInst", "root.MSG_GEN_ENTER_METHOD","componentInst="+componentInst+" id="+sDriverComponentId);
			if(componentInst == null)
			{
				// Get component instance from database
				componentInst = m_ComponentInstManager.getComponentInst(m_DDManager, sDriverComponentId, sFatherDriverSpaceId);
        ...
        {
			throw new AdminException("Admin.getComponentInst", SilverpeasException.ERROR, "admin.EX_ERR_GET_COMPONENT", "component Id: '" + sComponentId + "'", e);
        }
    }
	...
	{
		return m_ComponentInstManager.getComponentInstName(m_DDManager, bDriverComponentId);
	}
	...
	public List getComponentParameters(String sComponentId)
	{
		...
		{
            SilverTrace.error("admin", "Admin.getComponentParameters", "admin.EX_ERR_GET_COMPONENT_PARAMS", "sComponentId: '" + sComponentId + "'", e);
	...
	public String getComponentParameterValue(String sComponentId, String parameterName)
	{
		...
		{
			SilverTrace.error("admin", "Admin.getComponentParameterValue", "admin.EX_ERR_GET_COMPONENT_PARAMS", "sComponentId: '" + sComponentId + "'", e);
			return "";
		}
	}
	
	public void restoreComponentFromBasket(String sComponentId) throws AdminException
    {
    	try
		{
			// Start transaction
            ...
            //update data in database
            m_ComponentInstManager.restoreComponentFromBasket(m_DDManager, getDriverComponentId(sComponentId));
        ...
        {
            rollback();
			throw new AdminException("Admin.restoreComponentFromBasket", SilverpeasException.ERROR, "admin.EX_ERR_RESTORE_COMPONENT_FROM_BASKET", "componentId = " + sComponentId);
        }
    }
	...
	public String addComponentInst(String sUserId, ComponentInst componentInst) throws AdminException
    {
	 ...
	 */
	public String addComponentInst(String sUserId, ComponentInst componentInst, boolean startNewTransaction) throws AdminException
    {
		Connection connectionProd = null;
        ...
        try
        {
            ...
            sDriverComponentId = m_ComponentInstManager.createComponentInst(componentInst, m_DDManager, getDriverSpaceId(spaceInstFather.getId()));
			...
			if(componentName.equals("sources") || componentName.equals("documentation") || componentName.equals("infoTracker"))
			{
				...
				containerManager.registerNewContainerInstance(connectionProd, componentId, "containerPDC", "fileBoxPlus");
				contentManager.registerNewContentInstance(connectionProd, componentId, "containerPDC", "fileBoxPlus");
			}
			else if (componentName.equals("expertLocator") || componentName.equals("questionReply") || componentName.equals("whitePages")
					  || componentName.equals("kmelia") || componentName.equals("survey") || componentName.equals("toolbox")
					  || componentName.equals("quickinfo") || componentName.equals("almanach") || componentName.equals("quizz")
					  || componentName.equals("forums") || componentName.equals("pollingStation") || componentName.equals("bookmark")
					  || componentName.equals("chat") || componentName.equals("infoLetter") || componentName.equals("webSites")
        ...
        catch(Exception  e)
        {
            ...
            throw new AdminException("Admin.addComponentInst", SilverpeasException.ERROR, "admin.EX_ERR_ADD_COMPONENT", "component name: '" + componentInst.getName() + "'", e);
        }
		finally
		{
			// close connection
    ...
    public String deleteComponentInst(String sUserId, String sClientComponentId, boolean definitive) throws AdminException
    {
	 ...
	 */
    public String deleteComponentInst(String sUserId, String sClientComponentId, boolean definitive, boolean startNewTransaction) throws AdminException
    {
		Connection connectionProd = null;
        ComponentInst componentInst = null;

	   	SilverTrace.spy("admin", "Admin.deleteComponentInst()", "ACP", sClientComponentId, "", sUserId, SilverTrace.SPY_ACTION_DELETE);
        ...
        try
        {
            ...
            if (!definitive)
            {
            	...
            	m_ComponentInstManager.sendComponentToBasket(m_DDManager, sDriverComponentId, componentInst.getLabel()+Admin.basketSuffix, sUserId);
            }
            else
            {
            	connectionProd  = openConnection(m_sWaProductionDb, m_sWaProductionUser, m_sWaProductionPswd, false);
	            ...
	            unInstantiateComponents(sUserId, asCompoId, asCompoName, getClientSpaceId(sFatherClientId), connectionProd);
				...
				if(componentName.equals("sources") || componentName.equals("documentation") || componentName.equals("infoTracker"))
				{
						...
						containerManager.unregisterNewContainerInstance(connectionProd, sClientComponentId, "containerPDC", "fileBoxPlus");
						contentManager.unregisterNewContentInstance(connectionProd, sClientComponentId, "containerPDC", "fileBoxPlus");
				}
				else if(componentName.equals("whitePages") || componentName.equals("questionReply") || componentName.equals("expertLocator") ||
						componentName.equals("kmelia") || componentName.equals("survey") || componentName.equals("toolbox") ||
						componentName.equals("quickinfo") || componentName.equals("almanach") || componentName.equals("quizz") ||
						componentName.equals("forums") || componentName.equals("pollingStation") || componentName.equals("bookmark") ||
						componentName.equals("chat") || componentName.equals("infoLetter") || componentName.equals("webSites")
						|| componentName.equals("gallery") || componentName.equals("blog") )
				{
						...
						// Call the unregister functions
						containerManager.unregisterNewContainerInstance(connectionProd, sClientComponentId, "containerPDC", componentName);
						contentManager.unregisterNewContentInstance(connectionProd, sClientComponentId, "containerPDC", componentName);
				}
        ...
        catch(Exception  e)
        {
			...
			throw new AdminException("Admin.deleteComponentInst", SilverpeasException.ERROR, "admin.EX_ERR_DELETE_COMPONENT", "component Id: '" + sClientComponentId + "'", e);
        }
		finally
		{
			// close connection
    ...
    public void updateComponentOrderNum(String sComponentId, int orderNum) throws AdminException
    {
        try
        {
            SilverTrace.debug("admin", "Admin.updateComponentOrderNum", "root.MSG_GEN_ENTER_METHOD", "Component id: '" + sComponentId + "' New Order num: "+Integer.toString(orderNum) );
            String sDriverComponentId = getDriverComponentId(sComponentId);
            // Update the Component in tables
            m_ComponentInstManager.updateComponentOrder(m_DDManager, sDriverComponentId, orderNum);
            m_Cache.opUpdateComponent(m_ComponentInstManager.getComponentInst(m_DDManager, sDriverComponentId, null));
        }
        catch(Exception e)
        {
            throw new AdminException("Admin.updateComponentOrderNum", SilverpeasException.ERROR, "admin.EX_ERR_UPDATE_COMPONENT", "Component Id : '" + sComponentId + "'", e);
        }
    }
    ...
    public String updateComponentInst(ComponentInst componentInstNew) throws AdminException
    {
        try
        {
            ...
            if (useProfileInheritance && (oldComponentInst.isInheritanceBlocked() != componentInstNew.isInheritanceBlocked()))
        ...
        {
            rollback();
			throw new AdminException("Admin.updateComponentInst", SilverpeasException.ERROR, "admin.EX_ERR_UPDATE_COMPONENT", "component Id: '" + componentInstNew.getId() + "'", e);
        }
    }
    
    /**
     * Update the inheritance mode between a component and its space.
     * If inheritanceBlocked is true then all inherited space profiles are removed.
     * If inheritanceBlocked is false then all component profiles are removed and space profiles are inherited.   
     * @param componentId 
     * @param inheritanceBlocked
     * @throws AdminException
     */
    private void updateComponentInheritance(ComponentInst component, boolean inheritanceBlocked) throws AdminException
    {
        ...
        {
            rollback();
			throw new AdminException("Admin.updateComponentInst", SilverpeasException.ERROR, "admin.EX_ERR_UPDATE_COMPONENT", "component Id: '" + component.getId() + "'", e);
        }
    }
    ...
    private void setSpaceProfilesToSubSpace(SpaceInst subSpace, SpaceInst space) throws AdminException
    {
    	...
    	setSpaceProfileToSubSpace(subSpace, space, "publisher");
    	setSpaceProfileToSubSpace(subSpace, space, "writer");
    	setSpaceProfileToSubSpace(subSpace, space, "reader");
    }
     ...
     * @throws AdminException
     */
    private void setSpaceProfileToSubSpace(SpaceInst subSpace, SpaceInst space, String profileName)
    {   	
    ...
    private void setSpaceProfilesToComponent(ComponentInst component, SpaceInst space) throws AdminException
    {
    	...
    	for (int cr=0; cr<componentRoles.length; cr++)
    	{
    		...
    		if (!inheritedProfile.getAllGroups().isEmpty() || !inheritedProfile.getAllUsers().isEmpty())
    		{
...
//NEWD DLE
  ...
  public void moveComponentInst(String spaceId, String componentId, String idComponentBefore, ComponentInst[] componentInsts) throws AdminException
  {
	  try
	  {
		SilverTrace.info("admin", "admin.moveComponentInst", "root.MSG_GEN_PARAM_VALUE", "spaceId= "+spaceId+"  componentId="+componentId);
		...
		SilverTrace.info("admin", "admin.moveComponentInst", "root.MSG_GEN_PARAM_VALUE", "sDriverSpaceId= "+sDriverSpaceId+"  sDriverComponentId="+sDriverComponentId);
		...
		// Update the components in tables
		m_ComponentInstManager.moveComponentInst(m_DDManager, sDriverSpaceId, sDriverComponentId);
		
		// Remove links for the old spaceId 
		String currentSpaceId = getDriverSpaceId(oldSpaceId);
		SilverTrace.info("admin", "admin.moveComponentInst", "root.MSG_GEN_PARAM_VALUE", "Remove Link space Father= "+currentSpaceId);
		...
		SilverTrace.info("admin", "admin.moveComponentInst", "root.MSG_GEN_PARAM_VALUE", "Add Link space Father= "+currentSpaceId);
		...
		SilverTrace.info("admin", "admin.moveComponentInst", "root.MSG_GEN_PARAM_VALUE", "Avant setComponentPlace: componentId="+componentId+" idComponentBefore="+idComponentBefore);
		setComponentPlace(componentId, idComponentBefore, componentInsts);
		
		// Update extraParamPage from Space if necessary
		SilverTrace.info("admin", "admin.moveComponentInst", "root.MSG_GEN_PARAM_VALUE", "FirstPageExtraParam="+getSpaceInstById(oldSpaceId).getFirstPageExtraParam()+" oldSpaceId="+oldSpaceId);
		SpaceInst oldSpaceInst = getSpaceInstById(getDriverSpaceId(oldSpaceId));
		SilverTrace.info("admin", "admin.moveComponentInst", "root.MSG_GEN_PARAM_VALUE", "oldSpaceInst="+oldSpaceInst+" componentId="+componentId);
	  ...
	  {
		  rollback();
		  throw new AdminException("Admin.moveComponentInst", SilverpeasException.ERROR, "admin.EX_ERR_MOVE_COMPONENT", "spaceId = " + spaceId +" component Id: '" + componentId + " ", e);
	  }
  }
...
//NEWF DLE
	 ...
	 */
    public String getProfileLabelfromName(String sComponentName, String sProfileName) throws AdminException
    {
        String[] asProfiles = null;
        ...
        if(asProfiles != null && asProfilesLabel != null && asProfiles.length==asProfilesLabel.length)
		{
    ...
    public List getProfilesByObject(String objectId, String objectType, String componentId) throws AdminException
    {
    ...
    {
    	String[] profiles = m_ProfiledObjectManager.getUserProfileNames(m_DDManager, objectId, objectType, Integer.parseInt(getDriverComponentId(componentId)), Integer.parseInt(userId));
    ...
    private String addProfileInst(ProfileInst profileInst, String userId, boolean startNewTransaction) throws AdminException
    {
    	try
        {
            ...
            String sProfileId = m_ProfileInstManager.createProfileInst(profileInst, m_DDManager, sDriverFatherId);
            ...
            if (profileInst.getObjectId() == -1 || profileInst.getObjectId() == 0)
            	m_Cache.opAddProfile(m_ProfileInstManager.getProfileInst(m_DDManager, sProfileId, null));
        ...
        catch(Exception  e)
        {
            ...
            throw new AdminException("Admin.addProfileInst", SilverpeasException.ERROR, "admin.EX_ERR_ADD_PROFILE", "profile name: '" + profileInst.getName() + "'", e);
        }
    }
	 ...
	 */
    private String deleteProfileInst(String sProfileId, String userId, boolean startNewTransaction) throws AdminException
    {
    	// Get the Profile to delete
        ProfileInst profileInst = m_ProfileInstManager.getProfileInst(m_DDManager, sProfileId, null);
        ...
        try
        {
            ...
            //Update component to change last modification date
            if (StringUtil.isDefined(userId) && (profileInst.getObjectId() == -1 || profileInst.getObjectId() == 0))
           	{
	            //Get according component
        ...
        catch(Exception  e)
        {
			...
			throw new AdminException("Admin.deleteProfileInst", SilverpeasException.ERROR, "admin.EX_ERR_DELETE_PROFILE", "profile Id: '" + sProfileId + "'", e);
        }
    }
	 ...
	 */
    private String updateProfileInst(ProfileInst profileInstNew, String userId, boolean startNewTransaction) throws AdminException
    {
    	if (StringUtil.isDefined(userId))
    		SilverTrace.spy("admin", "Admin.updateProfileInst", "unknown", profileInstNew.getComponentFatherId(), profileInstNew.getName(), userId, SilverTrace.SPY_ACTION_UPDATE);
        try
        {
        	if (startNewTransaction)
        	{
            ...
            String sProfileNewId = m_ProfileInstManager.updateProfileInst(m_ProfileInstManager.getProfileInst(m_DDManager, profileInstNew.getId(), null), m_DDManager, profileInstNew);
            
            // Update component to change last modification date
            if (StringUtil.isDefined(userId) && (profileInstNew.getObjectId() == -1 || profileInstNew.getObjectId() == 0))
           	{
	            //Get according component
            ...
            if (profileInstNew.getObjectId() == -1 || profileInstNew.getObjectId() == 0)
            	m_Cache.opUpdateProfile(m_ProfileInstManager.getProfileInst(m_DDManager, sProfileNewId, null));
        ...
        catch(Exception  e)
        {
            if (startNewTransaction)
            	rollback();
			throw new AdminException("Admin.updateProfileInst", SilverpeasException.ERROR, "admin.EX_ERR_UPDATE_PROFILE", "profile Id: '" + profileInstNew.getId() + "'", e);
        }
    }
	 ...
	 */
    public SpaceProfileInst getSpaceProfileInst(String sSpaceProfileId) throws AdminException
    {
        return m_SpaceProfileInstManager.getSpaceProfileInst(m_DDManager, sSpaceProfileId, null);
    }
    
    public String addSpaceProfileInst(SpaceProfileInst spaceProfileInst, String userId) throws AdminException
    {
	 ...
	 */
    private String addSpaceProfileInst(SpaceProfileInst spaceProfileInst, String userId, boolean startNewTransaction) throws AdminException
    {
        try
        {
        	if (startNewTransaction)
            ...
            String sSpaceProfileId = m_SpaceProfileInstManager.createSpaceProfileInst(spaceProfileInst, m_DDManager, spaceInstFather.getId());
            ...
            m_Cache.opAddSpaceProfile(m_SpaceProfileInstManager.getSpaceProfileInst(m_DDManager, sSpaceProfileId, null));
        ...
        catch(Exception  e)
        {
        	if (startNewTransaction)
        		rollback();
            throw new AdminException("Admin.addSpaceProfileInst", SilverpeasException.ERROR, "admin.EX_ERR_ADD_SPACE_PROFILE", "space profile name: '" + spaceProfileInst.getName() + "'", e);
        }
    }
    ...
    private String deleteSpaceProfileInst(String sSpaceProfileId, String userId, boolean startNewTransaction) throws AdminException
    {
        ...
        try
        {
            ...
            // Delete the Profile in tables
            m_SpaceProfileInstManager.deleteSpaceProfileInst(spaceProfileInst, m_DDManager);
        ...
        catch(Exception  e)
        {
			...
			throw new AdminException("Admin.deleteSpaceProfileInst", SilverpeasException.ERROR, "admin.EX_ERR_DELETE_SPACEPROFILE", "space profile Id: '" + sSpaceProfileId + "'", e);
        }
    }
	 ...
	 */
    private String updateSpaceProfileInst(SpaceProfileInst spaceProfileInstNew) throws AdminException
    {
    	return updateSpaceProfileInst(spaceProfileInstNew, null);
    }
    
    public String updateSpaceProfileInst(SpaceProfileInst spaceProfileInstNew, String userId) throws AdminException
    {
        try
        {
            // Open the connections with auto-commit to false
            ...
            String sSpaceProfileNewId = m_SpaceProfileInstManager.updateSpaceProfileInst(oldSpaceProfile, m_DDManager, spaceProfileInstNew);
        ...
        {
        	rollback();
			throw new AdminException("Admin.updateSpaceProfileInst", SilverpeasException.ERROR, "admin.EX_ERR_UPDATE_SPACEPROFILE", "space profile Id: '" + spaceProfileInstNew.getId() + "'", e);
        }
    }
    ...
    private List componentRole2SpaceRoles(String componentRole, String componentName)
    {
    	List roles = new ArrayList();
    	
    	String role = spaceRole2ComponentRole("admin", componentName);
    	if (role != null && role.equalsIgnoreCase(componentRole))
    		roles.add("admin");
    	role = spaceRole2ComponentRole("publisher", componentName);
    	if (role != null && role.equalsIgnoreCase(componentRole))
    		roles.add("publisher");
    	role = spaceRole2ComponentRole("writer", componentName);
    	if (role != null && role.equalsIgnoreCase(componentRole))
    		roles.add("writer");
    	role = spaceRole2ComponentRole("reader", componentName);
    	if (role != null && role.equalsIgnoreCase(componentRole))
    		roles.add("reader");
    ...
    private void spreadSpaceProfile(SpaceInst space, SpaceProfileInst spaceProfile) throws AdminException
    {
    	SilverTrace.info("admin", "Admin.spreadSpaceProfile", "root.MSG_GEN_ENTER_METHOD", "spaceId = "+space.getId()+", profile = "+spaceProfile.getName());
        	...
        	if (component != null && !component.isInheritanceBlocked())
        	{
	        	...
	        	if (componentRole != null)
	        	{
	        		...
	        		if (inheritedProfile != null)
	        		{
	        			...
	        			List profilesToCheck = componentRole2SpaceRoles(componentRole, component.getName());
    	...
    	for (int s=0; subSpaceIds != null && s<subSpaceIds.length; s++)
    	{
    		...
    		if (!subSpace.isInheritanceBlocked())
    		{
	    		...
	    		else
	    		{
	    			...
	    			if (subSpaceProfile.getNumGroup() > 0 || subSpaceProfile.getNumUser() > 0)
	 ...
	 */
    public Group getGroupByNameInDomain(String sGroupName, String sDomainFatherId) throws AdminException
    {
        return m_GroupManager.getGroupByNameInDomain(m_DDManager, sGroupName, sDomainFatherId);
    }
    ...
    public String addGroup(Group group) throws AdminException
    {
        ...
        {
			throw new AdminException("Admin.addGroup", SilverpeasException.ERROR, "admin.EX_ERR_ADD_GROUP", "group name: '" + group.getName() + "'", e);
        }
	}
    ...
    public String addGroup(Group group, boolean onlyInSilverpeas) throws AdminException
    {
		try
		{
			// Start transaction
			m_DDManager.startTransaction(false);
			if (group.getDomainId() != null && !onlyInSilverpeas) m_DDManager.startTransaction(group.getDomainId(), false);

			// add group
			String sGroupId = m_GroupManager.addGroup(m_DDManager, group, onlyInSilverpeas);
            group.setId(sGroupId);
		    // Commit the transaction
			m_DDManager.commit();
			if (group.getDomainId() != null && !onlyInSilverpeas) m_DDManager.commit(group.getDomainId());
        ...
        catch(Exception e)
        {
            try
            {
                // Roll back the transactions
                m_DDManager.rollback();
                if (group.getDomainId() != null && !onlyInSilverpeas) m_DDManager.rollback(group.getDomainId());
            }
            catch(Exception e1)
            {
     ...
     * The delete is apply recursively to the sub-groups
	 */
    public String deleteGroupById(String sGroupId) throws AdminException
    {
        ...
        {
			throw new AdminException("Admin.deleteGroupById", SilverpeasException.ERROR, "admin.EX_ERR_DELETE_GROUP", "group Id: '" + sGroupId + "'", e);
 		}
    }
    ...
    public String deleteGroupById(String sGroupId, boolean onlyInSilverpeas) throws AdminException
    {
		...
		try
		{
			...
			if (group == null)
			{
				throw new AdminException("Admin.deleteGroupById", SilverpeasException.ERROR, "admin.EX_ERR_GROUP_NOT_FOUND", "group Id: '" + sGroupId + "'");
			}
			...
			// Delete the group
			String sReturnGroupId = m_GroupManager.deleteGroupById(m_DDManager, group, onlyInSilverpeas);
        ...
        catch(Exception  e)
        {
            ...
            throw new AdminException("Admin.deleteGroupById", SilverpeasException.ERROR, "admin.EX_ERR_GROUP_NOT_FOUND", "group Id: '" + sGroupId + "'", e);
		}
    }
    ...
    public String updateGroup(Group group) throws AdminException
    {
        ...
        {
			throw new AdminException("Admin.updateGroup", SilverpeasException.ERROR, "admin.EX_ERR_UPDATE_GROUP", "group name: '" + group.getName()+ "'", e);
		}
    }
    ...
    public String updateGroup(Group group, boolean onlyInSilverpeas) throws AdminException
    {
		try
		{
			...
			// Update group
	        String sGroupId = m_GroupManager.updateGroup(m_DDManager, group, onlyInSilverpeas);
...
//  --------------------------------------------------------------------------------------------------------
    ...
    {
        return m_GroupProfileInstManager.getGroupProfileInst(m_DDManager, null, groupId);
    }
    ...
    public String addGroupProfileInst(GroupProfileInst groupProfileInst, boolean startNewTransaction) throws AdminException
    {
        try
        {
            ...
            String sProfileId = m_GroupProfileInstManager.createGroupProfileInst(groupProfileInst, m_DDManager, group.getId());
            ...
            //m_Cache.opAddSpaceProfile(m_GroupProfileInstManager.getGroupProfileInst(m_DDManager, sSpaceProfileId, null));
        ...
        catch(Exception  e)
        {
        	if (startNewTransaction)
        		rollback();
            throw new AdminException("Admin.addGroupProfileInst", SilverpeasException.ERROR, "admin.EX_ERR_ADD_SPACE_PROFILE", "group roleName = " + groupProfileInst.getName(), e);
        }
    }
    ...
    public String deleteGroupProfileInst(String groupId, boolean startNewTransaction) throws AdminException
    {
        ...
        try
        {
            ...
            // Delete the Profile in tables
            m_GroupProfileInstManager.deleteGroupProfileInst(groupProfileInst, m_DDManager);
        ...
        catch(Exception  e)
        {
			...
			throw new AdminException("Admin.deleteGroupProfileInst", SilverpeasException.ERROR, "admin.EX_ERR_DELETE_GROUPPROFILE", "groupId = " + groupId, e);
        }
    }
    ...
    public String updateGroupProfileInst(GroupProfileInst groupProfileInstNew) throws AdminException
    {
        try
        {
        	...
        	else
        	{
	            ...
	            m_GroupProfileInstManager.updateGroupProfileInst(oldSpaceProfile, m_DDManager, groupProfileInstNew);
	            
	            m_DDManager.commit();
	
	            //m_Cache.opUpdateSpaceProfile(m_GroupProfileInstManager.getGroupProfileInst(m_DDManager, groupProfileInstNew.getId(), null));
        	}
        ...
        {
        	rollback();
			throw new AdminException("Admin.updateGroupProfileInst", SilverpeasException.ERROR, "admin.EX_ERR_UPDATE_SPACEPROFILE", "space profile Id: '" + groupProfileInstNew.getId() + "'", e);
        }
    }
    ...
    public UserDetail[] getUserDetails(String[] asUserId) throws AdminException
    {
        ...
        for(int nI=0; nI < asUserId.length; nI++)
		{
			...
			{
	            SilverTrace.error("admin", "Admin.getUserDetails", "admin.EX_ERR_GET_USER_DETAILS", "user id: '" + asUserId[nI] + "'", e);
				aUserDetail[nI] = null;
			}
		}
    ...
    public Hashtable getUsersLanguage(List userIds) throws AdminException
    {
    	...
    	try {
			...
			throw new AdminException("Admin.getUsersLanguage", SilverpeasException.ERROR, "root.EX_CONNECTION_OPEN_FAILED", e);
		}
		Hashtable usersLanguage = null;
		try {
			usersLanguage = PersonalizationDAO.getUsersLanguage(con, userIds);
		} catch (SQLException se) {
			throw new AdminException("Admin.getUsersLanguage", SilverpeasException.ERROR, "root.EX_SQL_QUERY_FAILED", se);
		}
		finally
		{
			closeConnection(con);
    ...
    public String getUserIdByLoginAndDomain(String sLogin, String sDomainId) throws AdminException
    {
        ...
        if (sDomainId == null || sDomainId.length() == 0)
        {
            ...
            {
				throw new AdminException("Admin.getUserIdByLoginAndDomain", SilverpeasException.ERROR, "admin.EX_ERR_GET_USER_BY_LOGIN_DOMAIN", "login: '" + sLogin + "', domain id: '" + sDomainId + "'", e);
            }
            ...
            if (valret == null)
            {
				throw new AdminException("Admin.getUserIdByLoginAndDomain", SilverpeasException.ERROR, "admin.EX_ERR_USER_NOT_FOUND", "login: '" + sLogin + "', in all domains");
            }
        }
        else
	...
	public String addUser(UserDetail userDetail) throws AdminException
    {
        ...
        {
			throw new AdminException("Admin.addUser", SilverpeasException.ERROR, "admin.EX_ERR_ADD_USER", userDetail.getFirstName() + " " + userDetail.getLastName(), e);
        }
    }
	 ...
	 * @param		addOnlyInSilverpeas		true if user must not be added in distant datasource (used by synchronization tools)
	...
	public String addUser(UserDetail userDetail, boolean addOnlyInSilverpeas) throws AdminException
    {
		try
		{
			...
			// add user
			String sUserId = m_UserManager.addUser(m_DDManager, userDetail, addOnlyInSilverpeas);
    ...
    public String deleteUser(String sUserId) throws AdminException
    {
        ...
        {
			throw new AdminException("Admin.deleteUser", SilverpeasException.ERROR, "admin.EX_ERR_DELETE_USER", "user id : '" + sUserId + "'", e);
		}
	}
    ...
    public String deleteUser(String sUserId, boolean onlyInSilverpeas) throws AdminException
    {
		...
		try
		{
			...
			if (user == null)
			{
				throw new AdminException("Admin.deleteUser", SilverpeasException.ERROR, "admin.EX_ERR_USER_NOT_FOUND", "user id : '" + sUserId + "'");
			}

			// Start transaction
			m_DDManager.startTransaction(false);
			if (user.getDomainId() != null && !onlyInSilverpeas) m_DDManager.startTransaction(user.getDomainId(), false);

			// Delete the user
			String sReturnUserId = m_UserManager.deleteUser(m_DDManager, user, onlyInSilverpeas);

		    // Commit the transaction
			m_DDManager.commit();
			if (user.getDomainId() != null && !onlyInSilverpeas) m_DDManager.commit(user.getDomainId());
        ...
        catch(Exception  e)
        {
            try
            {
                // Roll back the transactions
                m_DDManager.rollback();
                if (user.getDomainId() != null && !onlyInSilverpeas) m_DDManager.rollback(user.getDomainId());
            }
            catch(Exception e1)
            {
    ...
    public String updateUser(UserDetail user) throws AdminException
    {
        ...
        {
        	rollback();
    		throw new AdminException("Admin.updateUser", SilverpeasException.ERROR, "admin.EX_ERR_UPDATE_USER", "user id : '" + user.getId() + "'", e);
		}
    }
    ...
    public String updateUserFull(UserFull user) throws AdminException
    {
		try
		{
			// Start transaction
			m_DDManager.startTransaction(false);
			if (user.getDomainId() != null) m_DDManager.startTransaction(user.getDomainId(), false);
		    ...
		    // Commit the transaction
			m_DDManager.commit();
			if (user.getDomainId() != null) m_DDManager.commit(user.getDomainId());
            m_Cache.opUpdateUser(m_UserManager.getUserDetail(m_DDManager, sUserId));
        ...
        catch(Exception  e)
        {
            try
            {
                // Roll back the transactions
                m_DDManager.rollback();
                if (user.getDomainId() != null) m_DDManager.rollback(user.getDomainId());
            }
            catch(Exception e1)
            {
                SilverTrace.error("admin", "Admin.updateUserFull", "root.EX_ERR_ROLLBACK", e1);
            }
            throw new AdminException("Admin.updateUserFull", SilverpeasException.ERROR, "admin.EX_ERR_UPDATE_USER", "user id : '" + user.getId() + "'", e);
		}
    }
    ...
    private void instantiateComponents(String userId, String[] asComponentIds, String[] asComponentNames, String sSpaceId, Connection connectionProd) throws AdminException
	{
        ...
        {
			throw new AdminException("Admin.instantiateComponents", SilverpeasException.ERROR, "admin.EX_ERR_INSTANTIATE_COMPONENTS", e);
		}
    }
	 ...
	 */
    private void unInstantiateComponents(String userId, String[] asComponentIds, String[] asComponentNames, String sSpaceId, Connection connectionProd) throws AdminException
    {
		try
        {
            for(int nI=0; nI < asComponentIds.length; nI++)
        ...
        {
			throw new AdminException("Admin.unInstantiateComponents", SilverpeasException.ERROR, "admin.EX_ERR_UNINSTANTIATE_COMPONENTS", e);
        }
    }
    ...
    {
        String sDriverSpaceId = null;

        if ((sClientSpaceId != null) && (sClientSpaceId.startsWith(getComponentTablePrefix())))
        {
        	sDriverSpaceId = sClientSpaceId.substring(getComponentTablePrefix().length());
        }
        else
        {
            sDriverSpaceId = sClientSpaceId;
        }
    ...
    {
        if ((sDriverSpaceId != null) && (!sDriverSpaceId.startsWith(getComponentTablePrefix())))
        	return getComponentTablePrefix() + sDriverSpaceId;
        else
            return sDriverSpaceId;
    }
	 ...
	 */
    private String getClientComponentId(String sDriverComponentId) throws Exception
    {
        SilverTrace.debug("admin", "Admin.getClientComponentId", "root.MSG_GEN_ENTER_METHOD", "component id: " + sDriverComponentId);
	 ...
	 */
    private String[] getClientComponentIds(String[] sDriverComponentIds) throws Exception
    {
    ...
    public String addDomain(Domain theDomain) throws AdminException
    {
        ...
        {
			throw new AdminException("Admin.addDomain", SilverpeasException.ERROR, "admin.EX_ERR_ADD_DOMAIN", "domain name : '" + theDomain.getName() + "'", e);
        }
    }
    ...
    public String updateDomain(Domain theDomain) throws AdminException
    {
        ...
        {
			throw new AdminException("Admin.updateDomain", SilverpeasException.ERROR, "admin.EX_ERR_UPDATE_DOMAIN", "domain name : '" + theDomain.getName() + "'", e);
        }
    }
    ...
    public String removeDomain(String domainId) throws AdminException
    {
        ...
        {
            // Remove all users
			UserDetail[] toRemoveUDs = m_UserManager.getUsersOfDomain(m_DDManager, domainId);
            if (toRemoveUDs != null)
            {
            ...
            // Remove all groups
			Group[] toRemoveGroups = m_GroupManager.getGroupsOfDomain(m_DDManager, domainId);
        ...
        {
			throw new AdminException("Admin.removeDomain", SilverpeasException.ERROR, "admin.MSG_ERR_DELETE_DOMAIN", "domain Id : '" + domainId + "'", e);
        }
    }
    ...
    public Domain[] getAllDomains() throws AdminException
    {
        ...
        {
			throw new AdminException("Admin.getAllDomains", SilverpeasException.ERROR, "admin.EX_ERR_GET_ALL_DOMAINS", e);
        }
    }
    ...
    public Domain getDomain(String domainId) throws AdminException
    {
        ...
        {
			throw new AdminException("Admin.getDomain", SilverpeasException.ERROR, "admin.EX_ERR_GET_DOMAIN", "domain Id : '" + domainId + "'", e);
        }
    }
    ...
    public long getDomainActions(String domainId) throws AdminException
    {
        ...
        {
			throw new AdminException("Admin.getDomainActions", SilverpeasException.ERROR, "admin.EX_ERR_GET_DOMAIN", "domain Id : '" + domainId + "'", e);
        }
    }
    ...
    public Group[] getRootGroupsOfDomain(String domainId) throws AdminException
    {
        ...
        {
			throw new AdminException("Admin.getGroupsOfDomain", SilverpeasException.ERROR, "admin.EX_ERR_GET_DOMAIN", "domain Id : '" + domainId + "'", e);
        }
    }
    ...
    public Group[] getSynchronizedGroups() throws AdminException
    {
        ...
        {
			throw new AdminException("Admin.getGroupsOfDomain", SilverpeasException.ERROR, "admin.EX_ERR_GET_DOMAIN", e);
        }
    }
    ...
    public String[] getRootGroupIdsOfDomain(String domainId) throws AdminException
    {
        ...
        {
			throw new AdminException("Admin.getRootGroupIdsOfDomain", SilverpeasException.ERROR, "admin.EX_ERR_GET_DOMAIN", "domain Id : '" + domainId + "'", e);
        }
    }
    ...
    public UserDetail[] getAllUsersOfGroup(String groupId) throws AdminException
    {
        ...
        {
			throw new AdminException("Admin.getAllUsersOfGroup", SilverpeasException.ERROR, "admin.EX_ERR_GET_DOMAIN", "Group Id : '" + groupId + "'", e);
        }
    }
    ...
    public UserDetail[] getUsersOfDomain(String domainId) throws AdminException
    {
        ...
        {
			throw new AdminException("Admin.getUsersOfDomain", SilverpeasException.ERROR, "admin.EX_ERR_GET_DOMAIN", "domain Id : '" + domainId + "'", e);
        }
    }
    ...
    public String[] getUserIdsOfDomain(String domainId) throws AdminException
    {
        ...
        {
			throw new AdminException("Admin.getUserIdsOfDomain", SilverpeasException.ERROR, "admin.EX_ERR_GET_DOMAIN", "domain Id : '" + domainId + "'", e);
        }
    }
    ...
    public String authenticate(String sKey, String sSessionId, boolean isAppInMaintenance) throws AdminException
    {
        String sUserId = null;
        ...
        try
        {
			...
			if ( (!loginDomain.containsKey("login")) || (!loginDomain.containsKey("domainId")) )
				throw new AdminException("Admin.authenticate", SilverpeasException.WARNING, "admin.MSG_ERR_AUTHENTICATE_USER", "key : '" + sKey + "'");
            ...
            try
            {
    			sUserId = m_UserManager.getUserIdByLoginAndDomain(m_DDManager, sLogin, sDomainId);
            }
            catch (Exception ex)
            {
                if (synchroDomain.isSynchroOnLoginEnabled() && !isAppInMaintenance)
                { // Try to import new user
    	            SilverTrace.warn("admin", "Admin.authenticate", "admin.EX_ERR_USER_NOT_FOUND", "Login: '" + sLogin + "', Domain: " + sDomainId,ex);
                    sUserId = synchronizeImportUserByLogin(sDomainId,sLogin,synchroDomain.isSynchroOnLoginRecursToGroups());
                }
                else
                    throw ex;
            }
        ...
        {
			throw new AdminException("Admin.authenticate", SilverpeasException.WARNING, "admin.MSG_ERR_AUTHENTICATE_USER", "key : '" + sKey + "'", e);
        }
    }
    ...
    public String[] getDirectGroupsIdsOfUser(String userId) throws AdminException
    {
        ...
        {
			throw new AdminException("Admin.getDirectGroupsIdsOfUser", SilverpeasException.ERROR, "admin.EX_ERR_GROUP_NOT_FOUND", "user Id : '" + userId + "'", e);
        }
    }
    ...
    public UserDetail[] searchUsers(UserDetail modelUser, boolean isAnd) throws AdminException
    {
        ...
        {
			throw new AdminException("Admin.searchUsers", SilverpeasException.ERROR, "admin.EX_ERR_USER_NOT_FOUND", e);
        }
    }
    ...
    public Group[] searchGroups(Group modelGroup, boolean isAnd) throws AdminException
    {
        ...
        {
			throw new AdminException("Admin.searchGroups", SilverpeasException.ERROR, "admin.EX_ERR_GROUP_NOT_FOUND", e);
        }
    }
    ...
    public String[] getUserSpaceIds(String sUserId) throws AdminException
    {
        ...
        {
			throw new AdminException("Admin.getUserSpaceIds", SilverpeasException.ERROR, "admin.EX_ERR_GET_USER_ALLOWED_SPACE_IDS", "user Id : '" + sUserId + "'", e);
        }
    }
...
/**
    ...
    public String[] getUserRootSpaceIds(String sUserId) throws AdminException
    {
        ...
        {
			throw new AdminException("Admin.getUserRootSpaceIds", SilverpeasException.ERROR, "admin.EX_ERR_GET_USER_ALLOWED_ROOTSPACE_IDS", "user Id : '" + sUserId + "'", e);
        }
    }
	 ...
	 * @throws AdminException
	 */
	public List getSubSpacesOfUser(String userId, String spaceId) throws AdminException
	{
		SilverTrace.info("admin", "Admin.getSubSpacesOfUser", "root.MSG_GEN_ENTER_METHOD", "userId = " + userId+", spaceId = "+spaceId);
		try
        {
            return m_SpaceInstManager.getSubSpacesOfUser(m_DDManager, userId, getDriverSpaceId(spaceId));
        }
        catch(Exception e)
        {
			throw new AdminException("Admin.getSubSpacesOfUser", SilverpeasException.ERROR, "admin.EX_ERR_GET_USER_ALLOWED_SUBSPACES", "userId = " + userId + ", spaceId = "+spaceId, e);
        }
	}
	 ...
	 * @throws AdminException
	 */
	public List getAvailCompoInSpace(String userId, String spaceId) throws AdminException
	{
		SilverTrace.info("admin", "Admin.getAvailCompoInSpace", "root.MSG_GEN_ENTER_METHOD", "userId = " + userId+", spaceId = "+spaceId);
		try
        {
            return m_ComponentInstManager.getAvailCompoInSpace(m_DDManager, getDriverSpaceId(spaceId), userId);
        }
        catch(Exception e)
        {
			throw new AdminException("Admin.getAvailCompoInSpace", SilverpeasException.ERROR, "admin.EX_ERR_GET_USER_ALLOWED_COMPONENTS", "userId = " + userId + ", spaceId = "+spaceId, e);
        }
	}

	public Hashtable getTreeView(String userId, String spaceId) throws AdminException
	{
		...
		SilverTrace.info("admin", "Admin.getTreeView", "root.MSG_GEN_PARAM_VALUE", "SQL Queries done !");
		...
		while (it.hasNext())
		{
		    ...
		    String fatherId = "WA"+child.getFatherId();
	...
	public List getUserSpaceTreeview(String userId) throws AdminException
	{
		...
		String[] rootSpaceIds = m_UserManager.getAllowedRootSpaceIds(m_DDManager, userId);
	...
	private List getUserSpaceSubTreeview(List treeview, String userId, String spaceFatherId, int level) throws AdminException
	{
		SilverTrace.info("admin", "Admin.getUserSpaceSubTreeview", "root.MSG_GEN_ENTER_METHOD", "user id = " + userId+", spaceFatherId = "+spaceFatherId+", level = "+level);
		//String[] 	subSpaceIds = m_UserManager.getAllowedSpaceIdsByFatherId(m_DDManager, userId, spaceFatherId);
		String[]	 subSpaceIds = m_SpaceInstManager.getAllowedSubSpaceIds(m_DDManager, userId, spaceFatherId);
		...
		for (int s=0; s<subSpaceIds.length; s++)
		{
			...
			treeview = getUserSpaceSubTreeview(treeview, userId, subSpaceId, level+1);
		}
		return treeview;
	}
	...
	public SpaceInstLight getSpaceInstLightById(String sClientSpaceId) throws AdminException
	{
		...
		{
			throw new AdminException("Admin.getSpaceInstLightById", SilverpeasException.ERROR, "admin.EX_ERR_GET_SPACE", " space Id : '" + sClientSpaceId + "'", e);
		}
	}
    ...
    public String[] getGroupManageableSpaceIds(String sGroupId) throws AdminException
    {
        ...
        try
        {
            ...
            asManageableSpaceIds = m_GroupManager.getManageableSpaceIds(m_DDManager, sGroupId);
        ...
        {
			throw new AdminException("Admin.getGroupManageableSpaceIds", SilverpeasException.ERROR, "admin.EX_ERR_GET_USER_MANAGEABLE_SPACE_IDS", "group Id : '" + sGroupId + "'", e);
        }
    }
    ...
    public String[] getUserManageableSpaceIds(String sUserId) throws AdminException
    {
        ...
        try
        {
			...
			{
				// Get user manageable space ids from database
				asManageableSpaceIds = m_UserManager.getManageableSpaceIds(m_DDManager, sUserId);
        ...
        {
			throw new AdminException("Admin.getUserManageableSpaceIds", SilverpeasException.ERROR, "admin.EX_ERR_GET_USER_MANAGEABLE_SPACE_IDS", "user Id : '" + sUserId + "'", e);
        }
    }
    ...
    public String[] getUserManageableSpaceRootIds(String sUserId) throws AdminException
    {
        ...
        {
			throw new AdminException("Admin.getUserManageableSpaceRootIds", SilverpeasException.ERROR, "admin.EX_ERR_GET_USER_MANAGEABLE_SPACE_IDS", "user Id : '" + sUserId + "'", e);
        }
    }
    ...
    public String[] getUserManageableSubSpaceIds(String sUserId, String sParentSpaceId) throws AdminException 
    {
        ...
        {
			// Get user manageable space ids from database
			return m_UserManager.getManageableSubSpaceIds(m_DDManager, sUserId, getDriverSpaceId(sParentSpaceId));
        }
        catch(Exception e)
        {
			throw new AdminException("Admin.getManageableSubSpaceIds", SilverpeasException.ERROR, "admin.EX_ERR_GET_USER_MANAGEABLE_SPACE_IDS", "user Id : '" + sUserId + "' Spacez = " + sParentSpaceId, e);
        }
    }
    ...
    public List getUserManageableGroupIds(String sUserId) throws AdminException
    {
        ...
        {
			throw new AdminException("Admin.getUserManageableGroupIds", SilverpeasException.ERROR, "admin.EX_ERR_GET_USER_MANAGEABLE_GROUP_IDS", "userId + " + sUserId, e);
        }
    }
    ...
    public String[] getAvailCompoIds(String sClientSpaceId, String sUserId) throws AdminException
    {
        ...
        {
			throw new AdminException("Admin.getAvailCompoIds", SilverpeasException.ERROR, "admin.EX_ERR_GET_USER_AVAILABLE_COMPONENT_IDS", "user Id : '" + sUserId + "'", e);
        }
    }
    ...
    public boolean isComponentAvailable(String componentId, String userId) throws AdminException
    {
		try
		{
			return m_ComponentInstManager.isComponentAvailable(m_DDManager, userId, getDriverComponentId(componentId));
        }
        catch(Exception e)
        {
			throw new AdminException("Admin.isComponentAvailable", SilverpeasException.ERROR, "admin.EX_ERR_IS_COMPONENT_AVAILABLE", "user Id : '" + userId + "'" + " , component Id : '" + componentId + "'", e);
        }
    }
	 ...
	 */
    public ArrayList getAvailCompoIdsAtRoot(String sClientSpaceId, String sUserId, String componentNameRoot) throws AdminException
    {
        ...
        {
			throw new AdminException("Admin.getAvailCompoIdsAtRoot", SilverpeasException.ERROR, "admin.EX_ERR_GET_USER_AVAILABLE_COMPONENT_IDS", "user Id : '" + sUserId + "'", e);
        }
    }
    ...
    public String[] getAvailCompoIds(String sUserId) throws AdminException
    {
        try
        {
            //return getClientComponentIds(m_ComponentInstManager.getAvailCompoIds(m_DDManager, sUserId));
    ...
    public String[] getAvailDriverCompoIds(String sClientSpaceId, String sUserId) throws AdminException
    {
        try
        {
			...
			String[] compoIds = m_ComponentInstManager.getAvailCompoIdsInSpace(m_DDManager, spaceId, sUserId);

            return compoIds;
        }
        catch(Exception e)
        {
			throw new AdminException("Admin.getAvailDriverCompoIds", SilverpeasException.ERROR, "admin.EX_ERR_GET_USER_AVAILABLE_COMPONENT_IDS", "user Id : '" + sUserId + "'", e);
        }
    }
    
    public String[] getComponentIdsByNameAndUserId(String sUserId, String sComponentName) throws AdminException
    {
    	return m_ComponentInstManager.getAvailCompoIds(m_DDManager, sUserId, sComponentName);
    }
    ...
    public CompoSpace[] getCompoForUser(String sUserId, String sComponentName) throws AdminException
    {
        ...
        try
        {
			...
			for (int nI=0; nI<availComponents.size(); nI++)
			{
				...
				//ComponentInstLight componentInst = getComponentInstLight((String) alCompoIds.get(nI));
        ...
        {
			throw new AdminException("Admin.getCompoForUser", SilverpeasException.ERROR, "admin.EX_ERR_GET_USER_AVAILABLE_INSTANCES_OF_COMPONENT", "user Id : '" + sUserId + "', component name: '" + sComponentName + "'", e);
        }
    }
    ...
    public String[] getCompoId(String sComponentName) throws AdminException
    {
        ...
        {
			throw new AdminException("Admin.getCompoId", SilverpeasException.ERROR, "admin.EX_ERR_GET_AVAILABLE_INSTANCES_OF_COMPONENT", "component name: '" + sComponentName + "'", e);
        }
    }
	 ...
	 */
    public String[] getUserIds(String sProfileId) throws AdminException //!! private
    {
        try
        {
        ...
        {
			throw new AdminException("Admin.getUserIds", SilverpeasException.ERROR, "admin.EX_ERR_GET_USERS_OF_PROFILE", "profile Id : '" + sProfileId + "'", e);
        }
    }
	 ...
	 */
    public String[] getProfileIds(String sUserId) throws AdminException //!! private
    {
        try
        {
			...
			if(asProfilesIds == null)
			{
				...
				asProfilesIds = m_ProfileInstManager.getProfileIdsOfUser(m_DDManager, sUserId);
        ...
        {
			throw new AdminException("Admin.getProfiles", SilverpeasException.ERROR, "admin.EX_ERR_GET_USER_PROFILES", "user Id : '" + sUserId + "'", e);
        }
    }
	 ...
	 */
    public String[] getProfileIdsOfGroup(String sGroupId) throws AdminException //!! private
    {
		try
        {
            // retrieve value from database
        ...
        {
			throw new AdminException("Admin.getProfileIdsOfGroup", SilverpeasException.ERROR, "admin.EX_ERR_GET_GROUP_PROFILES", "group Id : '" + sGroupId + "'", e);
        }
    }
	 ...
	 */
    public String[] getSpaceManagerProfileIds(String sUserId) throws AdminException //!! private
    {
        try
        {
            return m_SpaceProfileInstManager.getSpaceProfileIdsOfUser(m_DDManager, sUserId);
        }
        catch(Exception e)
        {
			throw new AdminException("Admin.getProfiles", SilverpeasException.ERROR, "admin.EX_ERR_GET_USER_SPACEPROFILES", "user Id : '" + sUserId + "'", e);
        }
    }
	 ...
	 */
    public String[] getCurrentProfiles(String sUserId, ComponentInst componentInst) throws AdminException
    {
    ...
    /**
     * if bAllProfiles = true, return all the user details for the given space and given component
     * if bAllProfiles = false, return the user details only for the given profile for the given space and given component
     */
    public UserDetail[] getUsers(boolean bAllProfiles, String sProfile, String sClientSpaceId, String sClientComponentId) throws AdminException
    {
        ...
        try
        {
            ComponentInst componentInst = getComponentInst(getDriverComponentId(sClientComponentId), true, getDriverSpaceId(sClientSpaceId));

            for(int nI=0; nI < componentInst.getNumProfileInst(); nI++)
                if(componentInst.getProfileInst(nI).getName().equals(sProfile) || bAllProfiles)
                {
        ...
        {
			throw new AdminException("Admin.getUsers", SilverpeasException.ERROR, "admin.EX_ERR_GET_USERS_FOR_PROFILE_AND_COMPONENT", "profile : '" + sProfile + "', space Id: '" + sClientSpaceId + "' component Id: '" + sClientComponentId,  e);
        }
    }
    ...
    {
        String[] theIds = m_GroupManager.getAllSubGroupIds(m_DDManager,parentGroupId);
	 ...
	 * Open a connection
	 */
    private Connection openConnection(String sDbUrl, String sUser, String sPswd, boolean bAutoCommit) throws AdminException
    {
        try
        {
        ...
        {
			throw new AdminException("Admin.openConnection", SilverpeasException.FATAL, "root.EX_CONNECTION_OPEN_FAILED", "Db url: '" + sDbUrl + "', user: '" + sUser + "'",e);
        }
    }
    ...
    private void addArrayList(ArrayList al, String[] as)
    {
     ...
     {
        return intersection(getAllSubSpaceIds(sSpaceId), getClientSpaceIds(getUserSpaceIds(sUserId)));
     }
     ...
     { 
	    return getClientComponentIds( m_ComponentInstManager.getAllCompoIdsInSpace(m_DDManager, getDriverSpaceId(sSpaceId)) );
     } 

     /**
      * Return all the components Id recursively in (Space+subspaces, or only subspaces or in Silverpeas)
      * available in silverpeas given a userId and a componentNameRoot
      * @author dlesimple
      * @param sSpaceId
      * @param sUserId
     ...
     {
	 	SilverTrace.info("admin", "Admin.getAllComponentIdsRecur","root.MSG_GEN_PARAM_VALUE","inCurrentSpace=" + inCurrentSpace+" inAllSpaces="+inAllSpaces);
    	ArrayList alCompoIds = new ArrayList();
    	//In All silverpeas
		if (inAllSpaces)
		{
     ...
     /**
      * Return all the components Id recursively in (Space+subspaces, or only subspaces)
      * available in webactiv given a userId and a componentNameRoot
      * @author dlesimple
      * @param sSpaceId
      * @param sUserId
      * @param componentNameRoot
      ...
      */
     private ArrayList getAllComponentIdsRecur(String sSpaceId, String sUserId, String componentNameRoot, boolean inCurrentSpace) throws Exception
     {
		ArrayList alCompoIds = new ArrayList();
		SpaceInst spaceInst = getSpaceInstById(sSpaceId);
     ...
     public void synchronizeGroupByRule(String groupId, boolean scheduledMode) throws AdminException
     {
    	 ...
    	 {   
	    	 try {
				 ...
				 if (rule.toLowerCase().startsWith("ds_"))
				 {
					 if (rule.toLowerCase().startsWith("ds_accesslevel"))
					 {
						 ...
						 if (accessLevel.equalsIgnoreCase("*"))
						 {
							 ...
							 {
								 userIds = Arrays.asList(m_UserManager.getUserIdsOfDomain(m_DDManager, domainId));
							 }
						 }
						 else
						 {
							 ...
							 {
								 userIds = Arrays.asList(m_UserManager.getUserIdsOfDomainAndAccessLevel(m_DDManager, domainId, accessLevel));
							 }
						 }
					 }
				 ...
				 else if (rule.toLowerCase().startsWith("dc_"))
				 {
					 ...
					 if (domainId == null)
					 {
						 ...
						 {
							 userIds.addAll(getUserIdsBySpecificProperty(domains[d].getId(), propertyName, propertyValue));
						 }
					 }
					 else
					 {
				 ...
				 {
					 SilverTrace.error("admin", "Admin.synchronizeGroup", "admin.MSG_ERR_SYNCHRONIZE_GROUP", "rule '"+rule+"' for groupId '"+groupId+"' is not correct !");
				 }
				 ...
				 if (removedUsers.size() > 0)
				 	 m_DDManager.organization.group.removeUsersFromGroup((String[]) removedUsers.toArray(new String[0]), Integer.parseInt(groupId), false);
	    	...
	    	catch (Exception e) 
	    	{
	             ...
	             SynchroGroupReport.error("admin.synchronizeGroup", "Problème lors de la synchronisation : " + e.getMessage(), null);
	             throw new AdminException("Admin.synchronizeGroup", SilverpeasException.ERROR, "admin.MSG_ERR_SYNCHRONIZE_GROUP", "groupId : '" + groupId + "'", e);
			}
	    	finally
	    	{
	    		if (!scheduledMode)
     ...
     private List getUserIdsBySpecificProperty(String domainId, String propertyName, String propertyValue) throws AdminException
     {
		 ...
		 try {
			 ...
			 SynchroGroupReport.info("admin.getUserIdsBySpecificProperty", "Erreur ! Domaine "+iDomainId+" inaccessible !", null);
		 }
		 ...
		 if (domainDriver != null)
		 {
			 try {
				 ...
				 if (users == null)
					 SynchroGroupReport.info("admin.getUserIdsBySpecificProperty", "La propriété '"+propertyName+"' n'est pas définie dans le domaine "+iDomainId, null);
			 } catch (Exception e) {
				 SynchroGroupReport.info("admin.getUserIdsBySpecificProperty", "Domain "+domainId+" ne supporte pas les groupes synchronisés", null);
			 }
		 }
    ...
    public void difSynchro(String domainId) throws Exception
    {
        ...
        try
        {
            ...
            if (!synchroDomain.isSynchroInProcess())
            {
                synchronized(m_diffSynchroExmut)
                {
                    ...
                    if (timeStampField == null || (timeStampField != null && !fromTimeStamp.equals(toTimeStamp)))
                    {
                        // FIRST Synchro the users
                        // -----------------------
                        //Get all users of the domain from distant datasource that have changed since last full or update synchro
                        distantUDs = synchroDomain.getAllChangedUsers(fromTimeStamp,toTimeStamp);
                        for (nI=0; nI<distantUDs.length ; nI++)
                        {
                            ...
                            silverpeasId = "";
                             try
                             {
                                 silverpeasId = m_UserManager.getUserIdBySpecificIdAndDomainId(m_DDManager,specificId,domainId);
                             }
                             catch (AdminException e) // The user doesn't exist -> Synchronize him
                             {
                                 SilverTrace.warn("admin", "Admin.difSynchro", "admin.EX_ERR_USER_NOT_FOUND", "SpecId=" + specificId, e);
                                 ...
                                 {
                                     SilverTrace.warn("admin", "Admin.difSynchro", "admin.MSG_ERR_SYNCHRONIZE_USER", "SpecId=" + specificId, ex);
                                 }
                             }
                             if (silverpeasId.length() > 0)
                             {
                                 ...
                                 {
                                     SilverTrace.warn("admin", "Admin.difSynchro", "admin.MSG_ERR_SYNCHRONIZE_USER", "UserId=" + silverpeasId + " SpecId=" + specificId, ex);
                                 }
                             }
                        }
                        ...
                        distantGroups = synchroDomain.getAllChangedGroups(fromTimeStamp,toTimeStamp);
                        ...
                        for (nI=0; nI<distantGroups.length ; nI++)
                        {
                            ...
                            silverpeasId = "";
                             try
                             {
                                 silverpeasId = m_GroupManager.getGroupIdBySpecificIdAndDomainId(m_DDManager,specificId,domainId);
                             }
                             catch (AdminException e)
                             {
                                 SilverTrace.warn("admin", "Admin.difSynchro", "admin.EX_ERR_GROUP_NOT_FOUND", "SpecId=" + specificId, e);
                                 // The group doesnt exist -> import him
                                 try
                                 {
                                    synchronizeImportGroup(domainId,specificId,null,false,true);
                                 }
                                 catch (AdminException ex) // The group's synchro failed -> Ignore him
                                 {
                                     SilverTrace.warn("admin", "Admin.difSynchro", "admin.MSG_ERR_SYNCHRONIZE_GROUP", "SpecId=" + specificId, ex);
                                 }
                             }
                             if (silverpeasId.length() > 0)
                             {
                                 try
                                 {
                                     ...
                                     distantGroups[nI].setUserIds(translateUserIds(domainId,distantGroups[nI].getUserIds()));
                                     updateGroup(distantGroups[nI],true);
                                 }
                                 catch (AdminException ex) // The group's synchro failed -> Ignore him
                                 {
                                     SilverTrace.warn("admin", "Admin.difSynchro", "admin.MSG_ERR_SYNCHRONIZE_GROUP", "GroupId=" + silverpeasId + " SpecId=" + specificId, ex);
                                 }
                             }
                        }
                        ...
                        if (m_delUsersOnDiffSynchro)
                        {
	            			...
	            			UserDetail[] silverpeasUDs = m_UserManager.getUsersOfDomain(m_DDManager, domainId);
	            			...
	            			for (nI=0; nI<silverpeasUDs.length ; nI++)
	            			{
	            				...
	            				if (!bFound)
	            				{
	            					try
	            					{
	            						SilverTrace.info("admin", "admin.difSynchro", "root.MSG_GEN_PARAM_VALUE", "%%%%DIFFSYNCHRO%%%%>Delete User : "+silverpeasUDs[nI]);
	            						m_UserManager.deleteUser(m_DDManager, silverpeasUDs[nI], true);
	            					}
	            					catch (AdminException aeDel)
	            					{
	            						SilverTrace.error("admin", "admin.difSynchro", "root.MSG_GEN_PARAM_VALUE", "%%%%DIFFSYNCHRO%%%%>PB deleting User ! "+specificId,aeDel);
	            					}
	                            }
	                        }
	            			SilverTrace.warn("admin", "admin.difSynchro", "root.MSG_GEN_PARAM_VALUE", nbDeletedUsers+" users have been deleted !");
                        }
            ...
            {
                SilverTrace.warn("admin", "admin.difSynchro", "root.MSG_GEN_EXIT_METHOD", "Full synchro currently running, skipping diff synchro....");
            }
        }
        catch(Exception e)
        {
            SynchroReport.error("admin.difSynchro", "Problème lors de la synchronisation des utilisateurs : " + e.getMessage(),null );
            throw new AdminException("admin.difSynchro", SilverpeasException.ERROR, "admin.EX_ERR_SYNCHRONIZE_DOMAIN_USERS", "domain id : '" + domainId + "'\nReport:"+sReport, e);
        }
    }

	 private Vector translateGroupIds(String sDomainId, String[] groupSpecificIds, boolean recursGroups) throws Exception
	 {
         ...
         for (int i = 0; i < groupSpecificIds.length;i++ )
         {
             try
             {
                 groupId = m_GroupManager.getGroupIdBySpecificIdAndDomainId(m_DDManager,groupSpecificIds[i],sDomainId);
             }
             catch (AdminException e) // The group doesn't exist -> Synchronize him
             {
                 groupId = null;
                 SilverTrace.warn("admin", "Admin.translateGroupIds", "admin.EX_ERR_GROUP_NOT_FOUND", "SpecId=" + groupSpecificIds[i], e);
                 if (recursGroups)
                 {
                     try
                     {
                        groupId = synchronizeImportGroup(sDomainId,groupSpecificIds[i],null,true,true);
                     }
                     catch (AdminException ex) // The group's synchro failed -> Ignore him
                     {
                         SilverTrace.warn("admin", "Admin.translateGroupIds", "admin.MSG_ERR_SYNCHRONIZE_GROUP", "SpecId=" + groupSpecificIds[i], ex);
                         groupId = null;
                     }
                 }
             }
	 ...
	 private String[] translateUserIds(String sDomainId, String[] userSpecificIds) throws Exception
	 {
         ...
         for (int i = 0; i < userSpecificIds.length;i++ )
         {
             try
             {
                 userId = m_UserManager.getUserIdBySpecificIdAndDomainId(m_DDManager,userSpecificIds[i],sDomainId);
             }
             catch (AdminException e) // The user doesn't exist -> Synchronize him
             {
                 SilverTrace.warn("admin", "Admin.translateUserIds", "admin.EX_ERR_USER_NOT_FOUND", "SpecId=" + userSpecificIds[i], e);
                 try
                 {
                 ...
                 {
                     SilverTrace.warn("admin", "Admin.translateUserIds", "admin.MSG_ERR_SYNCHRONIZE_USER", "SpecId=" + userSpecificIds[i], ex);
                     userId = null;
                 }
             }
             if (userId != null)
	 ...
	 */
	 public String synchronizeImportGroup(String domainId, String groupKey, String askedParentId, boolean recurs, boolean isIdKey) throws Exception
	 {
         ...
         for (i = 0 ; (i < parentSpecificIds.length) && (parentId == null) ; i++ )
         {
             try
             {
                 parentId = m_GroupManager.getGroupIdBySpecificIdAndDomainId(m_DDManager,parentSpecificIds[i],domainId);
                 if ((askedParentId != null) && (askedParentId.length() > 0) && (askedParentId.equals(parentId) == false))
         ...
         {// We can't add the group (just the same restriction as for the directories...)
            throw new AdminException("Admin.synchronizeImportGroup", SilverpeasException.ERROR, "admin.EX_ERR_GROUP_PARENT_NOT_PRESENT", "group name : '" + groupKey + "'");
         }
         // The group is a root group or have a known parent
         gr.setSuperGroupId(parentId);

         // We must first add the group with no child. Then, the childs will be added during the internal synchronization function call
	 ...
	 */
     ...
     protected void internalSynchronizeGroup(AbstractDomainDriver synchroDomain, Group latestGroup, boolean recurs) throws Exception
     {
	 ...
	 */
	 public String synchronizeUser(String userId, boolean recurs) throws Exception
	 {
         ...
         try
         {
             ...
             incGroupsId = translateGroupIds(theUserDetail.getDomainId(),incGroupsSpecificId,recurs);
             oldGroupsId = m_GroupManager.getDirectGroupsOfUser(m_DDManager,userId);
             for (i = 0; i < oldGroupsId.length ; i++)
             {
                 if (incGroupsId.contains(oldGroupsId[i]))
                 { // No changes have to be performed to the group -> Remove it
                    incGroupsId.removeElement(oldGroupsId[i]);
                 }
                 else
                 {
                    Group grpToRemove = m_GroupManager.getGroup(m_DDManager,oldGroupsId[i]);
                    if (theUserDetail.getDomainId().equals(grpToRemove.getDomainId()))
                    {
                        // Remove the user from this group
                        m_GroupManager.removeUserFromGroup(m_DDManager,userId,oldGroupsId[i]);
                        m_Cache.opRemoveUserFromGroup(userId,oldGroupsId[i]);
                    }
                 }
             }
             // Now the remaining groups of the vector are the groups where the user is newly added
         ...
         {
            rollback();
            throw new AdminException("Admin.synchronizeUser", SilverpeasException.ERROR, "admin.EX_ERR_UPDATE_USER", "user id : '" + userId + "'", e);
         }
     }
	 ...
	 */
	 ...
	 public List getSpecificPropertiesToImportUsers(String domainId, String language) throws Exception
	 {
	 ...
	 public UserDetail[] searchUsers(String domainId, Hashtable query) throws Exception
	 {
    ...
    //		SynchroReport.warn("admin.synchronizeSilverpeasWithDomain", "Début de synchronisation...",null);
		try
		{
                SynchroReport.warn("admin.synchronizeSilverpeasWithDomain","Domaine : " + m_DDManager.getDomain(sDomainId).getName()+ ", ID : " + sDomainId,null);
        ...
        catch(Exception e)
        {
            ...
            throw new AdminException("Admin.synchronizeSilverpeasWithDomain", SilverpeasException.ERROR, "admin.EX_ERR_SYNCHRONIZE_DOMAIN", "domain id : '" + sDomainId + "'\nReport:"+sReport, e);
        }
		finally
		{
	 ...
	 */
	 private String synchronizeUsers(String domainId, Hashtable userIds) throws Exception
	 {
		boolean bFound = false;
		String specificId = null;
		String silverpeasId = null;
		...
		try
		{
			...
			SynchroReport.info("admin.synchronizeUsers", "AJOUT ou MISE A JOUR des utilisateurs dans la base...", null);
			SynchroReport.info("admin.synchronizeUsers", "Valeur du paramètre 'm_bFallbackUserLogins' = "+m_bFallbackUserLogins, null);
			...
			for (int nI=0; nI<distantUDs.length ; nI++)
			{
				bFound = false;
				specificId = distantUDs[nI].getSpecificId();
                SilverTrace.info("admin", "admin.synchronizeUsers", "root.MSG_GEN_PARAM_VALUE", "%%%%FULLSYNCHRO%%%%>Deal with user : "+specificId);

				// search for user in Silverpeas database
				for (int nJ=0; nJ<silverpeasUDs.length && !bFound; nJ++)
				{
					if (silverpeasUDs[nJ].getSpecificId().equals(specificId) || (m_bFallbackUserLogins && silverpeasUDs[nJ].getLogin().equals(distantUDs[nI].getLogin())))
					{
						bFound = true;
				...
				if (bFound)//MAJ
				{
					try
					{
						SilverTrace.info("admin", "admin.synchronizeUsers", "root.MSG_GEN_PARAM_VALUE", "%%%%FULLSYNCHRO%%%%>Update User : "+distantUDs[nI].getId());
						silverpeasId = m_UserManager.updateUser(m_DDManager, distantUDs[nI]);
						iNbUsersMaj++;
						SynchroReport.warn("admin.synchronizeUsers", "maj utilisateur " + distantUDs[nI].getFirstName() + " " + distantUDs[nI].getLastName() + " (id:" + silverpeasId + " / specificId:"+specificId + ") OK",null);
					sReport += "updating user " + distantUDs[nI].getFirstName() + " " + distantUDs[nI].getLastName() + "(id:" + specificId + ")\n";
				}
					catch (AdminException aeMaj)
					{
                        SilverTrace.info("admin", "admin.synchronizeUsers", "root.MSG_GEN_PARAM_VALUE", "%%%%FULLSYNCHRO%%%%>PB Updating User ! "+specificId,aeMaj);
                        sReport += "problem updating user " + distantUDs[nI].getFirstName() + " " + distantUDs[nI].getLastName() + " (specificId:"+specificId + ") - " + aeMaj.getMessage() + "\n";
				...
				else//AJOUT
				{
                    try
                    {
    					silverpeasId = m_UserManager.addUser(m_DDManager, distantUDs[nI], true);
    					if (silverpeasId.equals(""))
                        {
                            SilverTrace.info("admin", "admin.synchronizeUsers", "root.MSG_GEN_PARAM_VALUE", "%%%%FULLSYNCHRO%%%%>PB Adding User ! "+specificId);
                            sReport += "problem adding user " + distantUDs[nI].getFirstName() + " " + distantUDs[nI].getLastName() + "(specificId:"+specificId + ") - Login and LastName must be set !!!\n";
                            sReport += "user has not been added\n";
                        }
                        else
                        {
							iNbUsersAdded++;
                            SilverTrace.info("admin", "admin.synchronizeUsers", "root.MSG_GEN_PARAM_VALUE", "%%%%FULLSYNCHRO%%%%>Add User : "+silverpeasId);
                            sReport += "adding user " + distantUDs[nI].getFirstName() + " " + distantUDs[nI].getLastName() + "(id:" + silverpeasId + " / specificId:"+specificId + ")\n";
							SynchroReport.warn("admin.synchronizeUsers", "ajout utilisateur " + distantUDs[nI].getFirstName() + " " + distantUDs[nI].getLastName() + " (id:" + silverpeasId + " / specificId:"+specificId + ") OK",null);
                            userIds.put(specificId, silverpeasId);
                        }
                    }
                    catch (AdminException ae)
                    {
                        SilverTrace.info("admin", "admin.synchronizeUsers", "root.MSG_GEN_PARAM_VALUE", "%%%%FULLSYNCHRO%%%%>PB Adding User ! "+specificId,ae);
                        sReport += "problem adding user " + distantUDs[nI].getFirstName() + " " + distantUDs[nI].getLastName() + "(specificId:"+specificId + ") - " + ae.getMessage() + "\n";
                        sReport += "user has not been added\n";
                    }
				}
			}
			...
			SynchroReport.info("admin.synchronizeUsers", "SUPPRESSION des éventuels utilisateurs obsolètes de la base...", null);
			for (int nI=0; nI<silverpeasUDs.length ; nI++)
			{
				...
				for (int nJ=0; nJ<distantUDs.length && !bFound; nJ++)
				{
					if (distantUDs[nJ].getSpecificId().equals(specificId) || (m_bFallbackUserLogins && silverpeasUDs[nI].getLogin().equals(distantUDs[nJ].getLogin())))
					{
						bFound = true;
					}
				}
				...
				if (!bFound)
				{
					try
					{
	                    SilverTrace.info("admin", "admin.synchronizeUsers", "root.MSG_GEN_PARAM_VALUE", "%%%%FULLSYNCHRO%%%%>Delete User : "+silverpeasUDs[nI]);
					m_UserManager.deleteUser(m_DDManager, silverpeasUDs[nI], true);
						iNbUsersDeleted++;
					sReport += "deleting user " + silverpeasUDs[nI].getFirstName() + " " + silverpeasUDs[nI].getLastName() + "(id:" + specificId + ")\n";
						SynchroReport.warn("admin.synchronizeUsers", "suppression utilisateur " + silverpeasUDs[nI].getFirstName() + " " + silverpeasUDs[nI].getLastName() + " (specificId:" + specificId + ") OK",null);
					}
					catch (AdminException aeDel)
					{
						SilverTrace.info("admin", "admin.synchronizeUsers", "root.MSG_GEN_PARAM_VALUE", "%%%%FULLSYNCHRO%%%%>PB deleting User ! "+specificId,aeDel);
                        sReport += "problem deleting user " + silverpeasUDs[nI].getFirstName() + " " + silverpeasUDs[nI].getLastName() + " (specificId:"+specificId + ") - " + aeDel.getMessage() + "\n";
			...
			SynchroReport.info("admin.synchronizeUsers", "Nombre d'utilisateurs mis à jour : " + iNbUsersMaj + ", ajoutés : " + iNbUsersAdded + ", supprimés : " + iNbUsersDeleted, null);
			SynchroReport.warn("admin.synchronizeUsers", "Synchronisation utilisateurs terminée",null);
			return sReport;
		}
        catch(Exception e)
        {
			SynchroReport.error("admin.synchronizeUsers", "Problème lors de la synchronisation des utilisateurs : " + e.getMessage(),null );
			throw new AdminException("admin.synchronizeUsers", SilverpeasException.ERROR, "admin.EX_ERR_SYNCHRONIZE_DOMAIN_USERS", "domain id : '" + domainId + "'\nReport:"+sReport, e);
        }
	 }
	 ...
	 *	Synchronize users between cache and domain's datastore
	 */
	 private String synchronizeOnlyExistingUsers(String domainId, Hashtable userIds) throws Exception
	 {
		boolean bFound = false;
		String specificId = null;
		String silverpeasId = null;
		...
		SynchroReport.warn("admin.synchronizeOnlyExistingUsers", "SYNCHRONISATION UTILISATEURS :",null);
		try
		{
			//Clear conversion table
			userIds.clear();
			...
			SynchroReport.info("admin.synchronizeOnlyExistingUsers", "MISE A JOUR ou SUPPRESSION des utilisateurs dans la base...", null);
			SynchroReport.info("admin.synchronizeOnlyExistingUsers", "Valeur du paramètre 'm_bFallbackUserLogins' = "+m_bFallbackUserLogins, null);
			...
			for (int nI=0; nI<silverpeasUDs.length; nI++)
			{
				...
				for (int nJ=0; nJ<distantUDs.length && !bFound; nJ++)
				{
					...
					if (userLDAP.getSpecificId().equals(specificId) || (m_bFallbackUserLogins && userLDAP.getLogin().equals(userSP.getLogin())))
					{
						bFound = true;
				...
				if (bFound)//MAJ
				{
					try
					{
						SilverTrace.info("admin", "admin.synchronizeOnlyExistingUsers", "root.MSG_GEN_PARAM_VALUE", "%%%%FULLSYNCHRO%%%%>Update User : "+userLDAP.getId());
						silverpeasId = m_UserManager.updateUser(m_DDManager, userLDAP);
						iNbUsersMaj++;
						SynchroReport.warn("admin.synchronizeOnlyExistingUsers", "maj utilisateur " + userLDAP.getDisplayedName() + " (id:" + silverpeasId + " / specificId:"+specificId + ") OK",null);
						sReport += "updating user " + userLDAP.getDisplayedName() + "(id:" + specificId + ")\n";
					}
					catch (AdminException aeMaj)
					{
                        SilverTrace.info("admin", "admin.synchronizeOnlyExistingUsers", "root.MSG_GEN_PARAM_VALUE", "%%%%FULLSYNCHRO%%%%>PB Updating User ! "+specificId,aeMaj);
                        sReport += "problem updating user " + userLDAP.getDisplayedName() + " (specificId:"+specificId + ") - " + aeMaj.getMessage() + "\n";
                        sReport += "user has not been updated\n";
	                }
				}
				else
				{
					try
					{
	                    SilverTrace.info("admin", "admin.synchronizeOnlyExistingUsers", "root.MSG_GEN_PARAM_VALUE", "%%%%FULLSYNCHRO%%%%>Delete User : "+silverpeasUDs[nI]);
	                    m_UserManager.deleteUser(m_DDManager, userSP, true);
						iNbUsersDeleted++;
						sReport += "deleting user " + userSP.getDisplayedName() + "(id:" + specificId + ")\n";
						SynchroReport.warn("admin.synchronizeOnlyExistingUsers", "suppression utilisateur " + userSP.getDisplayedName() + " (specificId:" + specificId + ") OK",null);
					}
					catch (AdminException aeDel)
					{
						SilverTrace.info("admin", "admin.synchronizeOnlyExistingUsers", "root.MSG_GEN_PARAM_VALUE", "%%%%FULLSYNCHRO%%%%>PB deleting User ! "+specificId,aeDel);
                        sReport += "problem deleting user " + userSP.getDisplayedName() + " (specificId:"+specificId + ") - " + aeDel.getMessage() + "\n";
                        sReport += "user has not been deleted\n";
					}
				}
			}
			...
			sReport += "User synchronization terminated\n";
			SynchroReport.info("admin.synchronizeOnlyExistingUsers", "Nombre d'utilisateurs mis à jour : " + iNbUsersMaj + ", ajoutés : " + iNbUsersAdded + ", supprimés : " + iNbUsersDeleted, null);
			SynchroReport.warn("admin.synchronizeOnlyExistingUsers", "Synchronisation utilisateurs terminée",null);
			return sReport;
		}
        catch(Exception e)
        {
			SynchroReport.error("admin.synchronizeOnlyExistingUsers", "Problème lors de la synchronisation des utilisateurs : " + e.getMessage(),null );
			throw new AdminException("admin.synchronizeOnlyExistingUsers", SilverpeasException.ERROR, "admin.EX_ERR_SYNCHRONIZE_DOMAIN_USERS", "domain id : '" + domainId + "'\nReport:"+sReport, e);
        }
	 }
	 ...
	 */
	 private String synchronizeGroups(String domainId, Hashtable userIds) throws Exception
	 {
		boolean bFound = false;
		String specificId = null;
		...
		try
		{
			...
			Group[] silverpeasGroups = m_GroupManager.getGroupsOfDomain(m_DDManager, domainId);

			SynchroReport.info("admin.synchronizeGroups", "AJOUT ou MISE A JOUR des groupes dans la base...", null);
			//Check for new groups resursively
			sReport += checkOutGroups(domainId, silverpeasGroups, distantRootGroups, allDistantGroups, userIds, null, iNbGroupsAdded,iNbGroupsMaj,iNbGroupsDeleted);

			//Delete obsolete groups
			SynchroReport.info("admin.synchronizeGroups", "SUPPRESSION des éventuels groupes obsolètes de la base...", null);
			Group[] distantGroups = (Group[])allDistantGroups.values().toArray(new Group[0]);
			for (int nI=0; nI<silverpeasGroups.length ; nI++)
			{
				...
				for (int nJ=0; nJ<distantGroups.length && !bFound; nJ++)
				{
                    ...
                    else if (m_bFallbackGroupNames && distantGroups[nJ].getName().equals(specificId))
                    {
						bFound = true;
                    }
                }
				...
				if (!bFound)
				{
					try
					{
	                    SilverTrace.info("admin", "admin.synchronizeGroups", "root.MSG_GEN_PARAM_VALUE", "%%%%FULLSYNCHRO%%%%>Delete group : " + silverpeasGroups[nI].getId() + " - " + specificId);
					m_GroupManager.deleteGroupById(m_DDManager, silverpeasGroups[nI], true);
						iNbGroupsDeleted++;
					sReport += "deleting group " + silverpeasGroups[nI].getName() + "(id:" + specificId + ")\n";
						SynchroReport.warn("admin.synchronizeGroups", "suppression groupe " + silverpeasGroups[nI].getName() + "(SpecificId:" + specificId + ") OK",null);
					}
					catch (AdminException aeDel)
					{
						SilverTrace.info("admin", "admin.synchronizeGroups", "root.MSG_GEN_PARAM_VALUE", "%%%%FULLSYNCHRO%%%%>PB deleting group ! "+specificId,aeDel);
                        sReport += "problem deleting group " + silverpeasGroups[nI].getName() + " (specificId:"+specificId + ") - " + aeDel.getMessage() + "\n";
                        sReport += "group has not been deleted\n";
					}
				}
			}
			sReport += "Group synchronization terminated\n";
			SynchroReport.info("admin.synchronizeGroups", "Nombre de groupes mis à jour : " + iNbGroupsMaj + ", ajoutés : " + iNbGroupsAdded + ", supprimés : " + iNbGroupsDeleted, null);
			SynchroReport.warn("admin.synchronizeGroups", "Synchronisation groupes terminée",null);
			return sReport;
		}
        catch(Exception e)
        {
			SynchroReport.error("admin.synchronizeGroups", "Problème lors de la synchronisation des groupes : " + e.getMessage(),null );
			throw new AdminException("admin.synchronizeGroups", SilverpeasException.ERROR, "admin.EX_ERR_SYNCHRONIZE_DOMAIN_GROUPS", "domain id : '" + domainId + "'\nReport:"+sReport, e);
        }
	}
	 ...
	 */
	 //Au 1er appel : (domainId,silverpeasGroups,distantRootGroups, allDistantGroups(vide), userIds, null)
     // No need to refresh cache : the cache is reseted at the end of the synchronization
	private String checkOutGroups(String domainId, Group[] existingGroups, Group[] testedGroups, Hashtable allIncluededGroups, Hashtable userIds, String superGroupId, int iNbGroupsAdded,int iNbGroupsMaj,int iNbGroupsDeleted) throws Exception
	{
		boolean bFound = false;
		String specificId = null;
		String silverpeasId = null;
		...
		for (nI=0; nI<testedGroups.length ; nI++)
		{
            ...
            SilverTrace.info("admin", "admin.checkOutGroups", "root.MSG_GEN_PARAM_VALUE", "%%%%FULLSYNCHRO%%%%>Deal with group : "+specificId);
			...
			for (int nJ=0; nJ<existingGroups.length && !bFound; nJ++)
			{
                ...
                else if (m_bFallbackGroupNames && existingGroups[nJ].getSpecificId().equals(testedGroups[nI].getName()))
                {
					bFound = true;
					testedGroups[nI].setId(existingGroups[nJ].getId());
                }
            ...
            String [] groupParentsIds = m_DDManager.getGroupMemberGroupIds(domainId, testedGroups[nI].getSpecificId());
			...
			testedGroups[nI].setSuperGroupId(superGroupId);
				if (superGroupId != null)//sécurité
					SynchroReport.debug("admin.checkOutGroups", "le groupe " + specificId + " a pour père le groupe " + m_DDManager.getGroup(superGroupId).getSpecificId() + " d'Id base " + superGroupId,null);
            }
			...
			//Le groupe contiendra une liste d'IDs de users existant ds la base et non + une liste de logins récupérés via LDAP
			...
			{	
				try
					{
					SilverTrace.info("admin", "admin.checkOutGroups", "root.MSG_GEN_PARAM_VALUE", "%%%%FULLSYNCHRO%%%%>Update group : "+testedGroups[nI].getId());
					sResult = m_GroupManager.updateGroup(m_DDManager, testedGroups[nI], true);
					if (! sResult.equals(""))
						{
						iNbGroupsMaj++;
				silverpeasId = testedGroups[nI].getId();
				sReport += "updating group " + testedGroups[nI].getName() + "(id:" + specificId + ")\n";
						SynchroReport.warn("admin.checkOutGroups", "maj groupe " + testedGroups[nI].getName() + " (id:" + silverpeasId + ") OK",null);
						}
					else//le name groupe non renseigné
						{
						SilverTrace.info("admin", "admin.checkOutGroups", "root.MSG_GEN_PARAM_VALUE", "%%%%FULLSYNCHRO%%%%>PB Updating Group ! "+specificId);
						sReport += "problem updating group id : " + specificId + "\n";
						}
					}	
				catch(AdminException aeMaj)
					{
                     SilverTrace.info("admin", "admin.checkOutGroups", "root.MSG_GEN_PARAM_VALUE", "%%%%FULLSYNCHRO%%%%>PB Updating Group ! "+specificId,aeMaj);
                     sReport += "problem updating group " + testedGroups[nI].getName() + " (id:" + specificId + ") " + aeMaj.getMessage() + "\n";
			...
			else//AJOUT
			{
				try
			    {
				silverpeasId = m_GroupManager.addGroup(m_DDManager, testedGroups[nI], true);
					if (! silverpeasId.equals(""))
						{
						iNbGroupsAdded++;
		                SilverTrace.info("admin", "admin.checkOutGroups", "root.MSG_GEN_PARAM_VALUE", "%%%%FULLSYNCHRO%%%%>Add group : "+silverpeasId);
				sReport += "adding group " + testedGroups[nI].getName() + "(id:" + specificId + ")\n";
						SynchroReport.warn("admin.checkOutGroups", "ajout groupe " + testedGroups[nI].getName() + " (id:" + silverpeasId + ") OK",null);
						}
					else//le name groupe non renseigné
						{
						SilverTrace.info("admin", "admin.checkOutGroups", "root.MSG_GEN_PARAM_VALUE", "%%%%FULLSYNCHRO%%%%>PB Adding Group ! "+specificId);
						sReport += "problem adding group id : " + specificId + "\n";
						}
					}
				catch(AdminException aeAdd)
					{
                     SilverTrace.info("admin", "admin.checkOutGroups", "root.MSG_GEN_PARAM_VALUE", "%%%%FULLSYNCHRO%%%%>PB Adding Group ! "+specificId,aeAdd);
                     sReport += "problem adding group " + testedGroups[nI].getName() + " (id:" + specificId + ") " + aeAdd.getMessage() + "\n";
            ...
            {
            	Group[] cleanSubGroups = removeCrossReferences(subGroups,allIncluededGroups,specificId);
    			if (cleanSubGroups!=null && cleanSubGroups.length>0)
	    				...
	    				sReport += checkOutGroups(domainId, existingGroups, cleanSubGroups, allIncluededGroups, userIds, silverpeasId, iNbGroupsAdded, iNbGroupsMaj, iNbGroupsDeleted);
						}
	            }
            }
		}
	 ...
	 */
	private Group[] removeCrossReferences(Group[] subGroups, Hashtable allIncluededGroups, String fatherId) throws Exception
    {
		...
		for (nI=0; nI<subGroups.length ; nI++)
		{
            ...
            {
                SilverTrace.warn("admin", "Admin.removeCrossReferences", "root.MSG_GEN_PARAM_VALUE", "Cross removed for child : " + subGroups[nI].getSpecificId() + " of father : " + fatherId);
            }
        }
    ...
    //                       RECOVERY TOOLS
    //-------------------------------------------------------------------------
	public int recurseRecoverChildrenGroups(String sGroupFatherId) throws AdminException
	{
		int linkCount = 0;
		String [] asChildrenGroupIds = m_GroupManager.getAllSubGroupIds(m_DDManager, sGroupFatherId);
		for (int nI=0; nI<asChildrenGroupIds.length; nI++)
		{
			linkCount++;
			m_UserSetManager.addUserSetRelation(m_DDManager, "G", sGroupFatherId, "G", asChildrenGroupIds[nI]);
	...
	public void recoverUserSetTables() throws AdminException
	{
		try
		{
			...
			for (int nI=0; nI<asGroupIds.length; nI++)
			{
				...
				{
					m_UserSetManager.addUserRelation(m_DDManager, "G", asGroupIds[nI], asUserIds[nJ]);
					linkCount++;
				}
			}
			...
			for (int nI=0; nI<asSpaceIds.length; nI++)
			{
				...
				String [] asSpaceProfileIds = m_SpaceInstManager.getAllSpaceProfileIds(m_DDManager, m_sDriverId);
				if (asSpaceProfileIds != null && asSpaceProfileIds.length > 0)
				{
					for (int nJ=0; nJ<asSpaceProfileIds.length ; nJ++)
					{
						...
						if (m_SpaceProfileInst!=null)
						{
							...
							m_UserSetManager.addUserSetRelation(m_DDManager, "S", m_sDriverId, "M", m_SpaceProfileInst.getId());
							linkCount++;
							userSetCount++;
							...
							for (int nL=0; nL<m_SpaceProfileInst.getNumGroup(); nL++)
							{
								...
								m_UserSetManager.addUserSetRelation(m_DDManager, "M", asSpaceProfileIds[nJ], "G", sGroupId);
								linkCount++;
							}
							...
							for (int nM=0; nM<m_SpaceProfileInst.getNumUser(); nM++)
							{
								...
								m_UserSetManager.addUserRelation(m_DDManager, "M", asSpaceProfileIds[nJ], sUserId);
								linkCount++;
							}
						}
					}
			...
			for (int nI=0; nI<asSpaceIds.length; nI++)
			{
				...
				for(int nJ=0; nJ < alCompoInst.size(); nJ++)
				{
					...
					if (m_ComponentInst != null)
					{
						...
						m_UserSetManager.addUserSetRelation(m_DDManager, "S", m_sDriverId, "I", sCompoId);
						linkCount++;
						userSetCount++;
						...
						for (int nK=0; nK<al_ProfileInst.size(); nK++)
						{
							...
							if (m_ProfileInst != null)
							{
								...
								m_UserSetManager.addUserSetRelation(m_DDManager, "I", sCompoId, "R", sProfileId);
								linkCount++;
								userSetCount++;
								...
								for (int nL=0; nL<m_ProfileInst.getNumGroup(); nL++)
								{
									...
									m_UserSetManager.addUserSetRelation(m_DDManager, "R", sProfileId, "G", sGroupId);
									linkCount++;
								}
								...
								for (int nM=0; nM<m_ProfileInst.getNumUser(); nM++)
								{
									...
									m_UserSetManager.addUserRelation(m_DDManager, "R", sProfileId, sUserId);
									linkCount++;
								}
							}
						}
			...
			// Reset the cache
            SilverTrace.info("admin", "Admin.recoverUserSetTables", "root.MSG_GEN_RETURN_VALUE", "userSets created : " + userSetCount);
            SilverTrace.info("admin", "Admin.recoverUserSetTables", "root.MSG_GEN_RETURN_VALUE", "links created : " + linkCount);
	    }
        catch(Exception  e)
        {
        	rollback();
			throw new AdminException("Admin.recoverUserSetTables", SilverpeasException.ERROR, "admin.EX_ERR_RECOVER_USERSETS", e);
		}
		finally
		{
			// Reset the cache
    ...
    public String[] searchUsersIds(String sGroupId, String componentId, String[] profileId, UserDetail modelUser) throws AdminException
    {
        try
        {
            return m_UserManager.searchUsersIds(m_DDManager, sGroupId, getDriverComponentId(componentId), profileId, modelUser);
        }
        catch(Exception e)
        {
			throw new AdminException("Admin.searchUsersIds", SilverpeasException.ERROR, "admin.EX_ERR_USER_NOT_FOUND", e);
        }
    }
    ...
    public String[] searchGroupsIds(boolean isRootGroup, String componentId, String[] profileId, Group modelGroup) throws AdminException
    {
        try
        {
            return m_GroupManager.searchGroupsIds(m_DDManager, isRootGroup, getDriverComponentId(componentId), profileId, modelGroup);
        }
        catch(Exception e)
        {
			throw new AdminException("Admin.searchGroupsIds", SilverpeasException.ERROR, "admin.EX_ERR_GROUP_NOT_FOUND", e);
        }
    }
    ...
    public void resetAllDBConnections(boolean isScheduled) throws AdminException
    {
        ...
        {
			throw new AdminException("Admin.resetAllDBConnections", SilverpeasException.ERROR, "root.EX_CONNECTION_CLOSE_FAILED", e);
        }
    }
