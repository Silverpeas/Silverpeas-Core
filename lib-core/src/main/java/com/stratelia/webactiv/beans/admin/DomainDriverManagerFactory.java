...
public class DomainDriverManagerFactory {
  private ThreadLocal<DomainDriverManager> domainDriverManagerRef = new ThreadLocal<DomainDriverManager>() {
    @Override
    ...
    public static DomainDriverManagerFactory getFactory() { return instance; }
