...
{
    protected int m_DomainId = -1;             // The domainId of this instance of domain driver

    protected List m_Properties = new ArrayList(); //liste ordonnée des properties du bundle domainSP
    ...
    final static public long ACTION_MASK_RW        = ACTION_READ_USER | ACTION_READ_GROUP | ACTION_UPDATE_USER | ACTION_UPDATE_GROUP | ACTION_CREATE_USER | ACTION_CREATE_GROUP | ACTION_DELETE_USER | ACTION_DELETE_GROUP | ACTION_EDIT_USER_IN_GROUP;

    final static public long ACTION_MASK_RO        = ACTION_READ_USER | ACTION_READ_GROUP | ACTION_IMPORT_USER | ACTION_SYNCHRO_USER | ACTION_REMOVE_USER | ACTION_IMPORT_GROUP | ACTION_SYNCHRO_GROUP | ACTION_REMOVE_GROUP;

    final static public long ACTION_MASK_MIXED_GROUPS = ACTION_READ_GROUP | ACTION_UPDATE_GROUP | ACTION_CREATE_GROUP | ACTION_DELETE_GROUP | ACTION_EDIT_USER_IN_GROUP;

   /**
    * Initialize the domain driver with the initialization parameter stocked in table
    * This parameter could be a table name or a ressource file name or whatever specified by the domain driver
    ...
    public List getPropertiesToImport(String language)
    {
    	...
    	while(it.hasNext()) {
    		...
    		if(domainProp.isUsedToImport())
    		{
    			...
    			String propDescription = (String) theDescriptions.get(domainProp.getName());
   ...
   public boolean isSynchroOnLoginEnabled() { return false; }

   public boolean isSynchroThreaded() { return false; }

   public boolean isSynchroOnLoginRecursToGroups() { return true; }

   public boolean isGroupsInheritProfiles() { return false; }
   
   public boolean mustImportUsers() { return true; } 

   public String getTimeStamp(String minTimeStamp) throws Exception { return ""; }
   ...
   { throw new AdminException("AbstractDomainDriver.getAllChangedUsers", SilverpeasException.ERROR, "admin.EX_ERR_DOMAIN_DOES_NOT_SUPPORT", "DomainId=" + Integer.toString(m_DomainId)); }

   public Group[] getAllChangedGroups(String fromTimeStamp, String toTimeStamp) throws Exception
   { throw new AdminException("AbstractDomainDriver.getAllChangedGroups", SilverpeasException.ERROR, "admin.EX_ERR_DOMAIN_DOES_NOT_SUPPORT", "DomainId=" + Integer.toString(m_DomainId)); }

   /**
    * Called when Admin starts the synchronization
    */
   public void beginSynchronization() throws Exception { synchroInProcess = true; }

   public boolean isSynchroInProcess() throws Exception { return synchroInProcess; }
    ...
    */
   public String endSynchronization(boolean cancelSynchro) throws Exception { synchroInProcess = false; return ""; }
   ...
   { throw new AdminException("AbstractDomainDriver.importUser", SilverpeasException.ERROR, "admin.EX_ERR_DOMAIN_DOES_NOT_SUPPORT", "DomainId=" + Integer.toString(m_DomainId)); }
   ...
   { throw new AdminException("AbstractDomainDriver.removeUser", SilverpeasException.ERROR, "admin.EX_ERR_DOMAIN_DOES_NOT_SUPPORT", "DomainId=" + Integer.toString(m_DomainId)); }
   ...
   { throw new AdminException("AbstractDomainDriver.synchroUser", SilverpeasException.ERROR, "admin.EX_ERR_DOMAIN_DOES_NOT_SUPPORT", "DomainId=" + Integer.toString(m_DomainId)); }
   ...
   { throw new AdminException("AbstractDomainDriver.createUser", SilverpeasException.ERROR, "admin.EX_ERR_DOMAIN_DOES_NOT_SUPPORT", "DomainId=" + Integer.toString(m_DomainId)); }
   ...
   { throw new AdminException("AbstractDomainDriver.deleteUser", SilverpeasException.ERROR, "admin.EX_ERR_DOMAIN_DOES_NOT_SUPPORT", "DomainId=" + Integer.toString(m_DomainId)); }
   ...
   { throw new AdminException("AbstractDomainDriver.updateUser", SilverpeasException.ERROR, "admin.EX_ERR_DOMAIN_DOES_NOT_SUPPORT", "DomainId=" + Integer.toString(m_DomainId)); }
   ...
   { throw new AdminException("AbstractDomainDriver.getUser", SilverpeasException.ERROR, "admin.EX_ERR_DOMAIN_DOES_NOT_SUPPORT", "DomainId=" + Integer.toString(m_DomainId)); }
   ...
   { throw new AdminException("AbstractDomainDriver.getUserMemberGroupIds", SilverpeasException.ERROR, "admin.EX_ERR_DOMAIN_DOES_NOT_SUPPORT", "DomainId=" + Integer.toString(m_DomainId)); }
   ...
   { throw new AdminException("AbstractDomainDriver.getAllUsers", SilverpeasException.ERROR, "admin.EX_ERR_DOMAIN_DOES_NOT_SUPPORT", "DomainId=" + Integer.toString(m_DomainId)); }
   
   public UserDetail[] getUsersBySpecificProperty(String propertyName, String value) throws Exception
   { throw new AdminException("AbstractDomainDriver.getUsersBySpecificProperty", SilverpeasException.ERROR, "admin.EX_ERR_DOMAIN_DOES_NOT_SUPPORT", "DomainId=" + Integer.toString(m_DomainId)); }
   
   public UserDetail[] getUsersByQuery(Hashtable query) throws Exception
   { throw new AdminException("AbstractDomainDriver.getUsersByQuery", SilverpeasException.ERROR, "admin.EX_ERR_DOMAIN_DOES_NOT_SUPPORT", "DomainId=" + Integer.toString(m_DomainId)); }
   ...
   { throw new AdminException("AbstractDomainDriver.importGroup", SilverpeasException.ERROR, "admin.EX_ERR_DOMAIN_DOES_NOT_SUPPORT", "DomainId=" + Integer.toString(m_DomainId)); }
   ...
   { throw new AdminException("AbstractDomainDriver.removeGroup", SilverpeasException.ERROR, "admin.EX_ERR_DOMAIN_DOES_NOT_SUPPORT", "DomainId=" + Integer.toString(m_DomainId)); }
   ...
   { throw new AdminException("AbstractDomainDriver.synchroGroup", SilverpeasException.ERROR, "admin.EX_ERR_DOMAIN_DOES_NOT_SUPPORT", "DomainId=" + Integer.toString(m_DomainId)); }
   ...
   { throw new AdminException("AbstractDomainDriver.createGroup", SilverpeasException.ERROR, "admin.EX_ERR_DOMAIN_DOES_NOT_SUPPORT", "DomainId=" + Integer.toString(m_DomainId)); }
   ...
   { throw new AdminException("AbstractDomainDriver.deleteGroup", SilverpeasException.ERROR, "admin.EX_ERR_DOMAIN_DOES_NOT_SUPPORT", "DomainId=" + Integer.toString(m_DomainId)); }
   ...
   { throw new AdminException("AbstractDomainDriver.updateGroup", SilverpeasException.ERROR, "admin.EX_ERR_DOMAIN_DOES_NOT_SUPPORT", "DomainId=" + Integer.toString(m_DomainId)); }
   ...
   { throw new AdminException("AbstractDomainDriver.getGroup", SilverpeasException.ERROR, "admin.EX_ERR_DOMAIN_DOES_NOT_SUPPORT", "DomainId=" + Integer.toString(m_DomainId)); }
   ...
   { throw new AdminException("AbstractDomainDriver.getGroupByName", SilverpeasException.ERROR, "admin.EX_ERR_DOMAIN_DOES_NOT_SUPPORT", "DomainId=" + Integer.toString(m_DomainId)); }
   ...
   { throw new AdminException("AbstractDomainDriver.getGroups", SilverpeasException.ERROR, "admin.EX_ERR_DOMAIN_DOES_NOT_SUPPORT", "DomainId=" + Integer.toString(m_DomainId)); }
   ...
   { throw new AdminException("AbstractDomainDriver.getAllGroups", SilverpeasException.ERROR, "admin.EX_ERR_DOMAIN_DOES_NOT_SUPPORT", "DomainId=" + Integer.toString(m_DomainId)); }
   ...
   { throw new AdminException("AbstractDomainDriver.getAllRootGroups", SilverpeasException.ERROR, "admin.EX_ERR_DOMAIN_DOES_NOT_SUPPORT", "DomainId=" + Integer.toString(m_DomainId)); }
   ...
   { throw new AdminException("AbstractDomainDriver.getGroupMemberGroupIds", SilverpeasException.ERROR, "admin.EX_ERR_DOMAIN_DOES_NOT_SUPPORT", "DomainId=" + Integer.toString(m_DomainId)); }
   
   /**
    * Start a new transaction
	*	
	* @param		bAutoCommit	Specifies is transaction is automatically committed (without explicit 'commit' statement)
    */
   public void startTransaction(boolean bAutoCommit) throws Exception
   { throw new AdminException("AbstractDomainDriver.startTransaction", SilverpeasException.ERROR, "admin.EX_ERR_DOMAIN_DOES_NOT_SUPPORT", "DomainId=" + Integer.toString(m_DomainId)); }

   /**
    * Commit transaction
    */
   public void commit() throws Exception
   { throw new AdminException("AbstractDomainDriver.commit", SilverpeasException.ERROR, "admin.EX_ERR_DOMAIN_DOES_NOT_SUPPORT", "DomainId=" + Integer.toString(m_DomainId)); }

   /**
    * Rollback transaction
    */
   public void rollback() throws Exception
   { throw new AdminException("AbstractDomainDriver.rollback", SilverpeasException.ERROR, "admin.EX_ERR_DOMAIN_DOES_NOT_SUPPORT", "DomainId=" + Integer.toString(m_DomainId)); }
