...
public class GroupManager 
{
	...
	public void addUserInGroup(DomainDriverManager ddManager, String sUserId, String sGroupId) throws AdminException
	{
        ...
        {
			throw new AdminException("GroupManager.removeUserFromGroup", SilverpeasException.ERROR, "admin.EX_ERR_GET_USER_GROUPS", "User Id: '" + sUserId + "' GroupId = '"+sGroupId+"'", e);
        }
		finally
		{
	...
	public String[] getDirectGroupsOfUser(DomainDriverManager ddManager, String sUserId) throws AdminException
	{
        ...
        {
			throw new AdminException("GroupManager.getDirectGroupsOfUser", SilverpeasException.ERROR, "admin.EX_ERR_GET_USER_GROUPS", "User Id: '" + sUserId + "'", e);
        }
		finally
		{
			ddManager.releaseOrganizationSchema();
	...
	public String getGroupIdBySpecificIdAndDomainId(DomainDriverManager ddManager, String sSpecificId, String sDomainId) throws AdminException
	{
        ...
        {
			ddManager.getOrganizationSchema();
			GroupRow gr = ddManager.organization.group.getGroupBySpecificId(idAsInt(sDomainId), sSpecificId);
			return idAsString(gr.id);
		}
        catch(Exception e)
        {
			throw new AdminException("GroupManager.getGroupIdBySpecificIdAndDomain", SilverpeasException.ERROR, "admin.EX_ERR_GET_GROUP", "group specific Id: '" + sSpecificId + "', domain Id: '" + sDomainId + "'", e);
        }
		finally
		{
			ddManager.releaseOrganizationSchema();
    ...
    public String[] getAllGroupIds(DomainDriverManager ddManager) throws AdminException
    {
        ...
        {
			throw new AdminException("GroupManager.getAllGroupIds", SilverpeasException.ERROR, "admin.EX_ERR_GET_ALL_GROUP_IDS", e);
        }
		finally
		{
			ddManager.releaseOrganizationSchema();
    ...
    public String[] getAllRootGroupIds(DomainDriverManager ddManager) throws AdminException
    {
        ...
        {
			throw new AdminException("GroupManager.getAllRootGroupIds", SilverpeasException.ERROR, "admin.EX_ERR_GET_ALL_ROOT_GROUP_IDS", e);
        }
		finally
		{
			ddManager.releaseOrganizationSchema();
    ...
    public String[] getAllSubGroupIds(DomainDriverManager ddManager, String superGroupId) throws AdminException
    {
        ...
        {
			throw new AdminException("GroupManager.getAllSubGroupIds", SilverpeasException.ERROR, "admin.EX_ERR_GET_CHILDREN_GROUP_IDS", "father group Id: '" + superGroupId + "'", e);
        }
		finally
		{
			ddManager.releaseOrganizationSchema();
	 ...
	 */
    public List getPathToGroup(DomainDriverManager ddManager, String groupId) throws AdminException
    {
        try
        {
			ddManager.getOrganizationSchema();
        ...
        {
			throw new AdminException("GroupManager.getPathToGroup", SilverpeasException.ERROR, "admin.EX_ERR_GET_PATH_TO_GROUP", "groupId = " + groupId, e);
        }
		finally
		{
			ddManager.releaseOrganizationSchema();
    ...
    public boolean isGroupExist(DomainDriverManager ddManager, String sName) throws AdminException
    {
        ...
        {
			throw new AdminException("GroupManager.isGroupExist", SilverpeasException.ERROR, "admin.EX_ERR_IS_GROUP_EXIST", "group name: '" + sName + "'", e);
        }
		finally
		{
			ddManager.releaseOrganizationSchema();
    ...
    public Group getGroup(DomainDriverManager ddManager, String sGroupId) throws AdminException
    {
        try
        {
            ...
            // Get the father id
			/*gr = ddManager.organization.group.getSuperGroup(idAsInt(sGroupId));
            if(gr != null)
            ...
            if(asUsersId != null) group.setUserIds(asUsersId);
            
            return group;
        }
        catch(Exception e)
        {
			throw new AdminException("GroupManager.getGroup", SilverpeasException.ERROR, "admin.EX_ERR_GET_GROUP", "group Id: '" + sGroupId + "'", e);
        }
		finally
		{
			ddManager.releaseOrganizationSchema();
	 ...
	 */
    public String[] getAllSubGroupIdsRecursively(DomainDriverManager ddManager, String superGroupId) throws AdminException
    {
        try
        {
			ddManager.getOrganizationSchema();
            String[] asGroupIds = ddManager.organization.group.getAllSubGroupIds(idAsInt(superGroupId));
        ...
        {
			throw new AdminException("GroupManager.getAllSubGroupIdsRecursively", SilverpeasException.ERROR, "admin.EX_ERR_GET_CHILDREN_GROUP_IDS", "father group Id: '" + superGroupId + "'", e);
        }
		finally
		{
			ddManager.releaseOrganizationSchema();
    ...
    public Group getGroupByNameInDomain(DomainDriverManager ddManager, String sGroupName, String sDomainFatherId) throws AdminException
    {
        try
        {
            ...
            if(group != null)
            {
            	...
            	GroupRow gr = ddManager.organization.group.getGroupBySpecificId(idAsInt(sDomainFatherId), specificId);
            	if(gr != null) {
            		group.setId(idAsString(gr.id));
        ...
        {
			throw new AdminException("GroupManager.getGroupByNameInDomain", SilverpeasException.ERROR, "admin.EX_ERR_GET_GROUP", "group Name: '" + sGroupName + "'", e);
        }
		finally
		{
			ddManager.releaseOrganizationSchema();
	...
	public Group[] getRootGroupsOfDomain(DomainDriverManager ddManager, String sDomainId) throws AdminException
	{
		...
		try
        {
			...
			grs = ddManager.organization.group.getAllRootGroupsOfDomain(idAsInt(sDomainId));
			...
			for (int nI=0; nI<grs.length; nI++)
			{
                ...
                // Get the selected users for this group
                asUsersId = ddManager.organization.user.getDirectUserIdsOfGroup(idAsInt(groups[nI].getId()));
                if(asUsersId != null) groups[nI].setUserIds(asUsersId);
			}
        ...
        {
			throw new AdminException("GroupManager.getRootGroupsOfDomain", SilverpeasException.ERROR, "admin.EX_ERR_GET_GROUPS_OF_DOMAIN", "domain Id: '" + sDomainId + "'", e);
        }
		finally
		{
			ddManager.releaseOrganizationSchema();
	...
	public Group[] getSynchronizedGroups(DomainDriverManager ddManager) throws AdminException
	{
        ...
        {
			throw new AdminException("GroupManager.getRootGroupsOfDomain", SilverpeasException.ERROR, "admin.EX_ERR_GET_GROUPS_OF_DOMAIN", e);
        }
		finally
		{
			ddManager.releaseOrganizationSchema();
	...
	public String[] getRootGroupIdsOfDomain(DomainDriverManager ddManager, String sDomainId) throws AdminException
	{
		...
		try
        {
			...
			// Get groups of domain from Silverpeas database
			groupIds = ddManager.organization.group.getAllRootGroupIdsOfDomain(idAsInt(sDomainId));
        ...
        {
			throw new AdminException("GroupManager.getRootGroupIdsOfDomain", SilverpeasException.ERROR, "admin.EX_ERR_GET_GROUPS_OF_DOMAIN", "domain Id: '" + sDomainId + "'", e);
        }
		finally
		{
			ddManager.releaseOrganizationSchema();
	...
	public Group[] getGroupsOfDomain(DomainDriverManager ddManager, String sDomainId) throws AdminException
	{
		...
		try
        {
			...
			// Get groups of domain from Silverpeas database
			grs = ddManager.organization.group.getAllGroupsOfDomain(idAsInt(sDomainId));
        ...
        {
			throw new AdminException("GroupManager.getGroupsOfDomain", SilverpeasException.ERROR, "admin.EX_ERR_GET_GROUPS_OF_DOMAIN", "domain Id: '" + sDomainId + "'", e);
        }
		finally
		{
			ddManager.releaseOrganizationSchema();
     ...
     public String[] searchGroupsIds(DomainDriverManager ddManager, boolean isRootGroup, String componentId, String[] aProfileId, Group modelGroup) throws AdminException
     {
 		...
 		try
         {
             ...
             if ((modelGroup.getDomainId() == null) || (modelGroup.getDomainId().length() <= 0))
             {
                 model.domainId = -2;
             }
             if ((modelGroup.getSuperGroupId() == null) || (modelGroup.getSuperGroupId().length() <= 0))
             {
 			...
 			// Get groups
 			grids = ddManager.organization.group.searchGroupsIds(isRootGroup, idAsInt(componentId), aRoleId, model);
 			return grids;
         }
         catch(Exception  e)
         {
 			throw new AdminException("GroupManager.searchGroupsIdsInGroup", SilverpeasException.ERROR, "admin.EX_ERR_GET_GROUPS_OF_DOMAIN", e);
         }
 		finally
 		{
 			ddManager.releaseOrganizationSchema();
    ...
    public Group[] searchGroups(DomainDriverManager ddManager, Group modelGroup, boolean isAnd) throws AdminException
    {
        ...
        {
			throw new AdminException("GroupManager.searchGroups", SilverpeasException.ERROR, "admin.EX_ERR_GET_GROUPS_OF_DOMAIN", e);
        }
		finally
		{
			ddManager.releaseOrganizationSchema();
    ...
    public String addGroup(DomainDriverManager ddManager, Group group, boolean onlyInSilverpeas) throws AdminException
    {
		...
		try
        {
			...
			if (gr.superGroupId != -1)
				SynchroReport.info("GroupManager.addGroup()", "Ajout du groupe " + group.getName() + " (père=" + getGroup(ddManager,group.getSuperGroupId()).getSpecificId() + ") dans les tables ST_Group, ST_UserSet et maj de ST_UserSet_UserSet_Rel...", null);
			else //pas de père
				SynchroReport.info("GroupManager.addGroup()", "Ajout du groupe " + group.getName() + " (groupe racine) dans les tables ST_Group et ST_UserSet...", null);
			ddManager.organization.group.createGroup(gr);
			String sGroupId = idAsString (gr.id);
			
		    // Create the links group_user in Silverpeas
			SynchroReport.info("GroupManager.addGroup()", "Inclusion des utilisateurs directement associés au groupe " + group.getName() + " (tables ST_Group_User_Rel et ST_UserSet_User_Rel)", null);
        ...
        catch(Exception  e)
        {
			...
			throw new AdminException("GroupManager.addGroup", SilverpeasException.ERROR, "admin.EX_ERR_ADD_GROUP", "group name: '" + group.getName() + "'", e);
        }
		finally
		{
			ddManager.releaseOrganizationSchema();
    ...
    public String deleteGroupById(DomainDriverManager ddManager, Group group, boolean onlyInSilverpeas) throws AdminException
    {
        try
        {
			...
			ddManager.organization.group.removeGroup(idAsInt(group.getId()));//Les traces d'Info synchro y st mises car supp ss-groupes possible
        ...
        catch(Exception e)
        {
			...
			throw new AdminException("GroupManager.deleteGroupById", SilverpeasException.ERROR, "admin.EX_ERR_DELETE_GROUP", "group Id: '" + group.getId() + "'", e);
        }
		finally
		{
			ddManager.releaseOrganizationSchema();
    ...
    public String updateGroup(DomainDriverManager ddManager, Group group, boolean onlyInSilverpeas) throws AdminException
    {
        ...
        if(group == null || group.getName().length() == 0 || group.getId().length() == 0)
			{
			if (group != null)
        ...
        try
        {
			...
			if (group.getSuperGroupId()!=null )
				strInfoSycnhro = "Maj du groupe " + group.getName() + " (père=" + getGroup(ddManager,group.getSuperGroupId()).getSpecificId() + ") dans la base (table ST_Group et éventuellement ST_UserSet_UserSet_Rel et ST_UserSet_User_Rel)...";
			else
				strInfoSycnhro = "Maj du groupe " + group.getName() + " (groupe racine) dans la base (table ST_Group et éventuellement ST_UserSet_UserSet_Rel et ST_UserSet_User_Rel)...";
            ...
            SynchroReport.info("GroupManager.updateGroup()", "Maj éventuelle des relations du groupe " + group.getName() + " avec les utilisateurs qui y sont directement inclus (tables ST_Group_User_Rel et ST_UserSet_User_Rel)", null);

			String[] asOldUsersId = ddManager.organization.user.getDirectUserIdsOfGroup(idAsInt(sGroupId));//ds ST_Group_User_Rel
            ...
            for(int nI=0; nI < alRemUsers.size(); nI++)
				ddManager.organization.group.removeUserFromGroup(idAsInt((String)alRemUsers.get(nI)), idAsInt(sGroupId));

            // Add the new users of the group
            for(int nI=0; nI < alAddUsers.size(); nI++)
				ddManager.organization.group.addUserInGroup(idAsInt((String)alAddUsers.get(nI)), idAsInt(sGroupId));
        ...
        catch(Exception e)
        {
			...
			throw new AdminException("GroupManager.updateGroup", SilverpeasException.ERROR, "admin.EX_ERR_UPDATE_GROUP", "group Id: '" + group.getId() + "'", e);
        }
		finally
		{
			ddManager.releaseOrganizationSchema();
    ...
    public AdminGroupInst[] getAdminOrganization(DomainDriverManager ddManager) throws AdminException
    {
        try
        {
            ...
            for(int nI=0; nI < alRoot.size(); nI++)
            {
                ...
                aAdminGroupInst[nI].setGroup(aGroup[((Integer)alRoot.get(nI)).intValue()]);
        ...
        {
			throw new AdminException("GroupManager.getAdminOrganization", SilverpeasException.ERROR, "admin.EX_ERR_GET_ADMIN_ORGANIZATION", e);
        }
		finally
		{
			ddManager.releaseOrganizationSchema();
	 ...
	 */
    private ArrayList getChildrenGroupInst(DomainDriverManager ddManager, String sFatherGroupId, Group[] aGroup)
    {
        ArrayList alChildrenGroupInst = new ArrayList();
        
        // Search the children group
        for(int nI=0; nI < aGroup.length; nI++)
            if(aGroup[nI].getSuperGroupId()!=null && aGroup[nI].getSuperGroupId().equals(sFatherGroupId))
            {
	 ...
	 */
	public String[] getManageableSpaceIds(DomainDriverManager ddManager, String sGroupId) throws AdminException
	{
		try
        {
			ddManager.getOrganizationSchema();
			return ddManager.organization.group.getManageableSpaceIds(idAsInt(sGroupId));
        }
        catch(Exception  e)
        {
			throw new AdminException("GroupManager.getManageableSpaceIds", SilverpeasException.ERROR, "admin.EX_ERR_GET_USER_MANAGEABLE_SPACE_IDS", "group Id: '" + sGroupId + "'", e);
        }
		finally
		{
			ddManager.releaseOrganizationSchema();
