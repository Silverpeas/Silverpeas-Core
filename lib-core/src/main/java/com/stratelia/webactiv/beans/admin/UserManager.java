...
public class UserManager extends Object
{
    ...
    public int getUsersNumberOfDomain(DomainDriverManager ddManager, String domainId) throws AdminException
    {
        ...
        {
			throw new AdminException("UserManager.getUsersNumberOfDomain()", SilverpeasException.ERROR, "admin.EX_ERR_GET_USERSET_NUMBER", e);
        }
		finally
		{
    ...
    public int getUserNumber(DomainDriverManager ddManager) throws AdminException
    {
        ...
        {
			throw new AdminException("UserManager.getUserNumber()", SilverpeasException.ERROR, "admin.EX_ERR_GET_USERSET_NUMBER", e);
        }
		finally
		{
			ddManager.releaseOrganizationSchema();
	 ...
	 */
	public String[] getUsersOfProfile(DomainDriverManager ddManager, String sProfileId) throws AdminException
	{
		try
        {
			ddManager.getOrganizationSchema();
			return ddManager.organization.user.getAllUserIdsOfUserRole(idAsInt(sProfileId));
        }
        catch(Exception  e)
        {
			throw new AdminException("UserManager.getUsersOfProfile", SilverpeasException.ERROR, "admin.EX_ERR_GET_USERS_OF_PROFILE", "profile Id: '" + sProfileId + "'", e);
        }
		finally
		{
			ddManager.releaseOrganizationSchema();
	 ...
	 */
    public UserDetail[] getAllUsersOfGroup(DomainDriverManager ddManager, String sGroupId) throws AdminException
    {
		UserRow[] urs = null;
		UserDetail[] aus = null;
        ...
        {
			throw new AdminException("UserManager.getAllUsersOfGroup", SilverpeasException.ERROR, "admin.EX_ERR_GET_USER_GROUPS", "GroupId = '"+sGroupId+"'", e);
        }
		finally
		{
			ddManager.releaseOrganizationSchema();
	...
	public UserDetail[] getUsersOfDomain(DomainDriverManager ddManager, String sDomainId) throws AdminException
	{
        ...
        {
			throw new AdminException("UserManager.getUsersOfDomain", SilverpeasException.ERROR, "admin.EX_ERR_GET_USERS_OF_DOMAIN", "domain Id: '" + sDomainId + "'", e);
        }
		finally
		{
			ddManager.releaseOrganizationSchema();
	...
	public String[] getUserIdsOfDomain(DomainDriverManager ddManager, String sDomainId) throws AdminException
	{
        ...
        {
			throw new AdminException("UserManager.getUserIdsOfDomain", SilverpeasException.ERROR, "admin.EX_ERR_GET_USERS_OF_DOMAIN", "domain Id: '" + sDomainId + "'", e);
        }
		finally
		{
			ddManager.releaseOrganizationSchema();
	...
	public String[] getUserIdsOfDomainAndAccessLevel(DomainDriverManager ddManager, String sDomainId, String accessLevel) throws AdminException
	{
		String[] uids = null;
		...
		try
        {
			...
			// Get user ids of domain from Silverpeas database
			uids = ddManager.organization.user.getUserIdsOfDomainByAccessLevel(idAsInt(sDomainId), accessLevel);
        ...
        {
			throw new AdminException("UserManager.getUserIdsOfDomain", SilverpeasException.ERROR, "admin.EX_ERR_GET_USERS_OF_DOMAIN_BY_ACCESSLEVEL", "domain Id: " + sDomainId + ", AccessLevel = "+accessLevel, e);
        }
		finally
		{
			ddManager.releaseOrganizationSchema();
	 ...
	 */
	public String[] getAllowedSpaceIds(DomainDriverManager ddManager, String sUserId) throws AdminException
	{
		try
        {
			ddManager.getOrganizationSchema();
        ...
        {
			throw new AdminException("UserManager.getAllowedSpaceIds", SilverpeasException.ERROR, "admin.EX_ERR_GET_USER_ALLOWED_SPACE_IDS", "user Id: '" + sUserId + "'", e);
        }
		finally
		{
			ddManager.releaseOrganizationSchema();
	 ...
	 */
	public String[] getAllowedSpaceIdsByFatherId(DomainDriverManager ddManager, String sUserId, String fatherId) throws AdminException
	{
		try
		{
			ddManager.getOrganizationSchema();
			return ddManager.organization.user.getSpaceIdsByFatherId(idAsInt(sUserId), idAsInt(fatherId));
		}
		catch(Exception  e)
		{
			throw new AdminException("UserManager.getAllowedSpaceIdsByFatherId", SilverpeasException.ERROR, "admin.EX_ERR_GET_USER_ALLOWED_SPACE_IDS", "user Id: '" + sUserId + "', fatherId = "+fatherId, e);
		}
		finally
		{
			ddManager.releaseOrganizationSchema();
	 ...
	 */
	public String[] getAllowedRootSpaceIds(DomainDriverManager ddManager, String sUserId) throws AdminException
	{
		try
		{
			ddManager.getOrganizationSchema();
		...
		{
			throw new AdminException("UserManager.getAllowedRootSpaceIds", SilverpeasException.ERROR, "admin.EX_ERR_GET_USER_ALLOWED_SPACE_IDS", "user Id = " + sUserId, e);
		}
		finally
		{
			ddManager.releaseOrganizationSchema();
	 ...
	 */
	public String[] getManageableSpaceIds(DomainDriverManager ddManager, String sUserId) throws AdminException
	{
		try
        {
			ddManager.getOrganizationSchema();
			return ddManager.organization.user.getManageableSpaceIds(idAsInt(sUserId));
        }
        catch(Exception  e)
        {
			throw new AdminException("UserManager.getManageableSpaceIds", SilverpeasException.ERROR, "admin.EX_ERR_GET_USER_MANAGEABLE_SPACE_IDS", "user Id: '" + sUserId + "'", e);
        }
		finally
		{
			ddManager.releaseOrganizationSchema();
	 ...
	 * Get space ids manageable by given user
	 */
	public String[] getManageableSubSpaceIds(DomainDriverManager ddManager, String sUserId, String sSpaceId) throws AdminException
	{
		try
        {
			ddManager.getOrganizationSchema();
			return ddManager.organization.user.getManageableSubSpaceIds(idAsInt(sUserId),idAsInt(sSpaceId));
        }
        catch(Exception  e)
        {
			throw new AdminException("UserManager.getManageableSubSpaceIds", SilverpeasException.ERROR, "admin.EX_ERR_GET_USER_MANAGEABLE_SPACE_IDS", "user Id: '" + sUserId + "'", e);
        }
		finally
		{
			ddManager.releaseOrganizationSchema();
	...
	public List getManageableGroupIds(DomainDriverManager ddManager, String sUserId) throws AdminException
	{
		try
        {
			ddManager.getOrganizationSchema();
			return ddManager.organization.user.getManageableGroupIds(idAsInt(sUserId));
        }
        catch(Exception  e)
        {
			throw new AdminException("UserManager.getManageableSpaceIds", SilverpeasException.ERROR, "admin.EX_ERR_GET_USER_MANAGEABLE_GROUP_IDS", "userId = " + sUserId, e);
        }
		finally
		{
			ddManager.releaseOrganizationSchema();
    ...
    public String[] getAllUsersIds(DomainDriverManager ddManager) throws AdminException
    {
        ...
        {
			throw new AdminException("UserManager.getAllUsersIds", SilverpeasException.ERROR, "admin.EX_ERR_GET_ALL_USER_IDS", e);
        }
		finally
		{
			ddManager.releaseOrganizationSchema();
	...
	public String[] getAllAdminIds(DomainDriverManager ddManager,UserDetail fromUser) throws AdminException
    {
        ...
        {
			throw new AdminException("UserManager.getAllAdminIds", SilverpeasException.ERROR, "admin.EX_ERR_GET_ALL_ADMIN_IDS", e);
        }
		finally
		{
			ddManager.releaseOrganizationSchema();
	...
	public UserFull getUserFull(DomainDriverManager ddManager, String sUserId) throws AdminException
	{
        ...
        {
			throw new AdminException("UserManager.getUserFull", SilverpeasException.ERROR, "admin.EX_ERR_GET_USER_DETAIL", "user Id: '" + sUserId + "'", e);
        }
		finally
		{
			ddManager.releaseOrganizationSchema();
	...
	public UserDetail getUserDetail(DomainDriverManager ddManager, String sUserId) throws AdminException
	{
        ...
        {
			throw new AdminException("UserManager.getUser", SilverpeasException.ERROR, "admin.EX_ERR_GET_USER", "user Id: '" + sUserId + "'", e);
        }
		finally
		{
			ddManager.releaseOrganizationSchema();
	...
	public String getUserIdBySpecificIdAndDomainId(DomainDriverManager ddManager, String sSpecificId, String sDomainId) throws AdminException
	{
        ...
        {
			throw new AdminException("UserManager.getUserIdBySpecificIdAndDomainId", SilverpeasException.ERROR, "admin.EX_ERR_GET_USER_BY_LOGIN_DOMAIN", "user sSpecificId: '" + sSpecificId + "', domain Id: '" + sDomainId + "'", e);
        }
		finally
		{
			ddManager.releaseOrganizationSchema();
	...
	public String getUserIdByLoginAndDomain(DomainDriverManager ddManager, String sLogin, String sDomainId) throws AdminException
	{
        ...
        {
			throw new AdminException("UserManager.getUserIdByLoginAndDomain", SilverpeasException.ERROR, "admin.EX_ERR_GET_USER_BY_LOGIN_DOMAIN", "user login: '" + sLogin + "', domain Id: '" + sDomainId + "'", e);
        }
		finally
		{
			ddManager.releaseOrganizationSchema();
    ...
    public UserDetail[] searchUsers(DomainDriverManager ddManager, UserDetail modelUser, boolean isAnd) throws AdminException
    {
		...
		try
        {
            ...
            if ((modelUser.getDomainId() == null) || (modelUser.getDomainId().length() <= 0))
            {
                model.domainId = -2;
            }
    		// Get users of domain from Silverpeas database
        ...
        {
			throw new AdminException("UserManager.searchUsers", SilverpeasException.ERROR, "admin.EX_ERR_GET_USERS_OF_DOMAIN", e);
        }
		finally
		{
			ddManager.releaseOrganizationSchema();
     ...
     public String[] searchUsersIds(DomainDriverManager ddManager, String groupId, String componentId, String[] aProfileId, UserDetail modelUser) throws AdminException
     {
 		String[]    uids = null;
         UserRow     model;
         int[]       aRoleId = null;
 		...
 		try
         {
     		...
     		// Get users of domain from Silverpeas database
 			uids = ddManager.organization.user.searchUsersIds(idAsInt(groupId),idAsInt(componentId),aRoleId,model);
 
 			return uids;
         }
         catch(Exception  e)
         {
 			throw new AdminException("UserManager.searchUsersIdsInGroup", SilverpeasException.ERROR, "admin.EX_ERR_GET_USERS_OF_DOMAIN", e);
         }
 		finally
 		{
 			ddManager.releaseOrganizationSchema();
    ...
    public String addUser(DomainDriverManager ddManager, UserDetail userDetail, boolean addOnlyInSilverpeas) throws AdminException
    {
        ...
        if(userDetail == null 
			|| userDetail.getLastName().length() == 0 
            || userDetail.getLogin().length() == 0
			|| userDetail.getDomainId().length() == 0)
		{
            SilverTrace.error("admin", "UserManager.addUser", "admin.MSG_ERR_ADD_USER", userDetail.getFirstName() + " " + userDetail.getLastName() + "domainID, login or lastName is not set");
			...
			//SynchroReport.error("UserManager.addUser()", "Utilisateur " + userDetail.getSpecificId() + " non rajouté", null);
		...
		try
        {
			...
			UserRow ur = ddManager.organization.user.getUserByLogin(idAsInt(userDetail.getDomainId()), userDetail.getLogin());
	        if (ur!=null)
				{
				...
				throw new AdminException("UserManager.addUser", SilverpeasException.ERROR, "admin.EX_ERR_LOGIN_ALREADY_USED", "user login: '" + userDetail.getLogin() + "'");
				}
        ...
        catch(Exception  e)
        {
			...
			throw new AdminException("UserManager.addUser", SilverpeasException.ERROR, "admin.EX_ERR_ADD_USER", "user login: '" + userDetail.getLogin() + "'", e);
        }
		finally
		{
			ddManager.releaseOrganizationSchema();
    ...
    public String deleteUser(DomainDriverManager ddManager, UserDetail user, boolean onlyInSilverpeas) throws AdminException
    {
        ...
        catch(Exception e)
        {
			...
			throw new AdminException("UserManager.deleteUser", SilverpeasException.ERROR, "admin.EX_ERR_DELETE_USER", "user id: '" + user.getId() + "'", e);
        }
		finally
		{
			ddManager.releaseOrganizationSchema();
    ...
    public String updateUser(DomainDriverManager ddManager, UserDetail user) throws AdminException
    {
        ...
        catch(Exception e)
        {
			...
			throw new AdminException("UserManager.updateUser", SilverpeasException.ERROR, "admin.EX_ERR_UPDATE_USER", "user id: '" + user.getId() + "'", e);
        }
		finally
		{
			ddManager.releaseOrganizationSchema();
    ...
    public String updateUserFull(DomainDriverManager ddManager, UserFull userFull) throws AdminException
    {
        ...
        {
			throw new AdminException("UserManager.updateUserDetail", SilverpeasException.ERROR, "admin.EX_ERR_UPDATE_USER_DETAIL", "user id: '" + userFull.getId() + "'", e);
        }
		finally
		{
			ddManager.releaseOrganizationSchema();
