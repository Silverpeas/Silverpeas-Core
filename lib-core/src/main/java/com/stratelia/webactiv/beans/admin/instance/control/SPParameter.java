...
public class SPParameter implements Serializable, Comparable
{
	...
	public SPParameter(String name, String label, String value, String mandatory, String updatable, String type, Hashtable helps, String size, String defaultValue, String displayOrder, ArrayList options)
	{
		SilverTrace.info("admin", "SPParameter.SPParameter", "root.MSG_GEN_PARAM_VALUE", "name: " + name + ", value: " + value + " (mandatory ? " + mandatory + ")+(updatable ? " + updatable + ") options="+options);
		this.name			= name;
		this.label			= label;
		this.value			= value;
	...
	public SPParameter(String name, String label, String value, boolean mandatory, String updatable, String type, Hashtable helps, String size, String defaultValue, ArrayList options)
	{
		this.name			= name;
		this.label			= label;
		this.value			= value;
	...
	public Object clone()
	{
		SPParameter	clonedParameter	= new SPParameter(name, label, value, mandatory, updatable, type, helps, size, defaultValue, options);
