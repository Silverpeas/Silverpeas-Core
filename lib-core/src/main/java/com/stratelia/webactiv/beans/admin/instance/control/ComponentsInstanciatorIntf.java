...
/**
 * Interface for the instanciator component class. An instanciator creates and
 * deletes components on a space for a user.
 * 
 * @author Joaquim Vieira
 */
public interface ComponentsInstanciatorIntf {
  /**
   * The name of the component descriptor parameter holding the process file
   * name
   */
   ...
   * 
   * @param connection
   *          - Connection to the database used to save the create information.
   * @param spaceId
   *          - Identity of the space where the component will be instancied.
   * @param componentId
   *          - Identity of the component to instanciate.
   * @param userId
   *          - Identity of the user who want the component
   ...
   * 
   * @param connection
   *          - Connection to the database where the create information will be
   *          destroyed.
   * @param spaceId
   *          - Identity of the space where the instanced component will be
   *          deleted.
   * @param componentId
   *          - Identity of the instanced component
   * @param userId
   *          - Identity of the user who have instantiate the component.
   * @throws com.stratelia.webactiv.beans.admin.instance.control.InstanciationException
