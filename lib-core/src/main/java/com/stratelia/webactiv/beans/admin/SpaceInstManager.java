...
public class SpaceInstManager 
{
    ...
    public SpaceInst copy(SpaceInst spaceInstToCopy)
    {
        ...
        Iterator translations = spaceInstToCopy.getTranslations().values().iterator();
    ...
    public String createSpaceInst(SpaceInst spaceInst, DomainDriverManager ddManager) throws AdminException
    {
        try
        {
            ...
            for(int nI = 0; nI < spaceInst.getNumSpaceProfileInst(); nI++)
                m_SpaceProfileInstManager.createSpaceProfileInst(spaceInst.getSpaceProfileInst(nI), ddManager, sSpaceNodeId);

			return sSpaceNodeId;
        }
        catch(Exception  e)
        {
			throw new AdminException("SpaceInstManager.createSpaceInst", SilverpeasException.ERROR, "admin.EX_ERR_ADD_SPACE", "space name : '" + spaceInst.getName() + "'", e);
        }
    }
	 ...
	 */
    public SpaceInst getSpaceInstById(DomainDriverManager ddManager, String sSpaceInstId) throws AdminException
    {
        try
        {
        ...
        {
			throw new AdminException("SpaceInstManager.getSpaceInstById", SilverpeasException.ERROR, "admin.EX_ERR_GET_SPACE", "space Id : '" + sSpaceInstId + "'", e);
        }
		finally
		{
	...
	public SpaceInstLight getSpaceInstLightById(DomainDriverManager ddManager, String spaceId) throws AdminException
	{
		...
		{
			throw new AdminException("SpaceInstManager.getSpaceInstLightById", SilverpeasException.ERROR, "admin.EX_ERR_GET_SPACE", "space Id = " + spaceId, e);
		}
		finally
		{
			ddManager.releaseOrganizationSchema();
    ...
    public void updateSpaceOrder(DomainDriverManager ddManager, String sSpaceId, int orderNum) throws AdminException
    {
        ...
        {
			throw new AdminException("SpaceInstManager.updateSpaceOrder", SilverpeasException.ERROR, "admin.EX_ERR_UPDATE_SPACE", "space Id : '" + sSpaceId + "'", e);
        }
		finally
		{
			ddManager.releaseOrganizationSchema();
    ...
    public void updateSpaceInheritance(DomainDriverManager ddManager, String sSpaceId, boolean inheritanceBlocked) throws AdminException
    {
        try
        {
			ddManager.getOrganizationSchema();
            ddManager.organization.space.updateSpaceInheritance(idAsInt(sSpaceId), inheritanceBlocked);
        }
        catch(Exception e)
        {
			throw new AdminException("SpaceInstManager.updateSpaceInheritance", SilverpeasException.ERROR, "admin.EX_ERR_UPDATE_SPACE_INHERITANCE", "Component Id : '" + sSpaceId + "'", e);
        }
		finally
		{
			ddManager.releaseOrganizationSchema();
    ...
    private int getSpaceLevel(DomainDriverManager ddManager, int spaceId) throws AdminException
    {
    	String[] asParents = ddManager.organization.space.getAllFatherSpaceIds(spaceId);
	 ...
	 */
    private void setSpaceInstById(DomainDriverManager ddManager, SpaceInst spaceInst, String sSpaceInstId) throws AdminException
    {
        try
        {
			ddManager.getOrganizationSchema();
            ...
            //String[] asParents = ddManager.organization.space.getAllFatherSpaceIds(space.id);
			...
			// Get the sub spaces
            String[] asSubSpaceIds = ddManager.organization.space.getDirectSubSpaceIds(idAsInt(sSpaceInstId));
			spaceInst.setSubSpaceIds(asSubSpaceIds);

			// Get the components
            String[] asCompoIds = ddManager.organization.instance.getAllComponentInstanceIdsInSpace(idAsInt(sSpaceInstId));
            
            // Insert the componentsInst in the spaceInst
            for(int nI=0; asCompoIds != null && nI<asCompoIds.length; nI++) 
            {
                ComponentInst componentInst = m_ComponentInstManager.getComponentInst(ddManager, asCompoIds[nI], sSpaceInstId);
                spaceInst.addComponentInst(componentInst);
            }

			// Get the space profiles
			String[] asProfIds = ddManager.organization.spaceUserRole.getAllSpaceUserRoleIdsOfSpace(idAsInt(sSpaceInstId));
            
            // Insert the spaceProfilesInst in the spaceInst
            for(int nI=0; asProfIds != null && nI<asProfIds.length; nI++) 
            {
                SpaceProfileInst spaceProfileInst = m_SpaceProfileInstManager.getSpaceProfileInst(ddManager, asProfIds[nI], sSpaceInstId);
            ...
            List translations = ddManager.organization.spaceI18N.getTranslations(idAsInt(sSpaceInstId));
        ...
        {
			throw new AdminException("SpaceInstManager.setSpaceInstById", SilverpeasException.ERROR, "admin.EX_ERR_SET_SPACE", "space Id : '" + sSpaceInstId + "'", e);
        }
		finally
		{
			ddManager.releaseOrganizationSchema();
    ...
    public String[] getAllRootSpaceIds(DomainDriverManager ddManager) throws AdminException
    {
        ...
        {
			throw new AdminException("SpaceInstManager.getAllSpaceIds", SilverpeasException.ERROR, "admin.EX_ERR_GET_ALL_SPACE_IDS", e);
        }
        finally
        {
        	ddManager.releaseOrganizationSchema();
	 ...
	 * Return the all the spaces ids available in Silverpeas 
	 */
    public String[] getAllowedSpaceIds(DomainDriverManager ddManager, int userId) throws AdminException
    {
        try
        {
			ddManager.getOrganizationSchema();
        ...
        {
			throw new AdminException("SpaceInstManager.getAllowedSpaceIds", SilverpeasException.ERROR, "admin.EX_ERR_GET_ALLOWED_SPACEIDS", e);
        }
        finally
        {
        	ddManager.releaseOrganizationSchema();
	 ...
	 * Return the all the spaces ids available in Silverpeas 
	 */
    public String[] getAllowedRootSpaceIds(DomainDriverManager ddManager, int userId) throws AdminException
    {
        try
        {
			ddManager.getOrganizationSchema();
			SpaceRow[] rows = ddManager.organization.space.getAllRootSpacesOfUser(userId);
        ...
        {
			throw new AdminException("SpaceInstManager.getAllowedRootSpaceIds", SilverpeasException.ERROR, "admin.EX_ERR_GET_ALLOWED_SPACEIDS", e);
        }
        finally
        {
        	ddManager.releaseOrganizationSchema();
    ...
    public List getAllowedSubSpaces(DomainDriverManager ddManager, String userId, String spaceId) throws AdminException
    {
        try
        {
			ddManager.getOrganizationSchema();
			SpaceRow[] spaceRows = ddManager.organization.space.getSubSpacesOfUser(idAsInt(userId), idAsInt(spaceId));

			return spaceRows2SpaceInstLights(ddManager, spaceRows);
        }
        catch(Exception e)
        {
			throw new AdminException("SpaceInstManager.getSubSpacesOfUser", SilverpeasException.ERROR, "admin.EX_ERR_GET_SUBSPACES", e);
        }
        finally
        {
        	ddManager.releaseOrganizationSchema();
    ...
    public String[] getAllowedSubSpaceIds(DomainDriverManager ddManager, String userId, String spaceId) throws AdminException
    {
        try
        {
        	ddManager.getOrganizationSchema();
        	SpaceRow[] rows = ddManager.organization.space.getSubSpacesOfUser(idAsInt(userId), idAsInt(spaceId));
	 ...
	 */
    public List getRemovedSpaces(DomainDriverManager ddManager) throws AdminException
    {
        try
        {
			ddManager.getOrganizationSchema();
	 ...
	 */
    public List getSubSpacesOfUser(DomainDriverManager ddManager, String userId, String spaceId) throws AdminException
    {
        try
        {
			ddManager.getOrganizationSchema();
    ...
    private void setTranslations(DomainDriverManager ddManager, SpaceInstLight space, SpaceRow row)
    {
    	try {
			...
			{
				List translations = ddManager.organization.spaceI18N.getTranslations(row.id);
				for (int t=0; translations != null && t<translations.size(); t++)
				{
    ...
    private List spaceRows2SpaceInstLights(DomainDriverManager ddManager, SpaceRow[] spaceRows)
    {
    ...
    public String[] getAllSpaceProfileIds(DomainDriverManager ddManager, String sSpaceId) throws AdminException
    {
        ...
        {
			ddManager.getOrganizationSchema();
            String[] asSpaceProfileIds = ddManager.organization.spaceUserRole.getAllSpaceUserRoleIdsOfSpace(idAsInt(sSpaceId));
        ...
        {
			throw new AdminException("SpaceInstManager.getAllSpaceProfileIds", SilverpeasException.ERROR, "admin.EX_ERR_GET_ALL_SPACE_PROFILE_IDS", e);
        }
		finally
		{
			ddManager.releaseOrganizationSchema();
    ...
    public String[] getAllSubSpaceIds(DomainDriverManager ddManager, String sDomainFatherId) throws AdminException
    {
        ...
        {
			ddManager.getOrganizationSchema();
			String[] asSpaceIds = ddManager.organization.space.getDirectSubSpaceIds(idAsInt(sDomainFatherId));
            if(asSpaceIds != null)
                return asSpaceIds;
            else
                return new String[0];
        ...
        {
			throw new AdminException("SpaceInstManager.getAllSubSpaceIds", SilverpeasException.ERROR, "admin.EX_ERR_GET_ALL_SUBSPACE_IDS", " father space Id : '" + sDomainFatherId + "'", e);
        }
		finally
		{
			ddManager.releaseOrganizationSchema();
    ...
    public void deleteSpaceInst(SpaceInst spaceInst, DomainDriverManager ddManager) throws AdminException
    {
        ...
        {
			throw new AdminException("SpaceInstManager.deleteSpaceInst", SilverpeasException.ERROR, "admin.EX_ERR_DELETE_SPACE", "space Id : '" + spaceInst.getId() + "'", e);
        }
    }
	 ...
	 * Delete space from Silverpeas
	 */
    public void sendSpaceToBasket(DomainDriverManager ddManager, String spaceId, String newSpaceName, String userId) throws AdminException
    {
        try
        {
			ddManager.organization.space.sendSpaceToBasket(idAsInt(spaceId), newSpaceName, userId);
        }
        catch(Exception e)
        {
			throw new AdminException("SpaceInstManager.sendSpaceToBasket", SilverpeasException.ERROR, "admin.EX_ERR_SEND_SPACE_TO_BASKET", "spaceId = " + spaceId, e);
        }
    }
    ...
    public void removeSpaceFromBasket(DomainDriverManager ddManager, String spaceId) throws AdminException
    {
        ...
        {
			throw new AdminException("SpaceInstManager.removeSpaceFromBasket", SilverpeasException.ERROR, "admin.EX_ERR_RESTORE_SPACE_FROM_BASKET", "spaceId = " + spaceId, e);
        }
    }
    ...
    public void updateSpaceInst(DomainDriverManager ddManager, SpaceInst spaceInstNew) throws AdminException
    {
        try
        {
            ...
            if (spaceInstNew.isRemoveTranslation())
            {
            	...
            	{
            		List translations = ddManager.organization.spaceI18N.getTranslations(changedSpace.id);
            	...
            	{
            		ddManager.organization.spaceI18N.removeTranslation(Integer.parseInt(spaceInstNew.getTranslationId()));
            	}
            }
            else
            {
        ...
        {
			throw new AdminException("SpaceInstManager.updateSpaceInst", SilverpeasException.ERROR, "admin.EX_ERR_UPDATE_SPACE", "space Id : '" + spaceInstNew.getId() + "'", e);
        }
    }
    ...
    private void isValidSpace(SpaceInst spaceInst) throws AdminException
    {
        ...
        if (sError.length() != 0)
			throw new AdminException("SpaceInstManager.isValidSpace", SilverpeasException.ERROR, "admin.EX_ERR_INVALID_SPACE", "space Id : '" + spaceInst.getId() + "'");
    }
    ...
    public boolean isSpaceInstExist(DomainDriverManager ddManager, String sSpaceInstId) throws AdminException
    {
        ...
        {
			throw new AdminException("SpaceInstManager.isSpaceInstExist", SilverpeasException.ERROR, "admin.EX_ERR_IS_SPACE_EXIST", "space Id : '" + sSpaceInstId + "'", e);
        }
		finally
		{
			ddManager.releaseOrganizationSchema();
    ...
    /**
	 * Move first given space under the second one
	 * if second space is null, move the space as a root space
	 */
    public void moveSpace(DomainDriverManager ddManager, String sSpaceId, String sFatherSpaceId, SpaceInst space) throws AdminException
    {
        ...
        try
        {
			...
			{
				ddManager.organization.userSet.removeUserSetFromUserSet("S", idAsInt(sSpaceId), "S", idAsInt(sOldFatherId));
			}
			...
			// Create link Userset
			ddManager.organization.userSet.addUserSetInUserSet("S", idAsInt(sSpaceId), "S", idAsInt(sFatherSpaceId));
        }
        catch(Exception e)
        {
			throw new AdminException("SpaceInstManager.moveSpace", SilverpeasException.ERROR, "admin.EX_ERR_MOVE_SPACE", "move space Id : '" + sSpaceId + "', under space Id : '" + sFatherSpaceId + "'", e);
        }
    }
