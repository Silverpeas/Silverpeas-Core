...
public class Group extends Object implements Serializable, Comparable
{
    ...
    public void traceGroup()
    {
        ...
        SilverTrace.info("admin","Group.traceGroup","admin.MSG_DUMP_GROUP","id : " + id);
        SilverTrace.info("admin","Group.traceGroup","admin.MSG_DUMP_GROUP","specificId : " + specificId);
		SilverTrace.info("admin","Group.traceGroup","admin.MSG_DUMP_GROUP","domainId : " + domainId);
		SilverTrace.info("admin","Group.traceGroup","admin.MSG_DUMP_GROUP","superGroupId : " + superGroupId);
		SilverTrace.info("admin","Group.traceGroup","admin.MSG_DUMP_GROUP","name : " + name);
		SilverTrace.info("admin","Group.traceGroup","admin.MSG_DUMP_GROUP","description : " + description);
		SilverTrace.info("admin","Group.traceGroup","admin.MSG_DUMP_GROUP","rule : " + rule);
        for (i = 0; i < m_sUserIds.length ;i++ )
        {
            SilverTrace.info("admin","Group.traceGroup","admin.MSG_DUMP_GROUP","userId " + Integer.toString(i) + " : " + m_sUserIds[i]);
        }
   }
