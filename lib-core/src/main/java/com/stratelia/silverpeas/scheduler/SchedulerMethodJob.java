...
/**
 * This class extends the class 'SchedulerJob' for the functionality of a scheduled execution
 * of a class method.
 */
public class SchedulerMethodJob extends SchedulerJob
{
	 ...
	 */
	protected SchedulerMethodJob (SimpleScheduler theJobController, SchedulerEventHandler theJobOwner, String theJobName) throws SchedulerException
	{
	...
	// Get the execution method
		try
		{
			...
			{
				throw new Exception ("There is no method '" + aExecutionMethodName + " (java.io.PrintStream,java.util.Date)' in the class '" + methodOwner.getClass ().getName () + "'");
			}
		}
		catch (Exception aException)
		{
			throw new SchedulerException ("SchedulerMethodJob.setExecutionParameter: Getting the execution method fails (Msg: " + aException.toString () + ")");
		}
	}

	/**
	 * This method implements the abstract method of the base class. It only routes the parameter
	 * the the stored execution method.
	 *
