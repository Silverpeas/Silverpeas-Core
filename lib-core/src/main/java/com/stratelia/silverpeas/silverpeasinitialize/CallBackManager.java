...
public class CallBackManager
{
    ...
    // Call functions
    // --------------
    static public void invoke(int action, int iParam, String sParam, Object extraParam)
    {
	...
	static public String getInvokeString(int action, int iParam, String sParam, Object extraParam)
    {
        StringBuffer sb = new StringBuffer("Invoke Action = ");
        switch (action)
        {
        case ACTION_AFTER_CREATE_USER       : sb.append("ACTION_AFTER_CREATE_USER"); break;
        case ACTION_BEFORE_REMOVE_USER      : sb.append("ACTION_BEFORE_REMOVE_USER"); break;
        case ACTION_AFTER_CREATE_GROUP      : sb.append("ACTION_AFTER_CREATE_GROUP"); break;
        case ACTION_BEFORE_REMOVE_GROUP     : sb.append("ACTION_BEFORE_REMOVE_GROUP"); break;
        case ACTION_AFTER_CREATE_SPACE      : sb.append("ACTION_AFTER_CREATE_SPACE"); break;
        case ACTION_BEFORE_REMOVE_SPACE     : sb.append("ACTION_BEFORE_REMOVE_SPACE"); break;
        case ACTION_AFTER_CREATE_COMPONENT  : sb.append("ACTION_AFTER_CREATE_COMPONENT"); break;
        case ACTION_BEFORE_REMOVE_COMPONENT : sb.append("ACTION_BEFORE_REMOVE_COMPONENT"); break;
        case ACTION_ON_WYSIWYG				: sb.append("ACTION_ON_WYSIWYG"); break;
		case ACTION_ATTACHMENT_ADD			: sb.append("ACTION_ATTACHMENT_ADD"); break;
		case ACTION_ATTACHMENT_UPDATE		: sb.append("ACTION_ATTACHMENT_UPDATE"); break;
		case ACTION_ATTACHMENT_REMOVE		: sb.append("ACTION_ATTACHMENT_REMOVE"); break;
		case ACTION_VERSIONING_ADD			: sb.append("ACTION_VERSIONING_ADD"); break;
		case ACTION_VERSIONING_UPDATE		: sb.append("ACTION_VERSIONING_UPDATE"); break;
		case ACTION_VERSIONING_REMOVE		: sb.append("ACTION_VERSIONING_REMOVE"); break;
