...
public class PanelMiniFilterEdit extends PanelMiniFilterToken
{
    ...
    public PanelMiniFilterEdit(int index, String label, String valueText, String icon, String alt, String title)
    {
        m_Index = index;
        m_Type = TYPE_EDIT;
        m_Label = label;
    ...
    public String getHTMLDisplay()
    {
        ...
        sb.append("&nbsp;&nbsp;<input type=text size=5 name=\"miniFilter" + '_' + m_Label + '_' + Integer.toString(m_Index) + "\" style=\"font-size:9;\" value=\"" + m_Text + "\"");
        if (m_ReadOnly)
        {
            sb.append(" readonly>&nbsp;");
        }
        ...
        sb.append("<img src=\""+m_Icon+"\" border=0 align=absmiddle alt=\""+m_Alt+"\" title=\""+m_Title+"\"></a>");
