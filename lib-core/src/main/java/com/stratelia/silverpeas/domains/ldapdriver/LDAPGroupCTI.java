 ...
 * CONSIDERED AS ROOT GROUPS ALL DESCENDENT USERS ARE PUT IN FIRST LEVEL USERS For CTI : Add new
 * functionality : - Build Name from path (dn) - Use dn as key
 * @author tleroi
 */
...
public class LDAPGroupCTI extends AbstractLDAPGroup {
  ...
  /**
   * Called when Admin starts the synchronization overidded to manage local cache
   */
