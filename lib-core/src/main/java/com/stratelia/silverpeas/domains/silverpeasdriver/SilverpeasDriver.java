...
public class SilverpeasDriver extends AbstractDomainDriver
{
    ...
    */
        ...
        throws AdminException
    {
        if (organization == null)
        {
            ...
            {
				throw new AdminException("SilverpeasDriver.getDomainSPSchema", SilverpeasException.ERROR, "admin.EX_ERR_GET_SCHEMA");
            }
        }
    }
     ...
     */
    public void releaseDomainSPSchema()
        throws AdminException
    {
	...
	*/
	public String createUser(UserDetail ud) throws Exception
	{
        ...
        {
			throw new AdminException("SilverpeasDriver.createUser", SilverpeasException.ERROR, "admin.EX_ERR_ADD_USER", ud.getFirstName() + " " + ud.getLastName(), e);
        }
		finally
		{
   ...
   public void deleteUser(String userId) throws Exception
   {
        ...
        {
			throw new AdminException("SilverpeasDriver.deleteUser", SilverpeasException.ERROR, "admin.EX_ERR_DELETE_USER", "userId : " + userId, e);
        }
		finally
		{
			this.releaseDomainSPSchema();
   ...
   public void updateUserFull(UserFull ud) throws Exception
   {
        try
        {
			...
			SPUserRow oldUser = this.organization.user.getUser(idAsInt(ud.getSpecificId()));
            ...
            ur.loginMail = "";
            if (Authentication.ENC_TYPE_UNIX.equals(m_PasswordEncryption) && !ud.getPassword().equals(oldUser.password)) {
                ur.password = UnixMD5Crypt.crypt(ud.getPassword());
            } else if (Authentication.ENC_TYPE_MD5.equals(m_PasswordEncryption) && !ud.getPassword().equals(oldUser.password)) {
        ...
        {
			throw new AdminException("SilverpeasDriver.updateUser", SilverpeasException.ERROR, "admin.EX_ERR_UPDATE_USER", ud.getFirstName() + " " + ud.getLastName(), e);
        }
		finally
		{
			this.releaseDomainSPSchema();
	...
	*/
	public UserDetail getUser(String userId) throws Exception
	{
        ...
        {
			throw new AdminException("SilverpeasDriver.getUser", SilverpeasException.ERROR, "admin.EX_ERR_GET_USER", "userId : " + userId, e);
        }
		finally
		{
			this.releaseDomainSPSchema();
   ...
   public UserDetail[] getAllUsers() throws Exception
   {
        ...
        {
			throw new AdminException("SilverpeasDriver.getAllUsers", SilverpeasException.ERROR, "admin.EX_ERR_GET_ALL_USERS", e);
        }
		finally
		{
			this.releaseDomainSPSchema();
	...
	*/
	public String createGroup(Group m_Group) throws Exception
	{
        ...
        {
			throw new AdminException("SilverpeasDriver.createGroup", SilverpeasException.ERROR, "admin.EX_ERR_ADD_GROUP", m_Group.getName(), e);
        }
		finally
		{
			this.releaseDomainSPSchema();
   ...
   public void deleteGroup(String groupId) throws Exception
   {
        ...
        {
			throw new AdminException("SilverpeasDriver.deleteGroup", SilverpeasException.ERROR, "admin.EX_ERR_DELETE_GROUP", "groupId : " + groupId, e);
        }
		finally
		{
			this.releaseDomainSPSchema();
   ...
   public void updateGroup(Group group) throws Exception
   {
        ...
        try
        {
		    if(group == null || group.getName().length() == 0 || group.getId().length() == 0)
				    throw new AdminException("SilverpeasDriver.updateGroup", SilverpeasException.ERROR, "admin.EX_ERR_INVALID_GROUP");
            ...
            String[] asOldUsersId = this.organization.user.getDirectUserIdsOfGroup(gr.id);
            ...
            for(int nI=0; nI < alRemUsers.size(); nI++)
				this.organization.group.removeUserFromGroup(idAsInt((String)alRemUsers.get(nI)), gr.id);

            // Add the new users of the group
            for(int nI=0; nI < alAddUsers.size(); nI++)
				this.organization.group.addUserInGroup(idAsInt((String)alAddUsers.get(nI)), gr.id);
        }
        catch(Exception e)
        {
			throw new AdminException("SilverpeasDriver.updateGroup", SilverpeasException.ERROR, "admin.EX_ERR_UPDATE_GROUP", "groupId : " + group.getSpecificId(), e);
        }
		finally
		{
			this.releaseDomainSPSchema();
   ...
   public Group getGroup(String groupId) throws Exception
   {
        try
        {
            ...
            String[] asUsersId = this.organization.user.getDirectUserIdsOfGroup(idAsInt(groupId));
        ...
        {
			throw new AdminException("SilverpeasDriver.getGroup", SilverpeasException.ERROR, "admin.EX_ERR_GET_GROUP", "groupId : " + groupId, e);
        }
		finally
		{
			this.releaseDomainSPSchema();
	...
	*/
	public Group[] getGroups(String groupId) throws Exception
	{
        ...
        {
			this.getDomainSPSchema();
            SPGroupRow[] grs = this.organization.group.getDirectSubGroups(idAsInt(groupId));
			...
			for (int nI=0; nI<grs.length; nI++)
			{
	            ...
	            // Get the selected users for this group
		        String[] asUsersId = this.organization.user.getDirectUserIdsOfGroup(grs[nI].id);
			    if(asUsersId != null) group.setUserIds(asUsersId);
        ...
        {
			throw new AdminException("SilverpeasDriver.getGroups", SilverpeasException.ERROR, "admin.EX_ERR_GET_GROUPS", "father group id : " + groupId, e);
        }
		finally
		{
			this.releaseDomainSPSchema();
	...
	*/
	public Group[] getAllGroups() throws Exception
	{
        ...
        {
			throw new AdminException("SilverpeasDriver.getAllGroups", SilverpeasException.ERROR, "admin.EX_ERR_GET_ALL_GROUPS", e);
        }
		finally
		{
			this.releaseDomainSPSchema();
	...
	*/
	public Group[] getAllRootGroups() throws Exception
	{
        ...
        {
			throw new AdminException("SilverpeasDriver.getAllRootGroups", SilverpeasException.ERROR, "admin.EX_ERR_GET_ALL_ROOT_GROUPS", e);
        }
		finally
		{
			this.releaseDomainSPSchema();
   ...
   public void addUserInGroup(String userId, String groupId) throws Exception
   {
        ...
        {
			throw new AdminException("SilverpeasDriver.addUserInGroup", SilverpeasException.ERROR, "admin.EX_ERR_ADD_USER_IN_GROUP", "userId : '" + userId + "', groupId : '" + groupId + "'", e);
        }
		finally
		{
			this.releaseDomainSPSchema();
   ...
   public void removeUserFromGroup(String userId, String groupId) throws Exception
   {
        ...
        {
			this.getDomainSPSchema();
			this.organization.group.removeUserFromGroup(idAsInt(userId), idAsInt(groupId));
        }
        catch(Exception e)
        {
			throw new AdminException("SilverpeasDriver.removeUserFromGroup", SilverpeasException.ERROR, "admin.EX_ERR_REMOVE_USER_FROM_GROUP", "userId : '" + userId + "', groupId : '" + groupId + "'", e);
        }
		finally
		{
			this.releaseDomainSPSchema();
	...
	*/
	public void commit() throws Exception  
	{
        ...
        {
			throw new AdminException("SilverpeasDriver.commit", SilverpeasException.ERROR, "root.EX_ERR_COMMIT", e);
        }
	}
	...
	*/
	public void rollback() throws Exception  
	{
        ...
        {
			throw new AdminException("SilverpeasDriver.rollback", SilverpeasException.ERROR, "admin.EX_ERR_ROLLBACK", e);
        }
	}
