...
public class SPGroupTable extends Table
{
   ...
   static final private String GROUP_COLUMNS
      = "id,superGroupId,name,description";

   /**
    * Fetch the current group row from a resultSet.
    */
   protected SPGroupRow fetchGroup(ResultSet rs)
       throws SQLException
   {
    ...
    */
   public SPGroupRow getGroup(int id)
   ...
   static final private String SELECT_GROUP_BY_ID
      = "select "+GROUP_COLUMNS+" from DomainSP_Group where id = ?";

   /**
    * Returns the root Group whith the given name.
    */
   public SPGroupRow getRootGroup(String name)
       throws AdminPersistenceException
   {
       ...
       {
			throw new AdminPersistenceException("SPGroupTable.getRootGroup", SilverpeasException.ERROR, "admin.EX_ERR_GROUP_NAME_FOUND_TWICE", "name : '" + name + "'");
       }
   }
       ...
       throws AdminPersistenceException
   {
       ...
       {
			throw new AdminPersistenceException("SPGroupTable.getGroup", SilverpeasException.ERROR, "admin.EX_ERR_GROUP_NAME_FOUND_TWICE", "name: '" + name + "', father group Id: '" + superGroupId + "'");
       }
   }
    ...
    */
   public SPGroupRow[] getAllGroups()
       throws AdminPersistenceException
   {
       return (SPGroupRow[]) getRows(SELECT_ALL_GROUPS)
           .toArray(new SPGroupRow[0]);
   }

   static final private String SELECT_ALL_GROUPS
      = "select "+GROUP_COLUMNS+" from DomainSP_Group";

   /**
    * Returns all the Groups without a superGroup.
    */
   public SPGroupRow[] getAllRootGroups()
       throws AdminPersistenceException
   {
       return (SPGroupRow[]) getRows(SELECT_ALL_ROOT_GROUPS)
           .toArray(new SPGroupRow[0]);
   }

   static final private String SELECT_ALL_ROOT_GROUPS
      = "select "+GROUP_COLUMNS+" from DomainSP_Group where superGroupId is null";
   ...
   public SPGroupRow[] getDirectSubGroups(int superGroupId)
       throws AdminPersistenceException
   {
       return (SPGroupRow[]) getRows(SELECT_SUBGROUPS, superGroupId)
           .toArray(new SPGroupRow[0]);
   }

   static final private String SELECT_SUBGROUPS
      = "select "+GROUP_COLUMNS+" from DomainSP_Group where superGroupId = ?";
   ...
   public SPGroupRow[] getDirectGroupsOfUser(int userId)
       throws AdminPersistenceException
   {
       return (SPGroupRow[]) getRows(SELECT_USER_GROUPS, userId)
           .toArray(new SPGroupRow[0]);
   }
   ...
   public SPGroupRow[] getDirectGroupsInUserRole(int userRoleId)
       throws AdminPersistenceException
   {
       return (SPGroupRow[]) getRows(SELECT_USERROLE_GROUPS, userRoleId)
           .toArray(new SPGroupRow[0]);
   }

   static final private String SELECT_USERROLE_GROUPS
      = "select "+GROUP_COLUMNS
      + " from DomainSP_Group,ST_UserRole_Group_Rel"
   ...
   static final private String SELECT_SPACEUSERROLE_GROUPS
      = "select "+GROUP_COLUMNS
      + " from DomainSP_Group,ST_SpaceUserRole_Group_Rel"
    ...
    */
   public void createGroup(SPGroupRow group)
       throws AdminPersistenceException
   {
      ...
      if (group.superGroupId != -1)
      {
          ...
          if (superGroup == null)
          {
			  throw new AdminPersistenceException("SPGroupTable.createGroup", SilverpeasException.ERROR, "admin.EX_ERR_UNKNOWN_FATHER", "father group Id: '" + group.superGroupId + "'");
          }
      }
       ...
       throws SQLException
   {
       ...
       if (g.superGroupId == -1) insert.setNull(2, Types.INTEGER);
       else                      insert.setInt(2, g.superGroupId);
    ...
    * Updates a group row.
    */
   public void updateGroup(SPGroupRow group)
       throws AdminPersistenceException
   {
   ...
   static final private String DELETE_GROUP
      = "delete from DomainSP_Group where id = ?";
       ...
       throws AdminPersistenceException
   {
       ...
       if (user == null)
       {
 		   throw new AdminPersistenceException("SPGroupTable.addUserInGroup", SilverpeasException.ERROR, "admin.EX_ERR_UNKNOWN_USER", "user Id: '" + userId + "'");
       }

       SPGroupRow group = getGroup(groupId);
       if (group == null)
       {
 		   throw new AdminPersistenceException("SPGroupTable.addUserInGroup", SilverpeasException.ERROR, "admin.EX_ERR_UNKNOWN_GROUP", "group Id: '" + groupId + "'");
       }
       ...
       throws AdminPersistenceException
   {
       ...
       {
			throw new AdminPersistenceException("SPGroupTable.createGroup", SilverpeasException.ERROR, "admin.EX_ERR_USER_NOT_IN_GROUP", "group Id: '" + groupId + "', user Id: '" + userId + "'");
       }
