...
public class LDAPSettings extends Object
{
    ...
    * The optional properties are retreive with getSureString.
	*
	...
	*/
    ...
    {  
        ...
        LDAPMaxMsClientTimeLimit = getIntValue(rs, "database.LDAPMaxMsClientTimeLimit", LDAPMaxMsClientTimeLimit);
        LDAPMaxSecServerTimeLimit= getIntValue(rs, "database.LDAPMaxSecServerTimeLimit", LDAPMaxSecServerTimeLimit);
        LDAPMaxNbEntryReturned = getIntValue(rs, "database.LDAPMaxNbEntryReturned", LDAPMaxNbEntryReturned);
        ...
        LDAPPortSecured = getIntValue(rs, "database.LDAPPortSecured", LDAPPortSecured);
        ...
        groupsIncludeEmptyGroups = getBooleanValue(rs,"groups.IncludeEmptyGroups",groupsIncludeEmptyGroups);
    ...
    // HOST FIELDS
    // -----------
    public boolean isSynchroAutomatic()         {   return SYNCHROautomatic; }
    public boolean isSynchroRecursToGroups()    {   return SYNCHRORecursToGroups; }
    public boolean isSynchroThreaded()          {   return SYNCHROthreaded; }
    public String getTimeStampVar()             {   return SYNCHROtimeStampVar; }
    public boolean isSynchroCacheEnabled()      {   return SYNCHROCacheEnabled; }
    public boolean mustImportUsers()			{	return SYNCHROImportUsers; }
    ...
    public String getLDAPImpl()                 {   return LDAPImpl; }
    ...
    public boolean getLDAPSearchRecurs()        {   return LDAPSearchRecurs; }
    public boolean isLDAPSecured()              {   return LDAPSecured; }
    public int    getScope()                    {   if (LDAPSearchRecurs) { return LDAPConnection.SCOPE_SUB; } else { return LDAPConnection.SCOPE_ONE; } }
    ...
    { 
        ...
        if (allocateNew)
        {
            ...
            if (LDAPMaxNbReferrals == 0)
                ...
                doReferrals = true;
            theSearchConstraints = new LDAPSearchConstraints(LDAPMaxMsClientTimeLimit,LDAPMaxSecServerTimeLimit,LDAPSearchConstraints.DEREF_NEVER,LDAPMaxNbEntryReturned,doReferrals,LDAPBatchSize,null,LDAPMaxNbReferrals);
        }
        else
        {
    ...
    { 
        ...
        if (allocateNew)
        {
            ...
            if (LDAPMaxNbReferrals == 0)
                ...
                doReferrals = true;
            theConstraints = new LDAPConstraints(LDAPMaxMsClientTimeLimit,doReferrals,null,LDAPMaxNbReferrals);
        }
        else
        {
    ...
    {   
        ...
        {
			throw new AdminException("LDAPSettings.newLDAPUser", SilverpeasException.ERROR, "admin.EX_ERR_CANT_INSTANCIATE_USER_CLASS", usersType,e);
        }
    }
    public String getUsersClassName()           {   return usersClassName; }
    public String getUsersFilter()              {   return usersFilter; }
    ...
    // AdminUser fields
    public String getUsersIdField()             {   return usersIdField; }
    public String getUsersLoginField()          {   return usersLoginField; }
    public String getUsersFirstNameField()      {   return usersFirstNameField; }
    public String getUsersLastNameField()       {   return usersLastNameField; }
    public String getUsersEmailField()          {   return usersEmailField; }
    ...
    {   
        if (LDAPUtility.isAGuid(getUsersIdField()) && (value != null))
        {
            ...
            return "(&" + getUsersFullFilter() + "(" + getUsersIdField() + "=" + singleSlashValue.toString() + "))"; 
        }
        else
        {
            return "(&" + getUsersFullFilter() + "(" + getUsersIdField() + "=" + LDAPUtility.normalizeFilterValue(value) + "))"; 
        }
    }
    public String getUsersLoginFilter(String value){   return "(&" + getUsersFullFilter() + "(" + getUsersLoginField() + "=" + value + "))"; }
    ...
    {   
        ...
        {
			throw new AdminException("LDAPSettings.newLDAPGroup", SilverpeasException.ERROR, "admin.EX_ERR_CANT_INSTANCIATE_GROUP_CLASS", groupsType,e);
        }
    }
    public String getGroupsClassName()          {   return groupsClassName; }
    public boolean isGroupsInheritProfiles()    {   return groupsInheritProfiles; }
    public String getGroupsFilter()             {   return groupsFilter; }
    public int getGroupsNamingDepth()                 {   return groupsNamingDepth; }
    ...
    public String getGroupsMemberField()        {   return groupsMemberField; }
    ...
    // Group fields
    public String getGroupsIdField()             {   return groupsIdField; }
    public boolean getGroupsIncludeEmptyGroups() {   return groupsIncludeEmptyGroups; }
    public String getGroupsNameField()           {   return groupsNameField; }
    public String getGroupsDescriptionField()    {   return groupsDescriptionField; }
    ...
    {   
        if (LDAPUtility.isAGuid(getGroupsIdField()) && (value != null))
        {
            ...
            return "(&" + getGroupsFullFilter() + "(" + getGroupsIdField() + "=" + singleSlashValue.toString() + "))"; 
        }
        else
        {
            return "(&" + getGroupsFullFilter() + "(" + getGroupsIdField() + "=" + LDAPUtility.normalizeFilterValue(value) + "))"; 
        }
    }
    ...
    * (in that case, returns empty string)
    *
    ...
    */
    ...
    protected boolean getBooleanValue(ResourceLocator rs, String key, boolean defaultValue)
    {
        ...
        if (res != null)
        {
            if (res.equalsIgnoreCase("true") || res.equalsIgnoreCase("1") || res.equalsIgnoreCase("yes") || res.equalsIgnoreCase("oui") || res.equalsIgnoreCase("ok"))
                valret = true;
            else
                valret = false;
        }
    ...
    protected int getIntValue(ResourceLocator rs, String key, int defaultValue)
    {
        ...
        if (res != null)
        {
            ...
            {
                SilverTrace.error("admin", "LDAPSettings.getUserIds()", "admin.MSG_ERR_LDAP_GENERAL", "Int parse error : " + key + " = " + res, e);
            }
        }
        return valret;
    }
