...
/**
 * The DomainSPSchemaPool class manages a pool of DomainSPSchema shared
...
public class DomainSPSchemaPool extends SchemaPool
{
   ...
   */
  static public DomainSPSchema getDomainSPSchema()  throws AdminPersistenceException
  {
      try
      {
      ...
      {
          throw new AdminPersistenceException("DomainSPSchema.getSchema", SilverpeasException.ERROR, "root.EX_DATASOURCE_INVALID", ue);
      }
  }
