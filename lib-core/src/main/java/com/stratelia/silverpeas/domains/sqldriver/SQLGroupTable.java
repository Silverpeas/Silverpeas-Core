...
public class SQLGroupTable
{
   ...
   public int createGroup(Connection c, Group group) throws AdminException
   {
		...
		try
		{
			...
			nextId = DBUtil.getNextId(drvSettings.getGroupTableName(), drvSettings.getGroupSpecificIdColumnName());
		...
		{
		   throw new AdminException("SQLGroupTable.createGroup", SilverpeasException.ERROR, "root.EX_SQL_QUERY_FAILED", "Query = " + theQuery, e);
		}
		finally
		{
   ...
   public void deleteGroup(Connection c, int groupId) throws AdminException
   {
		...
		{
		   throw new AdminException("SQLGroupTable.deleteGroup", SilverpeasException.ERROR, "root.EX_SQL_QUERY_FAILED", "Query = " + theQuery, e);
		}
		finally
		{
		     DBUtil.close(statement);
   ...
   public void updateGroup(Connection c, Group g) throws AdminException
   {
		...
		String theQuery = "update " + drvSettings.getGroupTableName() + " set " 
						+ drvSettings.getGroupNameColumnName() + " = ?," + drvSettings.getGroupDescriptionColumnName()+ " = ?"  
						+ " where " + drvSettings.getGroupSpecificIdColumnName() + " = ?";
		...
		{
		   throw new AdminException("SQLGroupTable.updateGroup", SilverpeasException.ERROR, "root.EX_SQL_QUERY_FAILED", "Query = " + theQuery, e);
		}
		finally
		{
		     DBUtil.close(statement);
   ...
   public Group getGroup(Connection c, int groupId) throws AdminException
   {
		ResultSet rs = null;
		PreparedStatement statement = null;
		String theQuery = "select " + getColumns() + " from " + drvSettings.getGroupTableName() + " where id = ?";
		...
		{
		   throw new AdminException("SQLGroupTable.getGroup", SilverpeasException.ERROR, "root.EX_SQL_QUERY_FAILED", "Query = " + theQuery, e);
		}
		finally
		{
   ...
   public Group getGroupByName(Connection c, String groupName) throws AdminException
   {
	    ResultSet rs = null;
		PreparedStatement statement = null;
		String theQuery = "select " + getColumns() + " from " + drvSettings.getGroupTableName() + " where name = ?";
		try
		{
			...
			throw new AdminException("SQLGroupTable.getGroupByName", SilverpeasException.ERROR, "root.EX_SQL_QUERY_FAILED", "Query = " + theQuery, e);
		}
		finally {
			DBUtil.close(rs, statement);
		}
   ...
   public ArrayList getAllGroups(Connection c) throws AdminException
   {
		...
		String theQuery = "select " + getColumns() + " from " + drvSettings.getGroupTableName();
		...
		{
		   throw new AdminException("SQLGroupTable.getAllGroups", SilverpeasException.ERROR, "root.EX_SQL_QUERY_FAILED", "Query = " + theQuery, e);
		}
		finally
		{
		     DBUtil.close(rs,statement);
    ...
    * Returns the User whith the given id.
    */
   public ArrayList getDirectSubGroups(Connection c, int groupId) throws AdminException
   {
		ResultSet rs = null;
		PreparedStatement statement = null;
		ArrayList theResult = new ArrayList();
		String theQuery = "select " + getColumns() + " from " + drvSettings.getGroupTableName() + " where " + drvSettings.getGroupParentIdColumnName();
