...
public class SQLDriver extends AbstractDomainDriver
{
    ...
    protected SQLGroupUserRelTable localGroupUserRelMgr = new SQLGroupUserRelTable(drvSettings);
    ...
    */
    ...
    private void openConnection() throws AdminException
    {
        if (openedConnection == null)
        {
    		...
    		try
    		{
				...
				openedConnection = DriverManager.getConnection(drvSettings.getJDBCUrl(), drvSettings.getAccessLogin(), drvSettings.getAccessPasswd());
    		}
    		catch(Exception e)
    		{
    			throw new AdminException("SQLDriver.openConnection", SilverpeasException.ERROR, "root.EX_CONNECTION_OPEN_FAILED", e);
    		}
        }
    }
    ...
    public void closeConnection() throws AdminException
    {
        if ((openedConnection != null) && (!inTransaction))
        {
	    	...
	    	{
	    		throw new AdminException("SQLDriver.closeConnection", SilverpeasException.ERROR, "root.EX_CONNECTION_CLOSE_FAILED", e);
	    	}
	    	finally
			{
	...
	*/
	public String createUser(UserDetail ud) throws Exception
	{
        ...
        {
			throw new AdminException("SQLDriver.createUser", SilverpeasException.ERROR, "admin.EX_ERR_ADD_USER", ud.getFirstName() + " " + ud.getLastName(), e);
        }
		finally
		{
   ...
   public void deleteUser(String userId) throws Exception
   {
        ...
        {
			throw new AdminException("SQLDriver.deleteUser", SilverpeasException.ERROR, "admin.EX_ERR_DELETE_USER", "userId : " + userId, e);
        }
		finally
		{
			this.closeConnection();
   ...
   public void updateUserFull(UserFull uf) throws Exception
   {
        try
        {
        	...
        	for (int i = 0; i < specificProps.length; i++)
        	{
    			...
    			localUserMgr.updateUserSpecificProperty(openedConnection,userId,theProp,uf.getValue(theProp.getName()));
        	}
        	...
        	if (drvSettings.isUserPasswordAvailable())
        	{
            	...
            	String toPwd = "";
            	if (Authentication.ENC_TYPE_UNIX.equals(passwordEncryption) && !uf.getPassword().equals(fromPwd)) {
            		toPwd = UnixMD5Crypt.crypt(uf.getPassword());
            	} else if (Authentication.ENC_TYPE_MD5.equals(passwordEncryption) && !uf.getPassword().equals(fromPwd)) {
        ...
        {
			throw new AdminException("SQLDriver.updateUserFull", SilverpeasException.ERROR, "admin.EX_ERR_UPDATE_USER", uf.getFirstName() + " " + uf.getLastName(), e);
        }
		finally
		{
			this.closeConnection();
   ...
   public void updateUserDetail(UserDetail ud) throws Exception
   {
        ...
        {
			throw new AdminException("SQLDriver.updateUserDetail", SilverpeasException.ERROR, "admin.EX_ERR_UPDATE_USER", ud.getFirstName() + " " + ud.getLastName(), e);
        }
		finally
		{
			this.closeConnection();
	...
	*/
	public UserDetail getUser(String userId) throws Exception
	{
        ...
        {
			throw new AdminException("SQLDriver.getUser", SilverpeasException.ERROR, "admin.EX_ERR_GET_USER", "userId : " + userId, e);
        }
		finally
		{
			this.closeConnection();
	...
	public UserFull getUserFull(String id) throws Exception
    {
        try
        {
			...
			if (ud != null)
			{
	        	...
	        	if (drvSettings.isUserPasswordAvailable())
	        	{
		        	...
		        	uf.setPassword(localUserMgr.getUserPassword(openedConnection,userId));
		        	uf.setPasswordValid(localUserMgr.getUserPasswordValid(openedConnection,userId));
	        	}
	        	String[] specificProps = getPropertiesNames();
	        	DomainProperty theProp;
	        	String value;
        ...
        {
			throw new AdminException("SQLDriver.getUserFull", SilverpeasException.ERROR, "admin.EX_ERR_GET_USER", "userId : " + id, e);
        }
		finally
		{
			this.closeConnection();
   ...
   public UserDetail[] getAllUsers() throws Exception
   {
        ...
        {
			throw new AdminException("SQLDriver.getAllUsers", SilverpeasException.ERROR, "admin.EX_ERR_GET_ALL_USERS", e);
        }
		finally
		{
			this.closeConnection();
   ...
   public UserDetail[] getUsersBySpecificProperty(String propertyName, String propertyValue) throws Exception
   {
	   ...
	   else
	   {
	       ...
	       {
			   this.openConnection();
			   return (UserDetail[])(localUserMgr.getUsersBySpecificProperty(openedConnection, property.getMapParameter(), propertyValue).toArray(new UserDetail[0]));
	       }
	       catch(Exception e)
	       {
				throw new AdminException("SQLDriver.getUsersBySpecificProperty", SilverpeasException.ERROR, "admin.EX_ERR_GET_USERS", e);
	       }
	       finally
	       {
	    	   this.closeConnection();
	...
	*/
	public String createGroup(Group group) throws Exception
	{
        ...
        {
			throw new AdminException("SQLDriver.createGroup", SilverpeasException.ERROR, "admin.EX_ERR_ADD_GROUP", group.getName(), e);
        }
		finally
		{
			this.closeConnection();
   ...
   public void deleteGroup(String groupId) throws Exception
   {
        try
        {
        	...
        	while (allSubGroups.size() > 0)
        	{
        		...
        		// Add sub groups
            	allSubGroups.addAll(localGroupMgr.getDirectSubGroups(openedConnection,gid));
            	// Remove the group
        ...
        {
			throw new AdminException("SQLDriver.deleteGroup", SilverpeasException.ERROR, "admin.EX_ERR_DELETE_GROUP", "groupId : " + groupId, e);
        }
		finally
		{
			this.closeConnection();
   ...
   public void updateGroup(Group group) throws Exception
   {
        ...
        try
        {
		    if(group == null || group.getName().length() == 0 || group.getSpecificId().length() == 0)
				    throw new AdminException("SQLDriver.updateGroup", SilverpeasException.ERROR, "admin.EX_ERR_INVALID_GROUP");
            ...
            ArrayList asOldUsersId = localGroupUserRelMgr.getDirectUserIdsOfGroup(openedConnection, groupId);
            ...
            for(int nI=0; nI < asOldUsersId.size(); nI++)
				localGroupUserRelMgr.removeGroupUserRel(openedConnection, groupId, idAsInt(((String)asOldUsersId.get(nI))));

            // Add the new users of the group
            for(int nI=0; nI < alAddUsers.size(); nI++)
            	localGroupUserRelMgr.createGroupUserRel(openedConnection, groupId, idAsInt(((String)alAddUsers.get(nI))));
        }
        catch(Exception e)
        {
			throw new AdminException("SQLDriver.updateGroup", SilverpeasException.ERROR, "admin.EX_ERR_UPDATE_GROUP", "groupId : " + group.getSpecificId(), e);
        }
		finally
		{
			this.closeConnection();
   ...
   public Group getGroup(String groupId) throws Exception
   {
        try
        {
			...
			if (valret != null)
			{
	            ...
	            ArrayList asUsersId = localGroupUserRelMgr.getDirectUserIdsOfGroup(openedConnection, idAsInt(groupId));
        ...
        {
			throw new AdminException("SQLDriver.getGroup", SilverpeasException.ERROR, "admin.EX_ERR_GET_GROUP", "groupId : " + groupId, e);
        }
		finally
		{
			this.closeConnection();
   ...
   public Group getGroupByName(String groupName) throws Exception
   {
        ...
        {
			throw new AdminException("SQLDriver.getGroupByName", SilverpeasException.ERROR, "admin.EX_ERR_GET_GROUP", "groupName : " + groupName, e);
        }
		finally
		{
			this.closeConnection();
	...
	*/
	public Group[] getGroups(String groupId) throws Exception
	{
        ...
        {
			this.openConnection();
			ArrayList ar = localGroupMgr.getDirectSubGroups(openedConnection, idAsInt(groupId));
            ...
            while (it.hasNext())
            {
				...
				// Get the selected users for this group
	            ArrayList asUsersId = localGroupUserRelMgr.getDirectUserIdsOfGroup(openedConnection, idAsInt(theGroup.getSpecificId()));
        ...
        {
			throw new AdminException("SQLDriver.getGroups", SilverpeasException.ERROR, "admin.EX_ERR_GET_GROUPS", "father group id : " + groupId, e);
        }
		finally
		{
			this.closeConnection();
	...
	*/
	public Group[] getAllGroups() throws Exception
	{
        ...
        {
			throw new AdminException("SQLDriver.getAllGroups", SilverpeasException.ERROR, "admin.EX_ERR_GET_ALL_GROUPS", e);
        }
		finally
		{
			this.closeConnection();
	...
	*/
	public Group[] getAllRootGroups() throws Exception
	{
        ...
        {
			throw new AdminException("SQLDriver.getAllRootGroups", SilverpeasException.ERROR, "admin.EX_ERR_GET_ALL_ROOT_GROUPS", e);
        }
		finally
		{
			this.closeConnection();
   ...
   public void addUserInGroup(String userId, String groupId) throws Exception
   {
        ...
        {
			throw new AdminException("SQLDriver.addUserInGroup", SilverpeasException.ERROR, "admin.EX_ERR_ADD_USER_IN_GROUP", "userId : '" + userId + "', groupId : '" + groupId + "'", e);
        }
		finally
		{
			this.closeConnection();
   ...
   public void removeUserFromGroup(String userId, String groupId) throws Exception
   {
        ...
        {
			this.openConnection();
			localGroupUserRelMgr.removeGroupUserRel(openedConnection, idAsInt(groupId), idAsInt(userId));

        }
        catch(Exception e)
        {
			throw new AdminException("SQLDriver.removeUserFromGroup", SilverpeasException.ERROR, "admin.EX_ERR_REMOVE_USER_FROM_GROUP", "userId : '" + userId + "', groupId : '" + groupId + "'", e);
        }
		finally
		{
			this.closeConnection();
	...
	*/
	public void commit() throws Exception  
	{
       ...
       {
			throw new AdminException("SQLDriver.commit", SilverpeasException.ERROR, "root.EX_ERR_COMMIT", e);
       }
	}
	...
	*/
	public void rollback() throws Exception  
	{
       ...
       {
			throw new AdminException("SQLDriver.rollback", SilverpeasException.ERROR, "admin.EX_ERR_ROLLBACK", e);
       }
	}
}
