...
public class URLManager
{
    ...
    public static String getURL(String sSpace, String sComponentId)
    {
        ...
        */      
        public static String getEndURL(String spaceId,String componentId){
                //return URLEncoder.encode("&componentId="+componentId+"&spaceId="+spaceId);
        ...
        */
        private static String buildStandardURL(String componentName, String sComponentId, boolean isGlobalSearch){
			...
			if (isGlobalSearch){
				if(componentName.equals("sources") || componentName.equals("whitePages") ||
					componentName.equals("expertLocator") || componentName.equals("infoTracker") || componentName.equals("documentation"))
    ...
    public static String getApplicationURL()
    {
		if (applicationURL == null)
        {
          ...
          if (applicationURL == null) applicationURL="/silverpeas";
        }
	...
	public static String getSimpleURL(int type, String id, String componentId, boolean appendContext, String forumId) 
	{
		...
		switch (type)
		{
			case URL_MESSAGE : url += "/ForumsMessage/"+id+"?ForumId="+forumId;
							break;
		}
		return url;
	}
	...
	public static String getSimpleURL(int type, String id, String componentId, boolean appendContext) {
		...
		switch (type)
		{
			case URL_SPACE : url += "/Space/"+id;
							break;
			case URL_COMPONENT : url += "/Component/"+id;
							break;
			case URL_PUBLI : url += "/Publication/"+id;
							if (StringUtil.isDefined(componentId))
								url += "?ComponentId="+componentId;
							break;
			case URL_TOPIC : url += "/Topic/"+id+"?ComponentId="+componentId;
							break;
			case URL_FILE : url += "/File/"+id;
							break;
			case URL_SURVEY : url += "/Survey/"+id;
							break;
			case URL_QUESTION : url += "/Question/"+id;
							break;
		}
		return url;
	}
