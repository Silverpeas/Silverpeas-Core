...
public class jcrypt
{
   ...
   public static final String crypt(String original)
   {
	   ...
	   byte[] salt = new byte[] { legalSaltChars[random.nextInt(64)], legalSaltChars[random.nextInt(64)] };
   ...
   static {
	   byte[] bb;
	   try {
		   bb = "abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789./".getBytes("US-ASCII");
