...
public class WysiwygInstanciator  extends SQLRequest 
{
	...
	/**
	 * Method declaration
	 * call the method create AttachmentInstanciator class.
	 *
	 * @param con
	 * @param spaceId
	 * @param componentId
					   ...
					   String userId) throws InstanciationException
	{
		...
		AttachmentInstanciator ai = new AttachmentInstanciator("com.stratelia.webactiv.wysiwyg");
	...
	/**
	 * Method declaration
	 * call the method delete AttachmentInstanciator class.
	 *
	 * @param con
	 * @param spaceId
	 * @param componentId
	...
	public void delete(Connection con, String spaceId, String componentId,
					   String userId)
	{
        SilverTrace.debug("wysiwyg", "WysiwygInstanciator.delete", 	"delete called with: space=" + spaceId);

		AttachmentInstanciator ai = new AttachmentInstanciator("com.stratelia.webactiv.wysiwyg");
		try {
			ai.delete(con, spaceId, componentId, userId);			
		} catch (InstanciationException ie) {
            SilverTrace.error("wysiwyg", "wysiwygInstanciator.delete", "wysiwyg.DELETING_FAILED", ie);
		}
