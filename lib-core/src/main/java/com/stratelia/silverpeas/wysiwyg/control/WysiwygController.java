/**
 * Titre : Silverpeas<p>
 * Description : This object provides the functions of wysiwyg text editor<p>
 ...
 * CVS Informations
 *
 * $Id: WysiwygController.java,v 1.22 2009/03/26 14:16:24 neysseri Exp $
 *
 ...
 * no message
 *
 * Revision 1.19.2.2  2008/05/06 09:40:35  ehugonnet
 * Renommage du calcul du context
 *
 * Revision 1.19.2.1  2008/04/29 09:04:16  ehugonnet
 * Extraction de getContext d'AttachmentController dans FileRepositoryManager
 *
 * Revision 1.19  2008/03/26 13:16:30  neysseri
 * no message
 *
 * Revision 1.18  2008/02/26 15:21:13  dlesimple
 * Suppression de spaceId ds getWysiwyg
 *
 * Revision 1.17  2007/12/03 13:25:43  neysseri
 * no message
 *
 * Revision 1.16.2.5  2007/11/21 11:44:07  neysseri
 * no message
 *
 * Revision 1.16.2.4  2007/11/20 15:39:45  neysseri
 * no message
 *
 * Revision 1.16.2.3  2007/11/07 10:31:37  neysseri
 * no message
 *
 * Revision 1.16.2.2  2007/11/05 16:03:46  neysseri
 * no message
 *
 * Revision 1.16.2.1  2007/10/31 17:14:34  neysseri
 * no message
 *
 * Revision 1.16  2007/06/25 11:53:11  cbonin
 * correction bug liens si UNIX
 *
 * Revision 1.15  2007/04/20 14:22:56  neysseri
 * no message
 *
 * Revision 1.14.2.1  2007/03/29 14:13:27  neysseri
 * no message
 *
 ...
 * no message
 *
 * Revision 1.12  2005/10/13 19:15:05  neysseri
 * no message
 *
 * Revision 1.11  2005/07/07 18:04:01  neysseri
 * Nettoyage sources
 *
 * Revision 1.10  2005/07/04 09:50:45  dlesimple
 * Tiny MCE v1.45
 *
 * Revision 1.9  2005/04/22 12:15:51  neysseri
 * Added :
 ...
 * no message
 *
 * Revision 1.6.2.1  2005/03/11 19:19:55  sdevolder
 * *** empty log message ***
 *
 * Revision 1.6  2004/07/26 08:29:28  neysseri
 * no message
 *
 * Revision 1.5  2004/07/23 16:33:11  neysseri
 * Bug copier/coller
 *
 * Revision 1.4  2004/02/06 18:49:52  neysseri
 * Now, the both indexation methods are deprecated !
 *
 * Revision 1.3  2003/09/19 13:12:43  neysseri
 * no message
 *
 * Revision 1.2  2002/10/09 07:41:03  neysseri
 * no message
 *
 * Revision 1.1.1.1.6.1  2002/09/27 08:07:49  abudnikau
 * Remove debug
 *
 * Revision 1.1.1.1  2002/08/06 14:47:55  nchaix
 * no message
 *
 * Revision 1.11  2002/04/17 08:06:30  nchaix
 * no message
 *
 * Revision 1.10  2002/01/31 12:13:35  neysseri
 * no message
 *
 * Revision 1.9  2002/01/18 16:55:10  neysseri
 * Stabilisation Lot 2 : Exception et Silvertraces
 *
 */
...
public class WysiwygController
{
    ...
    /**
     * Method declaration
     * turn over all the files attached according to the parameters id, spaceId,  componentId, context.
     *
     *
     ...
     *
     * @return imagesList a table of string[N][2] with in logical index [N][0] = path name [N][1] = logical name of the file.
     *
     ...
     */
    public static String[][] searchAllAttachments(String id, String spaceId, String componentId, String context) /*throws /*WysiwygException, FinderException, NamingException, SQLException*/
    {
        ...
        for (int i = 0; i < nbImages; i++)
        {
            ...
            String path = FileServerUtils.getUrl(spaceId, componentId, attD.getLogicalName(), attD.getPhysicalName(), attD.getType(), "Attachment/" + context);

            imagesList[i][0] = path;
            imagesList[i][1] = attD.getLogicalName();
            SilverTrace.info("wysiwyg", "WysiwygController.searchAllAttachments()", "root.MSG_GEN_PARAM_VALUE", imagesList[i][0] + "] [" + imagesList[i][1]);
        }
        return imagesList;
    }
     ...
     * @param componentId
     * @return imagesList a table of string[N] with in logical index [N][0] = path name [N][1] = logical name of the file.
     *
     * @throws WysiwygException
     *
     */
	public static String[][] getWebsiteImages(String path, String componentId) throws WysiwygException
	{
		...
		{
			throw new WysiwygException("WebSiteSessionController.getWebsiteImages()",SilverpeasException.ERROR,"wysisyg.EX_GET_ALL_IMAGES_FAIL",e);
		}
	}

    /**
     * Method declaration
     * Get html pages of the website
     *
     * @param path type String: for example  of the directory
     * @param componentId
     *
	...
	public static String[][] getWebsitePages(String path, String componentId) throws WysiwygException
	{
		...
		{
			throw new WysiwygException("WebSiteSessionController.getWebsitePages()",SilverpeasException.ERROR,"wysisyg.EX_GET_ALL_PAGES_FAIL",e);
		}
	}
	  ...
	  private static String finNode2(String path, String componentId) {
	      ...
	      if (index == -1) //on est sous systeme UNIX : il n'y a que des Slash
	      {
	    	  ...
	    	  NEWD CBO 25/06/2007
	    	  int longueur = componentId.length();
		      int index2 = path.lastIndexOf(componentId);
		      finNode = path.substring(index2 + longueur);
		      finNode = ignoreAntiSlash(finNode);
    ...
    /**
     * Method declaration
     * Get the node of the path of the root Website
     *
     * @param path type String: for example: ex : c:\\j2sdk\\public_html\\WAwebSiteUploads\\webSite17\\3\\rep1\\rep11\\
     * @param componentId
     *
     * @return a String with the path of the node: ex: c:\\j2sdk\\public_html\\WAwebSiteUploads\\webSite17\\3
     *
     * @throws WysiwygException
     *
     */
	  private static String getNodePath(String currentPath, String componentId) {
	      ...
	      if (chemin != null) {
	          ...
	          if (index == -1) {
	              ...
	              finChemin = ignoreSlash(finChemin);
	              SilverTrace.info("wysiwyg", "WysiwygController.getNodePath()", "root.MSG_GEN_PARAM_VALUE", "nodePath = "+nodePath);
	          } //fin else
	      } //fin if
	      return nodePath;
	  }
...
/*============================================ END WEBSITES FUNCTIONS ====================================
	  ...
	  /**
     * Method declaration
     * built the name of the file to be attached.
     *
    ...
    /**
     * Method declaration
     * built the name of the images to be attached.
     *
	...
	public static void deleteFile(String componentId, String objectId, String language)
	{
		...
		while (f.hasNext())
		{
			...
			if (file != null && file.getPhysicalName().equalsIgnoreCase(getWysiwygFileName(objectId, language)))
			{
     ...
     * @see AttachmentController
     */
	public static void createFileAndAttachment(String textHtml, String fileName, String spaceId, String componentId, String context, String id, String userId) throws WysiwygException
	{
	...
	public static void createFileAndAttachment(String textHtml, String fileName, String spaceId, String componentId, String context, String id, String userId, boolean indexIt) throws WysiwygException
    {
        try
        {
            ...
            AttachmentDetail ad = new AttachmentDetail(atPK, fileName, fileName, null, "text/html", f.length(), context, new java.util.Date(), foreignKey);
			ad.setAuthor(userId);
        ...
        {
			throw new WysiwygException("WysiwygController.createFileAndAttachment()", SilverpeasException.ERROR, "wysiwyg.CREATING_WYSIWYG_DOCUMENT_FAILED", exc);
        }
    }
     ...
     * @see AttachmentController
     */
    public static void createFileAndAttachment(String textHtml, String spaceId, String componentId, String id) throws WysiwygException /*, FinderException, NamingException, SQLException*/
    {
        String fileName = WysiwygController.getWysiwygFileName(id);

        WysiwygController.createFileAndAttachment(textHtml, fileName, spaceId, componentId, WYSIWYG_CONTEXT, id, null);
    }

    /**
     * This method must be synchronized. Quick wysiwyg's saving can generate problems without synchronization !!!
	 * @param textHtml
	 * @param fileName
	 * @param spaceId
	 * @param componentId
	 ...
	 * @throws WysiwygException
	 */
	private static synchronized void updateFileAndAttachment(String textHtml, String fileName, String spaceId, String componentId, String context, String objectId, String userId, boolean indexIt) throws WysiwygException
    {
        SilverTrace.info("wysiwyg", "WysiwygController.updateFileAndAttachment()", "root.MSG_GEN_PARAM_VALUE","fileName="+fileName+" context="+context+"objectId="+objectId);
        AttachmentDetail attD = WysiwygController.searchAttachmentDetail(fileName, spaceId, componentId, context, objectId);
        if (attD != null)
        {
            AttachmentController.deleteAttachment(attD);
        }
        WysiwygController.createFileAndAttachment(textHtml, fileName, spaceId, componentId, context, objectId, userId, indexIt);
    }

    /**
     * Method declaration
     * remove and recreates the file attached
     *
     * @param textHtml  String : contains the text published by the wysiwyg
     * @param spaceId   String : the id of space.
     * @param componentId String : the id of component.
     ...
     * @see AttachmentController
     */
	public static void updateFileAndAttachment(String textHtml, String spaceId, String componentId, String objectId, String userId) throws WysiwygException
	{
    ...
    public static void save(String textHtml, String spaceId, String componentId, String objectId, String userId, String language, boolean indexIt) throws WysiwygException
    {
    	if (I18NHelper.isDefaultLanguage(language))
    	{
    		WysiwygController.updateFileAndAttachment(textHtml, spaceId, componentId, objectId, userId, indexIt);
    	}
    	else
    	{
     ...
     * @see AttachmentController
     */
    public static void deleteWysiwygAttachments(String spaceId, String componentId, String objectId) throws WysiwygException /*, FinderException, NamingException, SQLException*/
    {
        try
        {
            ...
            String path = AttachmentController.createPath(componentId, WysiwygController.getImagesFileName(objectId));

            WysiwygController.deletePath(path);
        }
        catch (Exception exc)
        {
            throw new WysiwygException("WysiwygController.deleteWysiwygAttachments()", SilverpeasException.ERROR, "wysiwyg.DELETING_WYSIWYG_ATTACHMENTS_FAILED", exc);
        }
    }
     ...
     * @throws WysiwygException
     */
    public static void deleteWysiwygAttachmentsOnly(String spaceId, String componentId, String objectId) throws WysiwygException /*, FinderException, NamingException, SQLException*/
    {
        try
        {
            // delete all the attachments
    ...
    /**
     * Method declaration
     * return the contents of the file attached.
     *
     * @param fileName  String : name of the file
     * @param spaceId   String : the id of space.
     * @param componentId String : the id of component.
     ...
     * @see AttachmentController
     */
    public static String loadFileAndAttachment(String fileName, String spaceId, String componentId, String context) throws WysiwygException
    {
        String 	text = null;
        String  path = AttachmentController.createPath(componentId, context);
		...
		catch (UtilException e)
		{
			...
			throw new WysiwygException("WysiwygController.loadFileAndAttachment()", SilverpeasException.WARNING, "wysiwyg.NO_WYSIWYG_DOCUMENT_ASSOCIATED");
		}
		return text;
    }
     ...
     * @see AttachmentController
     */
    public static String loadFileAndAttachment(String spaceId, String componentId, String objectId) throws WysiwygException
    {
        String fileName = WysiwygController.getWysiwygFileName(objectId);
     ...
     * @throws WysiwygException
     */
    public static String load(String spaceId, String componentId, String objectId, String language) throws WysiwygException
    {
     ...
     * @throws WysiwygException
     */
    public static String load(String componentId, String objectId, String language) throws WysiwygException
    {
    	String content = null;
    ...
    public static String loadFileWebsite(String path, String fileName) throws WysiwygException
    {
		...
		{
			//There is no document
			throw new WysiwygException("WysiwygController.loadFileWebsite()", SilverpeasException.WARNING, "wysiwyg.NO_WYSIWYG_DOCUMENT_ASSOCIATED");
		}
		return text;
    }
    ...
    public static boolean haveGotWysiwyg(String spaceId, String componentId, String objectId, String language)
    {
        try
        {
	...
	public static AttachmentDetail searchAttachmentDetail(String fileName, String spaceId, String componentId, String context, String objectId)
	{
     ...
     * @see AttachmentController
     */
    public static AttachmentDetail searchAttachmentDetail(String fileName, String spaceId, String componentId, String context, String objectId, Connection con)
    {
        AttachmentPK foreignKey		= new AttachmentPK(objectId, spaceId, componentId);
        Vector       vectAttachment = AttachmentController.searchAttachmentByPKAndContext(foreignKey, context, con);
     ...
     * @see AttachmentController
     */
    public static AttachmentDetail searchAttachmentDetail(String spaceId, String componentId, String context, String objectId) /*throws /* WysiwygException, FinderException, NamingException, SQLException*/
    {
        String fileName = WysiwygController.getWysiwygFileName(objectId);

        return WysiwygController.searchAttachmentDetail(fileName, spaceId, componentId, context, objectId);
    }

    /**
     * updateWebsite : creation or update of a file of a website
     * Param = cheminFichier = c:\\j2sdk\\public_html\\WAUploads\\webSite10\\nomSite\\rep1\\rep2
    ...
    /**
     * createFile : creation or update of a file
     * Param = cheminFichier = c:\\j2sdk\\public_html\\WAUploads\\webSite10\\nomSite\\rep1\\rep2
     * nomFichier = index.html
     * contenuFichier = code du fichier : "<HTML><TITLE>...."
     */
    protected static File createFile(String cheminFichier, String nomFichier, String contenuFichier) throws WysiwygException
    {
        ...
        SilverTrace.info("wysiwyg", "WysiwygController.createFile()", "root.MSG_GEN_PARAM_VALUE","cheminFichier="+cheminFichier+" nomFichier="+nomFichier);
        ...
        try
        {
            ...
            {
				throw new WysiwygException("WysiwygController.createFile()", SilverpeasException.ERROR, "wysiwyg.TARGET_DIRECTORY_ON_SERVER_DOES_NOT_EXIST");
            }
        }
        catch (IOException exc)
        {
            throw new WysiwygException("WysiwygController.createFile()", SilverpeasException.ERROR, "wysiwyg.CREATING_WYSIWYG_DOCUMENT_FAILED");
        }
    }

    /**
     * deleteFile : destruction of a file
    ...
    public synchronized void deleteFile(String directory, String fileName) throws WysiwygException
    {
        ...
        if (!result)
        {
            throw new WysiwygException("WysiwygController.deleteFile()", SilverpeasException.ERROR, "wysiwyg.DELETING_WYSIWYG_DOCUMENT_FAILED", "file = "+directory+fileName);
        }
    }
    ...
    {
        SilverTrace.info("wysiwyg", "WysiwygController.deletePath()", "root.MSG_GEN_ENTER_METHOD", "path = " + path);
        ...
        {
            throw new WysiwygException("WysiwygController.deletePath()", SilverpeasException.ERROR, "wysiwyg.DELETING_DIRECTORY_ON_SERVER_FAILED", "path = "+path);
        }
    }
     ...
     * @see
     */
    public static void copy(String oldSpaceId, String oldComponentId, String oldObjectId, String spaceId, String componentId, String objectId, String userId)
    {
        ...
        try
        {
			...
			//String       oldPath = AttachmentController.createPath(oldSpaceId, oldComponentId, getImagesFileName(oldObjectId));
			String		 oldPath = FileRepositoryManager.getAbsolutePath(oldComponentId, FileRepositoryManager.getAttachmentContext(getImagesFileName(oldObjectId)));
			String       currentPath = "";
			...
			Vector       vectAttachment = AttachmentController.searchAttachmentByPKAndContext(foreignKey, getImagesFileName(oldObjectId));
			int          nbImages = vectAttachment.size();
    ...
    private static void copyFile(String oldComponentId, String oldObjectId, String componentId, String objectId, String userId, String language, Hashtable<String, String> imageIds)
    {
        ...
        try
        {
			...
			{
				String newStr = replaceInternalImagesPath(wysiwygContent, oldComponentId, oldObjectId, componentId, objectId);
				newStr = replaceInternalImageIds(newStr, imageIds);

				createFileAndAttachment(newStr, WysiwygController.getWysiwygFileName(objectId, language), null, componentId, WYSIWYG_CONTEXT, objectId, userId);
			}
        }
        catch (Exception e) {}
    }
    ...
    public static void wysiwygPlaceHaveChanged(String oldComponentId, String oldObjectId, String newComponentId, String newObjectId) throws WysiwygException
    {
    	Iterator languages = I18NHelper.getLanguages();
    	...
    	while (languages.hasNext())
    	{
    		...
    		{
	    		wysiwyg = replaceInternalImagesPath(wysiwyg, oldComponentId, oldObjectId, newComponentId, newObjectId);

	    		//overwrite
	    		createFile(AttachmentController.createPath(newComponentId, WYSIWYG_CONTEXT), getWysiwygFileName(newObjectId, language), wysiwyg);
    		}
    	}
    }

    /*public static void moveWysiwyg(String fromComponentId, String fromObjectId, String toComponentId, String toObjectId) throws WysiwygException
    {
    	Iterator languages = I18NHelper.getLanguages();
    	String language = null;
    	String wysiwyg = null;
    	...
    	{
    		language = (String) languages.next();
    		wysiwyg = load(fromComponentId, fromObjectId, language);

    		wysiwyg = replaceInternalImagesPath(wysiwyg, fromComponentId, fromObjectId, toComponentId, toObjectId);

    		createFile(AttachmentController.createPath(fromComponentId, WYSIWYG_CONTEXT), getWysiwygFileName(fromObjectId, language), wysiwyg);
    	}
    }*/
