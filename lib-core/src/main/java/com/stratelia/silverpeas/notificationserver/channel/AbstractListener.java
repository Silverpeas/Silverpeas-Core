...
public abstract class AbstractListener implements INotificationServerChannel, MessageDrivenBean, MessageListener
{
	...
	private void extractData(Message msg) throws NotificationServerException
	{
		...
		try
		{
			m_channel = tm.getStringProperty(NotificationServerConstant.JMS_HEADER_CHANNEL);
		}
		catch (JMSException e)
		{
			throw new NotificationServerException("AbstractListener.extractData()", SilverpeasException.ERROR, "notificationServer.EX_CHANNEL_NOT_DEFINED", e);
		}
		...
		{
			throw new NotificationServerException("AbstractListener.extractData()", SilverpeasException.ERROR, "notificationServer.EX_NOTIF_DATA_NOT_DEFINED", e);
		}
	}
