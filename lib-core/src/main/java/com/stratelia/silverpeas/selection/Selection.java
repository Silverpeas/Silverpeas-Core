...
public class Selection
{
    ...
    public void setHostPath(PairObject[] hostPath) { if (hostPath != null) { m_hostPath = hostPath; } else { m_hostPath = new PairObject[0]; } }
    public PairObject[] getHostPath() { return m_hostPath; }

    public String getCancelURL() { return m_cancelURL; }
    public void setCancelURL(String cancelURL) { if (cancelURL != null) { m_cancelURL = cancelURL; } else { m_cancelURL = ""; } }

    public String getGoBackURL() { return m_goBackURL; }
    public void setGoBackURL(String goBackURL) { m_goBackURL = goBackURL; }

    public String getFirstPage() { return m_firstPage; }
    public void setFirstPage(String firstPage) { m_firstPage = firstPage; }
    ...
    public boolean isSetSelectable() { return m_setSelectable; }
    public void setSetSelectable(boolean setSelectable) { m_setSelectable = setSelectable; }

    public boolean isElementSelectable() { return m_elementSelectable; }
    public void setElementSelectable(boolean elementSelectable) { m_elementSelectable = elementSelectable; }

    public String[] getSelectedElements() { return m_selectedElements; }
    public void setSelectedElements(String[] selectedElements) { if (selectedElements != null) { m_selectedElements = selectedElements; } else { m_selectedElements = new String[0]; } }
    public String getFirstSelectedElement()
    {
        String[] elmts = m_selectedElements;
        String valret = null;

		if ((elmts != null) && (elmts.length > 0) && (elmts[0] != null) && (elmts[0] != null) && (elmts[0].length() > 0))
        {
            valret = elmts[0];
        }
		return valret;
    ...
    public String[] getSelectedSets() { return m_selectedSets; }
    public void setSelectedSets(String[] selectedSets) { if (selectedSets != null) { m_selectedSets = selectedSets; } else { m_selectedSets = new String[0]; } }
    public String getFirstSelectedSet()
    {
        String[] sets = m_selectedSets;
        String valret = null;

		if ((sets != null) && (sets.length > 0) && (sets[0] != null) && (sets[0] != null) && (sets[0].length() > 0))
        {
            valret = sets[0];
        }
		return valret;
    ...
    public SelectionExtraParams getExtraParams() { return m_extraParams; }
    public void setExtraParams(SelectionExtraParams extraParams) { m_extraParams = extraParams; }
