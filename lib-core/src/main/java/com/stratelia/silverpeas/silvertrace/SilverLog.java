...
public class SilverLog
{
    ...
    // protected static String     layoutDetailed = "%d{dd/MM/yy-HH:mm:SSS} - %-5p : %m%n";
     ...
     *
     */
    static public void logConnexion(String message, String adresseIP, String userLogin)
    {
        try
        {
            if (logCategory != null)
    ...
    static protected void initAll()
    {
        ...
        try
        {
            resource = java.util.ResourceBundle.getBundle("com.stratelia.silverpeas.silvertrace.settings.silverLog", new Locale("", ""));
    ...
    static public void initFromBundle(ResourceBundle resource)
    {
        ...
        try
        {
            ...
            // --------------------------
            i = 0;
            appenderTypeStr = resource.getString("appender" + Integer.toString(i) + ".type");
            // for each appenders
            while (appenderTypeStr != null)
            {
                ...
                appenderEnabled = MsgTrace.getBooleanProperty(resource, "appender" + Integer.toString(i) + ".enabled", true);
     ...
     *
     */
    static protected void addAppenderFromBundle(ResourceBundle resource, int appenderNumber, int appenderType)
    {
        String  layout;
        String  fileName;
        String  consoleName;
        ...
        layout = resource.getString("appender" + Integer.toString(appenderNumber) + ".layout");

        switch (appenderType)
        {
        case APPENDER_CONSOLE:
            consoleName = resource.getString("appender" + Integer.toString(appenderNumber) + ".consoleName");
            addAppenderConsole(layout, consoleName);
            break;
        case APPENDER_FILE:
            fileName = translateFileName(resource.getString("appender" + Integer.toString(appenderNumber) + ".fileName"));
            append = MsgTrace.getBooleanProperty(resource, "appender" + Integer.toString(appenderNumber) + ".append", true);
            addAppenderFile(layout, fileName, append);
            break;
        case APPENDER_ROLLING_FILE:
            fileName = translateFileName(resource.getString("appender" + Integer.toString(appenderNumber) + ".fileName"));
            rollingModeName = resource.getString("appender" + Integer.toString(appenderNumber) + ".rollingMode");
            ...
            break;
        case APPENDER_MAIL:
            mailHost = resource.getString("appender" + Integer.toString(appenderNumber) + ".mailHost");
            mailFrom = resource.getString("appender" + Integer.toString(appenderNumber) + ".mailFrom");
            mailTo = resource.getString("appender" + Integer.toString(appenderNumber) + ".mailTo");
            mailSubject = resource.getString("appender" + Integer.toString(appenderNumber) + ".mailSubject");
     ...
     *
     */
    static protected void addAppenderConsole(String patternLayout, String consoleName)
    {
     ...
     *
     */
    static protected void addAppenderFile(String patternLayout, String fileName, boolean appendOnFile)
    {
     ...
     *
     */
    static protected void addAppenderRollingFile(String patternLayout, String fileName, String rollingMode)
    {
        if (logCategory != null)
        {
            try
     ...
     *
     */
    static protected void addAppenderMail(String patternLayout, String mailHost, String mailFrom, String mailTo, String mailSubject)
    {
     ...
     *
     */
    static protected String formatTraceMessage(String message, String adresseIP, String userLogin)
    {
