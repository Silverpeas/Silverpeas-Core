  ...
  public void debug(String module, String classe, String message, String extraInfos, Throwable ex) {
    if (initFinished) {
      try {
        ...
        error("silvertrace", "SilverTrace.debug()", "silvertrace.ERR_RUNTIME_ERROR_OCCUR",
                "Msg=" + message, e);
  ...
  public void info(String module, String classe, String messageID, String extraInfos,
    ...
    if (initFinished) {
      try {
        ...
        error("silvertrace", "SilverTrace.info()", "silvertrace.ERR_RUNTIME_ERROR_OCCUR",
                "MsgId=" + messageID, e);
  ...
  public void warn(String module, String classe, String messageID, String extraInfos,
    ...
    if (initFinished) {
      try {
        ...
        error("silvertrace", "SilverTrace.warn()", "silvertrace.ERR_RUNTIME_ERROR_OCCUR",
                "MsgId=" + messageID, e);
        emergencyTrace(module, classe, messageID, extraInfos, ex);
      }
    } else {
    ...
    if (initFinished) {
      try {
        ...
        if (!module.equals("silvertrace")) {
          error("silvertrace", "SilverTrace.error()", "silvertrace.ERR_RUNTIME_ERROR_OCCUR",
                  "MsgId=" + messageID, e);
        }
        emergencyTrace(module, classe, messageID, extraInfos, ex);
      }
  ...
  public void fatal(String module, String classe, String messageID, String extraInfos,
    ...
    if (initFinished) {
      try {
        ...
        error("silvertrace", "SilverTrace.fatal()", "silvertrace.ERR_RUNTIME_ERROR_OCCUR",
                "MsgId=" + messageID, e);
        emergencyTrace(module, classe, messageID, extraInfos, ex);
      }
    } else {
...
* @param module the module name (ex : root, bus, outlook, ...)
  ...
  public void resetAll() {
    ...
    for (File theFile : theFiles) {
      ...
      try {
        ...
        if (initFinished) {
          error("silvertrace", "SilverTrace.resetAll()",
  ...
  public void applyProperties(String filePath) {
    ...
    try {
      ...
      if (initFinished) {
        error("silvertrace", "SilverTrace.resetAll()", "silvertrace.ERR_INIT_TRACE_FROM_PROP",
                "File:[" + filePath + "]", e);
      } else {
  ...
  public void addAppenderConsole(String module, String patternLayout, String consoleName) {
    ...
    if (cat != null) {
      try {
        ...
        if (initFinished) {
          error("silvertrace", "SilverTrace.addAppenderConsole()",
  ...
  public void addAppenderFile(String module, String patternLayout, String fileName,
    ...
    if (cat != null) {
      try {
        ...
        if (initFinished) {
          error("silvertrace", "SilverTrace.addAppenderFile()",
              "silvertrace.ERR_CANT_ADD_APPENDER",
  ...
  public void addAppenderRollingFile(String module, String patternLayout, String fileName,
    ...
    if (logger != null) {
      try {
        ...
        if (initFinished) {
          error("silvertrace", "SilverTrace.addAppenderRollingFile()",
              "silvertrace.ERR_CANT_ADD_APPENDER",
  ...
  public void addAppenderMail(String module, String patternLayout, String mailHost, String mailFrom,
    ...
    if (cat != null) {
      try {
        ...
        if (initFinished) {
          error("silvertrace", "SilverTrace.addAppenderMail()",
              "silvertrace.ERR_CANT_ADD_APPENDER",
...
* @param module the module name (ex : root, bus, outlook, ...)
  ...
  public String getTraceMessage(String messageId) {
    try {
      ...
      error("silvertrace", "SilverTrace.getTraceMessage()",
...
* @param messageId the message ID (ex. 'admin.MSG_ERR_GENERAL')
  ...
  public String getTraceMessage(String messageId, String language) {
    try {
      ...
      error("silvertrace", "SilverTrace.getTraceMessage()",
          "silvertrace.ERR_RUNTIME_ERROR_OCCUR", "MsgId=" + messageId + " Lang=" + language, ex);
...
* @param module
   ...
   * @return the built message
   */
  protected static String formatTraceMessage(String module, String classe,
