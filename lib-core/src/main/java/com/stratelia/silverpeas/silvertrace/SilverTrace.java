...
/**
 * SilverTrace is the trace tool used in silverpeas to trace debug, running
 * infos and errors. This is a 'fully' static class. All functions could be
 * called directly and is thread-safe. The trace functions are : debug, info,
 * warn, error, fatal.
 * 
...
public class SilverTrace {
  ...
  /**
   * Trace some debug informations. The programmer is free to display the
   * message he wants...
   * 
   * 
   * @param module
   ...
   * @param classe
   *          the short name of the classe that call this function (ex :
   *          "MyFavoriteClass") Could be followed by the function name (ex :
   *          "MyFavoriteClass.myFunction()")
   * @param message
   *          a string that will be displayed in the traces
   * 
   */
  ...
  /**
   * Trace some debug informations. The programmer is free to display the
   * message he wants... This function have one extra parameter : extraInfos to
   ...
   *          a string that will be displayed in the traces
   * @param extraInfos
   *          some extra-informations that are displayed after the message in
   *          parentesis
   * 
   */
  static public void debug(String module, String classe, String message,
  ...
  /**
   * Trace some debug informations. The programmer is free to display the
   * message he wants... This function have one extra parameters : ex to display
   * an exception
   * 
   * 
   * @param module
  ...
  /**
   * Trace some debug informations. The programmer is free to display the
   * message he wants... This function have two extra parameters : extraInfos to
   * add additional informations ex to display an exception
   * 
   * 
   * @param module
   *          the module name (ex : root, bus, outlook, ...)
  ...
  /**
   * Trace some 'info' informations. The message MUST BE one of the predefined
   * in the property files. To add some extra infos, use the function with the
   * 4th parameter : extraInfos
   * 
   * 
   * @param module
   *          the module name (ex : root, bus, outlook, ...)
   ...
   *          "MyFavoriteClass.myFunction()")
   * @param messageID
   *          the name of the message to display (ex :
   *          "root.MSG_GEN_FILE_NOT_FOUND")
   * 
   */
  ...
  /**
   * Trace some 'info' informations. The message MUST BE one of the predefined
   * in the property files. This function have one extra parameter : extraInfos
   * to add additional informations
   * 
   * 
   * @param module
   *          the module name (ex : root, bus, outlook, ...)
  ...
  /**
   * Trace some 'info' informations. The message MUST BE one of the predefined
   * in the property files. This function have one extra parameters : ex to
  ...
  /**
   * Trace some 'info' informations. The message MUST BE one of the predefined
   * in the property files. This function have two extra parameters : extraInfos
   * to add additional informations ex to display an exception
   * 
   * 
   * @param module
   *          the module name (ex : root, bus, outlook, ...)
  ...
  /**
   * Trace some 'warning' informations. The message MUST BE one of the
   * predefined in the property files. To add some extra infos, use the function
   * with the 4th parameter : extraInfos
   * 
   * 
   * @param module
   *          the module name (ex : root, bus, outlook, ...)
  ...
  /**
   * Trace some 'warning' informations. The message MUST BE one of the
   * predefined in the property files. This function have one extra parameter :
  ...
  /**
   * Trace some 'warning' informations. The message MUST BE one of the
   * predefined in the property files. This function have one extra parameters :
  ...
  /**
   * Trace some 'warning' informations. The message MUST BE one of the
   * predefined in the property files. This function have two extra parameters :
   * extraInfos to add additional informations ex to display an exception
   * 
   * 
   * @param module
   *          the module name (ex : root, bus, outlook, ...)
  ...
  /**
   * Trace some 'error' informations. The message MUST BE one of the predefined
   * in the property files. To add some extra infos, use the function with the
   * 4th parameter : extraInfos
   * 
   * 
  ...
  /**
   * Trace some 'fatal error' informations. The message MUST BE one of the
   * predefined in the property files. To add some extra infos, use the function
   * with the 4th parameter : extraInfos
   * 
   * 
  ...
  /**
   * Trace some actions (create, delete, update) done by a user on an object of
   * an instance in a space.
   * 
   * 
   * @param module
   *          the module name (ex : root, bus, outlook, ...)
   ...
   * @param instanceId
   * @param objectId
   *          the object (ex. publication) which is created, deleted ou updated.
   * @param userId
   *          the user who has created, deleted or updated.
   * @param actionId
   *          One of the constants SPY_ACTION_CREATE, SPY_ACTION_DELETE,
   *          SPY_ACTION_UPDATE.
   * 
   */
  ...
  /**
   * Set the minimum trace level of a module. All traces less than val will not
  ...
  /**
   * Get the trace level of a module. Depending on the value of chained, it
   * could ask for the inherited trace levels or not.
   * 
   * 
   * @param module
   *          the module name (ex : root, bus, outlook, ...)
   * @param chained
   *          if false : return a trace level only if the module have been set
   *          with one. Else, return TRACE_LEVEL_UNKNOWN. If true, look for the
   *          inherited trace level.
   * 
   * @return the trace level of the module or TRACE_LEVEL_UNKNOWN if the module
   *         was not found
   * 
   */
  ...
  /**
   * Add a new console appender to the module. If an appender with the same type
   * have been previously set, delete it and replace it with the new created
   * one.
   * 
   * 
   * @param module
  ...
  /**
   * Add a new file appender to the module. If an appender with the same type
   * have been previously set, delete it and replace it with the new created
   * one.
   * 
   * 
  ...
  /**
   * Add a new rolling file appender to the module. If an appender with the same
   * type have been previously set, delete it and replace it with the new
   * created one.
   * 
   * 
   * @param module
  ...
  /**
   * Add a new mail appender to the module. If an appender with the same type
   * have been previously set, delete it and replace it with the new created
   * one. How it works : mails are only sent when an ERROR or FATAL occur. The
   * mail contains the error and the 512 last traces taken into account (ie,
   * higher than the trace level).
   * 
   * 
   * @param module
   *          the module name (ex : root, bus, outlook, ...)
  ...
  /**
   * Remove appender(s) attached to a module. typeOfAppender could be one value
   * or a mask of multiple appender types
   * 
   * 
   * @param module
   *          the module name (ex : root, bus, outlook, ...)
  ...
  /**
   * The purpose of this function is just to return the list of available
   * modules to the JSP - Exploitation page This function is subject to change
   * and SHOULD NOT BE USED by any other page or java class...
   * 
   * 
   * @return The list of the modules with pairs (<module name>,<log4j-path to
   *         this module>)
   */
  ...
  /**
   * The purpose of this function is just to return the available appenders for
   * the JSP - Exploitation page This function is subject to change and SHOULD
   * NOT BE USED by any other page or java class...
   * 
   * 
   * @param module
   *          the module name (ex : root, bus, outlook, ...)
   * 
   * @return a mask of the appenders set to this module (not containing the
   *         herited ones)
   */
  ...
  /**
   * The purpose of this function is just to return informations about an
   * appender for the JSP - Exploitation page This function is subject to change
   * and SHOULD NOT BE USED by any other page or java class...
   * 
   * 
   * @param module
   ...
   * 
   * @return A set of properties discribing the attached appender or null if
   *         there is no such appender attached to this module
   */
  ...
  /**
   * Returns the message corresponding to the MessageId in the SilverTrace
   * default language
   * 
   * @param messageId
  ...
  static protected Category getCategory(String module, String classToAppend) {
    ...
    if (modulePath == null) {
      ...
      /*
       * FOR THE MOMENT, GO TO THE MODULES' LEVEL (level 3) if
       * (MsgTrace.stringValid(classToAppend)) { return
       * Category.getInstance(modulePath + "." + classToAppend); } else { return
