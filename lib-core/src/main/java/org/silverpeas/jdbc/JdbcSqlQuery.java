...
import static org.silverpeas.jdbc.JdbcSqlExecutorProvider.getJdbcSqlExecutor;
...
public class JdbcSqlQuery {
  ...
  /**
   * Centralization in order to populate the prepare statement parameters (FOR TABLE CREATION
   * ONLY).
