 ...
 */
package org.silverpeas.io.excepion;
 ...
 */
public class IOFileHandlerException extends SilverpeasRuntimeException {
   ...
   * @param message
   */
  public IOFileHandlerException(final String message) {
