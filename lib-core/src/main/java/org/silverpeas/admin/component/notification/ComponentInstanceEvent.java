...
public class ComponentInstanceEvent extends AbstractResourceEvent<ComponentInst> {
   ...
   * @param type the type of component instance life-cycle event (creation, update or deletion).
   * @param componentInst the component instance related by the event.
   */
  public ComponentInstanceEvent(final ResourceEvent.Type type, final ComponentInst componentInst) {
