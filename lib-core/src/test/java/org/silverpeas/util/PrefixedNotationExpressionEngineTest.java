...
public class PrefixedNotationExpressionEngineTest {
  ...
  private static PrefixedNotationExpressionEngine.OperatorFunction<Integer> add =
      new PrefixedNotationExpressionEngine.OperatorFunction<Integer>("+",
          new BiFunction<Integer, Integer, Integer>() {
            @Override
            public Integer apply(final Integer initial, final Integer value) {
              return initial == null ? value : (initial + value);
            }
          });
  ...
  private static PrefixedNotationExpressionEngine.OperatorFunction<Integer> multiply =
      new PrefixedNotationExpressionEngine.OperatorFunction<Integer>("multiply",
          new BiFunction<Integer, Integer, Integer>() {
            @Override
            public Integer apply(final Integer initial, final Integer value) {
              return initial == null ? value : (initial * value);
  ...
  private final static PrefixedNotationExpressionEngine<Integer> engine =
      PrefixedNotationExpressionEngine.from(new Function<String, Integer>() {
        @Override
        public Integer apply(final String s) {
          if (StringUtil.isNotDefined(s)) {
            return null;
          }
          return Integer.parseInt(StringUtil.defaultStringIfNotDefined(s, "0"));
        }
