...
package com.stratelia.webactiv.searchEngine;
...
public class TestDidYouMeanSearcher {
  ...
  public static void setUpBeforeClass() throws Exception {
    ...
    File fileSrc =
        ...
        File.separatorChar +
        "resources" + File.separatorChar + "index" + File.separatorChar + "kmelia2");
   ...
   */
  @Test
  public final void testSuggest() throws com.stratelia.webactiv.searchEngine.model.ParseException {

    DidYouMeanSearcher searcher = new DidYouMeanSearcher();

    QueryDescription query =
        new QueryDescription("\"la pierre coche\"  NOT présentation  jana OR jacq");
