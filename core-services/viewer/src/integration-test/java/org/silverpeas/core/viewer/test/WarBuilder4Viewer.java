...
package org.silverpeas.core.viewer.test;
 ...
 */
public class WarBuilder4Viewer extends BasicWarBuilder {
   ...
   */
  public static <T> WarBuilder4Viewer onWarForTestClass(Class<T> test) {
    return new WarBuilder4Viewer(test);
  }
}
