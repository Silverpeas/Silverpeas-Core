...
public class InterestsDAOException extends SilverpeasException {
  ...
  public InterestsDAOException(String callingClass, String message) {
    super(callingClass, ERROR, message);
  }

  public InterestsDAOException(String callingClass, String message, String extraParams) {
    super(callingClass, ERROR, message, extraParams);
  }

  public InterestsDAOException(String callingClass, String message, Exception nested) {
