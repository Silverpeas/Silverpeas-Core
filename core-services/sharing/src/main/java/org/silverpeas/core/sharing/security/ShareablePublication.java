...
*/
public class ShareablePublication extends ShareableResource<PublicationDetail> {

  public ShareablePublication(String token, PublicationDetail accessedObject) {
