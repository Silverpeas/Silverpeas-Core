 ...
 * @author silveryocha
 */
public class ToIncumbentReplacementNotificationBuilder
   ...
   */
  ToIncumbentReplacementNotificationBuilder(final Replacement resource, final NotifAction action) {
    super(resource, action);
  }

  @Override
  protected Collection<String> getUserIdsToNotify() {
    return Collections.singletonList(getResource().getIncumbent().getUserId());
  }
  ...
  protected void performTemplateData(final String language, final Replacement resource,
    ...
    template.setAttribute("toIncumbent", true);
  }
}
