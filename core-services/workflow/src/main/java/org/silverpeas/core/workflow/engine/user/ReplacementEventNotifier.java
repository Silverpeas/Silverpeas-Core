...
/**
 * Notifier of events on the replacements of users in a given workflow. The notifier gives
...
public class ReplacementEventNotifier
  ...
  private ReplacementEventNotifier() {
  }

  @Override
  protected ReplacementEvent createResourceEventFrom(final ResourceEvent.Type type,
      final Replacement... states) {
    return new ReplacementEvent(type, states);
  }
}
