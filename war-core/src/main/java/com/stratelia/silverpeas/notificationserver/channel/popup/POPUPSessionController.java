...
public class POPUPSessionController extends AbstractComponentSessionController
{
    ...
    {
        super(mainSessionCtrl, context, "com.silverpeas.notificationserver.channel.popup.multilang.popup", "com.silverpeas.notificationserver.channel.popup.settings.popupIcons");
