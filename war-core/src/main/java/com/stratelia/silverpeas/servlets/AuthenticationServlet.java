...
public class AuthenticationServlet extends HttpServlet {
  ...
  public void doPost(HttpServletRequest request, HttpServletResponse response)
    ...
    boolean cookieEnabled = SilverpeasSettings.readBoolean(
        authenticationSettings, "cookieEnabled", false);
    ...
    if (isNewEncryptMode) {
      ...
      sDecodedPassword = ((sCryptedPassword == null || sCryptedPassword
          .length() == 0) ? decode(sPassword, stringKey, false) : decode(
          sPassword, stringKey, true));
      if (cookieEnabled) {
  ...
  private String convert2Alpha(String toConvert) {
    ...
    // "AuthenticationServlet.convert2Alpha()",
    // "root.MSG_GEN_ENTER_METHOD","alphaString="+alphaString);
    return alphaString;
  }
