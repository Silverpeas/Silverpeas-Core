...
abstract public class BrowsePanelProvider extends PanelProvider
{
    ...
    public BrowsePanelProvider(String language, ResourceLocator rs, CacheManager cm, int what)
    {
        // Set the language
        m_Language = language;
    ...
    public void setSelectedElements(Set elements)
    {
        ...
        for (i = 0; i < max; i++ )
        {
            m_Cm.setSelected(m_what,m_Ids[m_FirstDisplayed + i], elements.contains(m_Ids[m_FirstDisplayed + i]));
        }
    }
