...
public class PubliPieChartBuilder extends AbstractPieChartBuilder 
{
	...
	public PubliPieChartBuilder(String dateStat, String dateFormate, String currentUserId, String filterIdGroup, String filterIdUser, String spaceId, OrganizationController organizationController, ResourceLocator message)
	{
	...
	public String getChartTitle() 
	{
		...
		try {
			...
			SilverTrace.error("silverStatisticsPeas", "PubliPieChartBuilder.getChartTitle()", "root.EX_SQL_QUERY_FAILED", e);
		}
	...
	Hashtable getCmpStats() 
	{
		...
		try 
		{
			cmpStats.putAll( SilverStatisticsPeasDAOAccesVolume.getStatsPublicationsVentil(dateStat, currentUserId, filterIdGroup, filterIdUser) );
		} 
		catch (SQLException e) 
		{
			SilverTrace.error("silverStatisticsPeas", "PubliPieChartBuilder.getCmpStats()", "root.EX_SQL_QUERY_FAILED", e);
		}
		return cmpStats;
	}
