...
public class ChartUtil 
{
	 ...
	 */
	public static AxisChart buildBarAxisChart(String xAxisTitle, String yAxisTitle, String title, String[] xAxisLabels, double[] values) throws ChartDataException 
	{
		...
		axisProperties.getXAxisProperties().setAxisTitleChartFont(new ChartFont(new Font("Arial", Font.BOLD, 13), Color.black));
		axisProperties.getYAxisProperties().setAxisTitleChartFont(new ChartFont(new Font("Arial", Font.BOLD, 13), Color.black));
	 ...
	 * @throws ChartDataException
	 */
	public static AxisChart buildLineAxisChart(String xAxisTitle, String yAxisTitle, String title, String[] xAxisLabels, double[] values) throws ChartDataException 
	{
		DataSeries dataSeries = new DataSeries( xAxisLabels, 
		                                        xAxisTitle, 
		                                        yAxisTitle,
		...
		if(values.length > 0) {
			...
			String[] legendLabels = { "Bugs" };
			LineChartProperties lineChartProperties = new LineChartProperties(new Stroke[] {PointChartProperties.DEFAULT_POINT_BORDER_STROKE}, new Shape[] {PointChartProperties.SHAPE_CIRCLE});
			Paint[] paints = getRandomPaints(1);
			AxisChartDataSet axisChartDataSet = new AxisChartDataSet( data, 
			                                     legendLabels, 
			                                     paints, 
	...
	public static PieChart2D buildPieChart(String title, double[] data, String[] legendLabels) throws ChartDataException 
	{
		...
		pieChart2DProperties.setValueLabelFont(new ChartFont(new Font("Arial", Font.PLAIN, 10), Color.black));
