...
public class SilverStatisticsPeasSessionController extends AbstractComponentSessionController
{
    ...
    private void initYears()
    {
        ...
        {
            SilverTrace.error("silverStatisticsPeas", "SilverStatisticsPeasDAOConnexion.getYears", "root.EX_SQL_QUERY_FAILED", e);
        }

        try
        {
            yearsAccess = SilverStatisticsPeasDAOAccesVolume.getYears(SilverStatisticsPeasDAOAccesVolume.TYPE_ACCES);
        }
        catch (Exception e)
        {
            SilverTrace.error("silverStatisticsPeas", "SilverStatisticsPeasDAOAccesVolume.getYears", "root.EX_SQL_QUERY_FAILED", e);
        }

        try
        {
            yearsVolume = SilverStatisticsPeasDAOAccesVolume.getYears(SilverStatisticsPeasDAOAccesVolume.TYPE_VOLUME);
        }
        catch (Exception e)
        {
            SilverTrace.error("silverStatisticsPeas", "SilverStatisticsPeasDAOAccesVolume.getYears", "root.EX_SQL_QUERY_FAILED", e);
    ...
    {
        super(mainSessionCtrl, componentContext, "com.stratelia.silverpeas.silverStatisticsPeas.multilang.silverStatisticsBundle", "com.stratelia.silverpeas.silverStatisticsPeas.settings.silverStatisticsIcons");
    ...
    {
        SilverTrace.info("silverStatisticsPeas", "SilverStatisticsPeasSessionController.getUserProfile()", "root.MSG_GEN_ENTER_METHOD");
        String userProfile = getUserDetail().getAccessLevel();
        AdminController ac = new AdminController(getUserId());
    	if( !userProfile.equals("A") && ac.getUserManageableSpaceRootIds(getUserId()) != null)
        {
            userProfile = SPACE_ADMIN;
        }
        SilverTrace.info("silverStatisticsPeas", "SilverStatisticsPeasSessionController.getUserProfile()", "root.MSG_GEN_PARAM_VALUE", "userProfile=" + userProfile);
        return userProfile;
    }
    ...
    public Collection getStatsConnexionAllAll(String dateBegin, String dateEnd)
    {
        ...
        {
            SilverTrace.error("silverStatisticsPeas", "SilverStatisticsPeasSessionController.getStatsConnexionAllAll()", "root.EX_SQL_QUERY_FAILED", e);
        }
        return c;
    }
	...
	{//date au format AAAA-MM-JJ -> Mois AAAA
		String dateFormate = "";
	 ...
	 * @return
	 */
	public AxisChart getDistinctUserConnectionsChart(String dateBegin, String dateEnd) 
	{
		AxisChart axisChart = null;
		try 
		{
			
			Collection[] statsUsers = SilverStatisticsPeasDAOConnexion.getStatsUser(dateBegin, dateEnd); // new Collection[]{dates, counts};
			...
			if(	"04".equals(mois) ||
				"08".equals(mois) ||
				"10".equals(mois)) {//Avril, Aout, Octobre
			...
			axisChart = ChartUtil.buildBarAxisChart(generalMessage.getString("GML.date"),
													generalMessage.getString("GML.users"),
													title,
													dates, 
		...
		{
			SilverTrace.error("silverStatisticsPeas", "SilverStatisticsPeasSessionController.getDistinctUserConnectionsChart()", "root.EX_SQL_QUERY_FAILED", se);
		}
	...
	public AxisChart getUserConnectionsChart(String dateBegin, String dateEnd) 
	{
		...
		try 
		{
			Collection[] statsConnection = SilverStatisticsPeasDAOConnexion.getStatsConnexion(dateBegin, dateEnd);
			Collection listDate = statsConnection[0];
			Iterator itDates = listDate.iterator();
			String[] dates = new String[statsConnection[0].size()]; //au format MM-AAAA
			String date;
			String annee;
			String mois;
			int i = 0;
			...
			axisChart = ChartUtil.buildBarAxisChart(generalMessage.getString("GML.date"),
													this.getString("silverStatisticsPeas.Connections"),
													title,
													dates, 
		...
		{
			SilverTrace.error("silverStatisticsPeas", "SilverStatisticsPeasSessionController.getUserConnectionsChart()", "root.EX_SQL_QUERY_FAILED", se);
		}
    ...
    public Collection getStatsConnexionAllUser(String dateBegin, String dateEnd, String idUser)
    {
        Collection c = null;
        try
        {
            c = SilverStatisticsPeasDAOConnexion.getStatsConnexionAllUser(dateBegin, dateEnd, Integer.parseInt(idUser));
        }
        catch (Exception e)
        {
            SilverTrace.error("silverStatisticsPeas", "SilverStatisticsPeasDAOConnexion.getStatsConnexionAllUser", "root.EX_SQL_QUERY_FAILED", e);
        }
        return c;
    }
	 ...
	 * @return
	 */
	public AxisChart getUserConnectionsUserChart(String dateBegin, String dateEnd, String idUser) 
	{
		AxisChart axisChart = null;
		try 
		{
			...
			Collection[] statsConnection = SilverStatisticsPeasDAOConnexion.getStatsUserConnexion(dateBegin, dateEnd, idUser);
			Collection listDate = statsConnection[0];
			Iterator itDates = listDate.iterator();
			String[] dates = new String[statsConnection[0].size()]; //au format MM-AAAA
			String date;
			...
			//title
			String title = this.getString("silverStatisticsPeas.LoginNumber")+" "+this.getString("silverStatisticsPeas.OfUser")+" "+lastName+" ";
			mois = dateBegin.substring(5, 7);
			if(	"04".equals(mois) ||
				"08".equals(mois) ||
				"10".equals(mois)) {//Avril, Aout, Octobre
		...
		{
			SilverTrace.error("silverStatisticsPeas", "SilverStatisticsPeasSessionController.getUserConnectionsUserChart()", "root.EX_SQL_QUERY_FAILED", se);
		}
    ...
    public Collection getStatsConnexionAllGroup(String dateBegin, String dateEnd, String idGroup)
    {
        Collection c = null;
        try
        {
            c = SilverStatisticsPeasDAOConnexion.getStatsConnexionAllGroup(dateBegin, dateEnd, Integer.parseInt(idGroup));
        }
        catch (Exception e)
        {
            SilverTrace.error("silverStatisticsPeas", "SilverStatisticsPeasSessionController.getStatsConnexionAllGroup()", "root.EX_SQL_QUERY_FAILED", e);
        }
        return c;
    }
	...
	public AxisChart getUserConnectionsGroupChart(String dateBegin, String dateEnd, String idGroup) 
	{
		...
		try 
		{
			Collection[] statsConnection = SilverStatisticsPeasDAOConnexion.getStatsGroupConnexion(dateBegin, dateEnd, idGroup);
			Collection listDate = statsConnection[0];
			Iterator itDates = listDate.iterator();
			String[] dates = new String[statsConnection[0].size()]; //au format MM-AAAA
			String date;
			...
			//title
			String title = this.getString("silverStatisticsPeas.LoginNumber")+" "+this.getString("silverStatisticsPeas.OfGroup")+" "+admin.getGroupName(idGroup)+" ";
			mois = dateBegin.substring(5, 7);
			if(	"04".equals(mois) ||
				"08".equals(mois) ||
				"10".equals(mois)) {//Avril, Aout, Octobre
		...
		{
			SilverTrace.error("silverStatisticsPeas", "SilverStatisticsPeasSessionController.getUserConnectionsGroupChart()", "root.EX_SQL_QUERY_FAILED", se);
		}
    ...
    // donne pour chaque groupe ses stats cad 3 infos par groupe, la collection contient auant d'elements que de groupes
    public Collection getStatsConnexionGroupAll(String dateBegin, String dateEnd)
    {
        ...
        {
            SilverTrace.error("silverStatisticsPeas", "SilverStatisticsPeasDAOConnexion.getStatsConnexionGroupAll", "root.EX_SQL_QUERY_FAILED", e);
        }
        return c;
    }

    // donne pour un chaque groupe d'un user les stats cad 3 infos par groupe, la collection contient autant d'elements
    // que de groupes dont le user fait parti
    public Collection getStatsConnexionGroupUser(String dateBegin, String dateEnd, String idUser)
    {
        Collection c = null;
        try
        {
            c = SilverStatisticsPeasDAOConnexion.getStatsConnexionGroupUser(dateBegin, dateEnd, Integer.parseInt(idUser));
        }
        catch (Exception e)
        {
            SilverTrace.error("silverStatisticsPeas", "SilverStatisticsPeasDAOConnexion.getStatsConnexionGroupUser", "root.EX_SQL_QUERY_FAILED", e);
        }
        return c;
    }

    // donne pour chaque user ses stats, cad 3 infos, la collection contient autant d'elements que de users
    public Collection getStatsConnexionUserAll(String dateBegin, String dateEnd)
    {
        ...
        {
            SilverTrace.error("silverStatisticsPeas", "SilverStatisticsPeasDAOConnexion.getStatsConnexionUserAll", "root.EX_SQL_QUERY_FAILED", e);
        }
        return c;
    }

    // donne pour chaque user d'un groupe ses stats, cad 3 infos, la collection contient autant d'elements que de users dans le groupe
    public Collection getStatsConnexionUserUser(String dateBegin, String dateEnd, String idUser)
    {
        Collection c = null;
        try
        {
            c = SilverStatisticsPeasDAOConnexion.getStatsConnexionUserUser(dateBegin, dateEnd, Integer.parseInt(idUser));
        }
        catch (Exception e)
        {
            SilverTrace.error("silverStatisticsPeas", "SilverStatisticsPeasDAOConnexion.getStatsConnexionUserUser", "root.EX_SQL_QUERY_FAILED", e);
        }
        return c;
    }
    ...
    public void notifySession(String userId, String message)
    {
        ...
        {
            SilverTrace.error("silverStatisticsPeas", "SilverStatisticsPeasSessionController.NotifySession", "root.EX_SQL_QUERY_FAILED", ex);
        }
    }
    ...
    public void notifyAllSessions(Collection listUserDetail, String message)
    {
    	...
    	if (listUserDetail != null)
    	{
    		...
    		while (itListUserDetail.hasNext()) {
				...
				if (!notifiedUsers.contains(sessionInfo.m_User.getId()) || sessionInfo.m_User.isAccessGuest())
				{
	...
	*/
	public void retourUserPanel()
    {
        ...
        SilverTrace.debug("silverStatisticsPeas", "SilverStatisticsPeasSessionController.retourUserPanel()", "filterType="+filterType);
        SilverTrace.debug("silverStatisticsPeas", "SilverStatisticsPeasSessionController.retourUserPanel()", "filterId="+filterId);
	}
	 ...
	 * @return
	 */
	public AxisChart getUserConnectionsFqChart(String dateBegin, String dateEnd, String statDetail) 
	{
		AxisChart axisChart = null;
		try 
		{
			...
			Collection[] statsUsersFq = SilverStatisticsPeasDAOConnexion.getStatsUserFq(dateBegin, dateEnd, minFreq, maxFreq);
			...
			//title
			String title = this.getString("silverStatisticsPeas.ConnectionNumberOfDistinctUsers")+" ";
			title += this.getString("silverStatisticsPeas.From")+" "+minFreq+" "+this.getString("silverStatisticsPeas.To")+" "+maxFreq+" "+this.getString("silverStatisticsPeas.Times")+" ";
			...
			axisChart = ChartUtil.buildBarAxisChart(generalMessage.getString("GML.date"),
													...
													title,
													dates, 
													buildDoubleArrayFromStringCollection(statsUsersFq[1])
											   );
		...
		{
			SilverTrace.error("silverStatisticsPeas", "SilverStatisticsPeasSessionController.getUserConnectionsFqChart()", "root.EX_SQL_QUERY_FAILED", se);
		}
    ...
    {
        Selection sel = communInitUserPanel("AccessCallUserPanelGroup", "AccessReturnFromUserPanelGroup");
	...
	*/
	public void retourAccessUserPanelGroup()
    {
        ...
        SilverTrace.debug("silverStatisticsPeas", "SilverStatisticsPeasSessionController.retourAccessUserPanelGroup()", "accessFilterIdGroup="+accessFilterIdGroup);
	}
	...
	*/
	public void retourAccessUserPanelUser()
    {
        ...
        SilverTrace.debug("silverStatisticsPeas", "SilverStatisticsPeasSessionController.retourAccessUserPanelUser()", "accessFilterIdUser="+accessFilterIdUser);
	}

	public String initVolumeUserPanelGroup()
    {
        Selection sel = communInitUserPanel("VolumeCallUserPanelGroup", "VolumeReturnFromUserPanelGroup");
        sel.setElementSelectable(false);
        return Selection.getSelectionURL(Selection.TYPE_USERS_GROUPS);
	}
	...
	*/
	 ...
	 * @return
	 */
	public PieChart2D getUserVentilChart(String dateStat, String filterIdGroup, String filterIdUser, String spaceId) 
	{
		UserPieChartBuilder userBuilder = new UserPieChartBuilder(dateStat, formatDate(dateStat), getUserId(), filterIdGroup, filterIdUser, spaceId, this.getMultilang(), getOrganizationController());
		resetPath(spaceId);
	 ...
	 * @return
	 */
	public AxisChart getEvolutionUserChart(String entite, String entiteId, String filterLibGroup, String filterIdGroup, String filterLibUser, String filterIdUser) 
	{
		AxisChart axisChart = null;
		try 
		{
			currentStats.clear();
			Collection statsUserAccess = SilverStatisticsPeasDAOAccesVolume.getStatsUserEvolution(entite, entiteId, filterIdGroup, filterIdUser);
			...
			if("SPACE".equals(entite)) {
				...
				if (!filterIdGroup.equals("") && filterIdUser.equals("")) {
					title += " "+this.getString("silverStatisticsPeas.EvolutionAccessGroup")+" "+filterLibGroup;
				}
				if (!filterIdUser.equals("")) {
					title += " "+this.getString("silverStatisticsPeas.EvolutionAccessUser")+" "+filterLibUser;
				}
				title += " "+this.getString("silverStatisticsPeas.EvolutionAccessSpace") + " ["+space.getName()+"]";
			} else {//CMP
				...
				title += " "+this.getString("silverStatisticsPeas.EvolutionAccessService") + " "+cmp.getLabel();
			}

			axisChart = ChartUtil.buildLineAxisChart(generalMessage.getString("GML.date"),
													this.getString("silverStatisticsPeas.Access"),
													title,
													dates, 
													nbAccess
											   );
		...
		{
			SilverTrace.error("silverStatisticsPeas", "SilverStatisticsPeasSessionController.getEvolutionUserChart()", "root.EX_SQL_QUERY_FAILED", se);
		}
	...
	public PieChart2D getVolumeServicesChart() 
	{
		...
		try 
		{
			Collection[] statsKMsInstances = SilverStatisticsPeasDAOVolumeServices.getStatsInstancesServices();
		...
		{
			SilverTrace.error("silverStatisticsPeas", "SilverStatisticsPeasSessionController.getVolumeServicesChart()", "root.EX_SQL_QUERY_FAILED", se);
		}
	 ...
	 * @return
	 */
	public PieChart2D getPubliVentilChart(String dateStat, String filterIdGroup, String filterIdUser, String spaceId) 
	{
		PubliPieChartBuilder publiBuilder = new PubliPieChartBuilder(dateStat, formatDate(dateStat), getUserId(), filterIdGroup, filterIdUser, spaceId, getOrganizationController(), this.getMultilang());
		resetPath(spaceId);
	...
	{
		DocPieChartBuilder userBuilder = new DocPieChartBuilder(getUserId(), spaceId, this.getMultilang());
		resetPath(spaceId);
		return userBuilder.getChart(spaceId, getUserId(), currentStats);
	}
	...
	{
		DocSizePieChartBuilder userBuilder = new DocSizePieChartBuilder(getUserId(), spaceId, this.getMultilang());
		resetPath(spaceId);
		return userBuilder.getChart(spaceId, getUserId(), currentStats);
	}
	...
	public AxisChart getEvolutionDocsSizeChart() 
	{
		...
		{
			currentStats.clear();
			Collection statsDocsSize = SilverStatisticsPeasDAOVolumeServer.getStatsVolumeServer();
			...
			axisChart = ChartUtil.buildLineAxisChart(generalMessage.getString("GML.date"),
													generalMessage.getString("GML.size")+" (Mo)",
													this.getString("silverStatisticsPeas.EvolutionAttachmentsTotalSize"),
													dates, 
													size
											   );
		...
		{
			SilverTrace.error("silverStatisticsPeas", "SilverStatisticsPeasSessionController.getEvolutionDocsSizeChart()", "root.EX_SQL_QUERY_FAILED", se);
		}
    ...
    private Collection getYear(String yearValue, Collection years)
    {
        ...
        SilverTrace.debug("silverStatisticsPeas", "SilverStatisticsPeasSessionController.getYear()", "yearValue="+yearValue);
    ...
    public Collection getMonth(String monthValue)
    {
        ...
        SilverTrace.debug("silverStatisticsPeas", "SilverStatisticsPeasSessionController.getMonth()", "monthValue="+monthValue);
        for (int i=0; i<12 ; i++)
        {
            stat = new String[2];
