...
public class DocPieChartBuilder extends AbstractPieChartBuilder {
  ...
  public String getChartTitle() {
    ...
    try {
      ...
      SilverTrace.error("silverStatisticsPeas",
          "DocPieChartBuilder.getChartTitle()", "root.EX_SQL_QUERY_FAILED", e);
    }
  ...
  public Hashtable<String, String[]> getCmpStats() {
    ...
    try {
      ...
      cmpStats.putAll(SilverStatisticsPeasDAOVolumeServer
          .getStatsVersionnedAttachmentsVentil(this.currentUserId));
    } catch (SQLException e) {
      SilverTrace.error("silverStatisticsPeas",
          "DocPieChartBuilder.getCmpStats()", "root.EX_SQL_QUERY_FAILED", e);
    }
