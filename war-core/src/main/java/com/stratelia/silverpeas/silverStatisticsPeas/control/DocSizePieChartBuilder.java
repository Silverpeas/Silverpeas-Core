...
public class DocSizePieChartBuilder extends AbstractPieChartBuilder 
{
	...
	public String getChartTitle() 
	{
		...
		try {
			...
			SilverTrace.error("silverStatisticsPeas", "DocSizePieChartBuilder.getChartTitle()", "root.EX_SQL_QUERY_FAILED", e);
		}
	...
	Hashtable getCmpStats() 
	{
		...
		try 
		{
			cmpStats.putAll( SilverStatisticsPeasDAOVolumeServer.getStatsAttachmentsSizeVentil(this.currentUserId));
			cmpStats.putAll( SilverStatisticsPeasDAOVolumeServer.getStatsVersionnedAttachmentsSizeVentil(this.currentUserId));
		} 
		catch (SQLException e) 
		{
			SilverTrace.error("silverStatisticsPeas", "DocSizePieChartBuilder.getCmpStats()", "root.EX_SQL_QUERY_FAILED", e);
		}
