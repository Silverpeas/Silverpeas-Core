...
public class MyLinksPeasSessionController extends AbstractComponentSessionController
{
	...
	{
		super(mainSessionCtrl, componentContext,  "com.silverpeas.mylinks.multilang.myLinksBundle", "com.silverpeas.mylinks.settings.myLinksIcons");
	}
	...
	public LinkDetail getLink(String linkId) 
	{
		...
		try
		{
			...
			SilverTrace.debug(
					"myLinks",
					"MyLinksPeasSessionController.getLink()",
					"root.MSG_GEN_PARAM_VALUE",
					"linkId = " + linkId);					
		}
		catch (Exception e)
	...
	public void createLink(LinkDetail link)
	{
		...
		try
		{
			...
			SilverTrace.debug(
					"myLinks",
					"MyLinksPeasSessionController.createLink()",
					"root.MSG_GEN_PARAM_VALUE",
					"liens = " + link.toString());	
		}
		catch (Exception e)
	...
	public void updateLink(LinkDetail link)
	{
		...
		catch (Exception e)
		{
			// traitement des exceptions
			throw new MyLinksRuntimeException(
					"MyLinksPeasSessionController.updateLink",
					SilverpeasException.ERROR, "root.EX_RECORD_NOT_FOUND", e);
		}
	}
	...
	public void deleteLinks(String[] links) 
	{
		try
		{
			...
			SilverTrace.debug(
					"myLinks",
					"MyLinksPeasSessionController.deleteLink()",
					"root.MSG_GEN_PARAM_VALUE",
	...
	private MyLinksBm getMyLinksBm()
	{
		...
		try
		{
			MyLinksBmHome myLinksBmHome = (MyLinksBmHome) EJBUtilitaire
					.getEJBObjectRef(JNDINames.MYLINKSBM_EJBHOME,
							MyLinksBmHome.class);
