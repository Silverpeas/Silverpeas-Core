...
public class PdcSubscriptionHelper {
  ...
  public static List<? extends Criteria> getCriteriasFromRequest(HttpServletRequest request) {
    String axisValueCouples = request.getParameter("AxisValueCouples");
    List<? extends Criteria> criteria = AxisValueCriterion.fromFlattenedAxisValues(
        axisValueCouples);
    return criteria;
  }
}
