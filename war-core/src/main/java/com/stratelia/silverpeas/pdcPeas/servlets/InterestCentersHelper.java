...
public class InterestCentersHelper {
	...
	public static String putSelectedInterestCenterId(HttpServletRequest request) throws Exception {
	...
	public static void loadICenter(PdcSearchSessionController pdcSC, String icId) throws Exception, PdcException {
        pdcSC.loadICenter(icId);
    }

	public static void processICenterSaving(PdcSearchSessionController pdcSC, HttpServletRequest request) throws Exception, PdcException {
	...
	private static java.util.Date getDate(String date, PdcSearchSessionController pdcSC) throws Exception {
		SilverTrace.info("pdcPeas", "InterestCentersHelper.getDate()", "root.MSG_GEN_PARAM_VALUE", "date= " + date);
        java.util.Date utilDate = null;
        if ((date != null) && (!date.equals(""))) {
            //java.text.SimpleDateFormat formatter = new java.text.SimpleDateFormat(pdcSC.getString("pdcPeas.DateFormat"));
