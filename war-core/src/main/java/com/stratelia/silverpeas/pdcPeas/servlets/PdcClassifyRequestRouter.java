...
public class PdcClassifyRequestRouter extends ComponentRequestRouter
{
    ...
    public String getDestination(String function, ComponentSessionController componentSC, HttpServletRequest request)
    {
		...
		PdcClassifySessionController pdcSC = (PdcClassifySessionController) componentSC; // get the session controller to inform the request
		try{
			...
			if (function.startsWith("Main")) {
				...
				request.setAttribute("ActiveThesaurus", new Boolean(pdcSC.getActiveThesaurus()));
				...
				PdcSearchSessionController pdcSearchSC = (PdcSearchSessionController) session.getAttribute("Silverpeas_pdcSearch_" + pdcSC.getCurrentComponentId());
				...
				switch (status) {
					case 1 : request.setAttribute("Position", position);
							 ...
							 destination = "/pdcPeas/jsp/positionAdd.jsp";
							 break;
					default : destination = "/pdcPeas/jsp/reload.jsp";
				}
			}
	...
	private void setBrowseContextInRequest(PdcClassifySessionController pdcSC, HttpServletRequest request) {
