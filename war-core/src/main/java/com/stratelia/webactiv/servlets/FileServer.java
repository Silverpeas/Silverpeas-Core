...
public class FileServer extends HttpServlet {
  ...
  public void doPost(HttpServletRequest req, HttpServletResponse res)
    ...
    if (tempFile != null) {
       ...
       * canonicalPath.indexOf("-1.html")); File indexFileName = new File(name +
       * "_ind.html"); File pureFileName = new File(name + ".html");
       * 
       * // delete indexFileName.delete(); pureFileName.delete(); // expurge
       * name = null; canonicalPath = null; }
       */
    }
