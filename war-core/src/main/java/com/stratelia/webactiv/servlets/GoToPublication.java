...
public class GoToPublication extends GoTo
{
	public String getDestination(String objectId, HttpServletRequest req, HttpServletResponse res) throws Exception
	{
		...
		String componentId	= req.getParameter("ComponentId");  //in case of an alias, componentId is given
		if (!StringUtil.isDefined(componentId))
		{
			componentId = pub.getPK().getInstanceId();
		}
        
        SilverTrace.info("peasUtil", "GoToPublication.doPost", "root.MSG_GEN_PARAM_VALUE", "componentId = "+componentId);
