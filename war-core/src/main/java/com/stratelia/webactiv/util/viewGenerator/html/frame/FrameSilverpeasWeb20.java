...
public class FrameSilverpeasWeb20 extends AbstractFrame
{
    ...
    public String printBefore()
    {
        ...
        {
            result += "<table cellpadding=0 cellspacing=0 border=0><tr><td><img src=\"" + iconsPath + "/1px.gif\" height=\"5\"></td></tr></table>\n";
        }
    ...
    public String printAfter()
    {
		...
		result += "\t\t</td>\n";
        result += "\t</tr>\n";
        result += "<tr><td><img src=\"" + iconsPath + "/1px.gif\" height=\"5\"></td></tr>\n";
        result += "</table>\n";
		result += "</td><td class=\"shadowFrame\" valign=\"top\"><img src=\"" + iconsPath + "/pxFond.gif\" width=\"2\" align=\"top\"></td>\n";
		result += "</tr><tr>\n";
		result += "<td class=\"shadowFrame\" width=\"100%\"><img src=\"" + iconsPath + "/pxFond.gif\" width=\"2\" align=\"left\"></td>\n";
		result += "<td class=\"shadowFrame\"><img src=\"" + iconsPath + "/1px.gif\"></td>\n";
		result += "</tr></table>\n";
        return result;
    }
