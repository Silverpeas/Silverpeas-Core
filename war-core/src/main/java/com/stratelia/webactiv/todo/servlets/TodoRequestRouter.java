...
public class TodoRequestRouter extends ComponentRequestRouter
{
	...
	public ComponentSessionController createComponentSessionController(MainSessionController mainSessionCtrl, ComponentContext context) {
		ComponentSessionController component = (ComponentSessionController) new ToDoSessionController(mainSessionCtrl, context);
		return component;
	}
    ...
    public String getDestination(String function, ComponentSessionController componentSC, HttpServletRequest request)
    {
        ...
        String destination = "";
      	...
      	try {        
	        ...
	        {
	            destination = "/todo/jsp/todoEdit.jsp?Action=Update&ToDoId=" + request.getParameter("Id");
	        }
        ...
        SilverTrace.info("todo", "TodoRequestRooter.getDestination()", "root.MSG_GEN_EXIT_METHOD");
        return destination;
    }
}
