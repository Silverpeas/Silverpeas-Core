...
public class ToDoAccess
{
	...
	static private CalendarBm getEJB() throws TodoException
	{
		if (calendarBm == null)
		{
			...
			{
				throw new TodoException("ToDoAccess.getEJB()", SilverpeasException.ERROR, "root.EX_CANT_GET_REMOTE_OBJECT", e);
			}
		}
		return calendarBm;
	}
     ...
     */
    static public Collection getNotCompletedToDos(String userId) throws TodoException
    {
        Collection result;
        ...
        {
            throw new TodoException("ToDoAccess.getNotCompletedToDos()", SilverpeasException.ERROR, "todo.MSG_CANT_GET_ENDED_TODOS", e);
        }
        SilverTrace.info("todo", "ToDoAccess.getNotCompletedToDos()", "root.MSG_GEN_EXIT_METHOD");
        return result;
    }
}