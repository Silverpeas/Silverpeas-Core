...
public class ToDoSessionController extends AbstractComponentSessionController
{
	...
	private void initEJB()
	{
		...
		{
			new TodoException("ToDoSessionControl.ToDoSessionControl()", SilverpeasException.ERROR, "root.EX_CANT_GET_REMOTE_OBJECT", e);
		}
	}
	...
	public Collection getNotCompletedToDos() throws TodoException
	{
		...
		SilverTrace.info("todo", "ToDoSessionController.getNotCompletedToDos()", "root.MSG_GEN_ENTER_METHOD");
		try
		{
		...
		catch (Exception e)
		{
			throw new TodoException(
				...
				"todo.MSG_CANT_GET_ENDED_TODOS",
				e);
		}
		SilverTrace.info("todo", "ToDoSessionController.getNotCompletedToDos()", "root.MSG_GEN_EXIT_METHOD");
		return result;
	}
	...
	{
		SilverTrace.info("todo", "ToDoSessionController.getOrganizerToDos()", "root.MSG_GEN_ENTER_METHOD");
		try
		{
			Collection result = calendarBm.getOrganizerToDos(getUserId());

			SilverTrace.info("todo", "ToDoSessionController.getOrganizerToDos()", "root.MSG_GEN_EXIT_METHOD");
			return result;
		}
		catch (Exception e)
		{
			throw new TodoException(
				...
				SilverpeasException.ERROR,
				"todo.MSG_CANT_GET_TODOS_ORGANIZER",
				e);
		}
	...
	public Collection getClosedToDos() throws TodoException
	{
		...
		try
		{
			...
			SilverTrace.info("todo", "ToDoSessionController.getClosedToDos()", "root.MSG_GEN_EXIT_METHOD");
			return result;
		}
		catch (Exception e)
		{
	...
	public ToDoHeader getToDoHeader(String todoId) throws TodoException
	{
		...
		{
			throw new TodoException("ToDoSessionController.getToDoHeader()", SilverpeasException.ERROR, "todo.MSG_CANT_GET_TODO_DETAIL", e);
		}
	}
		...
		throws TodoException
	{
		...
		{
			SilverTrace.warn("todo", "ToDoSessionController.updateToDo()", "todo.MSG_CANT_SET_TODO_PRIORITY");
		}
		try
		{
		...
		{
			SilverTrace.warn("todo", "ToDoSessionController.updateToDo()", "todo.MSG_CANT_SET_TODO_PERCENTCOMPLETED");
		}
		try
		{
		...
		{
			throw new TodoException("ToDoSessionController.updateToDo()", SilverpeasException.ERROR, "todo.MSG_CANT_UPDATE_TODO_DETAIL", e);
		}
	...
	{
		SilverTrace.info("todo", "ToDoSessionController.setToDoPercentCompleted()", "root.MSG_GEN_ENTER_METHOD");
		ToDoHeader todo = getToDoHeader(id);
		...
		{
			SilverTrace.warn("todo", "ToDoSessionController.setToDoPercentCompleted()", "todo.MSG_CANT_SET_TODO_PERCENTCOMPLETED");
		}

		try
		{
			calendarBm.updateToDo(todo);
			SilverTrace.info("todo", "ToDoSessionController.setToDoPercentCompleted()", "root.MSG_GEN_EXIT_METHOD");
		}
		catch (Exception e)
		{
			throw new TodoException(
	...
	protected void notifyAttendees(String id, String title, String text)
	{
		...
		{
			SilverTrace.error("todo", "ToDoSessionController.notifyAttendees()", "todo.MSG_CANT_SEND_MAIL");
		}
	}
	...
	public void closeToDo(String id) throws TodoException
	{
		...
		{
			throw new TodoException("ToDoSessionController.closeToDo()", SilverpeasException.ERROR, "todo.MSG_CANT_UPDATE_TODO_DETAIL", e);
		}

		notifyAttendees(id, "Cloture de la tache '" + todo.getName() + "'", "La tache intitulé '" + todo.getName() + "' a été cloturée.\n");
	...
	public void reopenToDo(String id) throws TodoException
	{
		...
		{
			throw new TodoException("ToDoSessionController.reopenToDo()", SilverpeasException.ERROR, "todo.MSG_CANT_UPDATE_TODO_DETAIL", e);
		}
	}
		...
		throws TodoException
	{
		...
		{
			SilverTrace.warn("todo", "ToDoSessionController.addToDo()", "todo.MSG_CANT_SET_TODO_PRIORITY");
		}
		try
		{
			todo.setPercentCompleted(new Integer(percent).intValue());
		...
		{
			SilverTrace.warn("todo", "ToDoSessionController.addToDo()", "todo.MSG_CANT_SET_TODO_PERCENTCOMPLETED");
		}
		try
		{
			todo.getClassification().setString(classification);
		...
		{
			throw new TodoException("ToDoSessionController.addToDo()", SilverpeasException.ERROR, "todo.MSG_CANT_ADD_TODO", e);
		}
	...
	public void removeToDo(String id) throws TodoException
	{
		...
		{
			throw new TodoException("ToDoSessionController.removeToDo()", SilverpeasException.ERROR, "todo.MSG_CANT_REMOVE_TODO", e);
		}
	}
	...
	public void indexAll() throws TodoException
	{
		...
		{
			throw new TodoException("ToDoSessionController.indexAll()", SilverpeasException.ERROR, "todo.MSG_CANT_INDEX_TODOS", e);
		}
	}
	...
	public Collection getToDoAttendees(String todoId) throws TodoException
	{
		...
		SilverTrace.info("todo", "ToDoSessionController.getToDoAttendees()", "root.MSG_GEN_ENTER_METHOD");
		try
		{
		...
		{
			throw new TodoException(
				"ToDoSessionController.getToDoAttendees()",
				SilverpeasException.ERROR,
				"todo.MSG_CANT_GET_TODO_ATTENDEES",
				e);
		}
		SilverTrace.info("todo", "ToDoSessionController.getToDoAttendees()", "root.MSG_GEN_EXIT_METHOD");
		return result;
	}
	...
	{
		SilverTrace.info("todo", "ToDoSessionController.setToDoAttendees()", "root.MSG_GEN_ENTER_METHOD");
		try
		{
			calendarBm.setToDoAttendees(todoId, userIds);
			SilverTrace.info("todo", "ToDoSessionController.setToDoAttendees()", "root.MSG_GEN_EXIT_METHOD");
		}
		catch (Exception e)
		{
			throw new TodoException(
	...
	public ResourceLocator getSettings()
	{
		if (settings == null)
		{
			settings = new ResourceLocator("com.stratelia.webactiv.todo.settings.todoSettings", "");
		}
		return settings;
	}
	...
	*/
	public String initSelectionPeas()
	{
		...
		PairObject hostComponentName = new PairObject(getString("todo"), m_context + "/Rtodo/jsp/Main");
		PairObject[] hostPath = new PairObject[1];
		hostPath[0] = new PairObject(getString("editionListeDiffusion"), m_context + "/Rtodo/jsp/Main");
