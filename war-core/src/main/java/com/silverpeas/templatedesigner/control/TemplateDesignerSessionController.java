...
public class TemplateDesignerSessionController extends AbstractComponentSessionController
{
	...
	{
		super(mainSessionCtrl, componentContext,  "com.silverpeas.templatedesigner.multilang.templateDesignerBundle", "com.silverpeas.templatedesigner.settings.templateDesignerIcons");
	}
	...
	public List getTemplates() throws TemplateDesignerException
	{
		try {
			...
			throw new TemplateDesignerException("TemplateDesignerSessionController.getTemplates", SilverpeasException.ERROR, "templateManager.GETTING_TEMPLATES_FAILED", e);
		}
	}
	...
	public PublicationTemplate setTemplate(String fileName) throws TemplateDesignerException
	{
		try {
			...
			throw new TemplateDesignerException("TemplateDesignerSessionController.getTemplate", SilverpeasException.ERROR, "templateManager.GETTING_TEMPLATE_FAILED", e);
		}
	}

	public void createTemplate(PublicationTemplate template) throws TemplateDesignerException
	{
	...
	public void updateTemplate(PublicationTemplateImpl updatedTemplate) throws TemplateDesignerException
	{
		...
		if (updatedTemplate.isSearchable())
    		this.template.setSearchFileName(getSubdir(template.getFileName())+File.separator+"search.xml");
    	else
    		this.template.setSearchFileName(null);
	...
	public void moveField(String fieldName, int direction) throws TemplateDesignerException
	{
		FieldTemplate field = getField(fieldName);
	...
	private void saveTemplateFields() throws TemplateDesignerException
	{
		try {
			...
			throw new TemplateDesignerException("TemplateDesignerSessionController.saveTemplate", SilverpeasException.ERROR, "templateManager.TEMPLATE_SAVING_FAILED", "template = "+template.getName(), e);
		}
	}
