...
public class MyTodosPortlet extends GenericPortlet implements FormNames {
	...
	public void doView(RenderRequest request, RenderResponse response) throws PortletException, IOException
	{
		...
		try {
			todos = (List) ToDoAccess.getNotCompletedToDos(m_MainSessionCtrl.getUserId());
    ...
    private void include(RenderRequest request, RenderResponse response, String pageName) throws PortletException 
    {
        ...
        try {
            PortletRequestDispatcher dispatcher = getPortletContext().getRequestDispatcher("/portlets/jsp/myTodos/"+pageName);
