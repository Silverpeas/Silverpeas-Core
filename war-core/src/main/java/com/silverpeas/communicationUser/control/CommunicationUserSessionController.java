...
public class CommunicationUserSessionController extends AbstractComponentSessionController
{
    ...
    {
    	//CBO : UPDATE
    	//super(mainSessionCtrl, componentContext,"com.silverpeas.communicationUser.multilang.communicationUserBundle");
    	super(mainSessionCtrl, componentContext,"com.silverpeas.communicationUser.multilang.communicationUserBundle", "com.silverpeas.communicationUser.settings.communicationUserIcons", "com.silverpeas.communicationUser.settings.communicationUserSettings");
    ...
    public void notifySession(String userId, String message)
    {
        ...
        {
            SilverTrace.error("communicationUser", "CommunicationUserSessionController.NotifySession", "root.EX_CANT_SEND_MESSAGE", ex);
        }
    }
    	...
    	if(m_PathDiscussions == null) {
    		...
    		if(m_PathDiscussions != null) {
    			try {
					...
					throw new CommunicationUserException("CommunicationUserSessionController.getPathDiscussions()", SilverpeasException.ERROR,
	...
	public File getExistingFileDiscussion(String userId) throws CommunicationUserException
    {
    	...
    	//serveur de fichiers : récupérer la discussion en cours entre ces 2 utilisateurs
    ...
    {
    	//serveur de fichiers : récupérer la discussion entre userId et currentUserId
    	if(getPathDiscussions() != null) {
    		try {
				Collection listFile = FileFolderManager.getAllFile(getPathDiscussions());
				...
				throw new CommunicationUserException("CommunicationUserSessionController.getExistingFileDiscussion()", SilverpeasException.ERROR,
						   "root.EX_NO_MESSAGE", e);
			}
    	}
    	return null;
    	...
    	if(getPathDiscussions() != null) {
    		try {
    		    ...
    		    if (directory.isDirectory()) {
		             ...
		             SilverTrace.error("communicationUser", "CommunicationUserSessionController.createDiscussion", "util.EX_CREATE_FILE_ERROR", getPathDiscussions());
		             throw new CommunicationUserException("CommunicationUserSessionController.createDiscussion", SilverpeasException.ERROR, 
    ...
    public String getDiscussion(File fileDiscussion) throws CommunicationUserException 
    {
		...
		try {
			...
			throw new CommunicationUserException("CommunicationUserSessionController.getDiscussion()", SilverpeasException.ERROR,
					   "root.EX_NO_MESSAGE", e);
		}
    }
    ...
    public void addMessageDiscussion(File fileDiscussion, String message) throws CommunicationUserException 
    {
    	...
    	if(getPathDiscussions() != null) {
    		try {
				...
				throw new CommunicationUserException("CommunicationUserSessionController.addMessageDiscussion()", SilverpeasException.ERROR,
						   "root.EX_NO_MESSAGE", e1);
			}
    	}
    }
    ...
    public void clearDiscussion(File fileDiscussion) throws CommunicationUserException
    {
    	if(getPathDiscussions() != null) {
			...
			try {
				...
				throw new CommunicationUserException("CommunicationUserSessionController.clearDiscussion()", SilverpeasException.ERROR,
						   "root.EX_NO_MESSAGE", e);
			}
    	}
    }
