...
public class POPUPRequestRouter extends ComponentRequestRouter
{
    ...
    {
        ComponentSessionController component = new POPUPSessionController(mainSessionCtrl, context);
        return component;
    }
	...
	public String getDestination(String function, ComponentSessionController componentSC, HttpServletRequest request)
	{
		...
		SilverTrace.info("popup", "POPUPRequestRouter.getDestination()", "root.MSG_GEN_PARAM_VALUE", "function="+function);
        ...
        {
    		SilverTrace.info("popup", "POPUPRequestRouter.getDestination()", "root.MSG_GEN_PARAM_VALUE", "request.getParameter(theUserId)="+request.getParameter("theUserId"));
        	popupSC.notifySession(request.getParameter("theUserId"), request.getParameter("messageAux"));
