...
public class WorkflowDesignerRequestRouter extends ComponentRequestRouter {
  ...
  static final private String root = "/workflowDesigner/jsp/"; // the root directory for all the *.jsp
  ...
  public String getDestination(String function, ComponentSessionController componentSC, HttpServletRequest request) {
    ...
    SilverTrace.info("workflowDesigner", "WorkflowDesignerRequestRouter.getDestination()", "root.MSG_GEN_PARAM_VALUE", "User=" + componentSC.getUserId() + " Function=" + function);
    ...
    SilverTrace.info("workflowDesigner", "WorkflowDesignerRequestRouter.getDestination()", "root.MSG_GEN_PARAM_VALUE", "Destination=" + destination);
    return destination;
  }
  ...
  synchronized private void initHandlers() {
    ...
    mapHandler.put("ModifyContextualDesignation", hndlEditContextualDesignation);
    mapHandler.put("UpdateContextualDesignation", hndlUpdateContextualDesignation);
    mapHandler.put("RemoveContextualDesignation", hndlRemoveContextualDesignation);
  ...
  private static FunctionHandler hndlEditWorkflow = new FunctionHandler() {
    ...
    public String getDestination(String function,
      ...
      // also pass an info whether the component descriptor has already been defined.
      //
    ...
    public String getDestination(String function,
      ...
      if ("ImportWorkflow".equals(function)) {
        ...
        try {
          ...
          throw new WorkflowException("WorkflowDesignerRequestRouter.hndlImportWorkflow",
              SilverpeasException.ERROR,
              "workflowEngine.EX_ROLE_NOT_FOUND",
              e);
        }

        return hndlListWorkflow.getDestination("Main", workflowDesignerSC, request);
      } else {
        return hndlListWorkflow.getDestination("Main", workflowDesignerSC, request);
      }
    }
  ...
  private static FunctionHandler hndlUpdateWorkflow = new FunctionHandler() {
    ...
    public String getDestination(String function,
      ...
      String strProcessFileName = request.getParameter("ProcessFileName"),
          strProcessName = request.getParameter("name");

      // The parameters may not be defined if the action is launched from a screen
  ...
  private static FunctionHandler hndlGenerateComponentDescription = new FunctionHandler() {
    ...
    public String getDestination(String function,
      ...
      //
      workflowDesignerSC.generateComponentDescriptor(request.getParameter("label"),
  ...
  private static FunctionHandler hndlUpdateRole = new FunctionHandler() {
    ...
    public String getDestination(String function,
      ...
      workflowDesignerSC.updateRole(role, (String) request.getParameter("name_original"));
  ...
  private static FunctionHandler hndlEditColumns = new FunctionHandler() {
    ...
    public String getDestination(String function,
      ...
      } else // ModifyColumns
      {
        ...
        columns = workflowDesignerSC.getProcessModel().getPresentation().getColumnsByRole(strColumnsName);
      }

      if (columns == null) {
        throw new WorkflowException("WorkflowDesignerRequestRouter.hndlEditColumns", //$NON-NLS-1$
            SilverpeasException.ERROR,
            "workflowEngine.EX_COLUMNS_NOT_FOUND");                                        //$NON-NLS-1$
      }
      request.setAttribute("Columns", columns);
      request.setAttribute("RoleNames", workflowDesignerSC.retrieveRoleNames(false, true));
      request.setAttribute("FolderItemNames", workflowDesignerSC.retrieveFolderItemNames(false, false));
  ...
  private static FunctionHandler hndlUpdateColumns = new FunctionHandler() {
    ...
    public String getDestination(String function,
      ...
      for (int i = 0; astrColumnNames != null && i < astrColumnNames.length; i++) {
        ...
        column.setItem(workflowDesignerSC.getProcessModel().getDataFolder().getItem(astrColumnNames[i]));
      ...
      //
      workflowDesignerSC.updateColumns(columns, (String) request.getParameter("role_original"));
  ...
  private static FunctionHandler hndlRemoveColumns = new FunctionHandler() {
    ...
    public String getDestination(String function,
        WorkflowDesignerSessionController workflowDesignerSC,
        HttpServletRequest request) throws WorkflowDesignerException {
      workflowDesignerSC.deleteColumns((String) request.getParameter("columns"));
  ...
  private static FunctionHandler hndlEditParticipant = new FunctionHandler() {
    ...
    public String getDestination(String function,
      ...
      {
        participant = workflowDesignerSC.getProcessModel().getParticipantsEx().getParticipant(strParticipantName);
  ...
  private static FunctionHandler hndlUpdateParticipant = new FunctionHandler() {
    ...
    public String getDestination(String function,
      ...
      workflowDesignerSC.updateParticipant(participant, (String) request.getParameter("name_original"));
  ...
  private static FunctionHandler hndlUpdateState = new FunctionHandler() {
    ...
    public String getDestination(String function,
      ...
      String strTimeoutAction = request.getParameter("timeoutAction"),
          strTimeoutInterval = request.getParameter("timeoutInterval"),
          strNotifyAdmin = request.getParameter("notifyAdmin");
      ...
      if (StringUtil.isDefined(strTimeoutAction)) {
        state.setTimeoutAction(workflowDesignerSC.getProcessModel().getActionsEx().getAction(strTimeoutAction));
      ...
      if (astrAllowedActions != null) {
        ...
        for (int i = 0; i < astrAllowedActions.length; i++) {
          ...
          allowedAction.setAction(workflowDesignerSC.getProcessModel().getActionsEx().getAction(astrAllowedActions[i]));
          allowedActions.addAllowedAction(allowedAction);
        }
        state.setAllowedActions(allowedActions);
      }

      workflowDesignerSC.updateState(state, (String) request.getParameter("name_original"));
  ...
  private static FunctionHandler hndlEditQualifiedUsers = new FunctionHandler() {
    ...
    public String getDestination(String function,
      ...
      // Configure the QualifiedUsrs editor to match the content of worikingUsers,
  ...
  private static FunctionHandler hndlEditAction = new FunctionHandler() {
    ...
    public String getDestination(String function,
      ...
      request.setAttribute("FormNames", workflowDesignerSC.retrieveFormNames(false));
  ...
  private static FunctionHandler hndlUpdateAction = new FunctionHandler() {
    ...
    public String getDestination(String function,
      ...
      action.setForm(workflowDesignerSC.getProcessModel().getForms().getForm(request.getParameter("form")));
      action.setKind(request.getParameter("kind"));

      workflowDesignerSC.updateAction(action, (String) request.getParameter("name_original"));
  ...
  private static FunctionHandler hndlEditConsequence = new FunctionHandler() {
    ...
    public String getDestination(String function,
      ...
      request.setAttribute("FolderItemNames", workflowDesignerSC.retrieveFolderItemNames(true, false));
  ...
  private static FunctionHandler hndlUpdateConsequence = new FunctionHandler() {
    ...
    public String getDestination(String function,
      ...
      String strContext = request.getParameter("context"),
          ...
          strKill = request.getParameter("kill"),
          strSetUnset;
      Action action = workflowDesignerSC.findAction(strContext);
      Consequences consequences = action.getConsequences();
      Consequence consequence;
      Iterator iterState = workflowDesignerSC.getProcessModel().getStatesEx().iterateState();
      State state;
  ...
  private static FunctionHandler hndlMoveConsequence = new FunctionHandler() {
    ...
    public String getDestination(String function,
      ...
      int nDirection = Integer.parseInt(request.getParameter("direction")),
          iConsequence = Integer.parseInt(request.getParameter("consequenceNo"));
  ...
  private static FunctionHandler hndlEditForm = new FunctionHandler() {
    ...
    public String getDestination(String function,
        ...
        throws WorkflowDesignerException, WorkflowException {
      String strContext = request.getParameter("context"),
          strFormType = WorkflowDesignerSessionController.FORM_TYPE_ACTION;
      Form form;
      ...
      if (form == null) {
        throw new WorkflowException("WorkflowDesignerRequestRouter.hndlEditForm", //$NON-NLS-1$
            SilverpeasException.ERROR,
            "workflowEngine.EX_FORM_NOT_FOUND");                                        //$NON-NLS-1$
      }
  ...
  private static FunctionHandler hndlUpdateForm = new FunctionHandler() {
    ...
    public String getDestination(String function,
      ...
      String strHTMLFileName = request.getParameter("HTMLFileName"),
          ...
          strRoleOriginal = request.getParameter("role_original"),
      ...
      workflowDesignerSC.updateForm(form,
    ...
    public String getDestination(String function,
      ...
      if (form == null) {
        throw new WorkflowDesignerException("WorkflowDesignerRequestRouter.hndlEditInput", //$NON-NLS-1$
            SilverpeasException.ERROR,
            "workflowDesigner.EX_PARENT_NOT_FOUND");                                        //$NON-NLS-1$
      }
  ...
  private static FunctionHandler hndlUpdateInput = new FunctionHandler() {
    ...
    public String getDestination(String function,
      ...
      String strContext = request.getParameter("context"),
          ...
          strDisplayer = request.getParameter("displayerName");
      Form form = workflowDesignerSC.findForm(strContext);
      Input input;
  ...
  private static FunctionHandler hndlEditRelatedUser = new FunctionHandler() {
    ...
    public String getDestination(String function,
      ...
      String strContext = request.getParameter("context"),
          strParticipant = request.getParameter("participant"),
          strFolderItem = request.getParameter("folderItem"),
  ...
  private static FunctionHandler hndlUpdateRelatedUser = new FunctionHandler() {
    ...
    public String getDestination(String function,
      ...
      String strParticipantOriginal = request.getParameter("participant_original"),
          ...
          strRelationOriginal = request.getParameter("relation_original"),
          strRoleOriginal = request.getParameter("role_original"),
          strParticipant = request.getParameter("participant"),
          strFolderItem = request.getParameter("folderItem"),
          strRelation = request.getParameter("relation"),
      ...
      if (StringUtil.isDefined(strParticipant)) {
        relatedUser.setParticipant(workflowDesignerSC.getProcessModel().getParticipantsEx().getParticipant(strParticipant));
      } else {
        strParticipant = null;
      ...
      if (StringUtil.isDefined(strFolderItem)) {
        relatedUser.setFolderItem(workflowDesignerSC.getProcessModel().getDataFolder().getItem(strFolderItem));
      } else {
        strFolderItem = null;
      ...
      workflowDesignerSC.updateRelatedUser(relatedUser,
          strContext,
  ...
  private static FunctionHandler hndlEditContextualDesignation = new FunctionHandler() {
    ...
    public String getDestination(String function,
      ...
      if (designation == null) {
        throw new WorkflowDesignerException("WorkflowDesignerRequestRouter.hndlEditContextualDesignation", //$NON-NLS-1$
            SilverpeasException.ERROR,
  ...
  private static FunctionHandler hndlUpdateContextualDesignation = new FunctionHandler() {
    ...
    public String getDestination(String function,
      ...
      String strLanguage = request.getParameter("lang_original"),
          strRole = request.getParameter("role_original"),
          strContext = request.getParameter("context"),
          strParentScreen = request.getParameter("parentScreen");
      ContextualDesignation designation = workflowDesignerSC.getProcessModel().createDesignation();
      ...
      workflowDesignerSC.updateContextualDesignations(strContext,
          designation,
          strLanguage,
          strRole);
  ...
  private static FunctionHandler hndlRemoveContextualDesignation = new FunctionHandler() {
    ...
    public String getDestination(String function,
        WorkflowDesignerSessionController workflowDesignerSC,
        HttpServletRequest request) throws WorkflowDesignerException {
      ContextualDesignation contextualDesignation = workflowDesignerSC.getProcessModel().createDesignation();
      String strContext = request.getParameter("context"),
          strParentScreen = request.getParameter("parentScreen");
  ...
  private static FunctionHandler hndlEditItem = new FunctionHandler() {
    ...
    public String getDestination(String function,
      ...
      request.setAttribute("UserInfosNames", workflowDesignerSC.retrieveUserInfoItemNames(true, false));
  ...
  private static FunctionHandler hndlUpdateItem = new FunctionHandler() {
    ...
    public String getDestination(String function,
      ...
      String strNameOriginal = request.getParameter("name_original"),
          ...
          strComupted = request.getParameter("computed"),
          strMapTo = request.getParameter("mapTo"),
          strType = request.getParameter("type"),
          strReadonly = request.getParameter("readonly"),
          strFormula = request.getParameter("formula"),
          strContext = request.getParameter("context");
  ...
  private static FunctionHandler hndlUpdateParameter = new FunctionHandler() {
    ...
    public String getDestination(String function,
      ...
      String strContext = request.getParameter("context"),
          strName = request.getParameter("name"),
          strValue = request.getParameter("value"),
          strNameOriginal = request.getParameter("name_original");
      Item item = workflowDesignerSC.findItem(strContext);
      Parameter parameter;
  ...
  static private String calculateEditorName(String strContext) {
    ...
    } else if (WorkflowDesignerSessionController.WORKING_USERS.equals(strEditor)) {
      return "workflowDesigner.editor.workingUsers";
    } else if (WorkflowDesignerSessionController.INTERESTED_USERS.equals(strEditor)) {
      return "workflowDesigner.editor.interestedUsers";
    } else if (WorkflowDesignerSessionController.ALLOWED_USERS.equals(strEditor)) {
      return "workflowDesigner.editor.allowedUsers";
    } else if (WorkflowDesignerSessionController.NOTIFIED_USERS.equals(strEditor)) {
  ...
  private static String calculateParentScreen(WorkflowDesignerSessionController workflowDesignerSC,
    ...
    try {
      ...
      if (WorkflowDesignerSessionController.LABELS.equals(strElement)
        ...
        strElement = strtok.nextToken();
        state = workflowDesignerSC.getProcessModel().getStatesEx().getState(strElement);
        strElement = strtok.nextToken();
        ...
        } else if (WorkflowDesignerSessionController.INTERESTED_USERS.equals(strElement)) {
          if (WorkflowDesignerSessionController.RELATED_USER.equals(strtok.nextToken())) {
            // is a 'relatedUser'
            //
            sb.append("/");
        ...
        if (WorkflowDesignerSessionController.PARAMETERS.equals(strtok.nextToken())) {
  ...
  private static List getRequestItems(HttpServletRequest request) throws FileUploadException {
