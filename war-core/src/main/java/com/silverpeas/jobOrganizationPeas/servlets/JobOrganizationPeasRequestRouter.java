...
public class JobOrganizationPeasRequestRouter extends ComponentRequestRouter
{
    ...
    {
        return new JobOrganizationPeasSessionController(mainSessionCtrl, componentContext);
    }
    ...
    public String getDestination(String function, ComponentSessionController componentSC, HttpServletRequest request)
    {
        ...
        SilverTrace.info("jobOrganizationPeas", "JobOrganizationPeasRequestRouter.getDestination()", "root.MSG_GEN_PARAM_VALUE", "User=" + jobOrganizationSC.getUserId() + " Function=" + function);
        ...
        SilverTrace.info("jobOrganizationPeas", "JobOrganizationPeasRequestRouter.getDestination()", "root.MSG_GEN_PARAM_VALUE", "Destination=" + destination);
        return destination;
    }
