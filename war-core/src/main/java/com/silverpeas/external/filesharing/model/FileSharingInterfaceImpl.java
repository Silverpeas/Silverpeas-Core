...
public class FileSharingInterfaceImpl implements FileSharingInterface {
   ...
   * (non-Javadoc)
   * @see
   * com.silverpeas.external.filesharing.model.FileSharingInterface#getTicketsByUser(java.lang.String
   * )
   */
  public List<TicketDetail> getTicketsByUser(String userId) throws RemoteException {
    ...
    try {
      /*
       * OrganizationController organizationController = new OrganizationController(); String[]
       * componentIds = organizationController.getAllComponentIdsRecur(null, userId, "kmelia",
       * false, true); List<String> ids = new ArrayList(); for (int c=0; c<componentIds.length; c++)
       * { String[] profiles = organizationController.getUserProfiles(userId, componentIds[c]);
       * boolean isAdmin = false; for (int p=0; !isAdmin && p<profiles.length; p++) { isAdmin =
       * "admin".equalsIgnoreCase(profiles[p]); } if (isAdmin) ids.add(componentIds[c]); } return
       * dao.getTicketsByComponentIds(con, ids);
       */
   ...
   * (non-Javadoc)
   * @see
   * com.silverpeas.external.filesharing.model.FileSharingInterface#getTicketsByFile(java.lang.String
   * )
   */
   ...
   * (non-Javadoc)
   * @see
   * com.silverpeas.external.filesharing.model.FileSharingInterface#createTicket(com.silverpeas.
   * external.filesharing.model.TicketDetail)
   */
   ...
   * (non-Javadoc)
   * @see
   * com.silverpeas.external.filesharing.model.FileSharingInterface#addDownload(com.silverpeas.external
   * .filesharing.model.DownloadDetail)
   */
   ...
   * (non-Javadoc)
   * @see
   * com.silverpeas.external.filesharing.model.FileSharingInterface#updateTicket(com.silverpeas.
   * external.filesharing.model.TicketDetail)
   */
   ...
   * (non-Javadoc)
   * @see
   * com.silverpeas.external.filesharing.model.FileSharingInterface#deleteTicket(java.lang.String)
   */
  ...
  private Connection initCon() {
    ...
    try {
      ...
      throw new FileSharingRuntimeException("FileSharingInterface.initCon()",
  ...
  private void fermerCon(Connection con) {
    try {
      ...
      // traitement des exceptions
      throw new FileSharingRuntimeException("FileSharingInterface.fermerCon()",
