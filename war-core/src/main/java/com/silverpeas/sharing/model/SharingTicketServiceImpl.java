 ...
 */
public class SharingTicketServiceImpl implements SharingTicketService {

  private TicketDAO dao;
  private OrganizationController organizationController = new OrganizationController();

  public SharingTicketServiceImpl() {
    dao = new TicketDAO();
  }
  ...
  public List<TicketDetail> getTicketsByUser(String userId) {
    ...
    try {
      ...
      throw new FileSharingRuntimeException("SharingTicketService.getTicketsByUser()",
  ...
  public void deleteTicketsByFile(String fileId, boolean versioning) {
    ...
    try {
      ...
      throw new FileSharingRuntimeException("SharingTicketService.getTicketsByFile()",
          SilverpeasRuntimeException.ERROR, "filsSharing.MSG_TICKETS_NOT_EXIST", e);
    } finally {
      // fermer la connexion
      closeConnection(con);
  ...
  public TicketDetail getTicket(String key) {
    ...
    try {
      ...
      throw new FileSharingRuntimeException("SharingTicketService.getTicket()",
  ...
  public String createTicket(TicketDetail ticket) {
    ...
    try {
      ...
      throw new FileSharingRuntimeException("SharingTicketService.createTicket()",
  ...
  public void addDownload(DownloadDetail download) {
    ...
    try {
      ...
      throw new FileSharingRuntimeException("SharingTicketService.addDownload()",
  ...
  public void updateTicket(TicketDetail ticket) {
    ...
    try {
      ...
      throw new FileSharingRuntimeException("SharingTicketService.updateTicket()",
  ...
  public void deleteTicket(String key) {
    ...
    try {
      ...
      throw new FileSharingRuntimeException("SharingTicketService.deleteTicket()",
  ...
  private Connection openConnection() {
    ...
    try {
      ...
      throw new FileSharingRuntimeException("SharingTicketService.openConnection()",
  ...
  private void closeConnection(Connection con) {
    try {
      ...
      // traitement des exceptions
      throw new FileSharingRuntimeException("SharingTicketService.closeConnection()",
