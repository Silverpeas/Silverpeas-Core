...
public class LaunchWebdavEdition extends HttpServlet {
  ...
  private void prepareJNLP(HttpServletRequest request, PrintWriter out, String login,
    ...
    out.println("\t\t<jar href=\"xercesImpl-2.6.2.jar\" download=\"eager\"/>");
    out.println("\t\t<jar href=\"commons-codec-1.4.jar\" download=\"eager\"/>");
    out.println("\t\t<jar href=\"commons-httpclient-3.1.jar\" download=\"eager\"/>");
    out.println("\t\t<jar href=\"jackrabbit-jcr-commons-1.6.4.jar\" download=\"eager\"/>");
    out.println("\t\t<jar href=\"jackrabbit-webdav-1.6.4.jar\" download=\"eager\"/>");
    ...
    out.println("\t\t<jar href=\"log4j-1.2.15.jar\" download=\"eager\"/>");
    out.println("\t</resources>");
