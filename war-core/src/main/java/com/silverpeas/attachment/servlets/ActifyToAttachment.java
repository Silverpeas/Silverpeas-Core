...
public class ActifyToAttachment extends HttpServlet
{
    ...
    public void init(ServletConfig config)
    {
        ...
        {
            SilverTrace.fatal("attachment", "ActifyToSilverpeas.init", "attachment.CANNOT_ACCESS_SUPERCLASS");
        }
    }
    ...
    public void doPost(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException
    {
        ...
        if (settings.getBoolean("ActifyPublisherEnable", false))
        {
	        try
	        {
	            SilverTrace.info("attachment", "ActifyToAttachment.doPost", "req=" + req.getParameter("AttachmentId"));
				...
				AttachmentDetail ad = AttachmentController.searchAttachmentByPK(new AttachmentPK(attachmentId));
				if (ad != null)
				{
					...
					String srcFile = FileRepositoryManager.getTemporaryPath() + actifyWorkingPath + File.separator + logicalName;
					String destFile = AttachmentController.createPath(ad.getInstanceId(), null) + ad.getPhysicalName();

					SilverTrace.info("attachment", "ActifyToAttachment", "root.MSG_GEN_PARAM_VALUE", "srcFile = "+srcFile);
					SilverTrace.info("attachment", "ActifyToAttachment", "root.MSG_GEN_PARAM_VALUE", "destFile = "+destFile);
