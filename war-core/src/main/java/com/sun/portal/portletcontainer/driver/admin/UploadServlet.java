...
public class UploadServlet extends HttpServlet {
    ...
    private static Logger logger = Logger.getLogger(UploadServlet.class.getPackage().getName(), "com.silverpeas.portlets.PCDLogMessages");
    ...
    private void deployPortlet(String[] fileNames, HttpSession session) throws PortletRegistryException {
