...
<%
	browseBar.setComponentName(resource.getString("webConnections.connections"));
		...
		while (it.hasNext()) {
			...
			IconPane iconPane = gef.getIconPane();
         	...
         	Icon deleteIcon = iconPane.addIcon();
          	updateIcon.setProperties(resource.getIcon("webConnections.update"), resource.getString("webConnections.updateConnection") , "javaScript:onClick=editConnection('"+ connection.getConnectionId() + "')");
         	deleteIcon.setProperties(resource.getIcon("webConnections.delete"), resource.getString("webConnections.deleteConnection") , "javaScript:onClick=deleteConnection('"+ connection.getConnectionId() + "')");
