...
%>
	<br>
	<table width=100%>
	<tr class="intfdcolor51"><td align="center" class="txtlibform"><img src="<%=resource.getIcon("JSPP.px")%>" height="20" width="1" align="absmiddle">Paramètres de l'instance</td></tr>
	</table>
<%
}
%>
