...
--%>
<%@page import="com.stratelia.webactiv.servlets.LoginServlet"%>
...
<body>
	<form id="changePwdForm" action="<%=m_context%>/CredentialsServlet/EffectiveChangePasswordBeforeExpiration" method="post">
            ...
            <div id="backgroundBig"> <!-- image de fond du formulaire -->
                <div class="cadre">
                    <div id="header">
                        ...
                        <p class="information"><%=authenticationBundle.getString("authentication.password.aboutToExpire") %><br/>
								<%
					...
					<p>
						...
						<tr>
							...
							<td style="background-image: url('images/bt-left.png'); width: 31px; height: 31px">&nbsp;</td>
							<td style="background-image: url('images/bt-bg.png'); background-repeat: repeat-x;"><a href="<%=m_context%>/Main/<%=gef.getLookFrame() %>" class="submit" ><%=authenticationBundle.getString("authentication.password.remindMeLater") %></a></td>
							<td style="background-image: url('images/bt-right.png');width: 16px; height: 31px">&nbsp;</td>
						</tr>
						</tbody>
						</table>
