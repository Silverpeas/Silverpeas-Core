...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <script type="text/javascript" src="/util/javaScript/angular.min.js"></script>
  ...
  <body class="userPanel" ng-app="userSelector">
    <div class="container_userPanel" ng-controller="MainController">
      <div id="filter_userPanel" ng-controller="FilterController">
        <h4 class="title"><fmt:message key="selection.Filter"/></h4>
        <ul class="listing_filter">
          <c:if test='${selectionScope == "user" || selectionScope == "usergroup"}'>
            <li>
              <a href="#" id="filter_users" class="filter" ng-click="renderAllUsers()"><fmt:message key="selection.AllUsers"/></a>
            </li>
            <li>
              <a href="#" id="filter_contact" class="filter" ng-click="renderMyContacts()"><fmt:message key="selection.MyContacts"/></a>
            </li>
          </c:if>
          <li id="filter_groups"><div id="breadcrumb" class="select filter"></div>
            <ul class="listing_groups_filter">
              <li ng-repeat="group in groups">
                <a href="#" class="filter" ng-click="renderGroupChildren(group)">
                  {{group.name}}<span class="nb_results_by_filter"> ({{group.userCount}}) </span>
                </a>
              </li>
            </ul>
          </li>
    ...
    <script type="text/javascript">
        /* set up the JQuery i18n plugin */
        $.i18n.properties({
          name: 'socialNetworkBundle',
          path: webContext + '/services/bundles/com/silverpeas/selection/multilang/selectionBundle',
