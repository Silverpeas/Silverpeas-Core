...
<frameset cols="<%=spaceModel.getColumnsRatios()%>" bordercolor="#FFFFFF" marginheight=5 marginwidth=5>
  ...
  %>
       <frame name="columnSet<%=column.getColumnNumber()%>" scrolling="NO" src="columnSet?col=<%=colNum%>&spaceId=<%=request.getParameter("spaceId")%>" marginheight=5 marginwidth=5>  <% } %>
</frameset>
<noframes>
  <body>
    Your browser is not configured for displaing frames
  </body>
</noframes>
</HTML>
