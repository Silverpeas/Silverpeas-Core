    ...
    <td>
      <table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF">
        <tr>
          ...
          <td align="right" bgcolor="#AFB8C9" valign="top" nowrap><a href="standard?id=<%=portlet.getIndex() +
                         "&spaceId=" + request.getParameter("spaceId") +
                         "&portletState=std"%>" target="MyMain"><img src="<%=m_context%>/util/icons/portlet/modePortlet.gif" border="0"></a></td>
        </tr>
        <tr bgcolor="#000000">
