...
<%--<table width="100%"  border="0" >
  <tr>
    <td id="profilHeadPhoto" height="100" width="100" style="vertical-align: top; background-repeat: no-repeat; background-image:url(http://localhost:8000/silverpeas/directory/jsp/icons/Photo_profil.jpg)"  >
