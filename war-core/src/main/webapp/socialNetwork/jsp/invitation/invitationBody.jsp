                    ...
                    <tr>
                        ...
                        <td  width="40%"  style="text-align: right">
                            ...
                            <%
                                                ...
                                                buttonPane.addButton((Button) gef.getFormButton( multilang.getString("invitation.action.confirme"), "AcceptInvitation?UserId="+invitationUser.getInvitation().getId() , false));
                                                buttonPane.addButton((Button) gef.getFormButton(multilang.getString("invitation.action.ignore"), "IgnoreInvitation?UserId="+invitationUser.getInvitation().getId() , false));
                                               
                                                out.println(buttonPane.print().replaceAll("width=\"100\"", " ").replaceAll("<table", "<table align=\"right\" "));
                            %>
