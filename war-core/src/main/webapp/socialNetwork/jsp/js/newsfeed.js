...
function getFragment(socialInfo) {
	...
	fragment += '<div class="txt">';
		fragment += '<p><a href="'+getApplicationContext()+'/Rprofil/jsp/Main?userId='+socialInfo.author.id+'" class="name">'+socialInfo.author.displayedName+'</a> '+ socialInfo.label +' <a href="'+socialInfo.url+'" class="publicationName txtColor">'+ socialInfo.title +'</a> '+ socialInfo.hour +'</p>';
		fragment += '<p class="detail decoration-'+socialInfo.type.toLowerCase()+'">'+socialInfo.description+'&nbsp;</p>';
	fragment += '</div>';
	fragment += '</div>';
...
function getStatusFragment(socialInfo) {
	...
	fragment += '<div class="txt">';
	fragment += '<p><a href="'+getApplicationContext()+'/Rprofil/jsp/Main?userId='+socialInfo.author.id+'" class="name">'+socialInfo.author.displayedName+'</a> '+socialInfo.title+' '+socialInfo.hour+'</p>';
	fragment += '<p class="detail decoration-'+socialInfo.type.toLowerCase()+'">'+socialInfo.description+'</p>';
	fragment += '</div>';
...
function getRelationFragment(socialInfo) {
	...
	fragment += '<div class="txt">';
	fragment += '<p><a href="'+getApplicationContext()+'/Rprofil/jsp/Main?userId='+socialInfo.author.id+'" class="name">'+socialInfo.author.displayedName+'</a> '+socialInfo.label+' '+socialInfo.hour+'</p>';
...
function getAvatarFragment(author) {
	...
	fragment += '<a href="'+getApplicationContext()+'/Rprofil/jsp/Main?userId='+author.id+'">';
