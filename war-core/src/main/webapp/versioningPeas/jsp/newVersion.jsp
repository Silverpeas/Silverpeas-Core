    ...
    function showDnD()
	{
		...
		String language = versioningSC.getLanguage();
	  	...
	  	if (versioningSC.isIndexable())
	  		indexIt = "1";
		String baseURL = URLManager.getFullApplicationURL(request)+"/VersioningDragAndDrop/jsp/Drop?UserId="+m_MainSessionCtrl.getUserId()+"&ComponentId="+componentId+"&Id="+publicationId+"&IndexIt="+indexIt+"&DocumentId="+documentId;
