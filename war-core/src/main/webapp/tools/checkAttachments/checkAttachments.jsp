...
%>
		...
		<form action="checkAttachments.jsp" method="get" name="toolForm">
			...
			<b>R�sultats par page :</b> <input type="text" name="nbItemsPerPage" value="<%=nbItemsPerPage%>" maxlength="3" size="5">
		...
		:&nbsp; <select name="attachmentType">
			...
			de Th�me et Publications</option>
		...
		<display:table export="true" name="listAttachments" id="row" pagesize="<%=nbItemsPerPage%>" defaultsort="2" defaultorder="ascending">
			<display:setProperty name="paging.banner.one_item_found">1 {0} trouv�.</display:setProperty>
			<display:setProperty name="paging.banner.all_items_found"><b>{0} {1}</b> trouv�s.</display:setProperty>
			<display:setProperty name="paging.banner.some_items_found"><b>{0} {1}</b> trouv�s, Affich�s: <b>{2} � {3}</b>.</display:setProperty>
			<display:setProperty name="paging.banner.full"><span class="pagelinks">[<a href="{1}">Premier</a> / <a href="{2}">Pr�c�dent</a>] {0} [<a href="{3}">Suivant</a> / <a href="{4}">Dernier</a>]</span></display:setProperty>
			<display:setProperty name="paging.banner.first"><span class="pagelinks">[Premier/Pr�c�dent] {0} [<a href="{3}">Suivant</a> / <a href="{4}">Dernier</a>]</span></display:setProperty>
			<display:setProperty name="paging.banner.last"><span class="pagelinks">[<a href="{1}">Premier</a> / <a href="{2}">Pr�c�dent</a>] {0} [Suivant / Dernier]</span></display:setProperty>
