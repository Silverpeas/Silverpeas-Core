...
<%
  ...
  ResourceLocator attachmentSettings = new ResourceLocator("org.silverpeas.util.attachment.Attachment", "");
...
<%
    ResourceLocator messages = new ResourceLocator("org.silverpeas.versioningPeas.multilang.versioning", mainSessionCtrl.getFavoriteLanguage());
...
for (SimpleDocument publicVersion : vVersions) {
    ...
    cell.setNoWrap(true);
      ...
      xtraData = "<a rel=\""+xmlURL+"\" href=\"#\" title=\""+document.getFilename()+" "+publicVersion.getMajorVersion()+"."+publicVersion.getMinorVersion()+"\"><img src=\""+URLManager.getApplicationURL()+"/util/icons/info.gif\" border=\"0\"></a> ";
    }
