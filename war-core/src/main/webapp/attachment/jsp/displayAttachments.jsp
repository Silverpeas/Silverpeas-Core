...
<%
  List<SimpleDocument> attachments = AttachmentServiceFactory.getAttachmentService().
      searchAttachmentsByExternalObject(
      new ForeignPK(request.getParameter("Id"), request.getParameter("ComponentId")),
        ...
        <c:if test="${isAttachmentPositionRight}">
          ...
          <c:if test="${contextualMenuEnabled}">
            <%com.silverpeas.attachment.MenuHelper.displayActions((SimpleDocument) pageContext.
                  getAttribute("attachment"), (Boolean) pageContext.getAttribute("useXMLForm"),
                  ...
                  "contentLanguage"), attResources,
                  URLManager.getServerURL(request), (Boolean) pageContext.
                getAttribute("showMenuNotif"), (Boolean) pageContext.getAttribute(
                "useContextualMenu"), out);%>              
          </c:if>
          <span class="lineMain">
            ...
            <c:if test="${attachment.versioned}">
              &nbsp;<span class="version-number" id="version_<c:out value="${attachment.oldSilverpeasId}"/>">v<c:out value="${attachment.majorVersion}"/>.<c:out value="${attachment.minorVersion}"/></span>
            </c:if>
          </span>
          <span class="lineSize">
