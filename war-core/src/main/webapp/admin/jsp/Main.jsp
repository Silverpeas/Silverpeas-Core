...
function readMessage(id){
	SP_openWindow("<%=m_sContext%>/RSILVERMAIL/jsp/ReadMessage.jsp?ID=" + id + "&from=homePage&SpaceId=<%=request.getParameter("SpaceId")%>","readMessage","600","380","scrollable=yes,scrollbars=yes");
}
...
<table width="100%" border="0" cellpadding="5" cellspacing="0">
  <tr>
    <td width="50%" valign="top">
      ...
      %>
      <table width="100%" border="0" cellpadding="2" cellspacing="0" class="intfdcolor">
        <tr>
          <td>
            <table width="100%" border="0" cellpadding="0" cellspacing="0">
              <tr class="intfdcolor">
                <td colspan="2"><img src="<%=m_sContext%>/util/icons/colorPix/1px.gif" width="1" height="1"></td>
              </tr>
              <tr>
                <td class="intfdcolor4" nowrap><img src="icons/accueil/picto_publications.gif" width="15" height="15" align="absmiddle"><span class="txtnav"><%=message.getStringWithParam("LatestPublications", String.valueOf(nbLatestPublications))%></span></td>
                <td class="intfdcolor" align="left" width="100%"><img src="../../util/icons/portlet/rond.gif" width="20" height="20"></td>
              </tr>
              <tr bgcolor="#000000">
                <td colspan="2"><img src="<%=m_sContext%>/util/icons/colorPix/1px.gif" width="1" height="1"></td>
              </tr>
              <tr>
                <td colspan="2" class="intfdcolor4">
      ...
      <table width="100%" border="0" cellpadding="2" cellspacing="0" class="intfdcolor">
        <tr>
          <td class="intfdcolor">
            <table width="100%" border="0" cellpadding="0" cellspacing="0">
              <tr>
                <td colspan="2" class="intfdcolor"><img src="<%=m_sContext%>/util/icons/colorPix/1px.gif" width="1" height="1"></td>
              </tr>
              <tr>
                <td class="intfdcolor4" nowrap><img src="icons/accueil/picto_requetes.gif" width="15" height="15" align="absmiddle">
						<span class="txtnav"><%=message.getString("MyPDCSubscriptions")%></span>
				</td>
                <td class="intfdcolor" align="left" width="100%"><img src="../../util/icons/portlet/rond.gif" width="20" height="20"></td>
              </tr>
              <tr bgcolor="#000000">
            ...
            <table width="100%" border="0" cellpadding="0" cellspacing="0">
              ...
              <tr>
                <td  class="intfdcolor4" nowrap>
                     <a href="<%=m_sContext%>/Ragenda/jsp/agenda.jsp"><img src="icons/agenda.gif" width="15" height="15" align="absmiddle" border="0"></a><span class="txtnav"><%=message.getString("MyNextEvent")%></span> 
                </td>
                <td class="intfdcolor" align="left" width="100%"><img src="../../util/icons/portlet/rond.gif" width="20" height="20"></td>
              </tr>
              <tr bgcolor="#000000">
        ...
        <tr>
          <td>
            <table width="100%" border="0" cellpadding="0" cellspacing="0">
              ...
              <tr>
                <td class="intfdcolor4" nowrap><a href="<%=m_sContext%>/Rtodo/jsp/todo.jsp"><img src="icons/todo.gif" width="15" height="15" align="absmiddle" border="0"></a><span class="txtnav"><%=message.getString("ToDo")%></span></td>
                <td class="intfdcolor" align="left" width="100%"><img src="../../util/icons/portlet/rond.gif" width="20" height="20"></td>
              </tr>
              <tr bgcolor="#000000">
                <td colspan="2"><img src="<%=m_sContext%>/util/icons/colorPix/1px.gif" width="1" height="1"></td>
        ...
        <tr>
          <td>
            <table width="100%" border="0" cellpadding="0" cellspacing="0">
              ...
              <tr>
                <td class="intfdcolor4" nowrap><a href="<%=m_sContext%>/RSILVERMAIL/jsp/Main"><img src="icons/notifications.gif" width="15" height="15" align="absmiddle" border="0"></a><span class="txtnav"><%=message.getString("Mail")%></span></td>
                <td class="intfdcolor" align="left" width="100%"><img src="../../util/icons/portlet/rond.gif" width="20" height="20"></td>
              </tr>
              <tr bgcolor="#000000">
                <td colspan="2"><img src="<%=m_sContext%>/util/icons/colorPix/1px.gif" width="1" height="1"></td>
        ...
        <tr>
          <td>
            <table width="100%" border="0" cellpadding="0" cellspacing="0">
              ...
              <tr>
                <td class="intfdcolor4" nowrap><a href="<%=m_sContext%>/RmyLinksPeas/jsp/Main"><img src="icons/favorits.gif" width="15" height="15" align="absmiddle" border="0"><span class="txtnav"><%=message.getString("MyFavorites")%></span></td>
                <td class="intfdcolor" align="left" width="100%"><img src="../../util/icons/portlet/rond.gif" width="20" height="20"></td>
              </tr>
              <tr bgcolor="#000000">
                <td colspan="2"><img src="<%=m_sContext%>/util/icons/colorPix/1px.gif" width="1" height="1"></td>
                    	...
                    	else 
                    	{
                    		...
                    		while (it.hasNext()) 
                    		{
								...
								if (link.isVisible())
								{
									...
									String popup = "";
									// regarder si on doit l'ouvrir dans une autre fen�tre 
									if (link.isPopup())
										popup = "target=_blank";
	  ...
	  if ((attachment != null && attachment.size() > 0) || (versioning != null && versioning.size() > 0))
	  {
          ...
          <td class="intfdcolor">
            <table width="100%" border="0" cellpadding="0" cellspacing="0">
              ...
              <tr>
                <td class="intfdcolor4" nowrap><img src="<%=m_sContext%>/util/icons/lock.gif" width="15" height="15" align="absmiddle"><span class="txtnav"><%=message.getString("MyAttachment")%></span></td>
                <td class="intfdcolor" align="left" width="100%"><img src="../../util/icons/portlet/rond.gif" width="20" height="20"></td>
              </tr>
              <tr bgcolor="#000000">
                <td colspan="2"><img src="<%=m_sContext%>/util/icons/colorPix/1px.gif" width="1" height="1"></td>
        ...
        <tr>
          <td>
            <table width="100%" border="0" cellpadding="0" cellspacing="0">
              ...
              <tr>
                <td class="intfdcolor4" nowrap><img src="icons/quickinfos.gif" width="15" height="15" align="absmiddle"><span class="txtnav"><%=message.getString("QuickInfos", "Quick infos")%></span></td>
                <td class="intfdcolor" align="left" width="100%"><img src="../../util/icons/portlet/rond.gif" width="20" height="20"></td>
              </tr>
              <tr bgcolor="#000000">
                <td colspan="2"><img src="<%=m_sContext%>/util/icons/colorPix/1px.gif" width="1" height="1"></td>
