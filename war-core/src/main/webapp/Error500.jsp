...
<head>
  <title><fmt:message key="GML.error"/>&nbsp;500</title>
...
<body>
<div class="page">
  <div class="titre"><fmt:message key="GML.error"/>&nbsp;500</div>
  <div id="background">
    <div class="cadre">
      <div id="header">
      ...
      <div class="fnfinformation">
        <fmt:message key="error.500.description" bundle="${fnf}"></fmt:message><br/>
      </div>
    </div>
  </div>
</div>
