	      ...
	      elements: [					
	        {
					        ...
					        {
					          type : 'html',
					          html : '<form name="myForm"><label title="user" class="txtlibform cke_dialog_ui_labeled_label cke_required" for="user">'+editor.lang.identitycard.user+'</label><div class="fieldInput"><input type="hidden" value="" name="user" id="user"/><input type="text" value="" name="user$$name" id="user_name" disabled="disabled"/>&nbsp;<a onclick="javascript:SP_openWindow(\'/silverpeas/RselectionPeasWrapper/jsp/open?formName=myForm&amp;elementId=user&amp;elementName=user_name&amp;selectedUser=\',\'selectUser\',800,600,\'\');" class="cke_dialog_ui_button" href="#"> <span class="cke_dialog_ui_button" > <img width="15" border="0" style="vertical-align:middle;" height="15" title="'+editor.lang.identitycard.select+'" alt="'+editor.lang.identitycard.select+'" src="/silverpeas/util/icons/user.gif"/> '+editor.lang.identitycard.select+'</span></a></div></form>',
					          setup: function( widget ) {
