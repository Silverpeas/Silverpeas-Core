...
public class ViewServiceCacheDemonstrationTestAfter extends AbstractViewerTest {
  ...
  public void demonstrateCache() throws Exception {
    if (canPerformViewConversionTest()) {
      ...
      assertThat((fromCacheDuration * 5),
          lessThan(ViewServiceCacheDemonstrationTestBefore.conversionDuration));
      ...
      assertThat(view.getPhysicalFile().getParentFile().getName(),
          is(ViewServiceCacheDemonstrationTestBefore.documentView.getPhysicalFile().getParentFile()
              .getName()));
      ...
      assertThat(view.getPhysicalFile().lastModified(),
          is(ViewServiceCacheDemonstrationTestBefore.documentView.getPhysicalFile()
              .lastModified()));
    }
  }
