...
public class SpaceEntityMatcher extends StructureElementEntityMatcher<SpaceEntity, SpaceInstLight> {
   ...
   * (non-Javadoc)
   * @see
   * com.silverpeas.admin.web.StructureElementEntityMatcher#matches(org.apache.commons.lang3.builder
   * .EqualsBuilder, java.lang.Object, com.silverpeas.admin.web.StructureElementEntity)
   */
  @Override
