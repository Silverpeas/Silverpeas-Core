...
@Authenticated
public class SpaceResourceMock extends com.silverpeas.admin.web.SpaceResource {
  ...
  /*
   * (non-Javadoc)
   * @see com.silverpeas.admin.web.AbstractAdminResource#getLookServices()
   */
  @Override
  ...
  /*
   * (non-Javadoc)
   * @see com.silverpeas.admin.web.AbstractAdminResource#getAdminPersonalDelegate()
   */
  @Override
      ...
      when(adminPersonalWebDelegateMock.getUsedTools()).thenAnswer(
          new Answer<Collection<AbstractTool>>() {
            ...
            public Collection<AbstractTool> answer(final InvocationOnMock invocation)
              ...
              for (int i = 1; i <= 7; i++) {
                tools.add(new ToolMock("personalToolId" + i));
              }
              return tools;
            }
          });
  ...
  private class ToolMock extends AbstractTool {
    public ToolMock(final String id) {
      super(null, null, "", id, "", "");
    }
  }
}
