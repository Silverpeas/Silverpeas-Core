 ...
 * findAPreDefinedClassification: the classification getter returns NONE_CLASSIFICATION and
 * the saver sets the unique identifier of the classification and sets the behaviour of the getter
 * to return it when asked.
 */
@Named("pdcClassificationService")
public class PdcClassificationServiceMockWrapper extends PdcClassificationService {
