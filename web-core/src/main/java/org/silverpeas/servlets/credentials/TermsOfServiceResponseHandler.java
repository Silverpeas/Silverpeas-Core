...
public class TermsOfServiceResponseHandler extends FunctionHandler {
  ...
  public String doAction(HttpServletRequest request) {
    HttpServletRequestWrapper requestWrapper =
        new HttpServletRequestWrapper(request, I18NHelper.defaultLanguage);
    ...
    if (StringUtil.isDefined(tosToken)) {
      ...
      UserMustAcceptTermsOfServiceVerifier verifier =
          AuthenticationUserVerifierFactory.getUserMustAcceptTermsOfServiceVerifier(tosToken);
      ...
      try {
        ...
        request.setAttribute("internalAuthToken",
            CacheServiceFactory.getApplicationCacheService().add(verifier.getUser()));
