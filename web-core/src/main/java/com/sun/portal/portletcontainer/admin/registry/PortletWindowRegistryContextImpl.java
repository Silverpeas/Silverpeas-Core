...
public class PortletWindowRegistryContextImpl implements PortletWindowRegistryContext {
    ...
    private List getAllPortletWindows(PortletType portletType, boolean allPortlets) throws PortletRegistryException {
    ...
    public void movePortletWindows(List portletWindows) throws PortletRegistryException {
    	...
    	for (int w=0; w<portletWindows.size(); w++)
    	{
    		...
    		PortletRegistryElement element = portletWindowRegistry.getRegistryElement(window.getPortletWindowName());
