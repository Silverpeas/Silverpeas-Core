...
public abstract class PortletRegistryWriter {
    ...
    public PortletRegistryWriter(String registryLocation, String filename, String context) {
     ...
     */
    public abstract void appendDocument(List portletRegistryElementList) throws PortletRegistryException;
     ...
     * @param portletRegistryElementList a <code>List</code> of Portlet registry elements
     */
    public abstract void writeDocument(List portletRegistryElementList) throws PortletRegistryException;
}
