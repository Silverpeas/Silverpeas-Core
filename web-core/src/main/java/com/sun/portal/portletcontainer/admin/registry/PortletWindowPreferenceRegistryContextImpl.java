...
public class PortletWindowPreferenceRegistryContextImpl implements PortletWindowPreferenceRegistryContext {
    ...
    private void init(String context) throws PortletRegistryException {
        ...
        portletWindowPreferenceRegistry = portletWindowPreferenceRegistryReader.readDocument();
        
        portletWindowPreferenceRegistryReader = new PortletWindowPreferenceRegistryReader(registryLocation, null);
        defaultPortletWindowPreferenceRegistry = portletWindowPreferenceRegistryReader.readDocument();
    }
    
    public Map getPreferencesReadOnly(String portletWindowName, String userName) throws PortletRegistryException {
        PortletRegistryElement portletRegistryElement = getDefaultRegistryElement(portletWindowName+getDefaultUserName());
    ...
    public Map getPreferences(String portletWindowName, String userName) throws PortletRegistryException {
        //PortletRegistryElement predefinedPortletRegistryElement = getDefaultRegistryElement(portletWindowName+getDefaultUserName());
    ...
    public void removeWindowPreference(String portletWindowName) throws PortletRegistryException {
        ...
        List portletWindowPreferences = portletWindowPreferenceRegistry.getRegistryElements();
        ...
        for(int i=0; i<size; i++) {
            portletWindowPreference = (PortletRegistryElement)portletWindowPreferences.get(i);
        ...
        for(int i=0; i<size; i++) {
            portletWindowPreference = (PortletRegistryElement)removeablePortletWindowPreferences.get(i);
    ...
    private PortletRegistryElement getDefaultRegistryElement(String name) throws PortletRegistryException {
        PortletRegistryElement portletRegistryElement = defaultPortletWindowPreferenceRegistry.getRegistryElement(name);
        if(portletRegistryElement == null)
            throw new PortletRegistryException(name  + " does not exist");
        return portletRegistryElement;
    }
