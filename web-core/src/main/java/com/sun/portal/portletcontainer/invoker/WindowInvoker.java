...
public abstract class WindowInvoker implements WindowInvokerConstants {
    ...
    // Debug logger
    //---
    private static Logger logger = ContainerLogger.getLogger(WindowInvoker.class, "com.silverpeas.portlets.PCCTXLogMessages");
    ...
    private static List initParamKeyList() {
        ...
        localParamKeyList.add(PORTLET_WINDOW_KEY);
        localParamKeyList.add(PORTLET_WINDOW_MODE_KEY);
    ...
    public String getActionURL(HttpServletRequest request, ChannelMode portletWindowMode,
        ...
        .append("&").append(PORTLET_WINDOW_MODE_KEY).append("=").append(portletWindowMode.toString())
        .append("&").append(PORTLET_WINDOW_STATE_KEY).append("=").append(portletWindowState.toString())
        .append("&").append(PORTLET_WINDOW_KEY).append("=").append(getPortletWindowName());
        
        String spaceId = (String) request.getAttribute("SpaceId");
        if (StringUtil.isDefined(spaceId))
        {
        	processURL.append("&").append(WindowInvokerConstants.DRIVER_SPACEID).append("=").append(spaceId);
