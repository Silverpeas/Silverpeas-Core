 ...
 * and undeployment functionality for Portlets on Tomcat container.
 */
public class TomcatWebAppDeployer implements WebAppDeployer {

    private static Logger logger = Logger.getLogger(TomcatWebAppDeployer.class.getPackage().getName(),
