...
public class PortletAdmin implements PortletAdminMBean {
    ...
    private File preparePortlet(String warFileName) throws Exception {
        ...
        PortletWarUpdater portletWarUpdater = new PortletWarUpdater(configFileLocation, warFileLocation);
    ...
    private Boolean registerPortlet(String warFile, Properties roles,
        ...
        portletRegistryGenerator.register(preparedWarFile, warFileLocation,
                roles, userinfo, portletLanguage);
    ...
    public Boolean deploy(String warFileName, Properties roles,
        ...
        Boolean registerSuccess = registerPortlet(warFileName, roles, userinfo, preparedWarFile);
    ...
    public Boolean unregisterPortlet(String warFileName) throws Exception {
        ...
        Boolean value = portletRegistryGenerator.unregister(
                configFileLocation, warFileLocation, warName);
