...
import static com.silverpeas.admin.web.AdminResourceURIs.buildURI;
...
public class SpaceEntity extends StructureElementEntity<SpaceEntity> {
  ...
  /*
   * (non-Javadoc)
   * @see com.silverpeas.admin.web.StructureElementEntity#withURI(java.net.URI)
   */
  @Override
  ...
  /*
   * (non-Javadoc)
   * @see com.silverpeas.admin.web.StructureElementEntity#getStringParentBaseURI()
   */
  @Override
