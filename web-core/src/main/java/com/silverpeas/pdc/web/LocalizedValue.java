...
public interface LocalizedValue {
   ...
   * than this number, then it is truncated.
   * 
   * An axis value is in fact a path of terms, each of them refining the parent term. In order to
   * avoid a long value rendering, the path is usually truncated between the first terms and the
   * last ones. This parameter indicates the maximum number of terms in a path to display.
   */
   ...
   * An axis value is in fact a path of terms, each of them refining the parent term. In order to
   * avoid a long value rendering, the path is usually truncated between the first terms and the
   * last ones. This parameter indicates the number of terms to print out before and after the
   * truncation.
   */
