...
/**
 * A ProcessInstanceDataRecord groups in a single DataRecord
 * all the data items of a ProcessInstance.
 *
...
public class ProcessInstanceDataRecord implements DataRecord
{
   ...
   * Builds the data record representation of a process instance.
	*/
  public ProcessInstanceDataRecord(ProcessInstance instance,
                                   String role, String lang)
     throws WorkflowException
  {
     this.instance = instance;
	  this.template = (ProcessInstanceRecordTemplate)
	     instance.getProcessModel().getAllDataTemplate(role, lang);
