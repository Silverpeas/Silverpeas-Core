...
**/
public class ItemImpl extends AbstractReferrableObject implements AbstractDescriptor, Item, Serializable 
{
    private String                 name;
    ...
    /*
     * (non-Javadoc)
     * @see com.silverpeas.workflow.api.model.Item#addDescription(com.silverpeas.workflow.api.model.ContextualDesignation)
     */
    ...
    /* (non-Javadoc)
     * @see com.silverpeas.workflow.api.model.Item#addLabel(com.silverpeas.workflow.api.model.ContextualDesignation)
     */
    ...
    /*
     * (non-Javadoc)
     * @see com.silverpeas.workflow.api.model.Item#addParameter(com.silverpeas.workflow.api.model.Parameter)
     */
