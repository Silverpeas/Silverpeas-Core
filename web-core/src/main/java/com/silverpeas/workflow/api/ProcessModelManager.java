...
public interface ProcessModelManager 
{
     ...
     * Retrieves all the files in the directory tree below the process model directory.
     * 
     ...
     * @throws WorkflowException when something goes wrong
	 */
	public ProcessModel createProcessModel(String fileName, String peasId) throws WorkflowException;
