...
/**
 * Interface describing an object holding a collection of <code>ContextualDesignation</code> objects.
 * Does not correspond to any Process Model schema elements.  
 */
public interface ContextualDesignations {
     ...
     * The collection shall be searched for a Designation with the same language and role.
     *   
    ...
    /**
     * Get the designation for the given role and language; make an exact match, do not fall-back
    ...
    /**
     * Get the designation for the given role and language; make the best match if the
     * required language and/ or role are not supported fall-back to the default values
     * to the default values.
     * 
     * @param role     the name of the role
     * @param language the code of the language
