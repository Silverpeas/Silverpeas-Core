...
/**
 * Interface describing a representation of the main &lt;processModel&gt;
 * element of a Process Model. The entry point to reading and manipulating the
 * whole Process Model.
 */
public interface ProcessModel
{
    ...
    /**
     * Create an object implementing ContextualDesignation Method needed
     * primarily by Castor
     */
     ...
     * @return wanted description as a String object. If description is not
     *         found, search description with given role and default language,
     *         if not found again, return the default description in given
     *         language, if not found again, return the default description in
     *         default language, if not found again, return empty string.
     */
     ...
     * 
     * @param data
     *            folder for this process model. it contains all the items
     *            declarations
     * @return
     */
     ...
     * 
     * @return user infos defined for this process model. It contains all the
     *         items necessary about user to allow him to use the instance
     */
    public DataFolder getUserInfos();

    /**
     * Set the user infos defined for this process model It contains all the
     * items necessary about user to allow him to use the instance
     * 
     * @param userInfos
    ...
    /**
     * Returns the record set where are saved all the folder of the instance
     ...
     * action is unknown.
     */
    public com.silverpeas.form.Form getPublicationForm(String actionName, String role, String language)
            throws WorkflowException;

    /**
     * Returns the action of kind create Throws a WorkflowException if there is
     * no action of type create
     */
    public Action getCreateAction() throws WorkflowException;

    /**
     * Returns the com.silverpeas.form.Form which be used to publish the named
     * form. We can give an action name too.
     * 
     * Returns null if the action exists but has no form. Throws a
     * WorkflowException if the action/form is unknown.
     */
    public com.silverpeas.form.Form getPresentationForm(String name, String role, String language)
            throws WorkflowException;

    /**
     * Returns the RecordTemplate which describes all the data of the process
     ...
     */
    public DataRecord getNewActionRecord(String actionName, String roleName, String lang, DataRecord data)
            throws WorkflowException;
