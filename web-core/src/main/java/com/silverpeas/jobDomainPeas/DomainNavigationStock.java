 ...
 *
 * PRE-REQUIRED : the Domain passed in the constructor MUST BE A VALID DOMAIN (with Id, etc...)
 *
 * @t.leroi
 */
public class DomainNavigationStock extends NavigationStock
{
    ...
    public DomainNavigationStock(String navDomain, AdminController adc, List manageableGroupIds)
    {
        super(adc);
