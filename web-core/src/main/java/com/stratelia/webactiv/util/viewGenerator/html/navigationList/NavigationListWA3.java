...
public class NavigationListWA3 extends AbstractNavigationList {
  ...
  public String print() {
    ...
    result
        .append("<table width=\"98%\" border=\"0\" cellspacing=\"0\" cellpadding=\"2\" class=intfdcolor>\n");
    result.append("<tr>\n");
    ...
    result.append("<tr><td>\n");
    result
        .append("<table width=\"100%\" border=\"0\" cellspacing=\"0\" cellpadding=\"3\" class=intfdcolor4>\n");
    ...
    while (i.hasNext()) {
      ...
      if (j <= nbCol) {
        ...
        result.append("\t\t\t\t<tr>\n");
        result.append("\t\t\t\t\t<td width=\"5\" valign=top><img src=\"")
