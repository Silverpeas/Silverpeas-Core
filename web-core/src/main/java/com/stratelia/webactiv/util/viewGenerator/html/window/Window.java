...
/**
 * The Window interface gives us the skeleton for all funtionnalities we need to
 * display typical WA window
 * 
 * @author neysseri
 * @version 1.0
 */
public interface Window extends SimpleGraphicElement {
  ...
  /**
   * Print the window in an html format. The string result must be displayed
   * between html tag <BODY> et </BODY>
   * 
