...
public class FrameSilverpeasV5 extends AbstractFrame
{
    ...
    public String printAfter()
    {
        ...
        result += "\t</tr>\n";
        result += "<tr>\n";
		result += "\t\t<td class=\"basGaucheFrame\"><img src=\"" + iconsPath + "/1px.gif\" height=\"15\"></td>\n";
		result += "\t\t<td class=\"basMilieuFrame\"><img src=\"" + iconsPath + "/1px.gif\" height=\"15\"></td>\n";
		result += "\t\t<td class=\"basDroiteFrame\"><img src=\"" + iconsPath + "/1px.gif\" height=\"15\"></td>\n";
		result += "\t</tr>\n";
        result += "</table>\n";
        return result;
    }
