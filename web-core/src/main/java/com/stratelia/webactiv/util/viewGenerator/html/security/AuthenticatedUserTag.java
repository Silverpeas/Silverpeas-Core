...
package com.stratelia.webactiv.util.viewGenerator.html.security;
  ...
  public int doStartTag() throws JspException {
   MainSessionController sessionController = (MainSessionController) pageContext.getSession()
    ...
    if(sessionController != null) {
      UserDetail user = sessionController.getOrganizationController().getUserDetail(sessionController.getUserId());
