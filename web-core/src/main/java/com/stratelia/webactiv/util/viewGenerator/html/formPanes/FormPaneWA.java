...
public class FormPaneWA extends FormPane
{
    ...
    public String print()
    {
        ...
        result = result + "\n<form name=\"" + name + "\" action=\"" + actionURL + "\" method=\"" + formMethod + "\">";
        ...
        if (formLines.size() > 0)
        {
            ...
            {
                result = result + "\n<tr>" + ((FormLine) formLines.elementAt(i)).print() + "\n</tr>";
            }
            result = result + "\n</table>";
        }
        ...
        if (formActionButtons.size() > 0)
        {
            ...
            {
                result = result + "\n<tr>" + ((FormLine) formActionButtons.elementAt(i)).print() + "\n</tr>";
            }
            result = result + "\n</table>";
        }
     ...
     * @see
     */
    public String printHeader(String trueActionPage, String submitPage, String modifyActionCode)
    {
        String retour = "<!--JAVASCRIPT UTIL -->";

        retour = retour + "\n<script language=\"JavaScript\">";
        retour = retour + "\nfunction addReply() {";
        retour = retour + "\ndocument.replyFormRequest.formName.value = document." + name + ".formName.value";
        retour = retour + "\ndocument.replyFormRequest.formDescription.value = document." + name + ".formDescription.value";
        retour = retour + "\ndocument.replyFormRequest.submit();";
        retour = retour + "\n}";
        retour = retour + "\nfunction clickPubliArchiDemandes() {";
        retour = retour + "\ndocument." + name + ".utilisateurEnvoiDemandes[0].click();";
        retour = retour + "\n}";
        retour = retour + "\nfunction clickUtilEnvoiDemandes() {";
        retour = retour + "\ndocument." + name + ".publieurArchivageDemandes[1].click();";
        retour = retour + "\n}";
        retour = retour + "\n</script>";
        retour = retour + "\n<!--TABLE CONTENU -->";
        retour = retour + "\n<table width=\"100%\" border=\"0\" cellspacing=\"0\" cellpadding=\"0\" class=couleurFondCadre>";
        retour = retour + "\n<FORM name=\"" + name + "\" action=\"" + submitPage + "\" method=\"post\" size=30>";
        if (reply)
        {
        ...
        retour = retour + "\n<tr>";
        retour = retour + "\n<td colspan=\"2\" class=\"couleurCadreInterieur\"><span class=\"titremodule\">&nbsp;" + message.getString("Form");
        retour = retour + "\n</span></td>";
        retour = retour + "\n</tr><tr>";
        retour = retour + "\n<td width=\"52%\" align=\"right\">&nbsp;<span class=\"txtnote\">" + message.getString("Name") + " :&nbsp;</span></td>";
        retour = retour + "\n<td width=\"48%\">";
        retour = retour + "\n<input type=\"text\" name=\"formName\" value=\"" + displayName + "\">";
        retour = retour + "\n</td>";
        retour = retour + "\n</tr>";
        retour = retour + "\n<tr bgcolor=\"#999999\">";
        ...
        retour = retour + "\n</tr>";
        retour = retour + "\n<tr>";
        retour = retour + "\n<td width=\"52%\" align=\"right\">&nbsp;<span class=\"txtnote\">" + message.getString("Description") + " :&nbsp;</span></td>";
        retour = retour + "\n<td width=\"48%\"><font size=\"1\">";
        retour = retour + "\n<textarea name=\"formDescription\" cols=\"45\" rows=\"6\" wrap=VIRTUAL>" + description + "</textarea>";
        retour = retour + "\n</font></td>";
        retour = retour + "\n</tr>";
        retour = retour + "\n<tr bgcolor=\"#999999\">";
        retour = retour + "\n<td colspan=\"2\" align=\"right\"><img src=\"icons/1px.gif\" width=\"1\" height=\"1\"></td>";
        retour = retour + "\n</tr>";
        retour = retour + "\n<tr>";
        retour = retour + "\n<td width=\"52%\" align=\"right\"><span class=\"txtnote\">" + message.getString("AskReply") + " :&nbsp;</span></td>";
        retour = retour + "\n<td width=\"48%\">";
        ...
        retour = retour + "\n</tr>";
        retour = retour + "\n<tr>";
        retour = retour + "\n<td colspan=\"2\" class=\"couleurCadreInterieur\"><span class=\"titremodule\">&nbsp;" + message.getString("EditorMode") + "</span></td>";
        retour = retour + "\n</tr>";
        retour = retour + "\n<tr>";
        retour = retour + "\n<td width=\"52%\" align=\"right\">&nbsp;<span class=\"txtnote\">" + message.getString("RequestsStorage") + " :</span></td>";
        retour = retour + "\n<td width=\"48%\"><span class=\"txtnote\">&nbsp;" + message.getString("Oui") + " ";
        ...
        retour = retour + "\n<img src=\"icons/1pxg.gif\" width=\"1\" height=\"20\" valign=\"absmiddle\" align=\"absmiddle\">&nbsp;" + message.getString("Non") + " ";
        ...
        {
            retour = retour + "\n<tr>";
            retour = retour + "\n<td width=\"52%\" align=\"right\">&nbsp;<span class=\"txtnote\">" + message.getString("ResponsesStorage") + "&nbsp;:</span></td>";
            retour = retour + "\n<td width=\"48%\"><span class=\"txtnote\">&nbsp;" + message.getString("Oui") + " ";
        ...
        retour = retour + "\n</tr>";
        retour = retour + "\n<tr>";
        retour = retour + "\n<td colspan=\"2\" class=\"couleurCadreInterieur\"><span class=\"titremodule\">&nbsp;" + message.getString("UserMode") + "</span></td>";
        retour = retour + "\n</tr>";
        retour = retour + "\n<tr>";
        retour = retour + "\n<td width=\"52%\" align=\"right\">&nbsp;<span class=\"txtnote\">" + message.getString("RequestsStorage") + " :</span></td>";
        retour = retour + "\n<td width=\"48%\"><span class=\"txtnote\">&nbsp;" + message.getString("Oui") + " ";
        ...
        retour = retour + "\n</tr>";
        retour = retour + "\n<tr>";
        retour = retour + "\n<td width=\"52%\" align=\"right\">&nbsp;<span class=\"txtnote\">" + message.getString("RequestsSending") + " :</span></td>";
        retour = retour + "\n<td width=\"48%\"><span class=\"txtnote\">&nbsp;" + message.getString("Oui") + " ";
        ...
        retour = retour + "\n</table>";
        retour = retour + "\n<!--  -->";
        retour = retour + "\n<form name=\"replyFormRequest\" action=\"" + trueActionPage + "&action=";
     ...
     * @see
     */
    public String printDemo(String trueActionPage, String deleteActionCode, String modifyActionCode)
    {
        int    i;
        String result = "\n<!-- Formulaire genere automatiquement par Activ'Portal -->\n";
        ...
        if (formHiddenFields.size() > 0)
        {
            ...
            for (i = 0; i < formHiddenFields.size(); i++)
            {
                result = result + "\n<tr>" + ((FormLine) formHiddenFields.elementAt(i)).printDemo();
                result = result + "\n<td>";
                ...
                {
                    result = result + "<a href=\"" + trueActionPage + "&action=" + deleteActionCode;
                    result = result + "&params=" + ((FormLine) formHiddenFields.elementAt(i)).getName() + "\">" + message.getString("Supprimer") + "</a>";
                }
                result = result + "\n</td>\n</tr>";
            }
            result = result + "\n</table>";
        ...
        if (formLines.size() > 0)
        {
            ...
            for (i = 0; i < formLines.size(); i++)
            {
                result = result + "\n<tr>" + ((FormLine) formLines.elementAt(i)).printDemo();
                result = result + "\n<td>";
                ...
                {
                    result = result + "<a href=\"" + trueActionPage + "&action=" + deleteActionCode;
                    result = result + "&params=" + ((FormLine) formLines.elementAt(i)).getName() + "\">" + message.getString("Supprimer") + "</a>";
                }
                result = result + "\n</td>\n</tr>";
            }
            result = result + "\n</table>";
        ...
        if (formActionButtons.size() > 0)
        {
            ...
            for (i = 0; i < formActionButtons.size(); i++)
            {
                result = result + "\n<tr>" + ((FormLine) formActionButtons.elementAt(i)).printDemo();
                result = result + "\n<td>";
                ...
                {
                    result = result + "<a href=\"" + trueActionPage + "&action=" + deleteActionCode;
                    result = result + "&params=" + ((FormLine) formActionButtons.elementAt(i)).getName() + "\">" + message.getString("Supprimer") + "</a>";
                }
                result = result + "\n</td>\n</tr>";
            }
            result = result + "\n</table>";
