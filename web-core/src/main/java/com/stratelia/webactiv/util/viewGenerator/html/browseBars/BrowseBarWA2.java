...
public class BrowseBarWA2 extends AbstractBrowseBar
{
    ...
    private String displayLine()
    {
        ...
        if ((getPath() == null) && (getExtraInformation() == null))
            ...
            nb = 3;
        line.append("<tr><td colspan=\"").append(nb).append("\" bgcolor=\"#999999\" width=\"100%\"><img src=\"").append(iconsPath).append("/1px.gif\" width=\"1\" height=\"1\"></td></tr>");
        line.append("<tr><td colspan=\"").append(nb).append("\" bgcolor=\"#666666\" width=\"100%\"><img src=\"").append(iconsPath).append("/1px.gif\" width=\"1\" height=\"1\"></td></tr>");
    ...
    public String print()
    {
        ...
        result.append("<table cellspacing=\"0\" cellpadding=\"0\" border=\"0\" width=\"100%\" bgcolor=DEDEDE>\n");
        result.append("<tr>\n");
        result.append("<td rowspan=5 bgcolor=999999><img src=\"").append(iconsPath).append("/1px.gif\" width=1></td>\n");
        result.append("<td colspan=3 bgcolor=999999><img src=\"").append(iconsPath).append("/1px.gif\"></td>\n");
        result.append("<td rowspan=5 bgcolor=333333><img src=\"").append(iconsPath).append("/1px.gif\" width=1></td>\n");
        result.append("</tr>\n");

        result.append("<tr><td colspan=3 bgcolor=FFFFFF><img src=\"").append(iconsPath).append("/1px.gif\"></td></tr>\n");
        result.append("<tr>\n");
