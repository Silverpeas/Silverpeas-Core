...
public abstract class AbstractPagination implements Pagination
{
	...
	public void init(int nbItems, int nbItemsPerPage, int firstItemIndex)
	{
		...
		SilverTrace.info("viewgenerator", "AbstractPagination.constructor()", "root.MSG_GEN_PARAM_VALUE", "nbItems = "+nbItems+", nbItemsPerPage = "+nbItemsPerPage+", firstItemIndex = "+firstItemIndex);
	}
	...
	public int getCurrentPage()
	{
		...
		SilverTrace.info("viewgenerator", "AbstractPagination.getCurrentPage()", "root.MSG_GEN_PARAM_VALUE", "currentPage = "+currentPage);
	...
	public int getNbPage()
	{
		...
		if ((getNbItems()%getNbItemsPerPage()) != 0)
			nbPage++;
		SilverTrace.info("viewgenerator", "AbstractPagination.getNbPage()", "root.MSG_GEN_PARAM_VALUE", "nbPage = "+nbPage);
		return nbPage;
	}
