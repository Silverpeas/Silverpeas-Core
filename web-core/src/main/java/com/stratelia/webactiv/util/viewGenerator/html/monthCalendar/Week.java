    ...
    private Vector initListEventWeek(Vector listEventMonth)
    {
        ...
        while (itEvent.hasNext())
        {
            ...
            if (currentEvt.isInWeek(startDate, endDate))
            {
                ...
                // ramène le date du nouvel evenement (issue de l'evenement en cours) au limite de date de la semaine
    ...
    private Vector initListRow(Vector listEventWeek)
    {
        ...
        while (it.hasNext())
        {
            ...
            while (!resultAddEventInRow)
            {
                ...
                {
                    // l'événement à été rajouter au row courrant, on remplace l'ancien row par le row courrant
                ...
                {
                    // il est impossible de rajouter l'evt dans le row courrant, on passe au row suivant s'il existe sinon on le crée
