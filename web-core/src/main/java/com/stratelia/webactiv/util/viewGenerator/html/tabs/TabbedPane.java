...
/**
 * TabbedPane is an interface to be implemented by a graphic element
 * to print tabs in an html format.
 * @author squere
 * @version 1.0
 */
public interface TabbedPane extends SimpleGraphicElement
{
    ...
    /**
     * Set the number of level between the root directory and
     * the current one (the directory from the page we are generating).
     * The default is 2.
     ...
     * @param action The action associated with this pane.
     * Exemple : "javascript:onClick=viewByDay()"
     ...
     */
    public void addTab(String label, String action, boolean selected, boolean enabled);
