...
public class OperationPaneSilverpeasV5 extends AbstractOperationPane
{
    ...
    public void addOperation(String iconPath, String altText, String action)
    {
        ...
        operation.append("<tr>\n");
        operation.append("<td valign=\"top\" align=center class=\"operationStyle\" width=\"34\" height=\"34\"><a id=\"")
        .append(altText).append("\" href=\"").append(action).append("\"><img src=\"").append(iconPath).append("\" alt=\"").append(altText).append("\" title=\"").append(altText).append("\" border=\"0\"></a></td>\n");
        operation.append("</tr>\n");
    ...
    public void addLine()
    {
        ...
        stack.add("<tr><td><img src=\""+iconsPath+"/tabs/1px.gif\"></td></tr>\n");
    }
