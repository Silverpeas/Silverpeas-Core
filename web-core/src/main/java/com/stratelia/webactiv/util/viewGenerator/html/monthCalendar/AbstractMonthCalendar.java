...
public abstract class AbstractMonthCalendar implements MonthCalendar
{
    ...
    {
    	SilverTrace.info("viewgenerator", "AbstractMonthCalendar.Constructor", "root.MSG_GEN_ENTER_METHOD", " Language = " + language);
        ...
        initDayOfWeek();
        SilverTrace.info("viewgenerator", "AbstractMonthCalendar.Constructor", "root.MSG_GEN_EXIT_METHOD");
    }
    /**
     * to add event in the month calendar
     * @param eventMonth: type com.stratelia.webactiv.util.viewGenerator.html.monthCalendar.Event: the evenet of the current month
     * @return: void
     */
    ...
    {
    	SilverTrace.debug("viewgenerator", "MonthCalendarWA1.setCurrentMonth()", "root.MSG_GEN_PARAM_VALUE", "currentDate = " + currentDate);
        ...
        numbersWeekInMonth = weeksIn(cal.get(Calendar.MONTH), this.firstDayOfWeek, cal.get(Calendar.YEAR));
        SilverTrace.debug("viewgenerator", "MonthCalendarWA1.setCurrentMonth()", "root.MSG_GEN_PARAM_VALUE", "numbersWeekInMonth = " + numbersWeekInMonth);
        
        modifiedListEventMonth();
        SilverTrace.debug("viewgenerator", "MonthCalendarWA1.setCurrentMonth()", "root.MSG_GEN_PARAM_VALUE", "cal.getTime() = " + cal.getTime());
    ...
    /**
     * the events are limited at the date of current month
     * example 1: current month jun
     * event Startdate = 28/05  -  EndDate = 15/06
     * for the object monthCalendar this event is modified:
     * event StartDate = 1/06  -  EndDate = 15/06
     * 
     * example 2: current month = jun
     * event StartDate = 9/06  -  EnDate = 18/07
     * for the object monthCalendar this event is modified:
     * event  StartDate = 9/06  - EndDate = 30/06
     * 
     * @return: void
    ...
    private void modifiedListEventMonth()
    {
        ...
        while (it.hasNext())
        {
            // limitation de la date de début de l'événement au premier jour du mois courrant
    ...
    private Vector initListWeek()
    {
        ...
        /*calY.clear(Calendar.HOUR_OF_DAY);
        calY.clear(Calendar.HOUR);
        calY.clear(Calendar.MINUTE);
        calY.clear(Calendar.SECOND);
		...
		SilverTrace.debug("viewgenerator", "MonthCalendarWA1.setCurrentMonth()", "root.MSG_GEN_PARAM_VALUE", "calY.getTime() = " + calY.getTime());
        ...
        for (int k = 1; k <= numbersWeekInMonth; k++)
        {
            ...
            SilverTrace.debug("viewgenerator", "MonthCalendarWA1.setCurrentMonth()", "root.MSG_GEN_PARAM_VALUE", "for k="+k+" calY.getTime() = " + calY.getTime());
            ...
            for (int z = 0; z < numbersDayOfWeek; z++)
            {
                ...
                Day     d = new Day(dateDay, getNameDay(dateDay), getNumbersDay(dateDay), dayIsInThisMonth);
            ...
            // ajout de la nouvelle semaine seulement s'il y a au mois 1 jour qui appartient au mois courrant
    ...
    private String getNameDay(Date date)
    {
        ...
        return messages.getString(propertieJour + calendar.get(Calendar.DAY_OF_WEEK));
    ...
    private void initDayOfWeek()
    {
        ...
        try
        {
            ...
            numbersDayOfWeek = Integer.parseInt(messages.getString("numbersDayOfWeek"));

            cal.set(Calendar.DAY_OF_WEEK, firstDayOfWeek);
        }
        catch (Exception e)
        {
            SilverTrace.warn("viewgenerator", "AbstractMonthCalendar.initDayOfWeek()", "viewgenerator.EX_CANT_LOAD_DATE_UTIL", "DateUtil propertie: firstDayOfWeek = " + firstDayOfWeek + "; lastDayOfWeek = " + lastDayOfWeek + "; numbersDayOfWeek = " + numbersDayOfWeek + "; numbersWeekInMonth = " + numbersWeekInMonth + ". ", e);
        }
    }
    ...
    {
    	SilverTrace.debug("viewgenerator", "MonthCalendarWA1.weeksIn()", "root.MSG_GEN_PARAM_VALUE", "month = "+month+", firstDayOfWeek = "+firstDayOfWeek+", year = "+year);
        ...
        SilverTrace.debug("viewgenerator", "MonthCalendarWA1.weeksIn()", "root.MSG_GEN_PARAM_VALUE", "minimal day in first week = "+calendar.getMinimalDaysInFirstWeek());
        ...
        SilverTrace.debug("viewgenerator", "MonthCalendarWA1.weeksIn()", "root.MSG_GEN_PARAM_VALUE", "calendar.getTime() = "+calendar.getTime());
    ...
    /**
     * this method is use by the class who extend AbstractMonthCalendar
     * the get method to obtain numbers week in the current month
     * @return: int
     */
    ...
    /**
     * this method is use by the class who extend AbstractMonthCalendar
     * the get method to obtain numbers day int the week of current month
     * @return: int
     */
    ...
    /**
     * this method is use by the class who extend AbstractMonthCalendar
     * the get method to obtain the list of Day
    ...
    /**
     * this method is use by the class who extend AbstractMonthCalendar
     * the get method to obtain the numbers of row int the week
     * @param: int: the week
     * @return: int:
     * @see com.stratelia.webactiv.util.viewGenerator.html.monthCalendar.Week
     * @see com.stratelia.webactiv.util.viewGenerator.html.monthCalendar.Row
    ...
    /**
     * this method is use by the class who extend AbstractMonthCalendar
     * the get method to obtain an array of object Event
     * @param int: the week
    ...
    protected Event[] getEventOfRow(int week, int row)
    {
        ...
        //EventBeginDateComparatorAsc comparateur = new EventBeginDateComparatorAsc();
