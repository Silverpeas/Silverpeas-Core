...
/**
 * The FormPane interface gives us the skeleton for all
 * funtionnalities we need to display typical WA form
 * table pane.
 * @author frageade
 * @version 1.0
 */
public abstract class FormPane implements SimpleGraphicElement
{
    ...
    {
        return formLines.size() + formHiddenFields.size() + formActionButtons.size();
    }
    ...
    public String toXML()
    {
        ...
        result = result + "\n<utilisateurArchivageDemandes>" + String.valueOf(utilisateurArchivageDemandes) + "</utilisateurArchivageDemandes>";
        result = result + "\n<publieurArchivageDemandes>" + String.valueOf(publieurArchivageDemandes) + "</publieurArchivageDemandes>";
        result = result + "\n<utilisateurArchivageReponses>" + String.valueOf(utilisateurArchivageReponses) + "</utilisateurArchivageReponses>";
        result = result + "\n<publieurArchivageReponses>" + String.valueOf(publieurArchivageReponses) + "</publieurArchivageReponses>";
        result = result + "\n<utilisateurEnvoiDemandes>" + String.valueOf(utilisateurEnvoiDemandes) + "</utilisateurEnvoiDemandes>";
    ...
    public String getBuildRequest()
    {
        ...
        if (formLines.size() > 0)
        {
            for (i = 0; i < formLines.size(); i++)
            {
                result = result + ((FormLine) formLines.elementAt(i)).getDBColumnCreationRequest();
            }
        }
     ...
     * @see
     */
    public abstract String printDemo(String trueActionPage, String deleteActionCode, String modifyActionCode);
     ...
     * @see
     */
    public abstract String printHeader(String trueActionPage, String submitPage, String modifyActionCode);
}
