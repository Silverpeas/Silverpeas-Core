...
public class EventBeginDateComparatorAsc implements Comparator
{
	...
	public int compare(Object o1, Object o2)
	{
		...
		String separator = ":";
		if (startHour != null && startHour.length() > 0 && startHour.lastIndexOf(separator) != -1)
		{
			int hour = Integer.parseInt(startHour.substring(0, startHour.lastIndexOf(separator)));
			int minutes = Integer.parseInt(startHour.substring(startHour.lastIndexOf(separator)+1, startHour.length()));
		...
		int compareResult = (new Long(date1.getTimeInMillis())).compareTo(new Long((date2.getTimeInMillis())));
