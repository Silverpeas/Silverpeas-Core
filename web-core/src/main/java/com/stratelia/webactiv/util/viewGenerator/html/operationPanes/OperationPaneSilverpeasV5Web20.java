...
public class OperationPaneSilverpeasV5Web20 extends AbstractOperationPane
{
    ...
    public String print()
    {
        ...
        result.append("<div align=\"right\"><span id=\"menutoggle\">"+GraphicElementFactory.getSettings().getString("ActionsLabel", "Opérations")+"<img src=\"").append(getIconsPath()).append("/ptr.gif\"></span></div>");
