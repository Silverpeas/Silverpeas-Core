...
/**
 * NavigationList is an interface to be implemented by a graphic element Very
 * usefull to create a list of items in an html format.
 * 
 * @author lloiseau
 * @version 1.0
 */
public interface NavigationList extends SimpleGraphicElement {
  /**
   * Add an item with label, number of elements, information in the navigation
   * list and an universal link
   * 
   * @param label
