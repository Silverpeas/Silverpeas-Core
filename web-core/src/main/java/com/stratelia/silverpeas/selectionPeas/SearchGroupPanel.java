...
public class SearchGroupPanel extends BrowsePanelProvider
{
    ...
    public SearchGroupPanel(String language, ResourceLocator rs, CacheManager cm, SelectionUsersGroups sug)
    {
...
//        refresh(null);
    ...
    public void initAll(SelectionUsersGroups sug)
    {
        ...
        m_SearchTokens[FILTER_NAME] = new PanelSearchEdit(0, m_Message.getString("GML.name"),"");
