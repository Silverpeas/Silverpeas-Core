        ...
        if (m_Session != null)
        {
            try
            {
                ...
                while (spSessionAttNames.hasMoreElements())
                {
                    ...
                    //SilverTrace.info("peasCore","LoginServlet.cleanSession()","root.MSG_GEN_PARAM_VALUE","spName=" + spName);
                ...
                for (int i=0; i<spNames.size(); i++)
                {
                    ...
                    {
                        SilverTrace.warn("peasCore","SessionInfo.cleanSession()","root.MSG_GEN_PARAM_VALUE","ERROR for parameter : " + spName,ex);
                    }
                }
            ...
            {
                SilverTrace.warn("peasCore","SessionInfo.cleanSession()","root.MSG_GEN_PARAM_VALUE","ERROR !!!",e);
            }
        }
    }
