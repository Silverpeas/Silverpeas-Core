...
public class SpaceModel
{
    ...
    /**
     * ArrayList portlets : Linear list of all portlets of this space whatever is the column where it reside
     */
    ...
    /**
     * Empty constructor to satisfy the J2EE requirement for the &lt;jsp:useBean&gt; tag
     * Should never be called
     * 
     */
    public SpaceModel() throws PortletException
    {
        throw new PortletException("SpaceModel.SpaceModel()", SilverpeasException.ERROR, "portlet.EX_CANT_USED_THIS_CONSTRUCTOR");
    }
    ...
    /**
     * Insert a single portlet to the SpaceModel at the specified col, before the specified row
     * if the col is invalid a new one is created and added to the spaceModel
     */
    ...
    /**
     * Append a single portlet to the SpaceModel to the specified column.
     * if the column is invalid, create a new one.
     */
    ...
    /*
     * public void removePortlet(int portletIndex) {
     * // retrieve the portlet
     * Portlet portlet = (Portlet)portlets.get(portletIndex) ;
     * // retrieve the portletIndex in the column
     * int col = portlet.getColumnNumber() ;
     * // remove the portlet from the SpaceColumn
     * SpaceColumn sc = (SpaceColumn)spaceColumns.get(col) ;
     * int row = portlet.getRow() ;
     * sc.removePortlet(row) ;
     * // remove the portlet from the space
