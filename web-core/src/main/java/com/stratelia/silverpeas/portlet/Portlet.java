...
public class Portlet
{
    ...
    private boolean         maximizable;  // true if the user is alowed to maximize the portlet
    private boolean         minimizable;  // true si l'utilisateur est autorisé à minimiser la portlet : Seule sa title bar est visible.
    ...
    {
        throw new PortletException("Portlet.Portlet()", SilverpeasException.ERROR, "portlet.EX_CANT_USED_THIS_CONSTRUCTOR");
    }
     ...
     * @see
     */
    public Portlet(int aId,  // now the instanceId in the database
    int aRowId,              // The PortletRowId in the database
    String aRequestRooter,   // The Component request rooter
    String aComponentName,   // 
    String aComponentInstanceId, String aName,  // This name will be in the title bar
    String aDescription, String aTitlebarUrl, String aIconUrl, String aContentUrl,  // The main property for the portlet
    String aMaxContentUrl, String aHeaderUrl, String aFooterUrl, String aHelpUrl, boolean aMaximizable,  // true if the user is aloud to maximize the portlet : elle occupe tout l'espace
    boolean aMinimizable,  // true if the user is aloud to minimiser la portlet : Seule sa title bar est visible.
    int aState)
    {                        // Current state of the portlet (Minimized, maximized, ...)
        ...
        setHelpUrl(aHelpUrl);
        setMaximizable(aMaximizable);  // true si l'utilisateur est autorisé à maximiser la portlet : elle occupe tout l'espace
        setMinimizable(aMinimizable);  // true si l'utilisateur est autorisé à minimiser la portlet : Seule sa title bar est visible.
        setState(aState);
    }
