...
public class PortletStateTable extends AbstractTable {
   ...
   */
  static final protected String PORTLETSTATE_COLUMNS
    = "id,state,userId,portletRowId";
  ...
  static final private String SELECT_PORTLETSTATE_BY_ID
    = "Select " + PORTLETSTATE_COLUMNS + " from ST_PortletState Where id = ?";


  /**
   * Returns all the PortletState rows having a given portletRowId
   */
  public PortletStateRow[] getAllByPortletRowId(int aPortletRowId, String orderField)
    throws UtilException
  {
    String req = "select " + PORTLETSTATE_COLUMNS +
                 " from ST_PortletState" +
  ...
  public PortletStateRow[] getAllByPortletRowId(int portletRowId)
    throws UtilException
  {
    return (PortletStateRow[]) getRows(SELECT_ALL_PORTLETSTATE_WITH_GIVEN_PORTLETROWID,portletRowId)
           .toArray(new PortletStateRow[0]);
  }

  static final private String SELECT_ALL_PORTLETSTATE_WITH_GIVEN_PORTLETROWID = "select " + PORTLETSTATE_COLUMNS + " from ST_PortletState where portletRowId=?";
  ...
  public PortletStateRow[] getAllByUserId(int userId)
    throws UtilException
  {
    return (PortletStateRow[]) getRows(SELECT_ALL_PORTLETSTATE_WITH_GIVEN_USERID,userId)
           .toArray(new PortletStateRow[0]);
  }

  static final private String SELECT_ALL_PORTLETSTATE_WITH_GIVEN_USERID = "select " + PORTLETSTATE_COLUMNS + " from ST_PortletState where userId=?";
  ...
  {
    return (PortletStateRow[]) getRows(SELECT_ALL_PORTLETSTATE).toArray(new PortletStateRow[0]);
  }

  static final private String SELECT_ALL_PORTLETSTATE
    = "select " + PORTLETSTATE_COLUMNS + " from ST_PortletState";
  ...
  {
    return (PortletStateRow[]) getRows(query)
           .toArray(new PortletStateRow[0]);
  }
  ...
  static final private String INSERT_PORTLETSTATE
    = "insert into"
  ...
  static final private String UPDATE_PORTLETSTATE
    = "Update ST_PortletState set"
    + " state = ?,"
    + " userId = ?,"
    + " portletRowId = ?"
    + " Where id = ?";
     ...
     throws UtilException
  {
    ...
    static final private String DELETE_PORTLETSTATE
       = "delete from ST_PortletState where id=?";
    ...
    throws UtilException
  {
    PortletStateRow[] portletStateToBeDeleted
       = getAllByPortletRowId(portletRowId);
  ...
  protected Object fetchRow(ResultSet rs)
     throws SQLException
  {
    return new PortletStateRow(
      rs.getInt("id"),
      rs.getInt("state"),
      rs.getInt("userId"),
      rs.getInt("portletRowId")) ;
  }
