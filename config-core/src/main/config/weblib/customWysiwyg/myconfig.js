...
['TextColor','BGColor'],
'/',
['Style','FontFormat','FontSize','Templates'],
['Source']
] ;
...
FCKConfig.ToolbarSets["quickinfo"] = [
	['Copy','Paste','PasteText','PasteWord'],
	['Undo','Redo'],
	['Link','Unlink'],
...
FCKConfig.ToolbarSets["almanach"] = [
	['Copy','Paste','PasteText','PasteWord'],
	['Undo','Redo'],
	['Link','Unlink'],
	['Table','Rule','SpecialChar'],
...
FCKConfig.LinkBrowserURL = FCKConfig.BasePath + '../../uploadFile.jsp';
FCKConfig.LinkBrowserWindowWidth	= FCKConfig.ScreenWidth * 0.7 ;		// 70%
FCKConfig.LinkBrowserWindowHeight	= FCKConfig.ScreenHeight * 0.7 ;	// 70%

FCKConfig.ImageBrowser = true ;
FCKConfig.ImageBrowserURL = FCKConfig.BasePath + '../../uploadFile.jsp';
FCKConfig.ImageBrowserWindowWidth  = FCKConfig.ScreenWidth * 0.7 ;	// 70% ;
FCKConfig.ImageBrowserWindowHeight = FCKConfig.ScreenHeight * 0.7 ;	// 70% ;

FCKConfig.FlashBrowser = true ;
FCKConfig.FlashBrowserURL = FCKConfig.BasePath + '../../uploadFile.jsp';
FCKConfig.FlashBrowserWindowWidth  = FCKConfig.ScreenWidth * 0.7 ;	//70% ;
FCKConfig.FlashBrowserWindowHeight = FCKConfig.ScreenHeight * 0.7 ;	//70% ;

FCKConfig.MediaBrowser = true ;
FCKConfig.MediaBrowserURL = FCKConfig.BasePath + '../../uploadFile.jsp';
