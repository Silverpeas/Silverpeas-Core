...
ALTER TABLE PdcAxisValue DROP CONSTRAINT PK_PdcAxisValue;

ALTER TABLE PdcClassification DROP CONSTRAINT PK_PdcClassification;

ALTER TABLE PdcClassification_PdcPosition DROP CONSTRAINT PK_PdcClassification_PdcPosition;
ALTER TABLE PdcClassification_PdcPosition DROP CONSTRAINT UQ_PdcClassification_PdcPosition;

ALTER TABLE PdcPosition DROP CONSTRAINT PK_PdcPosition;

ALTER TABLE PdcPosition_PdcAxisValue DROP CONSTRAINT PK_PdcPosition_PdcAxisValue;
