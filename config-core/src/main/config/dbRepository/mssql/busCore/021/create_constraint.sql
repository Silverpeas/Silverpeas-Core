ALTER TABLE ST_AccessLevel WITH NOCHECK ADD CONSTRAINT PK_AccessLevel PRIMARY KEY CLUSTERED(id);
ALTER TABLE ST_AccessLevel ADD CONSTRAINT UN_AccessLevel_1 UNIQUE (name);

ALTER TABLE ST_User WITH NOCHECK ADD CONSTRAINT PK_User PRIMARY KEY CLUSTERED(id);
...
ALTER TABLE ST_Group WITH NOCHECK ADD CONSTRAINT PK_Group PRIMARY KEY CLUSTERED(id);
...
ALTER TABLE ST_Group_User_Rel WITH NOCHECK ADD CONSTRAINT PK_Group_User_Rel PRIMARY KEY CLUSTERED(groupId, userId);
...
ALTER TABLE ST_Space WITH NOCHECK ADD CONSTRAINT PK_Space PRIMARY KEY CLUSTERED(id);
...
ALTER TABLE ST_ComponentInstance WITH NOCHECK ADD CONSTRAINT PK_ComponentInstance PRIMARY KEY CLUSTERED(id);
...
ALTER TABLE ST_Instance_Data WITH NOCHECK ADD CONSTRAINT PK_Instance_Data PRIMARY KEY CLUSTERED(id);
...
ALTER TABLE ST_UserRole WITH NOCHECK ADD CONSTRAINT PK_UserRole PRIMARY KEY CLUSTERED(id);
...
ALTER TABLE ST_UserRole_User_Rel WITH NOCHECK ADD CONSTRAINT PK_UserRole_User_Rel PRIMARY KEY CLUSTERED(userRoleId, userId);
...
ALTER TABLE ST_UserRole_Group_Rel WITH NOCHECK ADD CONSTRAINT PK_UserRole_Group_Rel PRIMARY KEY CLUSTERED(userRoleId, groupId);
...
ALTER TABLE ST_SpaceUserRole WITH NOCHECK ADD CONSTRAINT PK_SpaceUserRole PRIMARY KEY CLUSTERED(id);
...
ALTER TABLE ST_SpaceUserRole_User_Rel WITH NOCHECK ADD CONSTRAINT PK_SpaceUserRole_User_Rel PRIMARY KEY CLUSTERED(spaceUserRoleId, userId);
...
ALTER TABLE ST_SpaceUserRole_Group_Rel WITH NOCHECK ADD CONSTRAINT PK_SpaceUserRole_Group_Rel PRIMARY KEY CLUSTERED(spaceUserRoleId, groupId);
...
ALTER TABLE DomainSP_Group WITH NOCHECK ADD CONSTRAINT PK_DomainSP_Group PRIMARY KEY CLUSTERED(id);
...
ALTER TABLE DomainSP_User WITH NOCHECK ADD CONSTRAINT PK_DomainSP_User PRIMARY KEY CLUSTERED(id);
...
ALTER TABLE ST_Domain WITH NOCHECK ADD CONSTRAINT PK_ST_Domain PRIMARY KEY CLUSTERED(id);

ALTER TABLE DomainSP_Group_User_Rel WITH NOCHECK ADD CONSTRAINT PK_DomainSP_Group_User_Rel PRIMARY KEY CLUSTERED(groupId,userId);

ALTER TABLE ST_LongText WITH NOCHECK ADD CONSTRAINT PK_ST_LongText PRIMARY KEY  CLUSTERED (id,orderNum);
