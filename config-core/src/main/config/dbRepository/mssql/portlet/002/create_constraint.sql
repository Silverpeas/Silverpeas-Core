ALTER TABLE ST_PortletColumn WITH NOCHECK ADD CONSTRAINT PK_PortletColumn PRIMARY KEY CLUSTERED(id);
ALTER TABLE ST_PortletColumn ADD CONSTRAINT FK_PortletColumn_1 FOREIGN KEY(spaceId) REFERENCES ST_Space (id);

ALTER TABLE ST_PortletRow WITH NOCHECK ADD CONSTRAINT PK_PortletRow PRIMARY KEY CLUSTERED(id);
...
ALTER TABLE ST_PortletState WITH NOCHECK ADD CONSTRAINT PK_PortletState PRIMARY KEY CLUSTERED(id);
...
ALTER TABLE ST_Component WITH NOCHECK ADD CONSTRAINT PK_Component PRIMARY KEY CLUSTERED(id);
