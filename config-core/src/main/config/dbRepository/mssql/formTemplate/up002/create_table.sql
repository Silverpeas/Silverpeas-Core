...
ADD fieldName varchar(100) NOT NULL default('defaultValue')
;

UPDATE    SB_FormTemplate_TextField
SET       SB_FormTemplate_TextField.fieldName = SB_FormTemplate_TemplateField.fieldName
...
ALTER TABLE SB_FormTemplate_TextField ADD 
   ...
   PRIMARY KEY ( recordId, fieldName )
;
