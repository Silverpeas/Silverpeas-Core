...
ALTER TABLE ST_Space
ADD isInheritanceBlocked int default(0) NOT NULL
; 
...
ADD isInherited int default(0) NOT NULL 
;

ALTER TABLE ST_ComponentInstance
ADD isPublic int default(0) NOT NULL 
;

ALTER TABLE ST_ComponentInstance
ADD isHidden int default(0) NOT NULL
;
