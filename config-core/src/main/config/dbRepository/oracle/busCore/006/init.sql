...
insert into ST_Domain(id, name, description, propFileName, className, authenticationServer, theTimeStamp)
values             (-1, 'internal', 'Do not remove - Used by Silverpeas engine', '-', '-', '-', '0');

insert into ST_Domain(id, name, description, propFileName, className, authenticationServer, theTimeStamp)
values             (0, 'domainSilverpeas', 'default domain for Silverpeas', 'com.stratelia.silverpeas.domains.domainSP', 'com.stratelia.silverpeas.domains.silverpeasdriver.SilverpeasDriver', 'autDomainSP', '0');
