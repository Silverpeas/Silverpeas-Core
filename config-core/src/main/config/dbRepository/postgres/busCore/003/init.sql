...
insert into ST_Domain(id, name, description, propFileName, className, authenticationServer)
values             (0, 'domainSilverpeas', 'default domain for Silverpeas', 'com.stratelia.silverpeas.domains.domainSP', 'com.stratelia.silverpeas.domains.silverpeasdriver.SilverpeasDriver', 'autDomainSP');
