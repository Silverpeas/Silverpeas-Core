...
public class LDAPDriverIT {
  ...
  public static Archive<?> createTestArchive() {
    return WarBuilder4LibCore.onWarForTestClass(LDAPDriverIT.class)
  ...
  public void prepareConnection() throws Exception {
    ...
    final String BACKEND_ID = "org/silverpeas";
  ...
  private void stopLdapServer() {
    if (EmbeddedUtils.isRunning()) {
      EmbeddedUtils.stopServer(LDAPDriverIT.class.getName(), Message.EMPTY);
