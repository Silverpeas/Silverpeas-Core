...
/**
 * Unit tests on the deletion of a resource in Silverpeas through a REST web service. This class is
...
public abstract class ResourceDeletionTest<T extends TestResources> extends RESTWebServiceTest<T>
  ...
  /**
   * Requests a delete of the web resource identified at the specified URI. If an error occurs, then
   * an UniformInterfaceException exception is thrown.
