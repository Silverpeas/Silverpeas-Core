...
/**
 * Unit tests on the services provided by a web resource in Silverpeas. This interface defines the
 * operations a unit test about web resources should implement.
 */
