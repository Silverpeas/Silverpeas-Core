...
import edu.psu.swe.scim.server.rest.SelfResourceImpl;
 ...
 */
@WebService
@Path(SCIM_2_BASE_URI + "/Me")
@Authorized
@Alternative
@Priority(APPLICATION + 10)
public class ScimV2SelfResource extends SelfResourceImpl implements ScimProtectedWebResource {
