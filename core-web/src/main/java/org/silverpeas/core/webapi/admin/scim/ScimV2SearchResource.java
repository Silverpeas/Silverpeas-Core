...
import edu.psu.swe.scim.server.rest.SearchResourceImpl;
 ...
 */
@WebService
@Path(SCIM_2_BASE_URI + "/.search")
@Authorized
@Alternative
@Priority(APPLICATION + 10)
public class ScimV2SearchResource extends SearchResourceImpl implements ScimProtectedWebResource {
