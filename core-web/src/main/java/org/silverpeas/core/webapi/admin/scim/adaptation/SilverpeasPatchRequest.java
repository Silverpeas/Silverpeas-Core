...
public class SilverpeasPatchRequest extends PatchRequest {
  private static final long serialVersionUID = -7894681183248354490L;

  @XmlElement
  private List<SilverpeasPatchOperation> adaptedPatchOperationList;

  public void afterDecode() {
    final List<PatchOperation> patchOperations = adaptedPatchOperationList.stream().map(o -> {
      o.setPath(o.adaptedPath);
