...
VALUES (2, 1, 'Documentation', 'toto', '', 0, 1,
...
VALUES (0, 'Accueil', 'La Racine', '2020/09/14', '0', '/', 1, -1, NULL, 'Visible', 'toto2',
        'default', 1, 'fr', -1),
       (4, 'Informatique', '', '2020/10/12', 0, '/0/', 2, 0, NULL, 'Invisible', 'toto2',
        'default', 3, 'fr', -1),
       (5, 'Magazines', '', '2020/10/12', 0, '/0/4/', 3, 4, NULL, 'Invisible', 'toto2', 'default',
        1, 'fr', -1);
...
VALUES ('toto2', 4, 1, '1603468931595.png', NULL, 'image/png', NULL, NULL, NULL, NULL);
