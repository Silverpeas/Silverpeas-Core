 ...
 */
public class ReceivedInvitationResourceTest extends ResourceGettingTest<InvitationTestResources> {

  private String sessionKey;
  private UserDetail currentUser;

  public ReceivedInvitationResourceTest() {
  ...
  @Test
  public void getSomeReceivedInvitations() {
    InvitationEntity[] expectedInvitations = getTestResources().saveSomeReceivedInvitations(
            currentUser);
