...
/**
 * Default implementation of {@link WbeUser}.
 * @author silveryocha
 */
public class DefaultWbeUser extends WbeUser {

  public DefaultWbeUser(final SilverpeasUserSession spUserSession) {
    super(spUserSession.getId(), User.getById(spUserSession.getUser().getId()));
  }

  @Override
  public String getId() {
    return getWbeUserIdPrefix() + getUser().getId();
  }
}
