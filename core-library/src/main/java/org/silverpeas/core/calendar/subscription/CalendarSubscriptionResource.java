...
public class CalendarSubscriptionResource extends PKSubscriptionResource {
  ...
  public static CalendarSubscriptionResource from(final Calendar calendar) {
    return new CalendarSubscriptionResource(calendar);
  }
   ...
   * @param calendar a calendar instance.
   */
  protected CalendarSubscriptionResource(final Calendar calendar) {
    super(new ResourceReference(calendar.getId(), calendar.getComponentInstanceId()), CALENDAR);
  }
}
