 ...
 * @author mmoquillon
 */
public class SpaceProfileInstEvent extends AbstractResourceEvent<SpaceProfileInst> {

  public SpaceProfileInstEvent(Type type, @NotNull SpaceProfileInst... resource) {
    super(type, resource);
  }
}
