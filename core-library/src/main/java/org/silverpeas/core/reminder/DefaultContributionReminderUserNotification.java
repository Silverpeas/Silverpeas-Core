...
/**
 * Implementation in charge of handling data about {@link Contribution} entities for which it
 * does not exists a specific builder.
 * @author silveryocha
 */
@Named
public class DefaultContributionReminderUserNotification
  ...
  public boolean isReminderNotificationSenderOfContributionType(final String type) {
    // Always false because this default implementation is manually used set if necessary
    return false;
  }
   ...
   * @author silveryocha
   */
  public static class ContributionReminderUserNotification
    ...
    protected ContributionReminderUserNotification(final Reminder reminder) {
