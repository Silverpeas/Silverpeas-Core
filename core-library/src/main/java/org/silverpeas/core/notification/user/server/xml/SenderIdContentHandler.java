 ...
 * @author ehugonnet
 */
class SenderIdContentHandler extends DefaultHandler {
  ...
  public SenderIdContentHandler(NotificationData data, ContentHandler parent, XMLReader parser) {
    this.data = data;
    this.parent = parent;
    this.parser = parser;
  }
  ...
  public void endElement(String uri, String localName, String qName) throws SAXException {
    ...
    if (tag == NotificationTag.ID) {
      data.setSenderId(buffer.toString());
