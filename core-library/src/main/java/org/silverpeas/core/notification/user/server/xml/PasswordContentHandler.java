 ...
 * @author ehugonnet
 */
class PasswordContentHandler extends DefaultHandler {
  ...
  public PasswordContentHandler(NotificationData data, ContentHandler parent, XMLReader parser) {
    this.data = data;
    this.parent = parent;
    this.parser = parser;
  }
  ...
  public void endElement(String uri, String localName, String qName) throws SAXException {
    ...
    if (tag == NotificationTag.PASSWORD) {
      data.setLoginPassword(buffer.toString());
