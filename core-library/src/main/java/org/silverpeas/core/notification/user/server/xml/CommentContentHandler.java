 ...
 * @author ehugonnet
 */
class CommentContentHandler extends DefaultHandler {
  ...
  public CommentContentHandler(NotificationData data, ContentHandler parent, XMLReader parser) {
    this.data = data;
    this.parent = parent;
    this.parser = parser;
  }
  ...
  public void endElement(String uri, String localName, String qName) throws SAXException {
    ...
    if (tag == NotificationTag.COMMENT) {
      data.setComment(buffer.toString());
