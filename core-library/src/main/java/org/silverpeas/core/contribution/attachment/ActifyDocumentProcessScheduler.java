...
public class ActifyDocumentProcessScheduler implements SchedulerEventListener, Initialization {
  ...
  public void triggerFired(SchedulerEvent anEvent) throws Exception {
    logger.debug("Starting of the job ''{0}''", anEvent.getJobExecutionContext().
        getJobName());
  }

  @Override
  public void jobSucceeded(SchedulerEvent anEvent) {
    logger.debug("The job ''{0}'' has succeeded", anEvent.getJobExecutionContext().
        getJobName());
  }
  ...
  protected Job getActifyDocumentImporter() {
    return new Job("ImportActify") {
      ...
      public void execute(JobExecutionContext context) throws Exception {
        logger.debug("Importation of the 3D documents generated by Actify...");
  ...
  protected Job getActifyDocumentCleaner() {
    return new Job("PurgeActify") {
      ...
      @Override
      public void execute(JobExecutionContext context) throws Exception {
        logger.debug("Purge of the source directory used by Actify...");
