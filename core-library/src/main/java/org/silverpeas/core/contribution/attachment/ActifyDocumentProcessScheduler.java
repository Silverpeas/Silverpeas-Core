...
public class ActifyDocumentProcessScheduler implements SchedulerEventListener, Initialization {
  ...
  public void triggerFired(SchedulerEvent anEvent) {
    SilverLogger.getLogger(this).debug("Starting of the job ''{0}''", anEvent.getJobExecutionContext().
        getJobName());
  }

  @Override
  public void jobSucceeded(SchedulerEvent anEvent) {
    SilverLogger.getLogger(this).debug("The job ''{0}'' has succeeded", anEvent.getJobExecutionContext().
        getJobName());
  }
