...
public interface TokenGenerator {
   ...
   *
   * @param <T> the concrete type of the token to generate.
   * @param parameter the parameter of the token generation.
   * @return a new token.
   */
   ...
   *
   * @param <T> the concrete type of the token to renew.
