...
public class URLEncoder {
	 ...
	 * gen-delims = ":" / "/" / "?" / "#" / "[" / "]" / "@"
	 */
	public final static BitSet GEN_DELIMS = new BitSet(7);
	static {
		GEN_DELIMS.set(':');
		GEN_DELIMS.set('/');
		GEN_DELIMS.set('?');
	 ...
	 */
	public final static BitSet RESERVED = new BitSet(2);
	static {
	 ...
	 * "r" | "s" | "t" | "u" | "v" | "w" | "x" | "y" | "z"
	 */
	public final static BitSet LOW_ALPHA = new BitSet(26);
	static {
		LOW_ALPHA.set('a');
		LOW_ALPHA.set('b');
		LOW_ALPHA.set('c');
	 ...
	 * "R" | "S" | "T" | "U" | "V" | "W" | "X" | "Y" | "Z"
	 */
	public final static BitSet UP_ALPHA = new BitSet(26);
	static {
		UP_ALPHA.set('A');
		UP_ALPHA.set('B');
		UP_ALPHA.set('C');
	 ...
	 */
	public final static BitSet ALPHA = new BitSet(52);
	static {
		ALPHA.or(LOW_ALPHA);
		ALPHA.or(UP_ALPHA);
	}
	 ...
	 */
	public final static BitSet DIGIT = new BitSet(10);
	static {
		DIGIT.set('0');
		DIGIT.set('1');
		DIGIT.set('2');
	 ...
	 */
	public final static BitSet ALPHANUM = new BitSet(62);
	static {
		ALPHANUM.or(ALPHA);
		ALPHANUM.or(DIGIT);
	}
	 ...
	 */
	public final static BitSet UNRESERVED = new BitSet(66);
	static {
		UNRESERVED.or(ALPHA);
		UNRESERVED.or(DIGIT);
		UNRESERVED.set('-');
	 ...
	 * unescaped sequences
	 */
	public final static BitSet PCHAR = new BitSet(80);
	static {
		PCHAR.or(UNRESERVED);
		PCHAR.or(SUB_DELIMS);
		PCHAR.set(':');
