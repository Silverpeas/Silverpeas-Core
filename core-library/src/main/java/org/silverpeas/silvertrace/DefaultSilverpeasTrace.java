 ...
 */
package org.silverpeas.silvertrace;
...
public class DefaultSilverpeasTrace implements SilverpeasTrace {
   ...
   * @return the trace level value (as defined by {@code org.silverpeas.util.logging.Level})
   * of the module or 0 if it can be figured out.
   * @see org.silverpeas.util.logging.Level
   * @deprecated
   */
  @Deprecated
  @Override
