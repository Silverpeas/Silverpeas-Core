...
public class ByteArrayImageInputStream extends ImageInputStreamImpl2 {
   ...
   * <code>buf[count-1]</code> are the only bytes that can ever be read from the stream; element
  ...
  /**
   * Reads up to
   * <code>len</code> bytes of data into an array of bytes from this input stream. If
   * <code>streamPos</code> equals
   ...
   * <code>len</code> and
   * <code>count-streamPos</code>. If
   * <code>k</code> is positive, then bytes
   * <code>buf[streamPos]</code> through
   * <code>buf[streamPos+k-1]</code> are copied into
  ...
  /**
   * Skips
   * <code>n</code> bytes of input from this input stream. Fewer bytes might be skipped if the end
   * of the input stream is reached. The actual number
   * <code>k</code> of bytes to be skipped is equal to the smaller of
   * <code>n</code> and
   * <code>count-streamPos</code>. The value
   * <code>k</code> is added into
   * <code>streamPos</code> and
   ...
   * stream. <p> The value returned is
   * <code>count&nbsp;- streamPos</code>, which is the number of bytes remaining to be read from the
   * input buffer.
   *
   ...
   * after the stream has been closed without generating an <tt>IOException</tt>. <p>
   */
  @Override
  public void close() {
    // does nothing!!
