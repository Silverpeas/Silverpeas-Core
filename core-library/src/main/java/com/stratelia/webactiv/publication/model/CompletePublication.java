...
public class CompletePublication implements Serializable {
   ...
   * @see com.stratelia.webactiv.publication.model.PulicationDetail
   * @see com.stratelia.webactiv.publication.info.model.ModelDetail
   * @see com.stratelia.webactiv.publication.info.model.InfoDetail
   */
