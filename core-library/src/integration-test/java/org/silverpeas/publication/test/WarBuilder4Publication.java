package org.silverpeas.publication.test;
...
public class WarBuilder4Publication extends WarBuilder4LibCore {
  ...
  protected <CLASS_TEST> WarBuilder4Publication(final Class<CLASS_TEST> classOfTest) {
    ...
    addPackages(true, "org.silverpeas.rating", "com.silverpeas.notation",
        "com.stratelia.webactiv.node", "com.stratelia.webactiv.coordinates",
        "com.stratelia.webactiv.publication.model", "com.stratelia.webactiv.publication.info",
        "com.stratelia.webactiv.publication.control", "org.silverpeas.publication.notification");
    addAsResource("org/silverpeas/publication/service");
