 ...
 */
package org.silverpeas.core.persistence.repository.basicjpa;
...
import org.silverpeas.core.persistence.repository.basicjpa.model.AnimalCustomEntity;
import org.silverpeas.core.persistence.repository.basicjpa.model.AnimalTypeCustomEntity;
import org.silverpeas.core.persistence.repository.basicjpa.model.EquipmentCustomEntity;
import org.silverpeas.core.persistence.repository.basicjpa.model.PersonCustomEntity;
import org.silverpeas.core.persistence.repository.jpa.JpaCustomEntityServiceTest;
...
public class SilverpeasJpaCustomEntityManagerTest {
  ...
  public static final String TABLES_CREATION =
      "/org/silverpeas/core/persistence/basicjpa/create_table.sql";
  ...
  public static Archive<?> createTestArchive() {
    return WarBuilder4LibCore.onWarForTestClass(SilverpeasJpaCustomEntityManagerTest.class)
        ...
        .addJpaPersistenceFeatures().testFocusedOn((warBuilder) -> {
          ...
          warBuilder.addPackages(true, "org.silverpeas.core.persistence.repository");
          warBuilder.addAsResource("org/silverpeas/core/persistence/basicjpa/create_table.sql");
        }).build();
  }
  ...
  public void getPerson() {
    ...
    assertThat(personAnimalCustomEntity.getType(), is(AnimalTypeCustomEntity.cat));
