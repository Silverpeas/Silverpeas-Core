...
public class TransactionIsolationWithMultiServiceInstancesIntegrationTest
  ...
  public static Archive<?> createTestArchive() {
    return configureTestArchive(WarBuilder4LibCore
        .onWarForTestClass(TransactionIsolationWithMultiServiceInstancesIntegrationTest.class))
        .build();
  }
