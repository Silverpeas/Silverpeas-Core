...
public class TransactionIsolationWithOneServiceInstanceIntegrationTest
  ...
  public static Archive<?> createTestArchive() {
    return configureTestArchive(WarBuilder4LibCore
        .onWarForTestClass(TransactionIsolationWithOneServiceInstanceIntegrationTest.class))
        .build();
  }
  ...
  TransactionTestService getTestService() {
    return ServiceProvider.getService(TransactionSingletonTestServiceImpl.class);
  }
