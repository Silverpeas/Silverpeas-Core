 ...
 * @author mmoquillon
 */
@MessageDriven(name = "ResourceEventListener", activationConfig = {
    @ActivationConfigProperty(propertyName = "destinationLookup", propertyValue = "topic/resource"),
    @ActivationConfigProperty(propertyName = "destinationType", propertyValue = "javax.jms.Topic"),
    @ActivationConfigProperty(propertyName = "acknowledgeMode", propertyValue = "Auto-acknowledge") })
@Singleton
public class JMSTopicTestResourceEventListener extends JMSResourceEventListener<TestResourceEvent> {
