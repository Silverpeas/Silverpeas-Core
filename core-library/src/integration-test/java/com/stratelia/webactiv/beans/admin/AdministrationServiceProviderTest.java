...
public class AdministrationServiceProviderTest {
  ...
  public static Archive<?> createTestArchive() {
    return WarBuilder4LibCore.onWarForTestClass(AdministrationServiceProviderTest.class)
  ...
  public void getRightRecoveringService() {
    Recover recoverInstance = AdministrationServiceProvider.getRightRecoveringService();
    assertThat(recoverInstance, sameInstance(recover));
  }
}