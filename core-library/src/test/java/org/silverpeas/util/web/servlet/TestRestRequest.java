...
public class TestRestRequest extends TestCase {
  ...
  public void testNotRestRequest() {
    MockHttpServletRequestBuilder request = new MockHttpServletRequestBuilder();
    ...
    RestRequest rest = new RestRequest(request.build(), "");
  ...
  public void testRestRequest() {
    ...
    rest = new RestRequest(request.build(), "");
    assertEquals(FIND, rest.getAction());
  }
  ...
  public void testDoubleRestRequest() {
    ...
    request.setPathInfo("/RmailingList/mailingList45//list/45");
    request.setRequestURI("/silverpeas/RmailingList/mailingList45//list/45");
    RestRequest rest = new RestRequest(request.build(), "mailingList45");
    assertEquals(FIND, rest.getAction());
    request.setRemoteHost("localhost");
    request.setMethod("GET");
    request.setRemotePort(8000);
  ...
  public void testActionRestRequest() {
    ...
    rest = new RestRequest(request.build(), "mailingList45");
    assertEquals(FIND, rest.getAction());
  ...
  public void testDaisyRestRequest() {
    ...
    request.setPathInfo(
        "/SilverpeasWebFileServer/componentId/kmelia24/attachmentId/797/lang/fr/name/CIBC%20HABILITES.pdf");
    request.setRequestURI(
        "/webUnifaf/SilverpeasWebFileServer/componentId/kmelia24/attachmentId/797/lang/fr/name/CIBC%20HABILITES.pdf");
    RestRequest rest = new RestRequest(request.build(), "");
    assertEquals(FIND, rest.getAction());
  ...
  private static class MockHttpServletRequestBuilder {
    private HttpServletRequest mock = mock(HttpServletRequest.class);

    void setRemoteHost(final String remoteHost) {
      when(mock.getRemoteHost()).thenReturn(remoteHost);
    }
    ...
    void setRemotePort(final int remotePort) {
      when(mock.getRemotePort()).thenReturn(remotePort);
    }
    ...
    void setPathInfo(final String pathInfo) {
      when(mock.getPathInfo()).thenReturn(pathInfo);
    }
