...
public class DefaultScoreService implements ScoreService {
  ...
  /**
   * @see com.stratelia.webactiv.score.control.ScoreService#getUserNbParticipationsByFatherId
   */
  @Override
  ...
  /**
   * @see com.stratelia.webactiv.score.control.ScoreService#addScore
   */
  ...
  /**
   * @see com.stratelia.webactiv.score.control.ScoreService#updateScore
   */
  @Transactional(Transactional.TxType.REQUIRED)
  @Override
  ...
  /**
   * @see com.stratelia.webactiv.score.control.ScoreService#deleteScore
   */
  @Transactional(Transactional.TxType.REQUIRED)
  @Override
  ...
  /**
   * @see com.stratelia.webactiv.score.control.ScoreService#deleteScoreByFatherPK
   */
  @Override
  ...
  /**
   * @see com.stratelia.webactiv.score.control.ScoreService#getAllScores
   */
  @Override
  ...
  /**
   * @see com.stratelia.webactiv.score.control.ScoreService#getUserScores
   */
  @Override
  ...
  /**
   * @see com.stratelia.webactiv.score.control.ScoreService#getUserScoresByFatherId
   */
  @Override
  ...
  /**
   * @see com.stratelia.webactiv.score.control.ScoreService#getBestScoresByFatherId
   */
  @Override
  ...
  /**
   * @see com.stratelia.webactiv.score.control.ScoreService#getWorstScoresByFatherId
   */
  @Override
  ...
  /**
   * @see com.stratelia.webactiv.score.control.ScoreService#getNbVotersByFatherId
   */
  @Override
  ...
  /**
   * @see com.stratelia.webactiv.score.control.ScoreService#getAverageScoreByFatherId
   */
  @Override
  ...
  /**
   * @see com.stratelia.webactiv.score.control.ScoreService#getUserScoreByFatherIdAndParticipationId
   */
  @Override
  ...
  /**
   * @see com.stratelia.webactiv.score.control.ScoreService#getScoresByFatherId
   */
  @Override
