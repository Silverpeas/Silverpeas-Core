...
public class QuestionResult implements Serializable 
{
   ...
   public QuestionResult(QuestionResultPK pk, ForeignPK questionPK, AnswerPK answerPK, String userId, String openedAnswer, String voteDate) 
   {
   ...
   public QuestionResult(QuestionResultPK pk, ForeignPK questionPK, AnswerPK answerPK, String userId, String openedAnswer, String voteDate, int elapsedTime, int participationId) 
   {
    setQuestionResultPK(pk);
    setAnswerPK(answerPK);
    setQuestionPK(questionPK);
   ...
   public QuestionResult(QuestionResultPK pk, ForeignPK questionPK, AnswerPK answerPK, String userId, String openedAnswer, int nbPoints, String voteDate, int elapsedTime, int participationId) 
   {
    setQuestionResultPK(pk);
    setAnswerPK(answerPK);
    setQuestionPK(questionPK);
   ...
   public QuestionResult(QuestionResultPK pk, ForeignPK questionPK, AnswerPK answerPK, String userId, String openedAnswer) 
   {
    setQuestionResultPK(pk);
    setAnswerPK(answerPK);
    setQuestionPK(questionPK);
