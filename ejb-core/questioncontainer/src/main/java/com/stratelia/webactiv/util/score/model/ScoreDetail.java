...
public class ScoreDetail implements java.io.Serializable
{
     ...
     */
    public ScoreDetail(ScorePK scorePK, String fatherId, String userId, int participationId, String participationDate, int score, int elapsedTime, String suggestion, int nbParticipations, int position)
    {
        setScorePK(scorePK);
     ...
     * @see
     */
    public ScoreDetail(ScorePK scorePK, String fatherId, String userId, int participationId, String participationDate, int score, int elapsedTime, String suggestion)
    {
        setScorePK(scorePK);
        setFatherId(fatherId);
        setUserId(userId);
