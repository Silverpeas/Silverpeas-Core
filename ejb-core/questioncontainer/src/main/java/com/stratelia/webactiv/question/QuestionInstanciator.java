...
{
    private static ResourceLocator settings = new ResourceLocator("com.stratelia.webactiv.util.question.questionSettings", "fr");
    ...
    {
		SilverTrace.info("question", "QuestionInstanciator.create()", "root.MSG_GEN_ENTER_METHOD", "spaceId = " + spaceId+", componentId = "+componentId);
        try {
            //Create the images directory on the server disk
            createImagesDirectory(spaceId, componentId);
        } catch (Exception e) {
			throw new InstanciationException("QuestionInstanciator.create()", SilverpeasException.ERROR, "question.CREATING_IMAGES_DIRECTORY_FAILED", e);
        }
        SilverTrace.info("question", "QuestionInstanciator.create()", "root.MSG_GEN_EXIT_METHOD", "spaceId = " + spaceId+", componentId = "+componentId);
    }

    public void delete(Connection con, String spaceId, String componentId, String userId) throws InstanciationException
    {
		SilverTrace.info("question", "QuestionInstanciator.delete()", "root.MSG_GEN_ENTER_METHOD", "spaceId = " + spaceId+", componentId = "+componentId);
        ...
        try {
            ...
            throw new InstanciationException("QuestionInstanciator.delete()", SilverpeasException.ERROR, "question.DELETING_IMAGES_DIRECTORY_FAILED", e);
        }

        SilverTrace.info("question", "QuestionInstanciator.delete()", "root.MSG_GEN_EXIT_METHOD", "spaceId = " + spaceId+", componentId = "+componentId);
    }



    private void createImagesDirectory(String spaceId, String componentId) throws java.lang.Exception {
    ...
    private void deleteImagesDirectory(String spaceId, String componentId) throws java.lang.Exception {
	...
	*/
	private void deleteDataOfInstance(Connection con, String componentId, String suffixName) throws InstanciationException {
		...
		try {
		    ...
		    throw new InstanciationException("QuestionInstanciator.create()", SilverpeasException.ERROR, "question.DELETING_DATA_OF_INSTANCE_FAILED", se);
		}
		finally {
			try{
				stmt.close();
				...
				SilverTrace.error("question", "QuestionInstanciator.deleteDataOfInstance()", "root.EX_RESOURCE_CLOSE_FAILED", "", err_closeStatement);
			}
		}
