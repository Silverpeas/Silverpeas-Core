 ...
 * See QuestionBmBusinessSkeleton for methods documentation
 *
 * @author neysseri
 */
public class QuestionBmEJB implements javax.ejb.SessionBean, QuestionBmBusinessSkeleton
{
    ...
    {
		SilverTrace.info("question", "QuestionBmEJB.getQuestion()", "root.MSG_GEN_ENTER_METHOD", "questionPK = " + questionPK);
        Connection con = null;
        ...
        {
            throw new QuestionRuntimeException("QuestionBmEJB.getQuestion()", SilverpeasRuntimeException.ERROR, "question.GETTING_QUESTION_FAILED", e);
        }
        finally
        {
            freeConnection(con);
    ...
    private Collection getAnswersByQuestionPK(QuestionPK questionPK) throws RemoteException
    {
		SilverTrace.info("question", "QuestionBmEJB.getAnswersByQuestionPK()", "root.MSG_GEN_ENTER_METHOD", "questionPK = " + questionPK);
        Collection answers = getAnswerBm().getAnswersByQuestionPK(new ForeignPK(questionPK));
        return answers;
    }

    public Collection getQuestionsByFatherPK(QuestionPK questionPK, String fatherId) throws RemoteException
    {
		SilverTrace.info("question", "QuestionBmEJB.getQuestionsByFatherPK()", "root.MSG_GEN_ENTER_METHOD", "questionPK = " + questionPK+", fatherId = "+fatherId);
        Connection con = null;

        try
        {
            con = getConnection();
            Collection questions = QuestionDAO.getQuestionsByFatherPK(con, questionPK, fatherId);
        ...
        {
            throw new QuestionRuntimeException("QuestionBmEJB.getQuestionsByFatherPK()", SilverpeasRuntimeException.ERROR, "question.GETTING_QUESTIONS_FAILED", e);
        }
        finally
        {
            freeConnection(con);
    ...
    {
		SilverTrace.info("question", "QuestionBmEJB.createQuestion()", "root.MSG_GEN_ENTER_METHOD", "question = " + question);
        Connection con = null;
        ...
        try
        {
			...
			question.setDescription(Encode.transformStringForBD(question.getDescription()));
            ...
            getAnswerBm().addAnswersToAQuestion(question.getAnswers(), new ForeignPK(questionPK));
            return questionPK;
        }
        catch (Exception e)
        {
            throw new QuestionRuntimeException("QuestionBmEJB.createQuestion()", SilverpeasRuntimeException.ERROR, "question.CREATING_QUESTION_FAILED", e);
        }
        finally
        {
            freeConnection(con);
    ...
    {
		SilverTrace.info("question", "QuestionBmEJB.createQuestions()", "root.MSG_GEN_ENTER_METHOD", "fatherId = " + fatherId);
        Iterator it = questions.iterator();
        int      displayOrder = 1;
    ...
    {
		SilverTrace.info("question", "QuestionBmEJB.deleteQuestionsByFatherPK()", "root.MSG_GEN_ENTER_METHOD", "questionPK = " + questionPK+", fatherId = "+fatherId);
        Connection       con = null;
        ...
        {
            throw new QuestionRuntimeException("QuestionBmEJB.deleteQuestionsByFatherPK()", SilverpeasRuntimeException.ERROR, "question.DELETING_QUESTIONS_FAILED", e);
        }
        finally
        {
            freeConnection(con);
    ...
    {
		SilverTrace.info("question", "QuestionBmEJB.deleteQuestion()", "root.MSG_GEN_ENTER_METHOD", "questionPK = " + questionPK);
        Connection       con = null;

        try
        {
            con = getConnection();
            getQuestionResultBm().deleteQuestionResultsToQuestion(new ForeignPK(questionPK));
            // delete all answers
        ...
        {
            throw new QuestionRuntimeException("QuestionBmEJB.deleteQuestion()", SilverpeasRuntimeException.ERROR, "question.DELETING_QUESTION_FAILED", e);
        }
        finally
        {
            freeConnection(con);
    ...
    {
		SilverTrace.info("question", "QuestionBmEJB.updateQuestion()", "root.MSG_GEN_ENTER_METHOD", "questionDetail = " + questionDetail);
		// Transform the 'special' caracters for storing them in Database
    ...
    {
		SilverTrace.info("question", "QuestionBmEJB.updateQuestionHeader()", "root.MSG_GEN_ENTER_METHOD", "questionDetail = " + questionDetail);
        Connection con = null;
        ...
        {
            throw new QuestionRuntimeException("QuestionBmEJB.updateQuestion()", SilverpeasRuntimeException.ERROR, "question.UPDATING_QUESTION_FAILED", e);
        }
        finally
        {
            freeConnection(con);
    ...
    {
		SilverTrace.info("question", "QuestionBmEJB.updateAnswersToAQuestion()", "root.MSG_GEN_ENTER_METHOD", "questionDetail = " + questionDetail);
    ...
    {
		SilverTrace.info("question", "QuestionBmEJB.updateAnswerToAQuestion()", "root.MSG_GEN_ENTER_METHOD", "answerDetail = " + answerDetail);
        getAnswerBm().updateAnswerToAQuestion(answerDetail.getQuestionPK(), answerDetail);
    }

    public void deleteAnswersToAQuestion(QuestionPK questionPK) throws RemoteException
    {
		SilverTrace.info("question", "QuestionBmEJB.deleteAnswersToAQuestion()", "root.MSG_GEN_ENTER_METHOD", "questionPK = " + questionPK);
    ...
    {
		SilverTrace.info("question", "QuestionBmEJB.deleteAnswerToAQuestion()", "root.MSG_GEN_ENTER_METHOD", "questionPK = " + questionPK+", answerPK = " + answerPK);
        getAnswerBm().deleteAnswerToAQuestion(new ForeignPK(questionPK), answerPK.getId());
    }

    public void createAnswersToAQuestion(Question questionDetail) throws RemoteException
    {
		SilverTrace.info("question", "QuestionBmEJB.createAnswersToAQuestion()", "root.MSG_GEN_ENTER_METHOD", "questionDetail = " + questionDetail);
	...
	private AnswerBm getAnswerBm()
    {
        if (currentAnswerBm == null)
        {
			...
			{
				throw new QuestionRuntimeException("QuestionBmEJB.getAnswerBm()", SilverpeasRuntimeException.ERROR, "root.EX_CANT_GET_REMOTE_OBJECT", "Object = Answer", e);
			}
        }
    ...
    private QuestionResultBm getQuestionResultBm()
    {
        if (currentQuestionResultBm == null)
        {
			...
			{
				throw new QuestionRuntimeException("QuestionBmEJB.getAnswerBm()", SilverpeasRuntimeException.ERROR, "root.EX_CANT_GET_REMOTE_OBJECT", "Object = QuestionResult", e);
			}
        }
    ...
    private Connection getConnection()
    {
        ...
        {
            throw new QuestionRuntimeException("QuestionBmEJB.getConnection()", SilverpeasRuntimeException.ERROR, "root.EX_CONNECTION_OPEN_FAILED", e);
        }
    }
    ...
    private void freeConnection(Connection con)
    {
        if (con != null)
        {
            ...
            {
                SilverTrace.error("answer", "QuestionBmEJB.freeConnection()", "root.EX_CONNECTION_CLOSE_FAILED", "", e);
            }
        }
    }
