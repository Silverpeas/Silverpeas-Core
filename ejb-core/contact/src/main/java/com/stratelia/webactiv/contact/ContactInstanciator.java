...
public class ContactInstanciator extends SQLRequest {
  ...
  public void create(Connection con, String spaceId, String componentId, String userId) throws
    ...
    try {
      ...
      createAttachmentsAndImagesDirectory(componentId);
    } catch (Exception e) {
  ...
  private void deleteDataOfInstance(Connection con, String componentId,
    ...
    try {
      ...
      throw new InstanciationException("ContactInstanciator.deleteDataOfInstance",
          InstanciationException.ERROR, "root.EX_TABLE_DELETE_FAILED", "componentId = "
  ...
  private void createAttachmentsAndImagesDirectory(String componentId) throws java.lang.Exception {
    // Create the subdirectory for the attachments
    FileRepositoryManager.createAbsolutePath(componentId, settings.getString(
  ...
  private void deleteAttachmentsAndImagesDirectory(String spaceId, String componentId) throws
    ...
    FileRepositoryManager.deleteAbsolutePath(spaceId, componentId, settings.getString(
        "attachmentsSubDirectory"));
