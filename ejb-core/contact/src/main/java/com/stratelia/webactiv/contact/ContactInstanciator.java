...
{
    private static ResourceLocator settings = new ResourceLocator("com.stratelia.webactiv.contact.contactSettings", "fr");
    ...
    {       
        try {
		    ...
		    throw new InstanciationException("ContactInstanciator.create()",InstanciationException.ERROR, "root.CREATING_DATA_DIRECTORY_FAILED","componentId = "+componentId, e);
        }        
    }
      ...
      throws InstanciationException 
    {
        ...
        try {
            ...
            throw new InstanciationException("ContactInstanciator.delete()",InstanciationException.ERROR, "root.DELETING_DATA_DIRECTORY_FAILED","componentId = "+componentId, e);
        }
    }
	/**
	...
	*/
	private void deleteDataOfInstance(Connection con, String componentId, String suffixName) throws InstanciationException {	
		...
		try {
		    ...
		    throw new InstanciationException("ContactInstanciator.deleteDataOfInstance",InstanciationException.ERROR, "root.EX_TABLE_DELETE_FAILED","componentId = "+componentId+" delete query ="+deleteQuery, se);
		}
		finally {
			try{
				stmt.close();
			    ...
			    throw new InstanciationException("ContactInstanciator.deleteDataOfInstance",InstanciationException.ERROR, "root.EX_GEN_CONNECTION_CLOSE_FAILED","componentId = "+componentId+" delete query ="+deleteQuery, err_closeStatement);
			}
		}
    ...
    private void createAttachmentsAndImagesDirectory(String spaceId, String componentId) throws java.lang.Exception {       
        ...
        FileRepositoryManager.createAbsolutePath(componentId, settings.getString("attachmentsSubDirectory"));
