...
public class ContactEJB implements EntityBean {
  ...
  private Connection getConnection() {
    try {
      ...
      throw new ContactRuntimeException("ContactEJB.getConnection()",
  ...
  private void closeConnection(Connection con) {
    try {
      ...
      throw new ContactRuntimeException("ContactEJB.closeConnection()",
          SilverpeasRuntimeException.ERROR, "root.EX_CONNECTION_CLOSE_FAILED",
          re);
    }
  }
  ...
  public void setDetail(ContactDetail pubDetail) {
    if (pubDetail.getPK().equals(pk)) {
      ...
      throw new ContactRuntimeException("ContactEJB.setDetail()",
          SilverpeasRuntimeException.ERROR,
          "contact.EX_SET_CONTACT_DETAIL_FAILED");
    }
  }
  ...
  public void removeFather(NodePK fatherPK) {
    ...
    try {
      ...
      throw new ContactRuntimeException("ContactEJB.removeFather()",
          SilverpeasRuntimeException.ERROR,
          "contact.EX_CONTACT_REMOVE_FROM_FATHER_FAILED", re);
    } finally {
      closeConnection(con);
    }
  }
  ...
  public void removeAllFather() {
    ...
    try {
      ...
      throw new ContactRuntimeException("ContactEJB.removeAllFather()",
          SilverpeasRuntimeException.ERROR,
          "contact.EX_CONTACT_REMOVE_FROM_ALLFATHERS_FAILED", re);
    } finally {
      closeConnection(con);
    }
  }
  ...
  public void createInfo(String modelId) {
    ...
    try {
      ...
      throw new ContactRuntimeException("ContactEJB.createInfoDetail()",
          SilverpeasRuntimeException.ERROR,
  ...
  public CompleteContact getCompleteContact(String modelId) {
    ...
    try {
      ...
      throw new ContactRuntimeException("ContactEJB.getCompleteContact()",
          SilverpeasRuntimeException.ERROR,
  ...
  public ContactPK ejbCreate(ContactDetail pubDetail) {
    ...
    try {
      ...
      throw new ContactRuntimeException("ContactEJB.ejbCreate()",
  ...
  public ContactPK ejbFindByPrimaryKey(ContactPK pk) {
    ...
    try {
      ...
      if (primary != null) {
        ...
        throw new ContactRuntimeException("ContactEJB.ejbFindByPrimaryKey()",
  ...
  public void ejbLoad() {
    ...
    try {
      ...
      throw new ContactRuntimeException("ContactEJB.ejbLoad()",
          SilverpeasRuntimeException.ERROR, "contact.EX_CONTACT_NOT_FOUND", re);
    } finally {
      closeConnection(con);
    }
  ...
  public void ejbStore() {
    ...
    if (pk == null)
      return;
    ContactDetail detail = new ContactDetail(pk, firstName, lastName, email,
        phone, fax, userId, creationDate, creatorId);
    Connection con = getConnection();
    try {
      ContactDAO.storeRow(con, detail);
      isModified = false;
    } catch (Exception re) {
      throw new ContactRuntimeException("ContactEJB.ejbStore()",
          SilverpeasRuntimeException.ERROR, "contact.EX_CONTACT_RECORD_FAILED",
          re);
    } finally {
      closeConnection(con);
    }
  ...
  public void ejbRemove() {
    ...
    try {
      ...
      throw new ContactRuntimeException("ContactEJB.ejbRemove()",
