...
public class ClipboardException extends SilverpeasException
{
     ...
     * @see
     */
    public ClipboardException(String callingClass, int errorLevel, String message, String extraParams)
    {
     ...
     * @see
     */
    public ClipboardException(String callingClass, int errorLevel, String message, Exception nested)
    {
     ...
     * @see
     */
    public ClipboardException(String callingClass, int errorLevel, String message, String extraParams, Exception nested)
    {
