...
public class SilverStatisticsEJB implements SessionBean
{
    ...
    public void putStats(String typeOfStats, String data)
    {
        ...
        if (myStatsConfig.isGoodDatas(typeOfStats, dataArray))
        {
            ...
            {
                SilverTrace.error("silverstatistics", "SilverStatisticsEJB.putStats", "silverstatistics.MSG_ALIMENTATION_BD", "typeOfStats = "+typeOfStats+", dataArray = "+dataArray, e);
            }
        ...
        {
            SilverTrace.error("silverstatistics", "SilverStatisticsEJB.putStats", "MSG_CONFIG_DATAS","data en entree="+data+" pour "+typeOfStats);
        }
    }
    ...
    private Connection getConnection()
    {
        ...
        {
            throw new StatisticsRuntimeException("StatisticsEJB.getConnection()", SilverpeasRuntimeException.ERROR, "root.EX_CONNECTION_OPEN_FAILED", e);
        }
    }
    ...
    private void freeConnection(Connection con)
    {
        if (con != null)
        {
            ...
            {
                SilverTrace.error("statistics", "StatisticsEJB.freeConnection()", "root.EX_CONNECTION_CLOSE_FAILED", "", e);
            }
        }
    }
    ...
    public void setSessionContext(SessionContext sc)
    {
        ...
        try {
            ...
            {
                SilverTrace.error("silverstatistics", "SilverStatisticsEJB.setSessionContext", "silverstatistics.MSG_CONFIG_FILE");
            }
        }
        catch (SilverStatisticsConfigException e)
        {
            SilverTrace.error("silverstatistics", "SilverStatisticsEJB.setSessionContext", "silverstatistics.MSG_CONFIG_FILE", e);
        }
    }
