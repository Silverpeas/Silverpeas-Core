...
public class SilverStatisticsFactory {
  ...
  public SilverStatistics getSilverStatistics() {
    if (silverStatistics == null) {
      SilverTrace.warn("personalization", getClass().getSimpleName() + ".getSilverStatisticsService()",
          "EX_NO_MESSAGES", "IoC container not bootstrapped or no SilverStatisticsService bean found!");
    }
