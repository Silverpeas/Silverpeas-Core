...
public class CommentInstanciator implements ComponentsInstanciatorIntf {
	...
	public void create(Connection con, String spaceId, String componentId, String userId) throws InstanciationException 
  	{
		SilverTrace.info("comment","CommentInstanciator.create()", "root.MSG_GEN_PARAM_VALUE","componentId = "+componentId);
	}

	public void delete(Connection con, String spaceId, String componentId, String userId) throws InstanciationException
	{
		SilverTrace.info("comment","CommentInstanciator.delete()", "root.MSG_GEN_PARAM_VALUE","componentId = "+componentId);
		
		String delete_query = "delete from " + COMMENT_TABLENAME + " where instanceId = ? ";
		...
		{
			throw new InstanciationException("CommentInstanciator.delete()",InstanciationException.ERROR, "root.EX_RECORD_DELETION_FAILED", e);
		}
		finally
		{
