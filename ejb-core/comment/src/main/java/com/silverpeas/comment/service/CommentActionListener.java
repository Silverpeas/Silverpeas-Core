 ...
 * The listener is a subscriber for notifications coming from the actions on comments, so that it
 * will be informed about them.
 * All objects that whish to be informed of the adding or removing of comments should extends this
 * class.
 */
public abstract class CommentActionListener extends DefaultNotificationSubscriber {
   ...
   * The implementer implements this method to perform a computation when a comment is added.
   ...
   * The implementer implements this method to perform a computation when a comment is removed.
