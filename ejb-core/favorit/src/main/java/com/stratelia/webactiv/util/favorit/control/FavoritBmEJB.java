...
public class FavoritBmEJB implements SessionBean
{
    ...
    private void freeConnection(Connection con)
    {
        if (con != null)
        {
            ...
            {
                SilverTrace.error("favorit", "FavoritBmEJB.freeConnection", "root.MSG_GEN_CONNECTION_CLOSE_FAILED");
            }
        }
    }
    ...
    {
        SilverTrace.info("favorit", "FavoritBmEJB.addFavoritNode", "root.MSG_GEN_ENTER_METHOD", "userId = " + userId + ", node = " + node.toString());
        Connection con = null;
    ...
    {
        SilverTrace.info("favorit", "FavoritBmEJB.removeFavoritNode", "root.MSG_GEN_ENTER_METHOD", "userId = " + userId + ", node = " + node.toString());
        Connection con = null;
    ...
    {
        SilverTrace.info("favorit", "FavoritBmEJB.removeFavoritByUser", "root.MSG_GEN_ENTER_METHOD", "userId = " + userId);
        Connection con = null;
    ...
    {
        SilverTrace.info("favorit", "FavoritBmEJB.removeFavoritByNodePath", "root.MSG_GEN_ENTER_METHOD", "node = " + node.toString() + ", path = " + path);
        Connection con = null;
    ...
    {
        SilverTrace.info("favorit", "FavoritBmEJB.getFavoritNodePKs", "root.MSG_GEN_ENTER_METHOD", "userId = " + userId);
        Connection con = null;
...
//	NEWD DLE
     ...
     * @see
     */
/*    public Collection getFavoritNodePKsBySpaceAndComponent(String userId, String space, String componentName)
    {
        SilverTrace.info("favorit", "FavoritBmEJB.getFavoritNodePKsBySpaceAndComponent", "root.MSG_GEN_ENTER_METHOD", "userId = " + userId + ", space = " + space + ", componentName = " + componentName);
        Connection con = null;
        Collection result = null;
        ...
        {
            con = getConnection();
            result = NodeActorLinkDAO.getNodePKsByActorSpaceAndComponent(con, rootTableName, userId, space, componentName);
        }
        catch (Exception e)
        {
	...
	{
		SilverTrace.info("favorit", "FavoritBmEJB.getFavoritNodePKsByComponent", "root.MSG_GEN_ENTER_METHOD", "userId = " + userId + ", componentName = " + componentName);
		Connection con = null;
		Collection result = null;
		...
		{
			con = getConnection();
			result = NodeActorLinkDAO.getNodePKsByActorComponent(con, rootTableName, userId, componentName);
		}
		catch (Exception e)
		{
			throw new FavoritRuntimeException("favorit.CANNOT_GET_FAVORIT_BY_USER_SPACE_COMPONENT", e);
