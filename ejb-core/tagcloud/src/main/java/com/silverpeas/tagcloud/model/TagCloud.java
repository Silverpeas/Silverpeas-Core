...
public class TagCloud implements Serializable
{
	...
	private int id;
	// tag : used as a key to retrieve tagclouds which have the same key. Corresponds to the label
	// of the tagcloud which is uppercased and without accents or special characters.
	private String tag;
	// label : label displayed for the tagcloud.
	private String label;
	// instanceId : id of the component (topic) which the tagcloud refers to.
	private String instanceId;
	// externalId : id of the element (publication or forum) which the tagcloud refers to.
	private String externalId;
	// externalType : type of the element.
	private int externalType;
	// count : number of occurrences of the tag for the element which the tagcloud describes (topic, publication).
	private int count;
	
	private void init(int id, String tag, String label, String instanceId, String externalId, int externalType, int count)
	{
		setId(id);
		setTag(tag);
		setLabel(label);
    ...
    public TagCloud(int id, String tag, String label, String instanceId, String externalId, int externalType)
    {
        init(id, tag, label, instanceId, externalId, externalType, DEFAULT_COUNT);
    }
    
    public TagCloud(String tag, String label, String instanceId, String externalId, int externalType)
    {
	...
	public String toString()
	{
		return new StringBuffer()
			...
			.append("instanceId   = ").append(getInstanceId()).append(",\n")
			.append("externalId   = ").append(getExternalId()).append(",\n")
			.append("externalType = ").append(getExternalType()).append(",\n")
