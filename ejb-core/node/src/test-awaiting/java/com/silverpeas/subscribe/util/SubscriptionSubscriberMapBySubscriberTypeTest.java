 ...
 */
public class SubscriptionSubscriberMapBySubscriberTypeTest extends AbstractCommonSubscriptionTest {
  ...
  private Collection<SubscriptionSubscriber> prepareUserSubscriptionSubscribers(String... userIds) {
    Collection<SubscriptionSubscriber> result = new HashSet<SubscriptionSubscriber>();
