...
public class NodeI18NDAO
{
   ...
   static final private String SELECT_TRANSLATIONS = "select "+COLUMNS+" from Sb_Node_NodeI18N where nodeId = ?";
   ...
   static final public String TABLE_NAME = "sb_node_nodei18n";
	...
	private static NodeI18NDetail resultSet2NodeDetail(ResultSet rs) throws SQLException
	{
		...
		NodeI18NDetail nd =
			new NodeI18NDetail(id, lang, name, description);
    ...
    */
   public static List getTranslations(Connection con, int nodeId) throws SQLException
   {
		ResultSet rs = null;
		StringBuffer selectQuery = new StringBuffer();
		PreparedStatement prepStmt = null;
		SilverTrace.debug("node", "NodeI18NDAO.getTranslations", "root.MSG_QUERY", SELECT_TRANSLATIONS + "  nodeId: " + nodeId);
	   ...
	   try
	   {
		...
		{
			throw new NodeRuntimeException("NodeI18NDAO.getTranslations()",SilverpeasRuntimeException.ERROR,"root.EX_SQL_QUERY_FAILED","selectQuery = " + selectQuery.toString());
		}
		finally
		{
