...
public interface Node extends EJBObject {
	...
	*/
    ...
    public NodeDetail getDetail(String sorting) throws RemoteException, SQLException;
	...
	*/
    ...
    public Collection getChildrenDetails(String sorting) throws RemoteException, SQLException;
