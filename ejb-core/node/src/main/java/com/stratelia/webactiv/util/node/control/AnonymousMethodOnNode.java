...
/**
 * Representation of an anonymous method to invoke in some circumstances. This is class is for passing
 * a method invocation within another method call (second-order function).
 */
