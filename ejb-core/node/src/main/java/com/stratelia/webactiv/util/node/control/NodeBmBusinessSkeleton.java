...
public interface NodeBmBusinessSkeleton
{
    ...
    /**
     * Get the header of each child of the node
     * this function is to be used with frequently used nodes
     * because for each child, an ejb will be instanciated
     * (nodes next to the root will be frequently used)
     * For less used nodes, choose the getChildrenDetails() method
     * @return a NodeDetail collection
     * @see com.stratelia.webactiv.util.node.model.NodeDetail
     * @since 1.0
     */
     ...
     * @since 1.0
     */
    public NodePK createNode(NodeDetail nodeDetail, NodeDetail fatherDetail) throws RemoteException;
     ...
     * Its content must be added to the indexed content of the node
	 *
