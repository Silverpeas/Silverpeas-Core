...
public final class TestResources {
  ...
  protected void init() {
    ...
    try {
      ...
      when(nodeBmMock.getDetail(new NodePK(UNEXISTING_NODE_ID, COMPONENT_INSTANCE_1_ID))).thenThrow(new NodeRuntimeException("",
              SilverpeasException.ERROR, ""));
      when(nodeBmMock.getDetail(new NodePK(UNEXISTING_NODE_ID, COMPONENT_INSTANCE_2_ID))).thenThrow(new NodeRuntimeException("",
              SilverpeasException.ERROR, ""));
      when(nodeBmMock.getDetail(new NodePK(UNEXISTING_NODE_ID, COMPONENT_INSTANCE_3_ID))).thenThrow(new NodeRuntimeException("",
              SilverpeasException.ERROR, ""));
  ...
  private static List<PdcClassification> allPdcClassifications() {
    ...
    classifications.add(aPredefinedPdcClassification(0).inComponentInstance(COMPONENT_INSTANCE_2_ID).
    ...
    classifications.add(aPredefinedPdcClassification(2).inComponentInstance(COMPONENT_INSTANCE_2_ID).
    ...
    classifications.add(aPredefinedPdcClassification(4).inComponentInstance(COMPONENT_INSTANCE_1_ID).
