...
public class PdcRightsDAO 
{
		...
		public static ArrayList getUserIds(Connection con, String axisId, String valueId) throws SQLException
		{
		...
		public static ArrayList getGroupIds(Connection con, String axisId, String valueId) throws SQLException
		{
