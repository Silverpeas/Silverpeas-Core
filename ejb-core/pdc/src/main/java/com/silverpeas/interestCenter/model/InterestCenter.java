...
public class InterestCenter implements Cloneable, java.io.Serializable {
     ...
     * Full constructor
     */
    public InterestCenter(int iD, String name, String query, String workSpaceID, String peasID, String authorID,
                          java.util.Date afterDate, java.util.Date beforeDate, ArrayList pcdContext, int ownerID) {
        this.id = iD;
        this.name = name;
        this.query = query;
    ...
    public String toString() {
        return "InterestCenter object : [ ID = " + id +
                ", name = " + name +
                ", query = " + query +
