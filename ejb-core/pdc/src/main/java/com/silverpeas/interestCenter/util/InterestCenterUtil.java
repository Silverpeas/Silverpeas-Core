...
public class InterestCenterUtil {
    ...
    /** Constructor
     * Creates new Interest Center Util Controller
     */
    ...
    private void initEJB()  {
        if (icEjb == null) {
            try {
                InterestCenterBmHome icEjbHome = (InterestCenterBmHome) EJBUtilitaire.getEJBObjectRef(JNDINames.INTEREST_CENTER_EJBHOME, InterestCenterBmHome.class);
    ...
    /**    Method isICExists
     *
     *      returns true if InterstCenter with given name is already exists, false in other case
     *
     */
