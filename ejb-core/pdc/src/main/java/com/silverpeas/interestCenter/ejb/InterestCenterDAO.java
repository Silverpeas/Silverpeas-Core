...
public class InterestCenterDAO
{
	 ...
	 */
	public static ArrayList getICByUserID(Connection con, int userid) throws SQLException, DAOException
	{
		if (con == null)
		{
			throw new DAOException("InterestCenterDAO.getICByUserID", "InterestCenter.EX_NO_CONNECTION");
		}
	...
	public static InterestCenter getICByPK(Connection con, int icID) throws SQLException, DAOException
	{
		if (con == null)
		{
			throw new DAOException("InterestCenterDAO.getICByPK", "InterestCenter.EX_NO_CONNECTION");
		}
		PreparedStatement prepStmt = null;
	...
	/**
	 * @param rs ResultSet to Create <code>InterestCentre</code> from. ResultSet shoud be
	 * already positioned
	 */
	private static InterestCenter getICformRS(ResultSet rs, java.sql.Connection con) throws SQLException, DAOException
	{
		...
		{
			throw new DAOException("InterestCenterDAO.getICByUserID", "InterestCenter.EX_CANNOT_PARSE_DATE", e);
		}
	...
	public static int createIC(Connection con, InterestCenter interestCenter) throws SQLException, DAOException
	{
		if (con == null)
		{
			throw new DAOException("InterestCenterDAO.createIC", "InterestCenter.EX_NO_CONNECTION");
		}
		if (interestCenter == null)
		{
			throw new DAOException("InterestCenterDAO.createIC", "InterestCenter.EX_CANNOT_INSERT_NULL_IC");
		}
		PreparedStatement prepStmt = null;
		SimpleDateFormat formatter = new SimpleDateFormat(DATE_FORMAT);
		...
		{
			throw new DAOException("InterestCenterDAO.createIC", "root.EX_PK_GENERATION_FAILED", ICENTER_TABLE_NAME, e);
		}
		...
		try
		{
			...
			if (result < 1)
			{
				throw new DAOException(
					"InterestCenterDAO.createIC",
					"InterestCenter.WRONG_CREATED_ROW_NUMBER",
					"ID: " + newId + ". DataObject: " + interestCenter);
			}
	...
	public static void updateIC(Connection con, InterestCenter interestCenter) throws SQLException, DAOException
	{
		if (con == null)
		{
			throw new DAOException("InterestCenterDAO.updateIC", "InterestCenter.EX_NO_CONNECTION");
		}
		PreparedStatement prepStmt = null;
		SimpleDateFormat formatter = new SimpleDateFormat(DATE_FORMAT);
		...
		try
		{
			...
			{
				throw new DAOException(
					"InterestCenterDAO.updateIC",
					"InterestCenter.WRONG_UPDATED_ROW_NUMBER",
					interestCenter.toString());
			}
	...
	/**
	 * @param pks ArrayList of <code>java.lang.Integer</code> - id's of
	 *  <code>InterestCenter</code>s to be deleted
	 */
	public static void removeICByPK(Connection con, ArrayList removePKList) throws SQLException, DAOException
	{
	...
	public final static String REMOVE_IC_BY_PKS_LIST_QUERY = "delete from " + ICENTER_TABLE_NAME + " where id = ?";
	...
	public static void removeICByPK(Connection con, int removeID) throws SQLException, DAOException
	{
		if (con == null)
		{
			throw new DAOException("InterestCenterDAO.removeICByPK", "InterestCenter.EX_NO_CONNECTION");
		}
		PreparedStatement prepStmt = null;
		...
		try
		{
			...
			{
				throw new DAOException(
					"InterestCenterDAO.removeICByPK",
					"InterestCenter.WRONG_UPDATED_ROW_NUMBER",
					"ID=" + removeID);
			}
	...
	public final static String LOAD_PDC_PK_QUERY =
		"SELECT a.axisId, a.value " + "  FROM " + ICENTER_AXES_TABLE_NAME + " a WHERE a.icId = ? ";

	/**
	 * @return list of SearchCriteria
	 */
	public static ArrayList loadPdcContext(Connection con, int icId) throws SQLException, DAOException
	{
		if (con == null)
		{
			throw new DAOException("InterestCenterDAO.loadPdcContext", "InterestCenter.EX_NO_CONNECTION");
		}
		PreparedStatement prepStmt = null;
		ResultSet rs = null;
		ArrayList result = null;
	...
	public final static String CREATE_PDC_CONTEXT_QUERY =
		"INSERT  INTO " + ICENTER_AXES_TABLE_NAME + " ( " + " id, icId, axisId, value) VALUES (?, ?, ?, ?) ";

	/**
	 * Appends a list of SearchCriteria to the InterestCenter by InterestCenterID
	 * @param icId InterestCenterID
	 */
	public static int[] appendPdcContext(Connection con, ArrayList pdcContext, int icId)
		throws SQLException, DAOException
	{
		if (con == null)
		{
			throw new DAOException("InterestCenterDAO.appendPdcContext", "InterestCenter.EX_NO_CONNECTION");
		}
		if (pdcContext == null)
		{
			return null;
		...
		try
		{
			...
			for (int i = 0; i < pdcContext.size(); i++)
			{
				...
				{
					throw new DAOException(
						"InterestCenterDAO.appendPdcContext",
						"root.EX_PK_GENERATION_FAILED",
				...
				if (result < 1)
				{
					throw new DAOException(
						"InterestCenterDAO.appendPdcContext",
						"InterestCenter.WRONG_CREATED_ROW_NUMBER",
						"Criteria: " + criteria + ". ID = " + newId + ". For InterestCenter ID = " + icId);
				}
	 ...
	 * @param icId InterestCenterID
	 */
	public static void updatePdcContext(Connection con, ArrayList list, int icId) throws SQLException, DAOException
	{
		if (con == null)
		{
			throw new DAOException("InterestCenterDAO.updatePdcContext", "InterestCenter.EX_NO_CONNECTION");
		}
		if (icId < 0)
		{
			throw new DAOException(
				"InterestCenterDAO.updatePdcContext",
				"InterestCenter.INCORRECT_ID_NUMBER",
				String.valueOf(icId));
		}
	...
	public final static String REMOVE_IC_CONTEXT_QUERY = "delete from " + ICENTER_AXES_TABLE_NAME + " where icId = ?";
	...
	public static void removePdcContext(Connection con, int icId) throws SQLException, DAOException
	{
		if (con == null)
		{
			throw new DAOException("InterestCenterDAO.removePdcContext", "InterestCenter.EX_NO_CONNECTION");
		}
		PreparedStatement prepStmt = null;
		...
		try
		{
			...
			SilverTrace.debug(
				"InterestCenter",
				"InterestCenter.removePdcContext",
