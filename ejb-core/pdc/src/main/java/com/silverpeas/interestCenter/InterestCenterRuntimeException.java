...
public class InterestCenterRuntimeException extends SilverpeasRuntimeException {
    ...
    public InterestCenterRuntimeException(String callingClass, String message, String extraParams) {
        super(callingClass, ERROR, message, extraParams);
    }

    public InterestCenterRuntimeException(String callingClass, String message, Exception nested) {
        super(callingClass, ERROR, message, nested);
    }

    public InterestCenterRuntimeException(String callingClass, String message, String extraParams, Exception nested) {
