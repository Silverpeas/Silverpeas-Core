 ...
 *
 * Classe servant d'interface aux autres composants ayant besoin du thesaurus (module pdc et searchEngine) 
 *
 */
public class ThesaurusManager 
{
	...
	public ThesaurusManager() {
	 ...
	 /**
	 * Retourne la liste des synonymes d'un mot donné (ce mot peut-etre un terme ou un synonyme) pour un utilisateur donné
	 ...
	 */
	public Collection getSynonyms(String mot, String idUser) throws ThesaurusException {
		...
		try {
			...
			if (jargon != null) {
				...
				while (i.hasNext()) {
						String synonyme = (String) i.next(); 
						if ((! isExist(synonyme, finalList))&&(!mot.toLowerCase().equals(synonyme.toLowerCase()))) {
		...
		{
			throw new ThesaurusException("ThesaurusManager.getSynonyms(String mot, String idUser)",SilverpeasException.ERROR,"Thesaurus.EX_CANT_GET_SYNONYMS_USER","",e);
		}			
	 ...
	 * @throws ThesaurusException
	 *
	 * @see com.stratelia.silverpeas.pdc.control.PdcBm.getValues, com.silverpeas.thesaurus.control.ThesaurusBm.getSynonyms
	 */
	private Collection getSynonymsTerm(long idVoca, String term) throws ThesaurusException {
		...
		{
			throw new ThesaurusException("ThesaurusManager.getSynonymsTerm",SilverpeasException.ERROR,"Thesaurus.EX_CANT_GET_SYNONYMS_USER","",e);
		}			
		catch ( ThesaurusException e )
		{
			throw new ThesaurusException("ThesaurusManager.getSynonymsTerm",SilverpeasException.ERROR,"Thesaurus.EX_CANT_GET_SYNONYMS_USER","",e);
	 ...
	 /**
	 * Retourne la liste des autres synonymes d'un mot étant un synonyme d'un terme dans un vocabulaire donné
	 * retourne une Collection de String
	 *
	 *
	 * @param idVoca
	 ...
	 * @throws ThesaurusException
	 *
	 * @see com.silverpeas.thesaurus.control.ThesaurusBm.getSynonyms, com.stratelia.silverpeas.pdc.control.PdcBm.getValue
	 */
	private Collection getSynonyms(long idVoca, String synonym) throws ThesaurusException {
		...
		try {
			...
			while (i.hasNext()) {
				...
				while (j.hasNext()) {
					...
					PdcBm pdc = new PdcBmImpl();
					Value value = pdc.getAxisValue(new Long(idTerm).toString(), new Long(idTree).toString());
		...
		{
			throw new ThesaurusException("ThesaurusManager.getSynonyms(long idVoca, String synonym)",SilverpeasException.ERROR,"Thesaurus.EX_CANT_GET_SYNONYMS_USER","",e);
		}			
		catch ( ThesaurusException e )
		{
			throw new ThesaurusException("ThesaurusManager.getSynonyms(long idVoca, String synonym)",SilverpeasException.ERROR,"Thesaurus.EX_CANT_GET_SYNONYMS_USER","",e);
	 ...
	 */
	public Collection getSynonyms(long idTree, long idTerm, String idUser) throws ThesaurusException {
		...
		{
			throw new ThesaurusException("ThesaurusManager.getSynonyms(long idTree, long idTerm, String idUser)",SilverpeasException.ERROR,"Thesaurus.EX_CANT_GET_SYNONYMS","",e);
		}
		return theList;	
	}
	
	public Collection getSynonyms(long idTree, long idTerm, long idVoca) throws ThesaurusException {
	...
	public Collection getSynonymsByTree(long idTree, long idVoca)  throws ThesaurusException {
	 ...
	 * @throws ThesaurusException
	 *
	 * @see getJargon, com.stratelia.silverpeas.pdc.control.PdcBm.getRoot, com.silverpeas.thesaurus.control.ThesaurusBm.getSynonyms
	 */
	public Collection getSynonymsAxis(String axisId, String idUser) throws ThesaurusException {
		...
		{
			throw new ThesaurusException("ThesaurusManager.getSynonymsAxis(String axisId, String idUser)",SilverpeasException.ERROR,"Thesaurus.EX_CANT_GET_SYNONYMS","",e);
		}					
		catch ( ThesaurusException e )
		{
			throw new ThesaurusException("ThesaurusManager.getSynonymsAxis(String axisId, String idUser)",SilverpeasException.ERROR,"Thesaurus.EX_CANT_GET_SYNONYMS","",e);
	 ...
	 /**
	 * Retourne le jargon utilisé par l'utilisateur
	 * retourne un Jargon ou null s'il n'a pas de jargon
	 *
	 *
	 * @param idUser
	 *
	...
	public Jargon getJargon(String idUser) throws ThesaurusException {
		...
		{
			throw new ThesaurusException("ThesaurusManager.getJargon",SilverpeasException.ERROR,"Thesaurus.EX_CANT_GET_JARGON","",e);
		}			
