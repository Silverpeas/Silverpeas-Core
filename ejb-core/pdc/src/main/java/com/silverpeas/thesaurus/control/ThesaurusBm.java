...
public class ThesaurusBm 
{
	...
	private SilverpeasBeanDAO getVdao() throws PersistenceException {
		if (Vdao == null)
			Vdao = SilverpeasBeanDAOFactory.getDAO("com.silverpeas.thesaurus.model.Vocabulary");
		return Vdao;
	}
	
	private SilverpeasBeanDAO getSdao() throws PersistenceException {
		if (Sdao == null)
			Sdao = SilverpeasBeanDAOFactory.getDAO("com.silverpeas.thesaurus.model.Synonym");
		return Sdao;
	}
	
	private SilverpeasBeanDAO getJdao() throws PersistenceException {
		if (Jdao == null)
			Jdao = SilverpeasBeanDAOFactory.getDAO("com.silverpeas.thesaurus.model.Jargon");
		return Jdao;
	}
	...
	public Collection getListVocabulary() throws ThesaurusException
   	{
		...
		{
			throw new ThesaurusException("ThesaurusBm.getListVocabulary",SilverpeasException.ERROR,"Thesaurus.EX_CANT_GET_LIST_VOCABULARIES","",e);
		}	
		return vocabs;
   	}   
	...
	public Vocabulary getVocabulary(long idVoca) throws ThesaurusException
   	{
		...
		{
			throw new ThesaurusException("ThesaurusBm.getVocabulary",SilverpeasException.ERROR,"Thesaurus.EX_CANT_GET_VOCABULARY","",e);
		}	
		return vocab;
   	}      
	...
	public long createVocabulary(Vocabulary voca) throws ThesaurusException
   	{
		...
		{
			throw new ThesaurusException("ThesaurusBm.createVocabulary",SilverpeasException.ERROR,"Thesaurus.EX_CREATE_VOCABULARY_FAILED","",e);
		}		
		return idV;
   	}         	
	...
	public boolean existVocabulary(String name) throws ThesaurusException
   	{
		try
		{
			SilverpeasBeanDAO daoV = getVdao();
			IdPK pk = new IdPK();
			Collection vocabs = (Collection) daoV.findByWhereClause(pk, " name= '"+encode(name)+"'");
		...
		{
			throw new ThesaurusException("ThesaurusBm.existVocabulary",SilverpeasException.ERROR,"Thesaurus.EX_CANT_GET_VOCABULARY","name = "+name,e);
		}	
   	}     
	...
	public void updateVocabulary(Vocabulary voca) throws ThesaurusException
   	{
		...
		{
			throw new ThesaurusException("ThesaurusBm.updateVocabulary",SilverpeasException.ERROR,"Thesaurus.EX_UPDATE_VOCABULARY_FAILED","",e);
		}	   	
	}             
	...
	public void deleteVocabulary(long idVoca) throws ThesaurusException
   	{
		...
		catch( Exception e )
		{
			...
			{
				throw new ThesaurusException("ThesaurusBm.deleteVocabulary",SilverpeasException.ERROR,"Thesaurus.EX_DELETE_VOCABULARY_FAILED","Error in rollback",e1);
			}	
				
			throw new ThesaurusException("ThesaurusBm.deleteVocabulary",SilverpeasException.ERROR,"Thesaurus.EX_DELETE_VOCABULARY_FAILED","",e);
		}				
		finally
		{
			if (con != null)
	...
	private void deleteVocaSynonyms(Connection con, long idVoca) throws ThesaurusException
   	{
		...
		{
			throw new ThesaurusException("ThesaurusBm.deleteVocaSynonyms",SilverpeasException.ERROR,"Thesaurus.EX_DELETE_SYNONYMS_VOCA_FAILED","",e);
		}	   	   	
	}
	...
	private void deleteVocaJargons(Connection con, long idVoca) throws ThesaurusException
   	{
		...
		{
			throw new ThesaurusException("ThesaurusBm.deleteVocaJargons",SilverpeasException.ERROR,"Thesaurus.EX_DELETE_JARGONS_FAILED","",e);
		}	   	     	
	}
	...
	public void deleteJargons(Collection jargons) throws ThesaurusException
   	{
		...
		{
			throw new ThesaurusException("ThesaurusBm.deleteJargons",SilverpeasException.ERROR,"Thesaurus.EX_DELETE_JARGONS_FAILED","",e);
		}	
	}
	...
	private void deleteJargon(String idJargon) throws ThesaurusException
   	{
		...
		{
			throw new ThesaurusException("ThesaurusBm.deleteJargon",SilverpeasException.ERROR,"Thesaurus.EX_DELETE_JARGON_FAILED","",e);
		}	   	     	
	}
	 ...
	 * @see createSynonym
	 */
	private void createSynonyms(Connection con, Collection synonyms) throws ThesaurusException
   	{
   		try {
		...
		{
			throw new ThesaurusException("ThesaurusBm.createSynonyms",SilverpeasException.ERROR,"Thesaurus.EX_CREATE_SYNONYMS_FAILED","",e);
		}	   
	} 	
	...
	private void createSynonym(Connection con, Synonym synonym) throws ThesaurusException
   	{
		...
		{
			throw new ThesaurusException("ThesaurusBm.createSynonym",SilverpeasException.ERROR,"Thesaurus.EX_CREATE_SYNONYMS_FAILED","",e);
		}	   		
	}   
	 ...
	 * @see 
	 */
	public Collection getSynonyms(long idVoca, long idTree, long idTerm) throws ThesaurusException
   	{
		...
		{
			throw new ThesaurusException("ThesaurusBm.getSynonyms(long idVoca, long idTree, long idTerm)",SilverpeasException.ERROR,"Thesaurus.EX_CANT_GET_SYNONYMS","",e);
		}	
		return synonyms;
	} 	   
	...
	public void updateSynonyms(Collection synonyms) throws ThesaurusException
   	{
		...
		catch( Exception e )
		{
			...
			{
				throw new ThesaurusException("ThesaurusBm.updateSynonyms",SilverpeasException.ERROR,"Thesaurus.EX_UPDATE_SYNONYMS_FAILED","Error in rollback",e1);
			}
						
			throw new ThesaurusException("ThesaurusBm.updateSynonyms",SilverpeasException.ERROR,"Thesaurus.EX_UPDATE_SYNONYMS_FAILED","",e);
		}					
		finally
		{
			if (con != null)
	 ...
	 */
     public void deleteSynonyms(String idVoca, String idTree, String idTerm) throws ThesaurusException  {
             ...
             try {
                 ...
                 throw new ThesaurusException("ThesaurusBm.deleteSynonyms",SilverpeasException.ERROR,"Thesaurus.EX_DELETE_SYNONYMS_FAILED","",e);
             } finally {
                 if (con != null)
                     try {
                          con.close();
     ...
     private void deleteSynonyms(Connection con, long idVoca, long idTree, long idTerm) throws ThesaurusException
   	{
		...
		{
			throw new ThesaurusException("ThesaurusBm.deleteSynonyms(Connection con, long idVoca, long idTree, long idTerm)",SilverpeasException.ERROR,"Thesaurus.EX_DELETE_SYNONYMS_TERM_FAILED","",e);
		}	   	 
	}
	...
	public void deleteSynonyms(Collection idSynonyms) throws ThesaurusException
   	{
		...
		{
			throw new ThesaurusException("ThesaurusBm.deleteSynonyms(Collection idSynonyms)",SilverpeasException.ERROR,"Thesaurus.EX_DELETE_SYNONYMS_FAILED","",e);
		}	  		
	} 	 
	...
	private void deleteSynonym(long idSynonym) throws ThesaurusException
   	{
		...
		{
			throw new ThesaurusException("ThesaurusBm.deleteSynonym",SilverpeasException.ERROR,"Thesaurus.EX_DELETE_SYNONYM_FAILED","",e);
		}	 							
	} 	 
	...
	public void deleteSynonymsAxis(Connection con, long idTree) throws ThesaurusException 
	{
		...
		{
			throw new ThesaurusException("ThesaurusManager.deleteSynonymsAxis",SilverpeasException.ERROR,"Thesaurus.EX_DELETE_SYNONYMS_AXIS_FAILED","",e);
		}			
	}	
	 ...
	 */	
	public void deleteSynonymsTerms(Connection con, long idTree, List idTerms) throws ThesaurusException 
	{
		try {			
		...
		{
			throw new ThesaurusException("ThesaurusManager.deleteSynonymsTerms",SilverpeasException.ERROR,"Thesaurus.EX_DELETE_SYNONYMS_TERMS_FAILED","",e);
		}			
	}		
	...
	private void deleteSynonymsTerm(Connection con, long idTree, long idTerm) throws ThesaurusException 
	{
		...
		{
			throw new ThesaurusException("ThesaurusManager.deleteSynonymsTerm",SilverpeasException.ERROR,"Thesaurus.EX_DELETE_SYNONYMS_TERM_FAILED","",e);
		}			
	}			
		

	 /**
	 * Retourne la liste des utilisateurs utilisant le vocabulaire passé en paramètre
	 * retourne une Collection de Jargon
	 *
	 *
	 * @param idVoca
	 *
	...
	public Collection getJargons(long idVoca) throws ThesaurusException
   	{
		...
		{
			throw new ThesaurusException("ThesaurusBm.getJargons",SilverpeasException.ERROR,"Thesaurus.EX_CANT_GET_JARGONS","",e);
		}	
		return jargons;
	}  
	 ...
	 * @see 
	 */
	public Collection getJargons(Collection idUsers, int type) throws ThesaurusException
   	{
		Collection jargons = new ArrayList();
		try
		{
		...
		{
			throw new ThesaurusException("ThesaurusBm.getJargons",SilverpeasException.ERROR,"Thesaurus.EX_CANT_GET_JARGONS_USERS","",e);
		}	
		return jargons;
	}  
	 /**
	 ...
	 * @see 
	 */
	public Collection getJargons(Connection con, Collection idUsers, int type) throws ThesaurusException
   	{
		Collection jargons = new ArrayList();
		try
		{
			...
			while (i.hasNext()) {
				String idUser = (String) i.next();
				Collection theJargons = daoJ.findByWhereClause(con, pk, " idUser='"+idUser+"'"+
													   			" AND type="+type);
				Iterator j = theJargons.iterator();
				while (j.hasNext()) {
					Jargon jargon = (Jargon) j.next();	
	...
	public void createJargons(Collection jargons) throws ThesaurusException
   	{
		...
		{
			throw new ThesaurusException("ThesaurusBm.createJargons",SilverpeasException.ERROR,"Thesaurus.EX_CREATE_JARGONS_FAILED","",e);
		}	
	}  
	 /**
	 * Crée une liste de jargons
	 ...
	 * @see getJargons, createJargon, updateJargon
	 */
	public void createJargons(Connection con, Collection jargons) throws ThesaurusException
   	{
   		 try {
			Iterator i = jargons.iterator();
			while (i.hasNext()) {
	 ...
	 */
	public void createVocaJargons(Collection jargons, long idVoca) throws ThesaurusException
   	{
   		Connection con = null;
		...
		catch( Exception e )
		{
			...
			{
				throw new ThesaurusException("ThesaurusBm.createJargons",SilverpeasException.ERROR,"Thesaurus.EX_CREATE_JARGONS_FAILED","Error in rollback",e1);
			}
	...
	private void createJargon(Jargon jargon) throws ThesaurusException
   	{
		...
		{
			throw new ThesaurusException("ThesaurusBm.createJargon",SilverpeasException.ERROR,"Thesaurus.EX_CREATE_JARGON_FAILED","",e);
		}	   		
	}  
	...
	private void updateJargon(Jargon jargon) throws ThesaurusException
   	{
		...
		{
			throw new ThesaurusException("ThesaurusBm.updateJargon",SilverpeasException.ERROR,"Thesaurus.EX_UPDATE_JARGON_FAILED","",e);
		}	   		
	}  
	...
	public Jargon getJargon(String idUser) throws ThesaurusException
   	{
		...
		{
			throw new ThesaurusException("ThesaurusBm.getJargon",SilverpeasException.ERROR,"Thesaurus.EX_CANT_GET_JARGON","",e);
		}	
		return jargon;
	}  
	 ...
	 * @see 
	 */
	public Collection getSynonyms(long idVoca, String name) throws ThesaurusException
   	{
		Collection synonyms = new ArrayList();
		try
		{
			...
			IdPK pk = new IdPK();
			synonyms = daoS.findByWhereClause(pk, " idVoca="+idVoca+
												  " AND name='"+encode(name)+"'");
		}
		catch( PersistenceException e )
		{
			throw new ThesaurusException("ThesaurusBm.getSynonyms(long idVoca, String name)",SilverpeasException.ERROR,"Thesaurus.EX_CANT_GET_SYNONYMS_NAME","",e);
		}	
		return synonyms;
	}
	 ...
	 * @see 
	 */
	public Collection getSynonymsByTree(long idVoca, long idTree) throws ThesaurusException
   	{
		Collection synonyms = new ArrayList();
		try
		{
		...
		{
			throw new ThesaurusException("ThesaurusBm.getSynonymsByTree(long idVoca, long idTree)",SilverpeasException.ERROR,"Thesaurus.EX_CANT_GET_SYNONYMS_NAME","idVoca = "+idVoca+", idTree = "+idTree, e);
		}	
		return synonyms;
	}
