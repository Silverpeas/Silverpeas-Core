...
public class ThesaurusException extends SilverpeasException{
	...
	*/
	public ThesaurusException(String callingClass, int errorLevel, String message, String extraParams, Exception nested){
		super(callingClass, errorLevel, message, extraParams, nested);
	}

	public ThesaurusException(String callingClass, int errorLevel, String message, String extraParams){
		this(callingClass, errorLevel, message, extraParams, null);
	}

	public ThesaurusException(String callingClass, int errorLevel, String message, Exception nested){
