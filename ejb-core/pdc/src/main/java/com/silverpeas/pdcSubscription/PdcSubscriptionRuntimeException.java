...
public class PdcSubscriptionRuntimeException extends SilverpeasRuntimeException {
    ...
    public PdcSubscriptionRuntimeException(String callingClass, int level, String message) {
        super(callingClass, ERROR, message);
    }

    public PdcSubscriptionRuntimeException(String callingClass, int level, String message, Object extraParams) {
        super(callingClass, ERROR, message, makeString(extraParams));
    }

    public PdcSubscriptionRuntimeException(String callingClass, int level, String message, Exception nested) {
