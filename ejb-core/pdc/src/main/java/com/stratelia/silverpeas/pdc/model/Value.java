...
public class Value extends TreeNode implements java.io.Serializable {
	...
	*/
    ...
    public Value(String id, String treeId, String name, String description, String creationDate, String creatorId, String path, int level, int order, String fatherId)
    {    
		super(id, treeId, name, description, creationDate, creatorId, path, level, order, fatherId);
		setValuePK(new ValuePK(id));
    }
    public Value(String id, String treeId, String name, String creationDate, String creatorId, String path, int level, int order, String fatherId)
    {
