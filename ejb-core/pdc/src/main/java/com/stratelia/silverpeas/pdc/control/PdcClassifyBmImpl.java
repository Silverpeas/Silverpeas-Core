...
public class PdcClassifyBmImpl implements PdcClassifyBm
{
    ...
    {	
		...
		{
			//throw new PdcException("PdcClassifyBmImpl.addPosition", SilverpeasException.ERROR, "Pdc.CANNOT_ADD_POSITION", e);
		}
    }
    ...
    public int isPositionAlreadyExists(int silverObjectId, ClassifyPosition position) throws PdcException
    {
		...
		{
			throw new PdcException("PdcClassifyBmImpl.isPositionAlreadyExists", SilverpeasException.ERROR, "Pdc.CANNOT_ADD_POSITION", e);
		}
    }
    ...
    public int addPosition(int silverObjectId, ClassifyPosition position, String sComponentId) throws PdcException 
		{
				...
				try
				{
					...
					// Call the containerManager to register the association containerInstance - ContentInstance(SilverObjectId)
    ...
    public int updatePosition(ClassifyPosition position) throws PdcException 
		{
				...
				{
					throw new PdcException("PdcClassifyBmImpl.updatePosition", SilverpeasException.ERROR, "Pdc.CANNOT_UPDATE_POSITION", e);
				}
	}
	
	// add by SAN
	public int updatePositions(List classifyValues,int silverObjectId) throws PdcException 
		{
				try
				{
				...
				{
					throw new PdcException("PdcClassifyBmImpl.updatePositions", SilverpeasException.ERROR, "Pdc.CANNOT_UPDATE_POSITION", e);
				}
	}
    ...
    public void deletePosition(int nPositionId, String sComponentId) throws PdcException 
		{
				...
				try
				{
					...
					// Call the containerManager to unregister the association containerInstance - ContentInstance(SilverObjectId)
				...
				{
					rollbackConnection(connection);
					throw new PdcException("PdcClassifyBmImpl.deletePosition", SilverpeasException.ERROR, "Pdc.CANNOT_DELETE_POSITION", e);
				}
				finally
				{
					closeConnection(connection);
    ...
    public List getPositions(int silverObjectId, String sComponentId) throws PdcException 
		{
				...
				try
				{
						...
						List alFilteredPositionIds = containerManager.filterPositionsByComponentId(alPositionIds, sComponentId);
				...
				{
					throw new PdcException("PdcClassifyBmImpl.getPositions", SilverpeasException.ERROR, "Pdc.CANNOT_GET_POSITIONS", e);
				}
	}
	...
	public JoinStatement getPositionsJoinStatement(List alComponentId) throws PdcException 
	{
				try
				{
						// Get the join statement for all positions for the given componentId
						return containerManager.getFilterPositionsByComponentIdStatement(null, (List)alComponentId);
				}
				catch (Exception e)
				{
					throw new PdcException("PdcClassifyBmImpl.getPositions", SilverpeasException.ERROR, "Pdc.CANNOT_GET_POSITIONS", e);
	...
	public void registerAxis(Connection con, int axisId) throws PdcException {
		...
		{
			throw new PdcException("PdcClassifyBmImpl.getPositions", SilverpeasException.ERROR, "Pdc.CANNOT_CREATE_AXE", e);
		}
	}
	...
	public void unregisterAxis(Connection con, int axisId) throws PdcException {
		...
		{
			throw new PdcException("PdcClassifyBmImpl.getPositions", SilverpeasException.ERROR, "Pdc.CANNOT_DELETE_AXE", "axisId: " + axisId, e);
		}
	}
	...
	* Then, we replace the first Value list by the second
	* @param con - a connection to the database
	* @param axisId - the id of the axis
	* @param oldPath - a list of path
	* @param newPath - a list of path
	*/
	public void createValuesAndReplace(Connection con,String axisId,ArrayList oldPath,ArrayList newPath) throws PdcException {
		...
		try{
		 classifyEngine.replaceValuesOnAxis(con,(List) oldValues, (List)newValues);
		} catch (Exception e){
			throw new PdcException("PdcClassifyBmImpl.createValuesAndReplace", SilverpeasException.ERROR, "Pdc.CANNOT_UPDATE_POSITIONS", e);
		}
	}
	...
	public List getObjectsByInstance(String instanceId) throws PdcException {
		...
		try{
			List alPositionIds = containerManager.filterPositionsByComponentId(null, instanceId);
			objectIdList = (ArrayList) classifyEngine.getSilverContentIdsByPositionIds(alPositionIds);
		} catch (Exception e){
			SilverTrace.info("ClassifyEngine", "PdcClassifyBmImpl.hasAlreadyPositions", "pdcClassify.MSG_CANNOT_GET_SILVEROBJECTID_LIST", "", e);
		}
	...
	*/
	public boolean hasAlreadyPositions(List objectIdList, UsedAxis usedAxis)throws PdcException{
		String newBaseValue = "/"+(new Integer(usedAxis.getBaseValue())).toString()+"/";
		...
		for (int i=0;i<objectIdList.size() ; i++){
			...
			{
					positions = (ArrayList)getPositions(((Integer)objectIdList.get(i)).intValue(), instanceId);
					// maintenant, je récupère toutes les valeurs de toutes les positions
					// pour ne prendre que les path de chaques Values
					// si la valeur de base ne fait pas partie du chemin alors on ne peut pas
					...
					for (int k=0; k<positions.size();k++ ){
						...
						com.stratelia.silverpeas.classifyEngine.Value value = position.getValueByAxis(usedAxis.getAxisId());
						...
						// une position existe deja, inutile de continuer à chercher d'autres positions
						// je sors donc de la boucle
						if (hasOnePosition){
							break;
						}
					}
					// une position existe deja, inutile de chercher des positions dans d'autres silverobjectid
	...
	public List getPertinentAxis(SearchContext searchContext, List axisIds) throws PdcException {
		try
		{
		...
		{
				throw new PdcException("PdcClassifyBmImpl.getPertinentAxis", SilverpeasException.ERROR, "Pdc.CANNOT_GET_PERTINENT_AXIS", e);
		}
	}

	public List getPertinentValues(SearchContext searchContext, int axisId) throws PdcException {
		try
		{
		...
		{
				throw new PdcException("PdcClassifyBmImpl.getPertinentAxis", SilverpeasException.ERROR, "Pdc.CANNOT_GET_PERTINENT_VALUES", e);
		}
	}

	public List getPertinentAxis(SearchContext searchContext, List axisIds, JoinStatement joinStatementAllPositions) throws PdcException {
		try
		{
			return classifyEngine.getPertinentAxisByJoin(searchContext.getCriterias(), axisIds, joinStatementAllPositions);
		}
		catch(Exception e)
		{
				throw new PdcException("PdcClassifyBmImpl.getPertinentAxis", SilverpeasException.ERROR, "Pdc.CANNOT_GET_PERTINENT_AXIS", e);
	...
	public PertinentAxis getPertinentAxis(SearchContext searchContext, String axisId, String sRootValue, JoinStatement joinStatementAllPositions) throws PdcException {
		try
		{
			return classifyEngine.getSinglePertinentAxisByJoin(null, searchContext.getCriterias(), new Integer(axisId).intValue(), sRootValue, joinStatementAllPositions);
		}
		catch(Exception e)
		{
				throw new PdcException("PdcClassifyBmImpl.getPertinentAxis", SilverpeasException.ERROR, "Pdc.CANNOT_GET_PERTINENT_AXIS", e);
	...
	public List getPertinentValues(SearchContext searchContext, int axisId, JoinStatement joinStatementAllPositions) throws PdcException {
		try
		{
			return classifyEngine.getPertinentValuesByJoin(searchContext.getCriterias(), axisId, joinStatementAllPositions);
		}
		catch(Exception e)
		{
			throw new PdcException("PdcClassifyBmImpl.getPertinentAxis", SilverpeasException.ERROR, "Pdc.CANNOT_GET_PERTINENT_VALUES", e);
	...
	public List getObjectValuePairs(SearchContext searchContext, int axisId, JoinStatement joinStatementAllPositions) throws PdcException {
		try
		{
			return classifyEngine.getObjectValuePairsByJoin(searchContext.getCriterias(), axisId, joinStatementAllPositions);
		}
		catch(Exception e)
		{
			throw new PdcException("PdcClassifyBmImpl.getPertinentAxis", SilverpeasException.ERROR, "Pdc.CANNOT_GET_PERTINENT_VALUES", e);
		...
		public List removePosition(Connection connection, int nSilverContentId) throws PdcException
		{
				try
				{
						// Get all the positions of the removed object
						List alPositions = classifyEngine.findPositionsBySilverOjectId(nSilverContentId);
						...
						for(int nI=0; alPositions != null && nI < alPositions.size(); nI++)
								alPositionIds.add(new Integer(((Position)alPositions.get(nI)).getPositionId()));
				...
				{
						throw new PdcException("PdcClassifyBmImpl.removePosition", SilverpeasException.ERROR, "Pdc.CANNOT_REMOVE_SILVERCONTENTID", e);
				}
		}

		/** Find all the SilverContentId with the given position */
		public List findSilverContentIdByPosition(ContainerPositionInterface containerPosition, List alComponentId, String authorId, String afterDate, String beforeDate) throws PdcException
		{
			return findSilverContentIdByPosition(containerPosition, alComponentId, authorId, afterDate, beforeDate, true, true);
		}

		/** Find all the SilverContentId with the given position */
		public List findSilverContentIdByPosition(ContainerPositionInterface containerPosition, List alComponentId, String authorId, String afterDate, String beforeDate, boolean recursiveSearch, boolean visibilitySensitive) throws PdcException
		{
			try
			{
				...
				return classifyEngine.findSilverOjectByCriterias(alCriterias, containerManager.getFilterPositionsByComponentIdStatement(null, alComponentId), contentManager.getPositionsByGenericSearch(authorId, afterDate, beforeDate), afterDate, beforeDate, recursiveSearch, visibilitySensitive);
			}
			catch(Exception e)
			{
				throw new PdcException("PdcClassifyBmImpl.findSilverContentIdByPosition", SilverpeasException.ERROR, "Pdc.CANNOT_GET_SILVERCONTENTIDS", e);
			}
		}
		public List findSilverContentIdByPosition(ContainerPositionInterface containerPosition, List alComponentId) throws PdcException{
		...
		private void rollbackConnection(Connection con)
		{
			...
			{
				SilverTrace.error("Pdc", "PdcClassifyBmImpl.rollbackConnection()", "root.EX_CONNECTION_CLOSE_FAILED", "", e);
			}
		}
		...
		private void closeConnection(Connection connection)
		{
			...
			{
				SilverTrace.error("Pdc", "PdcClassifyBmImpl.closeConnection", "root.EX_CONNECTION_CLOSE_FAILED", "", e);
			}
		}
}