...
public class UsedAxis extends SilverpeasBean implements java.io.Serializable {
	...
	*/
	...
	public UsedAxis(UsedAxisPK pk, String instanceId, int axisId, int baseValue, int mandatory, int variant){
		setPK(pk);
	...
	public UsedAxis(int usedAxisId, String instanceId, int axisId, int baseValue, int mandatory, int variant){
	...
	public UsedAxis(String usedAxisId, String instanceId, int axisId, int baseValue, int mandatory, int variant){
		setPK(new UsedAxisPK(usedAxisId));
		this.instanceId = instanceId;
		this.axisId = axisId;
		this.baseValue = baseValue;
	...
	*/
	public String toString() {
		return "(pk = " + getPK() + ", instanceId = " + getInstanceId() + 
            ", axisId = " + getAxisId() + ", baseValue = " + getBaseValue() +", mandatory = " + getMandatory()+
			", variant = "+getVariant()+")";
	}
