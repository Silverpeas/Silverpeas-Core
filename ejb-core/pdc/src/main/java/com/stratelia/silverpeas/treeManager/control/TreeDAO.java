...
public class TreeDAO
{
	...
	public static String createRoot(Connection con, TreeNode root) throws SQLException
	{
		...
		String insertQuery = "insert into " + TreeTable + " values ( ? , ? , ? , ? , ? , ? , ? , ? , ? , ?, ? )";
	...
	public static void deleteNode(Connection con, TreeNodePK treeNodePK, String treeId) throws SQLException
	{
		...
		String deleteQuery = "delete from " + TreeTable + " where treeId=" + treeId + " and id=" + treeNodePK.getId();
	...
	public static void levelUp(Connection con, String path, String treeId) throws SQLException
	{
		String updateStatement =
			"update "
				+ TreeTable
				+ " set levelNumber = levelNumber - 1 where treeId = "
				+ treeId
				+ " and path like '"
				+ path
				+ "%' ";
	...
	public static void changeFatherAndPath(Connection con, int oldFather, int newFather, String path, String treeId)
		throws SQLException
	{
		String updateStatement =
			"update " + TreeTable + " set fatherId = ?, path = ? where treeId = " + treeId + " and fatherId = ? ";
		PreparedStatement prepStmt = null;
	...
	*/
	private static ArrayList getPathes(Connection con, String oldFather, String treeId) throws SQLException
	{
		String selectQuery =
			" select path from " + TreeTable + " where treeId = " + treeId + " and path like '%/" + oldFather + "/%'";
		Statement stmt = null;
		ResultSet rs = null;
