...
public class LinkDAO
{
	...
	public static Collection getAllLinksByInstance(Connection con, String instanceId)
	throws SQLException
	{
	...
	public static Collection getAllLinksByObject(Connection con, String instanceId, String objectId)
	throws SQLException
	{
	...
	private static void initParam(PreparedStatement prepStmt, int linkId, LinkDetail link) throws SQLException
	{
		prepStmt.setInt(1, new Integer(linkId).intValue());
