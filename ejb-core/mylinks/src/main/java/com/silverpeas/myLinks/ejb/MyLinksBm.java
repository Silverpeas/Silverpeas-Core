...
public interface MyLinksBm extends EJBObject 
{
	...
	public Collection getAllLinksByInstance(String instanceId) throws RemoteException;
	public Collection getAllLinksByObject(String instanceId, String objectId) throws RemoteException;
