...
/**
 * This object contains the description of a complete publication (publication parameter, model detail, info)
...
public class CompletePublication implements Serializable {
  ...
  private InfoDetail infoDetail;
	...
	* @since 1.0
	*/
  public CompletePublication(PublicationDetail pubDetail, ModelDetail modelDetail, InfoDetail infoDetail) {
