...
public class PublicationBmEJB implements SessionBean, PublicationBmBusinessSkeleton
{
    ...
    private static final ResourceLocator publicationSettings = new ResourceLocator("com.stratelia.webactiv.util.publication.publicationSettings", "fr");
    ...
    {   
        if (pubPK.getInstanceId() == null)
        {
        	...
        	//un findByPrimaryKey.
        	//On est donc obligé de faire une recherche directement dans la base avant
        	...
        	{
        		throw new PublicationRuntimeException("PublicationBmEJB.getDetail()", SilverpeasRuntimeException.ERROR, "publication.GETTING_PUBLICATION_HEADER_FAILED", "pubId = "+pubPK.getId(), e);
        	}
        	finally
        	{
        		freeConnection(con);
        ...
        {
            throw new PublicationRuntimeException("PublicationBmEJB.getDetail()", SilverpeasRuntimeException.ERROR, "publication.GETTING_PUBLICATION_HEADER_FAILED", "pubId = "+pubPK.getId(), re);
        }
    }
    ...
    private void setTranslations(Connection con, PublicationDetail publi)
    {
    	try
    	{
    		PublicationI18N translation = new PublicationI18N(publi.getLanguage(), publi.getName(), publi.getDescription(), publi.getKeywords());
    	...
    	{
    		throw new PublicationRuntimeException("PublicationBmEJB.setTranslations()", SilverpeasRuntimeException.ERROR, "publication.GETTING_TRANSLATIONS_FAILED", "pubId = "+publi.getPK().getId(), e);
    	}
    }
    ...
    public PublicationPK createPublication(PublicationDetail detail) throws RemoteException
    {
        ...
        try
        {
			...
			SilverTrace.info("publication", "PublicationBmEJB.createPublication()", "root.MSG_GEN_PARAM_VALUE", "indexOperation = " + indexOperation);
            ...
            if (SilverpeasSettings.readBoolean(publicationSettings, "useTagCloud", false))
            	createTagCloud(pubDetail);
        }
        catch (Exception re)
        {
        	throw new PublicationRuntimeException("PublicationBmEJB.createPublication()", SilverpeasRuntimeException.ERROR, "publication.CREATING_PUBLICATION_FAILED", "detail = "+detail.toString(), re);
        }
    ...
    public void movePublication(PublicationPK pubPK, NodePK nodePK, boolean indexIt) throws RemoteException
    {
        ...
        {
            throw new PublicationRuntimeException("PublicationBmEJB.movePublication()", SilverpeasRuntimeException.ERROR, "publication.MOVING_PUBLICATION_FAILED", "pubId = "+pubPK.getId(), re);
        }
    }
    ...
    public void changePublicationsOrder(List ids, NodePK nodePK) throws RemoteException
    {
    	...
    	try {
			...
			throw new PublicationRuntimeException("PublicationBmEJB.changePublicationsOrder()", SilverpeasRuntimeException.ERROR, "publication.SORTING_PUBLICATIONS_FAILED", "pubIds = "+ids.toString(), e);
		}
		finally
		{
			freeConnection(con);
    ...
    public void changePublicationOrder(PublicationPK pubPK, NodePK nodePK, int direction) throws RemoteException
    {
    	...
    	List publications = (List) getDetailsByFatherPK(nodePK, "P.pubUpdateDate desc");
    	...
    	try {
			...
			throw new PublicationRuntimeException("PublicationBmEJB.changePublicationOrder()", SilverpeasRuntimeException.ERROR, "publication.MOVING_PUBLICATION_FAILED", "pubId = "+pubPK.getId(), e);
		} finally {
			freeConnection(con);
		}
    }
	...
	{
		SilverTrace.debug("publication", "PublicationBmEJB.getIndexOfPublication()", "root.MSG_GEN_ENTER_METHOD", "pubId = "+pubId);
		PublicationDetail	publi	= null;
		int			index	= 0;
		if (publications != null)
		{
			for (int i=0; i<publications.size(); i++)
			{
				...
				{
					SilverTrace.debug("publication", "PublicationBmEJB.getIndexOfPublication()", "root.MSG_GEN_EXIT_METHOD", "index = "+index);
					return index;
				}
				index++;
			}
    ...
    public void removePublication(PublicationPK pubPK) throws RemoteException
    {
        ...
        {
            throw new PublicationRuntimeException("PublicationBmEJB.removePublication()", SilverpeasRuntimeException.ERROR, "publication.DELETING_PUBLICATION_FAILED", "pubId = "+pubPK.getId(), re);
        }
    }
    ...
    public void removeImage(PublicationPK pubPK) throws RemoteException
    {
        ...
        {
            throw new PublicationRuntimeException("PublicationBmEJB.removeImage()", SilverpeasRuntimeException.ERROR, "publication.DELETING_IMAGE_FAILED", "pubId = "+pubPK.getId(), re);
        }
    }
    ...
    public void setDetail(PublicationDetail detail) throws RemoteException
    {
        ...
        try
        {
            ...
            if (detail.isRemoveTranslation())
            {
            	...
            	SilverTrace.info("publication", "PublicationBmEJB.setDetail()", "root.MSG_GEN_PARAM_VALUE", "infoId = "+infoId);
    			if (StringUtil.isDefined(infoId) && !isInteger(infoId))
    			{
    				String xmlFormShortName = infoId;
    				
    				PublicationTemplate pubTemplate = PublicationTemplateManager.getPublicationTemplate(detail.getPK().getInstanceId()+":"+xmlFormShortName);
            ...
            SilverTrace.info("publication", "PublicationBmEJB.setDetail()", "root.MSG_GEN_PARAM_VALUE", "indexOperation = "+indexOperation);
        ...
        {
        	throw new PublicationRuntimeException("PublicationBmEJB.setDetail()", SilverpeasRuntimeException.ERROR, "publication.UPDATING_PUBLICATION_HEADER_FAILED", "detail = "+detail.toString(), re);
        }
    }
    ...
    public List getValidationSteps(PublicationPK pubPK) throws RemoteException
    {
		...
		{
    		throw new PublicationRuntimeException("PublicationBmEJB.getValidationSteps()", SilverpeasRuntimeException.ERROR,
    ...
    public ValidationStep getValidationStepByUser(PublicationPK pubPK, String userId) throws RemoteException
    {
		...
		{
    		throw new PublicationRuntimeException("PublicationBmEJB.getValidationStepByUser()", SilverpeasRuntimeException.ERROR,
    ...
    public void addValidationStep(ValidationStep step) throws RemoteException
    {
		...
		{
    		throw new PublicationRuntimeException("PublicationBmEJB.addValidationStep()", SilverpeasRuntimeException.ERROR,
    ...
    public void removeValidationSteps(PublicationPK pubPK) throws RemoteException
    {
		...
		{
    		throw new PublicationRuntimeException("PublicationBmEJB.removeValidationSteps()", SilverpeasRuntimeException.ERROR,
    ...
    public void addFather(PublicationPK pubPK, NodePK fatherPK) throws RemoteException
    {
        ...
        {
            throw new PublicationRuntimeException("PublicationBmEJB.addFather()", SilverpeasRuntimeException.ERROR, "publication.ADDING_FATHER_TO_PUBLICATION_FAILED", "pubId = "+pubPK.getId()+" and fatherId = "+fatherPK.getId(), re);
        }
    }
    ...
    public void removeFather(PublicationPK pubPK, NodePK fatherPK) throws RemoteException
    {
        ...
        {
                        throw new PublicationRuntimeException("PublicationBmEJB.removeFather()", SilverpeasRuntimeException.ERROR, "publication.REMOVING_FATHER_TO_PUBLICATION_FAILED", "pubId = "+pubPK.getId()+" and fatherId = "+fatherPK.getId(), re);
        }
    }
    ...
    public void removeFather(NodePK fatherPK) throws RemoteException
    {
        ...
        {
            throw new PublicationRuntimeException("PublicationBmEJB.removeFather()", SilverpeasRuntimeException.ERROR, "publication.REMOVING_FATHER_TO_ALL_PUBLICATIONS_FAILED", "fatherId = "+fatherPK.getId(), e);
        }
        finally
        {
            freeConnection(con);
    ...
    public void removeFathers(PublicationPK pubPK, Collection fatherIds) throws RemoteException
    {
        ...
        {
        	throw new PublicationRuntimeException("PublicationBmEJB.removeFathers()", SilverpeasRuntimeException.ERROR, "publication.REMOVING_FATHERS_TO_ALL_PUBLICATIONS_FAILED", "fatherIds = "+fatherIds.toString(), e);
        }
        finally
        {
            freeConnection(con);
    ...
    public void removeAllFather(PublicationPK pubPK) throws RemoteException
    {
        ...
        {
            throw new PublicationRuntimeException("PublicationBmEJB.removeAllFather()", SilverpeasRuntimeException.ERROR, "publication.REMOVING_FATHERS_TO_PUBLICATION_FAILED", "pubId = "+pubPK.getId(), e);
        }
    }
    ...
    public Collection getOrphanPublications(PublicationPK pubPK) throws RemoteException
    {
        ...
        {
        	throw new PublicationRuntimeException("PublicationBmEJB.getOrphanPublications()", SilverpeasRuntimeException.ERROR, "publication.GETTING_PUBLICATIONS_FAILED", e);
        }
        finally
        {
            freeConnection(con);
        ...
        public Collection getNotOrphanPublications(PublicationPK pubPK) throws RemoteException {
                Connection con = getConnection();
                try {
                        Collection pubDetails = PublicationDAO.getNotOrphanPublications(con, pubPK);
                        if (I18NHelper.isI18N)
                        	setTranslations(con, pubDetails);
                        return pubDetails;
                } catch (Exception e) {
                        throw new PublicationRuntimeException("PublicationBmEJB.getNotOrphanPublications()", SilverpeasRuntimeException.ERROR, "publication.GETTING_PUBLICATIONS_FAILED", e);
                } finally {
                        freeConnection(con);
                }
        }
    ...
    public void deleteOrphanPublicationsByCreatorId(PublicationPK pubPK, String creatorId) throws RemoteException
    {
        ...
        {
                        throw new PublicationRuntimeException("PublicationBmEJB.deleteOrphanPublicationsByCreatorId()", SilverpeasRuntimeException.ERROR, "publication.GETTING_PUBLICATIONS_FAILED", "creatorId = "+creatorId, e);
        }
        finally
        {
            freeConnection(con);
    ...
    public Collection getUnavailablePublicationsByPublisherId(PublicationPK pubPK, String publisherId, String nodeId) throws RemoteException
    {
        ...
        try
        {
            Collection pubDetails = PublicationDAO.getUnavailablePublicationsByPublisherId(con, pubPK, publisherId, nodeId);
            if (I18NHelper.isI18N)
            	setTranslations(con, pubDetails);
            return pubDetails;
        }
        ...
        {
            throw new PublicationRuntimeException("PublicationBmEJB.getUnavailablePublicationsByPublisherId()", SilverpeasRuntimeException.ERROR, "publication.GETTING_PUBLICATIONS_FAILED", "publisherId = "+publisherId, e);
        }
        finally
        {
            freeConnection(con);
    ...
    public Collection getAllFatherPK(PublicationPK pubPK) throws RemoteException
    {
        ...
        {
            throw new PublicationRuntimeException("PublicationBmEJB.getAllFatherPK()", SilverpeasRuntimeException.ERROR, "publication.GETTING_PUBLICATION_FATHERS_FAILED", "pubId = "+pubPK.getId(), e);
        }
        finally
        {
        	freeConnection(con);
    ...
    public Collection getAlias(PublicationPK pubPK) throws RemoteException
    {
        ...
        {
            throw new PublicationRuntimeException("PublicationBmEJB.getAlias()", SilverpeasRuntimeException.ERROR, "publication.GETTING_PUBLICATION_FATHERS_FAILED", "pubId = "+pubPK.getId(), e);
        }
        finally
        {
        	freeConnection(con);
    ...
    public void addAlias(PublicationPK pubPK, List aliases) throws RemoteException
    {
    	Connection con = getConnection();
    	try
        {
        ...
        {
            throw new PublicationRuntimeException("PublicationBmEJB.addAlias()", SilverpeasRuntimeException.ERROR, "publication.GETTING_PUBLICATION_FATHERS_FAILED", "pubId = "+pubPK.getId(), e);
        }
        finally
        {
        	freeConnection(con);
    ...
    public void removeAlias(PublicationPK pubPK, List aliases) throws RemoteException
    {
    	Connection con = getConnection();
    	try
        {
        ...
        {
            throw new PublicationRuntimeException("PublicationBmEJB.removeAlias()", SilverpeasRuntimeException.ERROR, "publication.GETTING_PUBLICATION_FATHERS_FAILED", "pubId = "+pubPK.getId(), e);
        }
        finally
        {
        	freeConnection(con);
    ...
    public Collection getDetailsByFatherPK(NodePK fatherPK, String sorting, boolean filterOnVisibilityPeriod) throws RemoteException
    {
        ...
        try
        {
        	Collection publis = PublicationDAO.selectByFatherPK(con, fatherPK, sorting, filterOnVisibilityPeriod);
        	if (I18NHelper.isI18N)
        ...
        {
            throw new PublicationRuntimeException("PublicationBmEJB.getDetailsByFatherPK()", SilverpeasRuntimeException.ERROR, "publication.GETTING_PUBLICATIONS_FAILED", "fatherPK = "+fatherPK.toString(), e);
        }
        finally
        {
            freeConnection(con);
    ...
    public Collection getDetailsByFatherPK(NodePK fatherPK, String sorting, boolean filterOnVisibilityPeriod, String userId) throws RemoteException
    {
        ...
        try
        {
        	Collection publis = PublicationDAO.selectByFatherPK(con, fatherPK, sorting, filterOnVisibilityPeriod, userId);
        	if (I18NHelper.isI18N)
        		setTranslations(con, publis);
        	return publis;
        }
    ...
    public Collection getDetailsNotInFatherPK(NodePK fatherPK, String sorting) throws RemoteException
    {
        ...
        try
        {
            Collection detailList = PublicationDAO.selectNotInFatherPK(con, fatherPK, sorting);
            if (I18NHelper.isI18N)
        ...
        {
            throw new PublicationRuntimeException("PublicationBmEJB.getDetailsNotInFatherPK()", SilverpeasRuntimeException.ERROR, "publication.GETTING_PUBLICATIONS_FAILED", "fatherPK = "+fatherPK.toString(), e);
        }
        finally
        {
            freeConnection(con);
    ...
    public Collection getDetailsByBeginDateDescAndStatus(PublicationPK pk, String status, int nbPubs) throws RemoteException
    {
        ...
        try
        {
            ...
            detailList = PublicationDAO.selectByBeginDateDescAndStatus(con, pk, status);
        ...
        {
            throw new PublicationRuntimeException("PublicationBmEJB.getDetailsByBeginDateDescAndStatus()", SilverpeasRuntimeException.ERROR, "publication.GETTING_PUBLICATIONS_FAILED", "status = "+status, e);
        }
        finally
        {
            freeConnection(con);
    ...
    public Collection getDetailsByBeginDateDescAndStatusAndNotLinkedToFatherId(PublicationPK pk, String status, int nbPubs, String fatherId) throws RemoteException
    {
        ...
        try
        {
            detailList = PublicationDAO.selectByBeginDateDescAndStatusAndNotLinkedToFatherId(con, pk, status, fatherId, nbPubs);
            if (I18NHelper.isI18N)
            	setTranslations(con, detailList);
            return detailList;
        }
        ...
        {
            throw new PublicationRuntimeException("PublicationBmEJB.getDetailsByBeginDateDescAndStatusAndNotLinkedToFatherId()", SilverpeasRuntimeException.ERROR, "publication.GETTING_PUBLICATIONS_FAILED", "fatherId = "+fatherId, e);
        }
        finally
        {
            freeConnection(con);
    ...
    public Collection getDetailsByBeginDateDesc(PublicationPK pk, int nbPubs) throws RemoteException
    {
        ...
        {
            throw new PublicationRuntimeException("PublicationBmEJB.getDetailsByBeginDateDesc()", SilverpeasRuntimeException.ERROR, "publication.GETTING_PUBLICATIONS_FAILED", "nbPubs = "+nbPubs, e);
        }
        finally
        {
            freeConnection(con);
    ...
    public Collection getAllModelsDetail() throws RemoteException
    {
        ...
        {
        	throw new PublicationRuntimeException("PublicationBmEJB.getAllModelsDetail()", SilverpeasRuntimeException.ERROR, "publication.GETTING_MODELS_FAILED", e);
        }
        finally
        {
            freeConnection(con);
    ...
    public ModelDetail getModelDetail(ModelPK modelPK) throws RemoteException
    {
        ...
        {
        	throw new PublicationRuntimeException("PublicationBmEJB.getModelDetail()", SilverpeasRuntimeException.ERROR, "publication.GETTING_MODEL_FAILED", "modelPK = "+modelPK.toString(), e);
        }
        finally
        {
            freeConnection(con);
    ...
    public void createInfoDetail(PublicationPK pubPK, ModelPK modelPK, InfoDetail infos) throws RemoteException
    {
        ...
        {
            throw new PublicationRuntimeException("PublicationBmEJB.createInfoDetail()", SilverpeasRuntimeException.ERROR, "publication.CREATING_PUBLICATION_DETAIL_FAILED", "pubId = "+pubPK.getId()+", modelPK = "+modelPK.toString()+", infos = "+infos.toString(), e);
        }
    }
    ...
    public void createInfoModelDetail(PublicationPK pubPK, ModelPK modelPK, InfoDetail infos) throws RemoteException
    {
        ...
        {
        	throw new PublicationRuntimeException("PublicationBmEJB.createInfoModelDetail()", SilverpeasRuntimeException.ERROR, "publication.CREATING_PUBLICATION_DETAIL_FAILED", "pubId = "+pubPK.getId()+", modelPK = "+modelPK.toString()+", infos = "+infos.toString(), e);
        }
    }
    ...
    public InfoDetail getInfoDetail(PublicationPK pubPK) throws RemoteException
    {
        ...
        {
        	throw new PublicationRuntimeException("PublicationBmEJB.getInfoDetail()", SilverpeasRuntimeException.ERROR, "publication.GETTING_PUBLICATION_DETAIL_FAILED", "pubId = "+pubPK.getId(), e);
        }
    }
    ...
    public void updateInfoDetail(PublicationPK pubPK, InfoDetail infos) throws RemoteException
    {
        ...
        try
        {
        	if (isInteger(pub.getDetail().getInfoId()) && !"0".equals(pub.getDetail().getInfoId()))
        	{
        ...
        {
        	throw new PublicationRuntimeException("PublicationBmEJB.updateInfoDetail()", SilverpeasRuntimeException.ERROR, "publication.UPDATING_INFO_DETAIL_FAILED", "pubId = "+pubPK.getId(), e);
        }
        finally
        {
        	freeConnection(con);
	...
	public void deleteInfoLinks(PublicationPK pubPK, List pubIds) throws RemoteException
	{
		...
		{
			throw new PublicationRuntimeException("PublicationBmEJB.deleteInfoLinks()", SilverpeasRuntimeException.ERROR, "publication.UPDATING_INFO_DETAIL_FAILED", "pubId = "+pubPK.getId(), e);
		}
	}
    ...
    public CompletePublication getCompletePublication(PublicationPK pubPK) throws RemoteException
    {
        ...
        {
        	throw new PublicationRuntimeException("PublicationBmEJB.getCompletePublication()", SilverpeasRuntimeException.ERROR, "publication.GETTING_PUBLICATION_FAILED", "pubId = "+pubPK.getId(), e);
        }
    }
    ...
    public Collection searchByKeywords(String query, PublicationPK pubPK) throws RemoteException
    {
        ...
        try
        {
            Collection resultList = PublicationDAO.searchByKeywords(con, query, pubPK);
            if (I18NHelper.isI18N)
        ...
        {
        	throw new PublicationRuntimeException("PublicationBmEJB.searchByKeywords()", SilverpeasRuntimeException.ERROR, "publication.GETTING_PUBLICATIONS_FAILED", "query = "+query, e);
        }
        finally
        {
            freeConnection(con);
    ...
    public Collection getPublications(Collection publicationPKs) throws RemoteException
    {
        ...
        try
        {
            Collection publications = PublicationDAO.selectByPublicationPKs(con, publicationPKs);
            if (I18NHelper.isI18N)
        ...
        {
        	throw new PublicationRuntimeException("PublicationBmEJB.getPublications()", SilverpeasRuntimeException.ERROR, "publication.GETTING_PUBLICATIONS_FAILED", "publicationPKs = "+publicationPKs.toString(), e);
        }
        finally
        {
            freeConnection(con);
    ...
    public Collection getPublicationsByStatus(String status, PublicationPK pubPK) throws RemoteException
    {
        ...
        try
        {
            Collection publications = PublicationDAO.selectByStatus(con, pubPK, status);
            if (I18NHelper.isI18N)
            	setTranslations(con, publications);
            return publications;
        }
        ...
        {
        	throw new PublicationRuntimeException("PublicationBmEJB.getPublicationsByStatus()", SilverpeasRuntimeException.ERROR, "publication.GETTING_PUBLICATIONS_FAILED", "status = "+status, e);
        }
        finally
        {
            freeConnection(con);
    ...
    public Collection getPublicationPKsByStatus(String status, List componentIds) throws RemoteException
    {
        ...
        {
        	throw new PublicationRuntimeException("PublicationBmEJB.getPublicationPKsByStatus()", SilverpeasRuntimeException.ERROR, "publication.GETTING_PUBLICATIONS_FAILED", "status = "+status+", componentIds = "+componentIds.toString(), e);
        }
        finally
        {
            freeConnection(con);
    ...
    public Collection getPublicationsByStatus(String status, List componentIds) throws RemoteException
    {
        ...
        try
        {
        	Collection publications = PublicationDAO.selectByStatus(con, componentIds, status);
        	if (I18NHelper.isI18N)
        		setTranslations(con, publications);
        	return publications;
        }
        ...
        {
        	throw new PublicationRuntimeException("PublicationBmEJB.getPublicationsByStatus()", SilverpeasRuntimeException.ERROR, "publication.GETTING_PUBLICATIONS_FAILED", "status = "+status+", componentIds = "+componentIds.toString(), e);
        }
        finally
        {
            freeConnection(con);
    ...
    public int getNbPubInFatherPKs(Collection fatherPKs) throws RemoteException
    {
        ...
        {
            throw new PublicationRuntimeException("PublicationBmEJB.getNbPubInFatherPKs()", SilverpeasRuntimeException.ERROR, "publication.GETTING_NUMBER_OF_PUBLICATIONS_FAILED", "fatherPKs = "+fatherPKs.toString(), e);
        }
        finally
        {
            freeConnection(con);
    ...
    public Hashtable getDistribution(String instanceId, String statusSubQuery, boolean checkVisibility) throws RemoteException
    {
        ...
        try
        {
            return PublicationDAO.getDistribution(con, instanceId, statusSubQuery, checkVisibility);
        }
        catch (Exception e)
        {
            throw new PublicationRuntimeException("PublicationBmEJB.getDistribution()", SilverpeasRuntimeException.ERROR, "publication.GETTING_NUMBER_OF_PUBLICATIONS_FAILED", "instanceId = "+instanceId, e);
        }
        finally
        {
            freeConnection(con);
    ...
    public int getNbPubByFatherPath(NodePK fatherPK, String fatherPath) throws RemoteException
    {
        ...
        {
            throw new PublicationRuntimeException("PublicationBmEJB.getNbPubByFatherPath()", SilverpeasRuntimeException.ERROR, "publication.GETTING_NUMBER_OF_PUBLICATIONS_FAILED", "fatherPath = "+fatherPath, e);
        }
        finally
        {
            freeConnection(con);
    ...
    {
    	return getDetailsByFatherIdsAndStatusList(fatherIds, pubPK, null, null, filterOnVisibilityPeriod);
    }
	...
	public Collection getDetailsByFatherIdsAndStatusList(ArrayList fatherIds, PublicationPK pubPK, String sorting, ArrayList status, boolean filterOnVisibilityPeriod) throws RemoteException
    {
        ...
        try
        {
        	Collection detailList = PublicationDAO.selectByFatherIds(con, fatherIds, pubPK, sorting, status, filterOnVisibilityPeriod);
        	if (I18NHelper.isI18N)
        		setTranslations(con, detailList);
            return detailList;
        }
        ...
        {
            throw new PublicationRuntimeException("PublicationBmEJB.getDetailsByFatherIdsAndStatus()", SilverpeasRuntimeException.ERROR, "publication.GETTING_PUBLICATIONS_FAILED", "fatherIds = "+fatherIds.toString(), e);
        }
        finally
        {
            freeConnection(con);
    ...
    public Collection getPubPKsInFatherPKs(Collection fatherPKs) throws RemoteException
    {
        ...
        {
        	throw new PublicationRuntimeException("PublicationBmEJB.getPubPKsInFatherPKs()", SilverpeasRuntimeException.ERROR, "publication.GETTING_PUBLICATIONS_PK_FAILED", "fatherPKs = "+fatherPKs.toString(), e);
        }
        finally
        {
            freeConnection(con);
    ...
    public Collection getPubPKsInFatherPK(NodePK fatherPK) throws RemoteException
    {
        ...
        {
            throw new PublicationRuntimeException("PublicationBmEJB.getPubPKsInFatherPK()", SilverpeasRuntimeException.ERROR, "publication.GETTING_PUBLICATIONS_PK_FAILED", "fatherPK = "+fatherPK.getId(), e);
        }
        finally
        {
            freeConnection(con);
    ...
    private PublicationHome getPublicationHome()
    {
        try
        {
            PublicationHome pubHome = (PublicationHome) EJBUtilitaire.getEJBObjectRef(JNDINames.PUBLICATION_EJBHOME, PublicationHome.class);

            return pubHome;
        }
        catch (Exception re)
        {
            throw new PublicationRuntimeException("PublicationBmEJB.getPublicationHome()", SilverpeasRuntimeException.ERROR, "root.EX_CANT_GET_REMOTE_OBJECT", re);
        }
    ...
    private Publication findPublication(PublicationPK pubPK)
    {
        ...
        {
            throw new PublicationRuntimeException("PublicationBmEJB.findPublication()", SilverpeasRuntimeException.ERROR, "publication.PUBLICATION_UNFINDABLE", "pubId = "+pubPK.getId(), re);
        }
    }
	...
	private Publication findPublicationByName(PublicationPK pubPK, String name)
    {
        ...
        {
            throw new PublicationRuntimeException("PublicationBmEJB.findPublicationByName()", SilverpeasRuntimeException.ERROR, "publication.PUBLICATION_UNFINDABLE", "pubName = "+name, re);
        }
    }
	
	private Publication findPublicationByNameAndNodeId(PublicationPK pubPK, String name,int nodeId)
    {
        PublicationHome pubHome = getPublicationHome();
        ...
        {
            throw new PublicationRuntimeException("PublicationBmEJB.findPublicationByNameAndNodeId()", SilverpeasRuntimeException.ERROR, "publication.PUBLICATION_UNFINDABLE", "pubName = "+name+", nodeId="+nodeId, re);
        }
    }
    ...
    private Connection getConnection()
    {
        ...
        {
            throw new PublicationRuntimeException("PublicationBmEJB.getConnection()", SilverpeasRuntimeException.ERROR, "root.EX_CONNECTION_OPEN_FAILED", e);
        }
    }
     ...
     * ****************************************************************************************************
     */
    private FullIndexEntry updateIndexEntryWithModelContent(FullIndexEntry indexEntry, Collection textList)
    {
        SilverTrace.info("publication", "PublicationBmEJB.updateIndexEntryWithModelContent()", "root.MSG_GEN_ENTER_METHOD", "indexEntry = " + indexEntry.toString());
        if (textList != null)
        {
     ...
     * @see
     */
    private FullIndexEntry updateIndexEntryWithInfoDetail(FullIndexEntry indexEntry, InfoDetail infoDetail)
    {
        SilverTrace.info("publication", "PublicationBmEJB.updateIndexEntryWithInfoDetail()", "root.MSG_GEN_ENTER_METHOD", "indexEntry = " + indexEntry.toString()+", infoDetail = "+infoDetail.toString());
        if (infoDetail != null)
        {
	...
	private FullIndexEntry updateIndexEntryWithWysiwygContent(FullIndexEntry indexEntry, PublicationDetail pubDetail)
    {
		PublicationPK pubPK = pubDetail.getPK();
        SilverTrace.info("publication", "PublicationBmEJB.updateIndexEntryWithWysiwygContent()", "root.MSG_GEN_ENTER_METHOD", "indexEntry = " + indexEntry.toString()+", pubPK = "+pubPK.toString());
		try
		{
			if (pubPK != null)
			{
				...
				while (languages.hasNext())
				{
					...
					String wysiwygContent = WysiwygController.load(pubPK.getInstanceId(), pubPK.getId(), language);
					if (StringUtil.isDefined(wysiwygContent)) {
						String wysiwygPath = WysiwygController.getWysiwygPath(pubPK.getInstanceId(), pubPK.getId(), language);
						indexEntry.addFileContent(wysiwygPath, null, "text/html", language);
					}
				}
				/*String wysiwygContent = WysiwygController.loadFileAndAttachment(pubPK.getSpace(), pubPK.getComponentName(), pubPK.getId());
				if (wysiwygContent != null) {
					String wysiwygPath = WysiwygController.getWysiwygPath(pubPK.getInstanceId(), pubPK.getId());
	...
	private FullIndexEntry updateIndexEntryWithXMLFormContent(FullIndexEntry indexEntry, PublicationDetail pubDetail)
	{
		SilverTrace.info("publication", "PublicationBmEJB.updateIndexEntryWithXMLFormContent()", "root.MSG_GEN_ENTER_METHOD", "indexEntry = " + indexEntry.toString()+", pubDetail.getInfoId() = "+pubDetail.getInfoId());
		if (!isInteger(pubDetail.getInfoId()))
		{
			try {
				PublicationTemplate pub = PublicationTemplateManager.getPublicationTemplate(pubDetail.getPK().getInstanceId()+":"+pubDetail.getInfoId());
			...
			{
				SilverTrace.error("publication", "PublicationBmEJB.updateIndexEntryWithXMLFormContent()", "", e);
			}
		}
		return indexEntry;
	}
    ...
    {
		SilverTrace.info("publication", "PublicationBmEJB.createIndex()", "root.MSG_GEN_ENTER_METHOD", "pubDetail.getIndexOperation() = " + pubDetail.getIndexOperation());
    	if (pubDetail.getIndexOperation()==IndexManager.ADD || pubDetail.getIndexOperation() == IndexManager.READD)
    	{
			SilverTrace.info("publication", "PublicationBmEJB.createIndex()", "root.MSG_GEN_PARAM_VALUE", "pubDetail = " + pubDetail.toString());
			try
			{
			...
			{
				SilverTrace.error("publication", "PublicationBmEJB.createIndex()", "root.MSG_GEN_ENTER_METHOD", "pubDetail = " + pubDetail.toString()+ ", indexEngineBm.addIndexEntry() failed !", e);
			}
    	}
    }
	...
	{
		SilverTrace.info("publication", "PublicationBmEJB.createIndex()", "root.MSG_GEN_ENTER_METHOD", "processWysiwygContent = "+processWysiwygContent+", indexOperation = " + indexOperation);
		if (indexOperation==IndexManager.ADD || indexOperation == IndexManager.READD)
		{
			SilverTrace.info("publication", "PublicationBmEJB.createIndex()", "root.MSG_GEN_ENTER_METHOD", "pubPK = " + pubPK.toString());
			try
			{
				...
				if (completePublication != null)
				{
					...
					if (pubDetail != null)
					{
						...
						indexEntry = this.updateIndexEntryWithInfoDetail(indexEntry, infoDetail);

						if (processWysiwygContent)
						{
							indexEntry = updateIndexEntryWithWysiwygContent(indexEntry, pubDetail);
							indexEntry = updateIndexEntryWithXMLFormContent(indexEntry, pubDetail);
						}
			...
			{
				SilverTrace.error("publication", "PublicationBmEJB.createIndex()", "root.MSG_GEN_ENTER_METHOD", "pubPK = " + pubPK.toString()+ ", indexEngineBm.addIndexEntry() failed !", e);
			}
		}
	}
    ...
    private FullIndexEntry getFullIndexEntry(PublicationDetail pubDetail)
    {
		...
		{
			// Index the Publication Header
			indexEntry = new FullIndexEntry(pubDetail.getPK().getComponentName(), "Publication", pubDetail.getPK().getId());
			...
			if (publicationSettings.getString("indexAuthorName").equals("true")) {
				...
				{
					// unable to find user detail, ignore and don't index creator's full name
				}
			}
    ...
    {
        SilverTrace.info("publication", "PublicationBmEJB.deleteIndex()", "root.MSG_GEN_ENTER_METHOD", "pubPK = " + pubPK.toString());
        IndexEntryPK indexEntry = new IndexEntryPK(pubPK.getComponentName(), "Publication", pubPK.getId());

        IndexEngineProxy.removeIndexEntry(indexEntry);
        
        //Suppression du nuage de tags lors de la suppression de l'index (et pas lors de l'envoi de la publication dans la corbeille).
        if (SilverpeasSettings.readBoolean(publicationSettings, "useTagCloud", false))
        	deleteTagCloud(pubPK);
        
        //idem pour les notations
        if (SilverpeasSettings.readBoolean(publicationSettings, "useNotation", false))
    ...
    public Collection getAllPublications(PublicationPK pubPK, String sorting) throws RemoteException
    {
        ...
        try
        {
            Collection publications = PublicationDAO.selectAllPublications(con, pubPK, sorting);

            return publications;
        }
        catch (Exception e)
        {
            throw new PublicationRuntimeException("PublicationBmEJB.getAllPublications()", SilverpeasRuntimeException.ERROR, "publication.GETTING_PUBLICATIONS_FAILED", e);
        }
        finally
        {
            freeConnection(con);
	...
	{
		SilverTrace.info("publication","PublicationBmEJB.getDetailByName()", "root.MSG_GEN_ENTER_METHOD", "pubPK = "+pubPK.toString()+", pubName = "+pubName);
		PublicationDetail result = null;
        ...
        {
            throw new PublicationRuntimeException("PublicationBmEJB.getDetailByName()", SilverpeasRuntimeException.ERROR, "publication.GETTING_PUBLICATION_HEADER_FAILED", "pubPK = "+pubPK.toString()+", pubName = "+pubName, re);
        }
	}
	
	public PublicationDetail getDetailByNameAndNodeId(PublicationPK pubPK, String pubName,int nodeId) throws RemoteException
	{
		SilverTrace.info("publication","PublicationBmEJB.getDetailByNameAndNodeId()", "root.MSG_GEN_ENTER_METHOD", "pubPK = "+pubPK.toString()+", pubName = "+pubName+", nodeId="+nodeId);
		PublicationDetail result = null;
        ...
        {
            throw new PublicationRuntimeException("PublicationBmEJB.getDetailByNameAndNodeId()", SilverpeasRuntimeException.ERROR, "publication.GETTING_PUBLICATION_HEADER_FAILED", "pubPK = "+pubPK.toString()+", pubName = "+pubName+", nodeId="+nodeId, re);
        }
	}	
	...
	public Collection getDetailBetweenDate(String beginDate, String endDate, String instanceId) throws RemoteException
	{
        ...
        try
        {
            ...
            detailList = PublicationDAO.selectBetweenDate(con, beginDate, endDate, instanceId);
            Iterator          it = detailList.iterator();
            int               i = 0;
            PublicationDetail pubDetail = null;
        ...
        {
        	throw new PublicationRuntimeException("PublicationBmEJB.getDetailBetweenDate()", SilverpeasRuntimeException.ERROR, "publication.GETTING_PUBLICATIONS_FAILED", "", e);
        }
        finally
        {
            freeConnection(con);
    ...
    private TagCloudBm getTagCloudBm()
    {
        ...
        {
            throw new TagCloudRuntimeException("PublicationBmEJB.getTagCloudBm()", SilverpeasException.ERROR,
		...
		throws RemoteException
	{
	    ...
	    if (keywords != null)
	    {
	    	...
	    	TagCloud tagCloud = new TagCloud(pubDetail.getInstanceId(), pubDetail.getId(), TagCloud.TYPE_PUBLICATION);
    ...
    private void deleteTagCloud(PublicationPK pubPK)
    	throws RemoteException
    {
    	getTagCloudBm().deleteTagCloud(new TagCloudPK(pubPK.getId(), pubPK.getInstanceId()), TagCloud.TYPE_PUBLICATION);
    }
    ...
    {
    	getNotationBm().deleteNotation(new NotationPK(
    		pubPK.getId(), pubPK.getInstanceId(), Notation.TYPE_PUBLICATION));
    }
