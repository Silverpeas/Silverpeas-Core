...
import com.stratelia.webactiv.clipboard.model.SKDException;
...
public class PublicationSelection extends ClipboardSelection implements Serializable {
  ...
  static {
    try {
      PublicationDetailFlavor = new DataFlavor (Class.forName ("com.stratelia.webactiv.util.publication.model.PublicationDetail"), "Publication");
      CompletePublicationFlavor = new DataFlavor (Class.forName ("com.stratelia.webactiv.util.publication.model.CompletePublication"), "Publication");
  ...
  public PublicationSelection (CompletePublication pub) {
	...
	public synchronized Object getTransferData (DataFlavor parFlavor) throws UnsupportedFlavorException {
		...
		try {
		   ...
		   if (parFlavor.equals (PublicationDetailFlavor))
			   ...
			   transferedData = new CompletePublication(m_pub, m_modelDetail, m_infoDetail);
		   else
			   throw e;
		}
	...
	public IndexEntry getIndexEntry () {
	   ...
	   PublicationPK pubPK = m_pub.getPK();
		indexEntry = new IndexEntry(pubPK.getComponentName(), "Publication", m_pub.getPK().getId());
  ...
  /**--------------------------------------------------------------------------------------------------------
	...
	public SilverpeasKeyData getKeyData () {
		...
		try {
            ...
            SilverTrace.error("publication", "PublicationSelection.getKeyData" , "publication.ERROR_KEY_DATA",  e);
		}
		return keyData;
	}
