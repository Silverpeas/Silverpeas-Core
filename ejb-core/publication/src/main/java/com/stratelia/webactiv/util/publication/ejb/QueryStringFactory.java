...
public class QueryStringFactory extends Object {
  ...
  public static String getSelectByBeginDateDescAndStatusAndNotLinkedToFatherId(
    ...
    if (selectByBeginDateDescAndStatusAndNotLinkedToFatherId == null) {
      ...
      query.append(" from ").append(tableName).append(" P, ").append(tableName)
          .append("Father F ");
  ...
  public static String getSelectByFatherPK(String tableName,
    ...
    StringBuffer query = new StringBuffer();
    query
        .append("select  P.pubId, P.infoId, P.pubName, P.pubDescription, P.pubCreationDate, P.pubBeginDate, ");
    query
        .append("        P.pubEndDate, P.pubCreatorId, P.pubImportance, P.pubVersion, P.pubKeywords, P.pubContent, ");
    query
        .append("		 P.pubStatus, P.pubImage, P.pubImageMimeType, P.pubUpdateDate, P.instanceId, P.pubUpdaterId, P.pubValidateDate, P.pubValidatorId, P.pubBeginHour, P.pubEndHour, P.pubAuthor, P.pubTargetValidatorId, P.pubCloneId, P.pubCloneStatus, P.lang ");
  ...
  public static String getSelectByNameAndNodeId() {
    if (selectByNameAndNodeId == null) {
      StringBuffer query = new StringBuffer();
      query
          .append("SELECT * FROM sb_publication_publi pub, sb_publication_publifather pubnode");
