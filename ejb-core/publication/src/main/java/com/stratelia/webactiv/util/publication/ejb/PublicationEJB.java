...
public class PublicationEJB implements EntityBean
{
    ...
    {
		PublicationDetail pubDetail = new PublicationDetail(pk, name, description, creationDate, beginDate, endDate, creatorId, importance, version, keywords, content, status, image, imageMimeType, updateDate, updaterId, author);
    ...
    public void setDetail(PublicationDetail pubDetail)
    {
            ...
            if (pubDetail.isRemoveTranslation())
            {
            	...
            	try {
					...
					if (oldLang.equalsIgnoreCase(pubDetail.getLanguage()))
					{
						...
						{
							PublicationI18N translation = (PublicationI18N) translations.get(0);
					...
					throw new PublicationRuntimeException("PublicationEJB.setDetail()", SilverpeasRuntimeException.ERROR, "publication.CANNOT_MANAGE_TRANSLATIONS", e);
				}
				finally
				{
					freeConnection(con);
        ...
        {
			throw new PublicationRuntimeException("PublicationEJB.setDetail()", SilverpeasRuntimeException.ERROR, "publication.PUBDETAIL_PK_NOT_SAME_THAN_THIS_OBJECT");
        }
    }
    
    private void getTranslations()
    {
    	PublicationI18N translation = new PublicationI18N(lang, name, description, keywords);
		...
		try {
			...
			throw new PublicationRuntimeException("PublicationEJB.getTranslations()", SilverpeasRuntimeException.ERROR, "publication.CANNOT_GET_TRANSLATIONS", e);
		}
		finally
		{
			freeConnection(con);
    ...
    private void createTranslations(Connection con, PublicationDetail publication) throws SQLException, UtilException
    {
    	if (publication.getTranslations() != null)
    	{
        	...
        	while (translations.hasNext())
        	{
        		...
        		if (publication.getLanguage() != null && !publication.getLanguage().equals(translation.getLanguage()))
        		{
    ...
    {
		SilverTrace.info("publication", "PublicationEJB.addFather()", "root.MSG_GEN_ENTER_METHOD", "fatherId = " + fatherPK.getId());
        Connection con = getConnection();
    ...
    {
    	SilverTrace.info("publication", "PublicationEJB.move()", "root.MSG_GEN_ENTER_METHOD", "fatherId = " + fatherPK.getId());
        Connection con = getConnection();
    ...
    {
        SilverTrace.info("publication", "PublicationEJB.removeFather()", "root.MSG_GEN_ENTER_METHOD", "fatherId = " + fatherPK.getId());
        Connection con = getConnection();
        try
        {
    ...
    {
		SilverTrace.info("publication", "PublicationEJB.getAllFatherPK()", "root.MSG_GEN_ENTER_METHOD");
        Connection con = getConnection();
     ...
     * @since 1.0
     */
    public void createInfoDetail(ModelPK modelPK, InfoDetail infos) throws SQLException, UtilException
    {
		SilverTrace.info("publication", "PublicationEJB.createInfoDetail()", "root.MSG_GEN_ENTER_METHOD", "modelId = " + modelPK.getId());
        Connection con = getConnection();
     ...
     * @since 1.0
     */
    public void createInfoModelDetail(ModelPK modelPK, InfoDetail infos) throws SQLException, UtilException
    {
		SilverTrace.info("publication", "PublicationEJB.createInfoModelDetail()", "root.MSG_GEN_ENTER_METHOD", "modelId = " + modelPK.getId());
        Connection con = getConnection();

        try
        {
            // The publication have already some info attached (model, attached files, links...)
     ...
     * @since 1.0
     */
    public void updateInfoDetail(InfoDetail infos) throws SQLException, UtilException
    {
		SilverTrace.info("publication", "PublicationEJB.updateInfoDetail()", "root.MSG_GEN_ENTER_METHOD");
        ...
        InfoDetail.selectToCreateAndToUpdateItems(infos.getInfoTextList(), old.getInfoTextList(), newText, oldText);

        // update or create imageDetail ?
        ArrayList newImage = new ArrayList();
        ArrayList oldImage = new ArrayList();

        InfoDetail.selectToCreateAndToUpdateItems(infos.getInfoImageList(), old.getInfoImageList(), newImage, oldImage);
        ...
        InfoDetail.selectToCreateAndToUpdateItems(infos.getInfoLinkList(), old.getInfoLinkList(), newLink, oldLink);
        ...
        try
        {
            ...
            {
                createInfoDetail(new ModelPK("0", this.pk), new InfoDetail(infoPK, newText, newImage, newLink, ""));
            }
            else
            {
            	InfoDAO.updateInfoItems(con, new InfoDetail(infoPK, oldText, oldImage, oldLink, ""), infoPK);
    ...
    {
		SilverTrace.info("publication", "PublicationEJB.getCompletePublication()", "root.MSG_GEN_ENTER_METHOD");
        Connection con = getConnection();
    ...
    {
		SilverTrace.info("publication", "PublicationEJB.ejbCreate()", "root.MSG_GEN_ENTER_METHOD", "pubDetail = " + pubDetail.toString());
        Connection con = getConnection();
        ...
        try
        {
            ...
            pubDetail.setDescription(Encode.transformStringForBD(pubDetail.getDescription()));
            ...
            {
				throw new PublicationRuntimeException("PublicationEJB.ejbCreate()", SilverpeasRuntimeException.ERROR, "root.EX_GET_NEXTID_FAILED", ex);
            }
            ...
            {
                throw new PublicationRuntimeException("PublicationEJB.ejbCreate()", SilverpeasRuntimeException.ERROR, "root.EX_CANT_INSERT_ENTITY_ATTRIBUTES", ex);
            }
            if (I18NHelper.isI18N)
            {
	            ...
	            {
	                throw new PublicationRuntimeException("PublicationEJB.ejbCreate()", SilverpeasRuntimeException.ERROR, "root.EX_CANT_INSERT_TRANSLATIONS", ex);
	            }
            }
        }
        finally
     ...
     * @since 1.0
     */
    public PublicationPK ejbFindByPrimaryKey(PublicationPK pk) throws FinderException
    {
        Connection con = getConnection();
        ...
        try
        {
            ...
            {
                throw new PublicationRuntimeException("PublicationEJB.ejbFindByPrimaryKey()", SilverpeasRuntimeException.ERROR, "root.EX_CANT_FIND_ENTITY", "PubId = "+pk.getId());
            }
        }
		catch (Exception e) {
            throw new PublicationRuntimeException("PublicationEJB.ejbFindByPrimaryKey()", SilverpeasRuntimeException.ERROR, "root.EX_CANT_FIND_ENTITY", "PubId = "+pk.getId(), e);
		}
        finally
        {
            freeConnection(con);
     ...
     * @since 1.0
     */
    public PublicationPK ejbFindByName(PublicationPK pk, String name) throws FinderException
    {
        Connection con = getConnection();

        try
        {
            PublicationPK primary = PublicationDAO.selectByPublicationName(con, pk, name);
            if (primary != null)
            {
                return primary;
            }
            ...
            {
                throw new PublicationRuntimeException("PublicationEJB.ejbFindByName()", SilverpeasRuntimeException.ERROR, "root.EX_CANT_FIND_ENTITY", "name = "+name);
            }
        }
		catch (Exception e) {
			throw new PublicationRuntimeException("PublicationEJB.ejbFindByName()", SilverpeasRuntimeException.ERROR, "root.EX_CANT_FIND_ENTITY", "name = "+name, e);
		}
        finally
        {
            freeConnection(con);
    ...
    public PublicationPK ejbFindByNameAndNodeId(PublicationPK pk, String name, int nodeId) throws FinderException
    {
        Connection con = getConnection();

        try
        {
            PublicationPK primary = PublicationDAO.selectByPublicationNameAndNodeId(con, pk, name,nodeId);
            if (primary != null)
            {
                return primary;
            }
            ...
            {
                throw new PublicationRuntimeException("PublicationEJB.ejbFindByNameAndNodeId()", SilverpeasRuntimeException.ERROR, "root.EX_CANT_FIND_ENTITY", "name = "+name+", nodeId="+nodeId);
            }
        }
		catch (Exception e) {
			throw new PublicationRuntimeException("PublicationEJB.ejbFindByNameAndNodeId()", SilverpeasRuntimeException.ERROR, "root.EX_CANT_FIND_ENTITY", "name = "+name+", nodeId="+nodeId, e);
		}
        finally
        {
            freeConnection(con);
    ...
    public void ejbLoad()
    {
		SilverTrace.info("publication", "PublicationEJB.ejbLoad()", "root.MSG_GEN_ENTER_METHOD");
        if (pk == null)
        {
            return;
        }
        ...
        {
            throw new PublicationRuntimeException("PublicationEJB.ejbLoad()", SilverpeasRuntimeException.ERROR, "root.EX_CANT_LOAD_ENTITY_ATTRIBUTES", "PubId = "+pk.getId(), e);
        }
        finally
        {
             freeConnection(con);
    ...
    public void ejbStore()
    {
		...
		keywords 	= Encode.transformStringForBD(keywords);
		auhor 		= Encode.transformStringForBD(author);*/

		PublicationDetail detail = new PublicationDetail(pk, name, description, creationDate, beginDate, endDate, creatorId, importance, version, keywords, content, status, image, imageMimeType, updateDate, updaterId, validateDate, validatorId, author);
        ...
        {
            throw new PublicationRuntimeException("PublicationEJB.ejbStore()", SilverpeasRuntimeException.ERROR, "root.EX_CANT_STORE_ENTITY_ATTRIBUTES", "PubId = "+pk.getId(), e);
        }
        finally
        {
            freeConnection(con);
    ...
    {
		SilverTrace.info("publication", "PublicationEJB.ejbRemove()", "root.MSG_GEN_ENTER_METHOD");
        Connection con = getConnection();
        ...
        {
            throw new PublicationRuntimeException("PublicationEJB.ejbRemove()", SilverpeasRuntimeException.ERROR, "root.EX_CANT_DELETE_ENTITY", "PubId = "+pk.getId(), e);
        }
        finally
        {
            freeConnection(con);
	...
	private Connection getConnection()
    {
        ...
        {
            throw new PublicationRuntimeException("PublicationEJB.getConnection()", SilverpeasRuntimeException.ERROR, "root.EX_CONNECTION_OPEN_FAILED", e);
        }
    }
