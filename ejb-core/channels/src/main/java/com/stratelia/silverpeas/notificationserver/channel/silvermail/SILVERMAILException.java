...
public class SILVERMAILException extends SilverpeasException
{
	 ...
	 * @see
	 */
	public SILVERMAILException(String callingClass, int errorLevel, String message, Exception nested)
	{
	 ...
	 * @see
	 */
	public SILVERMAILException(String callingClass, int errorLevel, String message, String extraParams, Exception nested)
	{
