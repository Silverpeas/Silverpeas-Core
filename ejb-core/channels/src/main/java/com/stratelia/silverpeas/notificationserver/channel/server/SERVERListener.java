...
public class SERVERListener extends AbstractListener
{
	...
	*/
	public void onMessage(Message msg) {
		SilverTrace.info("server", "SERVERListener.onMessage()", "root.MSG_GEN_PARAM_VALUE", "JMS message = "+msg);
		try
		{
			processMessage(msg);
		}
	...
	*/
	public void send(NotificationData p_Message) throws NotificationServerException {
		...
		SilverMessageFactory.push(p_Message.getTargetReceipt(), p_Message.getMessage(), sessionId);
	}
}