...
public class VersioningDAO
{
	...
	public final static String GET_DOCUMENT_BYID_QUERY =
		"SELECT d.documentId, "
			...
			+ " d.currentWorkListOrder, d.alertDate, d.expiryDate "
			+ " FROM "
			+ documentTableName
			+ " d WHERE d.documentId = ? ";

	public final static String GET_DOCUMENT_VERSION_BYID_QUERY =
		"SELECT d.* FROM " + versionTableName
			+ " d WHERE d.versionId = ? ";
	 ...
	 */
	public static Document getDocument(Connection conn, DocumentPK pk) throws SQLException, VersioningRuntimeException
	{
		if (conn == null)
		{
			throw new VersioningRuntimeException(
				"VersioningDAO.getDocument",
	...
	public final static String GET_DOCUMENT_BYFORID_QUERY =
		"SELECT d.documentId, "
			+ " d.documentName, d.documentDescription, d.documentStatus, d.documentOwnerId, "
			+ " d.documentCheckoutDate, d.documentInfo, d.foreignId, d.instanceId, d.typeWorkList, "
			+ " d.currentWorkListOrder, d.alertDate, d.expiryDate "
	 ...
	 * @throws VersioningRuntimeException
	 */
	public static ArrayList getDocuments(Connection conn, WAPrimaryKey foreignID)
		throws SQLException, VersioningRuntimeException
	{
		if (conn == null)
		{
			throw new VersioningRuntimeException(
				"VersioningDAO.getDocuments",
				SilverTrace.TRACE_LEVEL_DEBUG,
				"root.EX_NO_CONNECTION");
		}
		if (foreignID == null)
	...
	public final static String GET_DOCUMENTS_BYINSTANCEID_QUERY =
			"SELECT documentId, "
				...
				+ " currentWorkListOrder, alertDate, expiryDate "
	 ...
	 * @throws SQLException
	 */
	public static ArrayList getDocumentsByInstanceId(Connection con, String instanceId) throws SQLException
	{
		SilverTrace.info("versioning", "VersioningDAO.getDocumentsByInstanceId()", "root.MSG_GEN_ENTER_METHOD", "instanceId = "+instanceId);
		PreparedStatement prepStmt = null;
		ResultSet rs = null;
		ArrayList result = new ArrayList();
	 ...
	 * @throws VersioningRuntimeException
	 */
	private static Document getDocFormRS(ResultSet rs, Connection con, String spaceID)
		throws SQLException, VersioningRuntimeException
	{
...
//		ArrayList readers = getReaders(con, doc.getPk());
		ArrayList workers = WorkListDAO.getWorkers(con, doc.getPk());
//		doc.setReadList(readers);
		...
		{
			throw new VersioningRuntimeException("VersioningDAO.getDocFormRS",SilverTrace.TRACE_LEVEL_DEBUG,"root.EX_CANT_PARSE_DATE",e);
		}
		try
		{
	...
	public final static String CREATE_DOCUMENT_QUERY =
		"INSERT INTO "
			...
			+ " documentCheckoutDate, documentInfo, foreignId, instanceId, typeWorkList, currentWorkListOrder, alertDate, expiryDate) "
			+ " VALUES ( ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
	 ...
	 * @throws VersioningRuntimeException
	 */
	public static DocumentPK createDocument(Connection conn, Document document, DocumentVersion initialVersion)
		throws SQLException, VersioningRuntimeException
	{
		if (conn == null)
		{
			throw new VersioningRuntimeException(
				"VersioningDAO.createDocument",
				SilverTrace.TRACE_LEVEL_DEBUG,
				"root.EX_NO_CONNECTION");
		}
		if ((document == null)
			|| (document != null && ((document.getPk() == null) || (document.getForeignKey() == null))))
		{
			throw new VersioningRuntimeException(
				"VersioningDAO.createDocument",
				SilverTrace.TRACE_LEVEL_DEBUG,
		...
		try
		{
			...
			if (readers != null && readers.size() != 0)
			{
				for (int i = 0; i < readers.size(); i++)
				{
					...
					reader.setDocumentId(newId);
					reader.setInstanceId(document.getPk().getComponentName());
				}
		...
		throws SQLException, VersioningRuntimeException
	{
		...
		{
			throw new VersioningRuntimeException(
				"VersioningDAO.updateDocument",
				SilverTrace.TRACE_LEVEL_DEBUG,
				"VersioningDAO.EX_NO_CONNECTION");
		}
		if ((document == null)
			|| (document != null && ((document.getPk() == null) || (document.getForeignKey() == null))))
		{
	...
	public final static String UPDATE_DOCUMENT_FOREIGNKEY_QUERY = "UPDATE " + documentTableName + " SET foreignId = ?, instanceId = ? WHERE documentId = ? ";
	 ...
	 * @throws VersioningRuntimeException
	 */
	public static void updateDocumentForeignKey(Connection conn, DocumentPK documentPK, ForeignPK foreignKey) throws SQLException, VersioningRuntimeException
	{
		PreparedStatement prepStmt = null;
	...
	public static void deleteWorkList(Connection conn, Document document, boolean keepSaved)
	throws SQLException, VersioningRuntimeException
	{
		WorkListDAO.removeAllWorkers(conn, document.getPk(), keepSaved);
	}

	public static final String CHECKOUT_DOCUMENT_QUERY =
		"UPDATE "
			+ documentTableName
			+ " SET documentOwnerId = ? ,"
	...
	public static void checkDocumentOut(Connection conn, DocumentPK documentPK, int ownerId, Date checkOutDate)
	throws SQLException, VersioningRuntimeException
	{
	 ...
	 * @throws VersioningRuntimeException
	 */
	public static void checkDocumentOut(Connection conn, DocumentPK documentPK, int ownerId, Date checkOutDate, Date alertDate, Date expiryDate)
		throws SQLException, VersioningRuntimeException
	{
		if (conn == null)
		{
			throw new VersioningRuntimeException(
				"VersioningDAO.checkDocumentOut",
				SilverTrace.TRACE_LEVEL_DEBUG,
				"VersioningDAO.EX_NO_CONNECTION");
		}
		...
		{
			throw new VersioningRuntimeException(
				"VersioningDAO.checkDocumentIn",
				SilverTrace.TRACE_LEVEL_DEBUG,
				"root.EX_NULL_VALUE_OBJECT_OR_PK");
		}
		SilverTrace.debug("versioning", "DAO.checkDocumentOut", "root.MSG_GEN_PARAM_VALUE", "instanceId = " + documentPK.getId());
		...
		try
		{
			...
			SilverTrace.debug("versioning", "DAO.checkDocumentOut", "root.MSG_GEN_PARAM_VALUE", "doc.getExpiryDate() = " + expiryDate);
		...
		if (rowCount == 0)
		{
			throw new VersioningRuntimeException(
				...
				"NodeId = " + documentPK.getId());
		}
	}

	public static final String CHECKIN_DOCUMENT_QUERY = 
		"UPDATE " + documentTableName + " SET" + " documentStatus = 0 , alertDate = null , expiryDate = null " + " WHERE documentId = ?";
		...
		throws SQLException, VersioningRuntimeException
	{
		if (conn == null)
		{
			throw new VersioningRuntimeException("VersioningDAO.checkDocumentIn",SilverTrace.TRACE_LEVEL_DEBUG,"VersioningDAO.EX_NO_CONNECTION");
		}
		if (documentPK == null)
		{
			throw new VersioningRuntimeException("VersioningDAO.checkDocumentIn",SilverTrace.TRACE_LEVEL_DEBUG,"root.EX_NULL_VALUE_OBJECT_OR_PK");
		}
		...
		if (rowCount == 0)
		{
			throw new VersioningRuntimeException("VersioningDAO.checkDocumentIn",SilverpeasRuntimeException.ERROR,"root.EX_CANT_STORE_ENTITY_ATTRIBUTES",
				"NodeId = " + documentPK.getId());
		}
	}
	 ...
	 * @throws VersioningRuntimeException
	 */
	public static DocumentVersionPK addDocumentVersion(Connection conn, DocumentVersion newVersion)
		throws SQLException, VersioningRuntimeException
	{
		if (conn == null)
		{
			throw new VersioningRuntimeException(
				"VersioningDAO.addDocumentVersion",
				SilverTrace.TRACE_LEVEL_DEBUG,
				"VersioningDAO.EX_NO_CONNECTION");
		}
		if ((newVersion == null) || (newVersion != null && (newVersion.getDocumentPK() == null)))
		{
			throw new VersioningRuntimeException(
				"VersioningDAO.addDocumentVersion",
				SilverTrace.TRACE_LEVEL_DEBUG,
	 ...
	 * @throws VersioningRuntimeException
	 */
	public static void updateDocumentVersion(Connection conn, DocumentVersion version)
		throws SQLException, VersioningRuntimeException
	{
		if (conn == null)
		{
		...
		if ((version == null) || (version != null && ((version.getPk() == null) || (version.getDocumentPK() == null))))
		{
			throw new VersioningRuntimeException(
				"VersioningDAO.updateDocumentVersion",
				SilverTrace.TRACE_LEVEL_DEBUG,
	 ...
	 * @throws VersioningRuntimeException
	 */
	public static ArrayList getDocumentVersions(Connection conn, DocumentPK documentPK)
		throws SQLException, VersioningRuntimeException
	{
		if (conn == null)
		{
			throw new VersioningRuntimeException(
				"VersioningDAO.getDocumentVersions",
				SilverTrace.TRACE_LEVEL_DEBUG,
				"root.EX_NO_CONNECTION");
		}
		if (documentPK == null)
	 ...
	 * @throws VersioningRuntimeException
	 */
	public static DocumentVersion getLastPublicDocumentVersion(Connection conn, DocumentPK documentPK)
		throws SQLException, VersioningRuntimeException
	{
		if (conn == null)
		{
	 ...
	 * @throws VersioningRuntimeException
	 */
	public static DocumentVersion getDocumentVersion(Connection conn, DocumentVersionPK pk) throws SQLException, VersioningRuntimeException
	{
		if (conn == null)
		{
			throw new VersioningRuntimeException(
				"VersioningDAO.getDocumentVersion",
	 ...
	 * @throws VersioningRuntimeException
	 */
	private static DocumentVersion getDocVersionFormRS(ResultSet rs) throws SQLException, VersioningRuntimeException
	{
		SimpleDateFormat formatter = new SimpleDateFormat(DATE_FORMAT);
		...
		{
			throw new VersioningRuntimeException(
				"VersioningDAO.getDocVersionFormRS",
				SilverTrace.TRACE_LEVEL_ERROR,
				"root.EX_CANT_PARSE_DATE",
				e);
		}
	...
	public final static String DELETE_DOCUMENT = "delete from " + documentTableName + " where documentId = ? ";
	public final static String DELETE_DOCUMENT_HEADER = "delete from " + versionTableName + " where documentId = ? ";
	 ...
	 * @throws VersioningRuntimeException
	 */
	public static ArrayList deleteDocument(Connection conn, DocumentPK documentPK)
		throws SQLException, VersioningRuntimeException
	{
		SilverTrace.info("versioning", "VersioningDAO.deleteDocument()", "root.MSG_GEN_ENTER_METHOD", "documentPK = "+documentPK.toString());
		if (conn == null)
		{
			throw new VersioningRuntimeException(
				"WorkListDAO.deleteDocument",
				SilverTrace.TRACE_LEVEL_ERROR,
				"root.EX_NO_CONNECTION");
		}
		if (documentPK == null)
	...
	public static final String GET_ALL_PUBLIC_VERSIONS_QUERY =
			"SELECT versionId, "
				+ " documentId, versionMajorNumber , versionMinorNumber, versionAuthorId, "
				+ " versionCreationDate, versionComments, versionType, versionStatus, versionPhysicalname, "
				+ " versionLogicalName, versionMimeType, versionSize, instanceId "
				...
				+ " ORDER BY versionMajorNumber DESC";
	 ...
	 * @throws VersioningRuntimeException
	 */
	public static List getAllPublicDocumentVersions(Connection conn, DocumentPK documentPK) throws SQLException, VersioningRuntimeException
	{
		if (conn == null)
		{
			throw new VersioningRuntimeException("VersioningDAO.getAllPublicDocumentVersions", SilverTrace.TRACE_LEVEL_DEBUG, "root.EX_NO_CONNECTION");
		}
		if (documentPK == null)
		{
			throw new VersioningRuntimeException("VersioningDAO.getAllPublicDocumentVersions", SilverTrace.TRACE_LEVEL_DEBUG, "root.EX_NULL_VALUE_OBJECT_OR_PK");
		}
		...
		try
		{
			...
			{
				throw new VersioningRuntimeException("VersioningDAO.getAllPublicDocumentVersions", SilverTrace.TRACE_LEVEL_DEBUG, "root.EX_WRONG_PK", documentPK.toString(), e);
			}
	 ...
	 * @throws VersioningRuntimeException
	 */
	public static void deleteDocumentsByInstanceId(Connection con, String instanceId) throws SQLException, VersioningRuntimeException
	{
		SilverTrace.info("versioning", "VersioningDAO.deleteDocumentsByInstanceId()", "root.MSG_GEN_ENTER_METHOD", "instanceId = "+instanceId);
		List 		documentsOfInstance = getDocumentsByInstanceId(con, instanceId);
		Document 	document 			= null;
		for (int d=0; d<documentsOfInstance.size();d++)
		{
			document = (Document) documentsOfInstance.get(d);
			deleteDocument(con, document.getPk());
		}
	}

	public static final String GET_ALL_FILES_RESERVED_QUERY =
		"SELECT d.documentId, "
			+ " d.documentName, d.documentDescription, d.documentStatus, d.documentOwnerId, "
			+ " d.documentCheckoutDate, d.documentInfo, d.foreignId, d.instanceId, d.typeWorkList, "
			+ " d.currentWorkListOrder, alertDate, expiryDate "
			+ " FROM " 	+ documentTableName
	 ...
	 * @throws VersioningRuntimeException
	 */
	public static List getAllFilesReserved(Connection conn, int ownerId) throws SQLException, VersioningRuntimeException
	{
		if (conn == null)
		{
			throw new VersioningRuntimeException("VersioningDAO.getAllFilesReserved", SilverTrace.TRACE_LEVEL_DEBUG, "root.EX_NO_CONNECTION");
		}
		...
		try
		{
			...
			{
				throw new VersioningRuntimeException("VersioningDAO.getAllFilesReserved", SilverTrace.TRACE_LEVEL_DEBUG, "root.EX_WRONG_PK", Integer.toString(ownerId), e);
			}
	...
	public static final String GET_ALL_ALERT_FILES_RESERVED_BY_DATE_QUERY =
		"SELECT documentId, "
			+ " documentName, documentDescription, documentStatus, documentOwnerId, "
			+ " documentCheckoutDate, documentInfo, foreignId, instanceId, typeWorkList, "
			+ " currentWorkListOrder, alertDate, expiryDate "
	...
	public static final String GET_ALL_EXPIRY_FILES_RESERVED_BY_DATE_QUERY =
		"SELECT documentId, "
			+ " documentName, documentDescription, documentStatus, documentOwnerId, "
			+ " documentCheckoutDate, documentInfo, foreignId, instanceId, typeWorkList, "
			+ " currentWorkListOrder, alertDate, expiryDate "
	...
	public static final String GET_ALL_FILES_RESERVED_BY_DATE_QUERY =
		"SELECT documentId, "
			+ " documentName, documentDescription, documentStatus, documentOwnerId, "
			+ " documentCheckoutDate, documentInfo, foreignId, instanceId, typeWorkList, "
			+ " currentWorkListOrder, alertDate, expiryDate "
	 ...
	 * @throws VersioningRuntimeException
	 */
	public static List getAllFilesReservedByDate(Connection conn, Date date, boolean alert) throws SQLException, VersioningRuntimeException
	{
		if (conn == null)
		{
			throw new VersioningRuntimeException("VersioningDAO.getAllFilesReserved", SilverTrace.TRACE_LEVEL_DEBUG, "root.EX_NO_CONNECTION");
		...
		try
		{
			...
			{
				throw new VersioningRuntimeException("VersioningDAO.getAllFilesReservedByDate", SilverTrace.TRACE_LEVEL_DEBUG, "root.EX_WRONG_PK", date, e);
			}
	 ...
	 * @throws SQLException
	 */
	public static List getAllDocumentsToLib(Connection conn, Date date) throws SQLException
	{
		if (conn == null)
		{
			throw new VersioningRuntimeException("VersioningDAO.getAllDocumentsToLib", SilverTrace.TRACE_LEVEL_DEBUG, "root.EX_NO_CONNECTION");
		}
		...
		try
		{
			...
			{
				throw new VersioningRuntimeException("VersioningDAO.getAllDocumentsToLib", SilverTrace.TRACE_LEVEL_DEBUG, "root.EX_WRONG_PK", date, e);
			}
	 ...
	 * @throws VersioningRuntimeException
	 */
	public static void insertReadersAccessList(Connection conn, String componentId, ArrayList groupsIds, ArrayList usersIds)
		throws SQLException, VersioningRuntimeException
	{
		SilverTrace.debug("versioning", "VersioningDAO.insertReadersAccessList", "root.MSG_GEN_ENTER_METHOD");
		...
		{
			throw new VersioningRuntimeException("VersioningDAO.insertReadersAccessList",SilverTrace.TRACE_LEVEL_DEBUG,"root.EX_GET_NEXTID_FAILED",accessListTableName,e);
		}
		...
		{
			throw new VersioningRuntimeException(
				"VersioningDAO.insertAccessList",
				SilverpeasRuntimeException.ERROR,
				"root.EX_CANT_STORE_ENTITY_ATTRIBUTES",
		...
		SilverTrace.debug("versioning", "VersioningDAO.insertReadersAccessList", "root.MSG_GEN_EXIT_METHOD");
	}
	 ...
	 * @throws VersioningRuntimeException
	 */
	public static String insertReadersAccessGroupsList(Connection conn, String componentId, ArrayList groupsIds, ArrayList usersIds)
		throws SQLException, VersioningRuntimeException
	{
		SilverTrace.debug("versioning", "VersioningDAO.insertReadersAccessGroupsList", "root.MSG_GEN_ENTER_METHOD");
		...
		{
			throw new VersioningRuntimeException("VersioningDAO.insertReadersAccessGroupsList",SilverTrace.TRACE_LEVEL_DEBUG,"root.EX_GET_NEXTID_FAILED",accessListTableName,e);
		}
		...
		SilverTrace.debug("versioning", "VersioningDAO.insertReadersAccessGroupsList", "root.MSG_GEN_EXIT_METHOD");
	 ...
	 * @throws VersioningRuntimeException
	 */
	private static void insertAccessListContent(Connection conn, int accessId, ArrayList groupsIds, ArrayList usersIds)
		throws SQLException, VersioningRuntimeException
	{
		SilverTrace.debug("versioning", "VersioningDAO.insertAccessListContent", "root.MSG_GEN_PARAM_VALUE", "accessId = " + accessId);
	 ...
	 * @throws VersioningRuntimeException
	 */
	private static void insertAccessGroupsListContent(Connection conn, int accessId, ArrayList groupsIds, ArrayList usersIds)
	throws SQLException, VersioningRuntimeException
	{
		SilverTrace.debug("versioning", "VersioningDAO.insertAccessGroupsListContent", "root.MSG_GEN_PARAM_VALUE", "accessId = " + accessId);
		for (int i=0; i<groupsIds.size(); i++)
		{
			int groupId = new Integer((String) groupsIds.get(i)).intValue();
			insertAccessListContentRow(conn, "G", groupId, accessId);
	 ...
	 * @throws VersioningRuntimeException
	 */
	public static void insertAccessListContentRow(Connection conn, String setType, int setTypeId, int accessId)
	throws SQLException, VersioningRuntimeException
	{
		SilverTrace.debug("versioning", "VersioningDAO.insertAccessListContentRow", "root.MSG_GEN_PARAM_VALUE", "accessId = " + accessId);
		...
		{
			throw new VersioningRuntimeException("VersioningDAO.insertAccessListContentRow",SilverTrace.TRACE_LEVEL_DEBUG,"root.EX_GET_NEXTID_FAILED",accessListContentTableName,e);
		}
	 ...
	 * @throws VersioningRuntimeException
	 */
	public static void removeReadersAccessList(Connection conn, String componentId) throws SQLException, VersioningRuntimeException
	{
		SilverTrace.debug("versioning", "VersioningDAO.removeAccessList", "root.MSG_GEN_PARAM_VALUE", "componentId = " + componentId);
		PreparedStatement prepStmt = null;
		ResultSet rs = null;
		try
		{
			...
			{
				conn.rollback();
				throw new VersioningRuntimeException("VersioningDAO.removeAccessList", SilverTrace.TRACE_LEVEL_DEBUG, "root.EX_WRONG_PK", componentId, e);
			}
		}
		finally
		{
	 ...
	 * @throws SQLException
	 */
	public static ArrayList getReadersAccessListGroups(Connection conn, String componentId) throws SQLException
	{
		if (conn == null)
		{
			throw new VersioningRuntimeException("VersioningDAO.getAccessListGroups", SilverTrace.TRACE_LEVEL_DEBUG, "root.EX_NO_CONNECTION");
		}
		...
		try
		{
			...
			{
				throw new VersioningRuntimeException("VersioningDAO.getAccessListGroups", SilverTrace.TRACE_LEVEL_DEBUG, "root.EX_WRONG_PK", componentId, e);
			}
	 ...
	 * @throws SQLException
	 */
	public static ArrayList getReadersAccessListUsers(Connection conn, String componentId) throws SQLException
	{
		if (conn == null)
		{
			throw new VersioningRuntimeException("VersioningDAO.getAccessListUsers", SilverTrace.TRACE_LEVEL_DEBUG, "root.EX_NO_CONNECTION");
		}
		...
		try
		{
			...
			{
				throw new VersioningRuntimeException("VersioningDAO.getAccessListUsers", SilverTrace.TRACE_LEVEL_DEBUG, "root.EX_WRONG_PK", componentId, e);
			}
	 ...
	 * 
	 */
	public static final String SELECT_ACCESS_LIST_USERS =
		"select t2.settypeid from "
			+ accessListTableName +" t1, " + accessListContentTableName + " t2"
			+ " where t1.componentid = ? and t2.accessId = t1.id and t2.settype = 'U'";

	public static final String SELECT_ACCESS_LIST_USERS_BY_DOCUMENT =
		"select t2.settypeid from "
			+ accessListTableName +" t1, " + accessListContentTableName + " t2"
			+ " where t1.componentid = ? and t2.accessId = t1.id and t2.settype = 'U'";
	 ...
	 * 
	 */
	public static final String SELECT_ACCESS_LIST_GROUPS =
		"select t2.settypeid from "
		+ accessListTableName +" t1, " + accessListContentTableName + " t2"
		+ " where t1.componentid = ? and t2.accessId = t1.id and t2.settype = 'G'";

	public static final String SELECT_ACCESS_LIST_GROUPS_BY_DOCUMENT =
		"select t2.settypeid from "
		+ accessListTableName +" t1, " + accessListContentTableName + " t2"
		+ " where t1.componentid = ? and t2.accessId = t1.id and t2.settype = 'G'";
	 ...
	 * 
	 */
	public static final String INSERT_ACCESS_LIST =
		"insert into "
			+ accessListTableName
	 ...
	 * 
	 */
	public static final String DELETE_ACCESS_LIST =
		"delete from "
			+ accessListTableName
			+ " where componentid = ?";
	 ...
	 * 
	 */
	public static final String INSERT_ACCESS_LIST_CONTENT =
		"insert into "
	 ...
	 * 
	 */
	public static final String DELETE_ACCESS_LIST_CONTENT =
		"delete from " + accessListContentTableName
			+ " where accessid in (select id from " + accessListTableName
			+ " where componentId = ?)";
