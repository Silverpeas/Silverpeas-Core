...
public class WorkListDAO
{
	...
	public final static String SAVE_WORKERS =
		"UPDATE "
			+ workListTableName
			+ " set saved = 1, listtype = ? "
			+ " where instanceid = ? and documentId = ?";

	public final static String GET_WORKERS_ACCESS_LIST_USERS =
		"SELECT * from "
			+ workListTableName
			+ " where instanceid = ? and saved = 1 and settype='U' order by orderby";

	public final static String GET_WORKERS_ACCESS_LIST_GROUPS =
		"SELECT * from "
			+ workListTableName
			+ " where instanceid = ? and saved = 1 and settype='G' order by orderby";
	
	public final static String REMOVE_ALL_WORKERS = "delete from " + workListTableName + " where documentId = ? ";
	public final static String REMOVE_WORKERS_NOT_SAVED = "delete from " + workListTableName + " where documentId = ? and saved = 0";

	public final static String GET_WORKERS_QUERY =
		"SELECT a.documentId, a.userid, "
			+ " a.orderBy, a.writer,  a.approval, a.instanceId, a.settype, a.saved, a.used, a.listtype"
			+ " FROM "
			+ workListTableName
			+ " a WHERE a.documentId = ? order by orderby";

	public final static String GET_SAVED_LIST_TYPE = "SELECT listtype from " + workListTableName
			+ " where instanceid = ? and saved = 1";

	public final static String REMOVE_SAVED_LIST = "delete from " + workListTableName
	+ " where instanceid = ? and saved = 1 and used = 0";

	public final static String UPDATE_OLD_SAVED_LIST = "update " + workListTableName
	+ " set saved=0 where instanceid = ?";
	 ...
	 */
	public static void addWorkers(Connection conn, ArrayList workers) throws SQLException, VersioningRuntimeException
	{
		if (conn == null)
		{
	 ...
	 * @throws VersioningRuntimeException
	 */
	public static void saveWorkersAccessList(Connection conn, String componentId, String documentId, int listType) throws SQLException, VersioningRuntimeException
	{
		PreparedStatement prepStmt = null;
		try
		{
			...
			{
				throw new VersioningRuntimeException(
					"WorkListDAO.saveWorkersAccessList",
					SilverTrace.TRACE_LEVEL_DEBUG,
					"root.EX_WRONG_PK",
	 ...
	 * @throws VersioningRuntimeException
	 */
	public static ArrayList getWorkersAccessListUsers(Connection con, String componentId) throws SQLException, VersioningRuntimeException
	{
		PreparedStatement prepStmt = null;
		ResultSet rs = null;
		ArrayList result = new ArrayList();
	 ...
	 * @throws VersioningRuntimeException
	 */
	public static ArrayList getWorkersAccessListGroups(Connection con, String componentId) throws SQLException, VersioningRuntimeException
	{
		PreparedStatement prepStmt = null;
		ResultSet rs = null;
		ArrayList result = new ArrayList();
	 ...
	 * @throws VersioningRuntimeException
	 */
	public static int getSavedListType(Connection con, String componentId)  throws SQLException, VersioningRuntimeException
	{
		PreparedStatement prepStmt = null;
		ResultSet rs = null;
		int listType = 0;
		try
		{
			...
			{
				throw new VersioningRuntimeException("WorkListDAO.getSavedListType()",SilverTrace.TRACE_LEVEL_DEBUG,"root.EX_WRONG_PK",
					componentId.toString(),
					e);
			}
	...
	public static void removeAccessList(Connection conn, String componentId) throws SQLException, VersioningRuntimeException
	{
		PreparedStatement prepStmt = null;
		try
		{
