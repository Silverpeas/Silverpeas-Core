...
public class Worker implements java.io.Serializable, Cloneable {
    ...
    private int listType;	//0=Non ordered 1=Non ordered with approval 2=Ordered with approval
     ...
     * @param instanceId
     */
    public Worker(int id, int documentId, int order, boolean approval, boolean writer, String instanceId) {
        this.id = id;
    ...
    public Worker(int id, int documentId, int order, boolean approval, boolean writer, String instanceId, String type, boolean saved, boolean used, int listType) {
        this.id = id;
        this.documentId = documentId;
        this.order = order;
        this.approval = approval;
