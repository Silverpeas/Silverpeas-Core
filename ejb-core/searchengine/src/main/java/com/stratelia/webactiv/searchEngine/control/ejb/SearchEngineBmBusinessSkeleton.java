...
/**
 * With the SearchEngineBmBusinessSkeleton interface,
 * which is extended by SearchEngineBm and SearchEngineEJB,
 * we can verify at compile time that SearchEngineEJB
 * expose the expected interface : the SearchEngineBm's one.
 */
