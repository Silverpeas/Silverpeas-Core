...
public class PublicationTemplateManager
{
     ...
     throws PublicationTemplateException
  {
	 ...
	 */
	static public PublicationTemplateImpl loadPublicationTemplate(String xmlFileName) throws PublicationTemplateException
	{
		...
		try 
		{
			...
			PublicationTemplateImpl publicationTemplate = (PublicationTemplateImpl) unmar.unmarshal(new InputSource(new FileInputStream(xmlFilePath)));
