...
public class GenericFieldTemplate implements FieldTemplate, Serializable
{
   ...
   /**
	 * Builds a GenericFieldTemplate
	 * from a field name and a field type name.
	 * The type name must be known by the type manager.
	 *
   ...
   /**
	 * Builds a GenericFieldTemplate
	 * from a field name and a field implementation.
	 *
	 * You must use the set and add methods to change any default value.
	 */
   ...
   public String getLabel()
	{
	   if (defaultLabel == null) return ""/*fieldName*/;
   ...
   public String getLabel(String language)
	{
	   String label = null;
	   if (getLabels() != null) label = (String) getLabels().get(language);

		if (label == null) return getLabel();
		else               return label;
	}
   ...
   public void addLabel(String label, String language)
	{
	   if (language == null || language.trim().equals("")) setLabel(label);
	   else
		{
