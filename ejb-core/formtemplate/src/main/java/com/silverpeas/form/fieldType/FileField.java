...
public class FileField implements Field
{
  ...
  {
	SilverTrace.info("form", "FileField.setAttachmentId", "root.MSG_GEN_ENTER_METHOD", "attachmentId = "+attachmentId);
  ...
  {
	SilverTrace.info("form", "FileField.getValue", "root.MSG_GEN_PARAM_VALUE", "attachmentId = "+getAttachmentId());
   ...
   *
   * There is no local format for a user field,
  ...
  /**
   * Does nothing
	* since a user reference can't be computed from a user name.
   */
  ...
  public void setObjectValue(Object value) throws FormException
  {
     ...
     {
     	throw new FormException("FileField.setObjectValue", "form.EXP_NOT_AN_USER");
     }
  }
  ...
  {
  	SilverTrace.info("form", "FileField.setStringValue", "root.MSG_GEN_ENTER_METHOD", "value = "+value);
