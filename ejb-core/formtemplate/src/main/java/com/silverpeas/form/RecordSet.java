...
/**
 * A RecordSet manages a set of DataRecord built on
 * a same RecordTemplate.
 *
 * @see DataRecord
 * @see RecordTemplate
 */
public interface RecordSet
{
  ...
  /**
   * Index the given DataRecord into the indexEntry.
   * formName looks like allFields (ie template filename allFields.xml without extension)  
   * 
   * @param data
   * @param formName
   * @param indexEntry
   ...
   * Set to cloneExternalId its externalId and insert it.
   */
