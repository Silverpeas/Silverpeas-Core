...
public class GenericRecordSetManager
{
	 ...
	 */
	static public GenericRecordSet createRecordSet(String externalId, RecordTemplate template) throws FormException {
		return createRecordSet(externalId, template, null);
	}

//	public GenericRecordSet createRecordSet(String externalId, RecordTemplate template, String templateName, boolean migration) throws FormException {
	
	static public GenericRecordSet createRecordSet(String externalId, RecordTemplate template, String templateName) throws FormException {
	    Connection con = null;
   ...
   */
	static public void removeRecordSet(String externalId) throws FormException {
		...
		try
		{
			...
			if (template == null)
			{
				//throw new FormException("GenericRecordSetManager", "form.EXP_UNKNOWN_TEMPLATE", externalId);
	...
	*/
	static public DataRecord getRecord(IdentifiedRecordTemplate template, String recordId) throws FormException {
		return getRecord(template, recordId, null);
	}
	
	static public DataRecord getRecord(IdentifiedRecordTemplate template, String recordId, String language) throws FormException {
		SilverTrace.debug("form", "GenericRecordSetManager.getRecord", "root.MSG_GEN_PARAM_VALUE", "recordId = "+recordId+", language = "+language);
		Connection con = null;
	...
	static public List getLanguagesOfRecord(IdentifiedRecordTemplate template, String externalId) throws FormException {
   ...
   */
	static public void insertRecord(IdentifiedRecordTemplate template, DataRecord insertedRecord) throws FormException {
		Connection con = null;
	...
	static public void cloneRecord(IdentifiedRecordTemplate templateFrom, String recordIdFrom, IdentifiedRecordTemplate templateTo, String recordIdTo, Hashtable fileIds) throws FormException
	{
		SilverTrace.debug("form", "GenericRecordSetManager.cloneRecord", "root.MSG_GEN_ENTER_METHOD", "recordIdFrom = "+recordIdFrom+", recordIdTo = "+recordIdTo);
		...
		while (languages.hasNext())
		{
			String language = (String) languages.next();
		   	...
		   	GenericDataRecord record = (GenericDataRecord) getRecord(templateFrom, recordIdFrom, language);
		   	if (record != null)
		   	{
   ...
   * @throw FormException when the (templateId, recordId) pair is unknown.
   */
	static public void updateRecord(IdentifiedRecordTemplate template, DataRecord updatedRecord) throws FormException {
		Connection con = null;
   ...
   * @throw FormException when the (templateId, recordId) pair is unknown.
   */
	static public void deleteRecord(IdentifiedRecordTemplate template, DataRecord deletedRecord) throws FormException {
		Connection con = null;
   ...
   */
  static private void selectTemplateFieldsFromXML(IdentifiedRecordTemplate template) throws FormException
  {
		GenericRecordTemplate genericRecordTemplate =  null;
		try
		{
			PublicationTemplateImpl publicationTemplateImpl = PublicationTemplateManager.loadPublicationTemplate(template.getTemplateName());
   ...
   */
	static synchronized private Connection getConnection() throws FormException {
		...
		try
		{
			...
			DataSource  src = (DataSource) ctx.lookup(JNDINames.FORMTEMPLATE_DATASOURCE);
			con = src.getConnection();
			con.setAutoCommit(false);
		}
		catch (NamingException e)
		{
			//throw new FormException("GenericRecordSetManager", "root.EX_DATASOURCE_NOT_FOUND", e);
			...
			try {
				...
				throw new FormException("GenericRecordSetManager.getConnection()", "Data source "+JNDINames.DIRECT_DATASOURCE+" not found", ne);
			} catch(SQLException se) {
				throw new FormException("GenericRecordSetManager.getConnection()", "root.EX_DATASOURCE_INVALID", JNDINames.DIRECT_DATASOURCE, se);
			}
		}
		catch (SQLException e)
		{
			rollbackConnection(con);
			throw new FormException("GenericRecordSetManager", "root.EX_DATASOURCE_INVALID", e);
		}
		return con;
	}
   ...
   */
	static private int getNextId(String tableName, String idColumn) throws SQLException {
		int nextId = 0;
		
		try
		{
			nextId = com.stratelia.webactiv.util.DBUtil.getNextId(tableName, idColumn);
		}
		catch (Exception e)
		{
   ...
   */
	static private void insertTemplateRow(Connection con, IdentifiedRecordTemplate template) throws SQLException {
   ...
   */
	static private void insertTemplateFieldRows(Connection con, IdentifiedRecordTemplate template) throws SQLException, FormException {
		PreparedStatement insert = null;
   ...
   */
	static private IdentifiedRecordTemplate selectTemplateRow(Connection con, String externalId) throws SQLException {
   ...
   */
	static private void selectTemplateFieldRows(Connection con, IdentifiedRecordTemplate template) throws SQLException, FormException {
		PreparedStatement select	= null;
		ResultSet         rs		= null;
		GenericRecordTemplate wrapped = (GenericRecordTemplate) template.getWrappedTemplate();
   ...
   */
	static private void deleteFieldRows(Connection con, IdentifiedRecordTemplate template) throws SQLException {
   ...
   */
	static private void deleteRecordRows(Connection con, IdentifiedRecordTemplate template) throws SQLException {
		PreparedStatement delete = null;
   ...
   */
	static private void deleteTemplateFieldRows(Connection con, IdentifiedRecordTemplate template) throws SQLException {
		PreparedStatement delete = null;
   ...
   */
	static private void deleteTemplateRow(Connection con, IdentifiedRecordTemplate template) throws SQLException {
		PreparedStatement delete = null;
   ...
   */
	static private void insertRecordRow(Connection con, IdentifiedRecordTemplate template, GenericDataRecord record) throws SQLException {
		PreparedStatement insert = null;
		...
		try
		{
			...
			if (!I18NHelper.isI18N || I18NHelper.isDefaultLanguage(record.getLanguage()))
   ...
   * Creates a row for each template_fields.
   */
	static private void insertFieldRows(Connection con, IdentifiedRecordTemplate template, GenericDataRecord record) throws SQLException, FormException {
		PreparedStatement insert = null;
   ...
   * Select the template header.
   */
	static private GenericDataRecord selectRecordRow(Connection con, IdentifiedRecordTemplate template, String externalId, String language) throws SQLException, FormException {
   ...
   * Select the template field declarations.
   */
	static private void selectFieldRows(Connection con, IdentifiedRecordTemplate template, GenericDataRecord record) throws SQLException, FormException {
		PreparedStatement select = null;
		ResultSet         rs = null;
	...
	static private List selectLanguagesOfRecord(Connection con, IdentifiedRecordTemplate template, String externalId) throws SQLException, FormException {
		PreparedStatement select 	= null;
		ResultSet         rs 		= null;
   ...
   */
	static private void updateFieldRows(Connection con, IdentifiedRecordTemplate template, GenericDataRecord record) throws SQLException, FormException {
			...
			for (int i=0; i<fieldNames.length ; i++)
			{
				...
				if (fieldValue != null)
				{
					...
					if (nbRowsCount == 0) {
						...
						//The form has changed since the last modification of the record. So we must insert this new field.
						insert = con.prepareStatement(INSERT_FIELD);
   ...
   */
	static private void deleteFieldRows(Connection con, IdentifiedRecordTemplate template, GenericDataRecord record) throws SQLException {
		PreparedStatement delete = null;
   ...
   * Deletes the record.
   */
	static private void deleteRecordRows(Connection con, IdentifiedRecordTemplate template, GenericDataRecord record) throws SQLException {
		PreparedStatement delete = null;
  ...
  static private void closeConnection(Connection con) throws FormException {
		if (con != null)
		{
		   ...
		   {
			  throw new FormException("GenericRecordSetManager", "form.EXP_CLOSE_FAILED", e);
		   }
		}
	}
  ...
  static final private String TEMPLATE_TABLE
      = "SB_FormTemplate_Template";

  static final private String TEMPLATE_COLUMNS
      = "templateId,externalId,templateName";

  static final private String SELECT_TEMPLATE
      = "select " +TEMPLATE_COLUMNS
      + " from " +TEMPLATE_TABLE+ " where externalId=?";

  static final private String INSERT_TEMPLATE
      = "insert into " +TEMPLATE_TABLE + "("+TEMPLATE_COLUMNS+")"
      + " values (?,?,?)";

  static final private String DELETE_TEMPLATE
      = "delete from " +TEMPLATE_TABLE
      + " where templateId=?";

  /* Template fields table */

  static final private String TEMPLATE_FIELDS_TABLE
      = "SB_FormTemplate_TemplateField";
  ...
  static final private String SELECT_TEMPLATE_FIELDS
      = "select " +TEMPLATE_FIELDS_COLUMNS
      + " from " +TEMPLATE_FIELDS_TABLE+ " where templateId=?"
		+ " order by fieldIndex";

  static final private String INSERT_TEMPLATE_FIELD
      = "insert into " +TEMPLATE_FIELDS_TABLE + "("+TEMPLATE_FIELDS_COLUMNS+")"
      + " values (?,?,?,?,?,?,?)";

  static final private String DELETE_TEMPLATE_FIELDS
      = "delete from " +TEMPLATE_FIELDS_TABLE
      + " where templateId=?";


  /* Record table */

  static final private String RECORD_TABLE
      = "SB_FormTemplate_Record";

  static final private String RECORD_COLUMNS
      = "recordId,templateId,externalId,lang";

  static final private String SELECT_RECORD
      = "select " +RECORD_COLUMNS
      + " from " +RECORD_TABLE+ " where templateId=? and externalId=?";

  static final private String INSERT_RECORD
      = "insert into " +RECORD_TABLE + "("+RECORD_COLUMNS+")"
      + " values (?,?,?,?)";

  static final private String DELETE_TEMPLATE_RECORDS
  ...
  static final private String FIELDS_TABLE
      = "SB_FormTemplate_TextField";

  static final private String FIELDS_COLUMNS
      = "recordId,fieldName,fieldValue";

  static final private String SELECT_FIELDS
      = "select " +FIELDS_COLUMNS
      + " from " +FIELDS_TABLE+ " where recordId=?";
//		+ " order by fieldIndex";

  static final private String INSERT_FIELD
      = "insert into " +FIELDS_TABLE + "("+FIELDS_COLUMNS+")"
      + " values (?,?,?)";

  static final private String UPDATE_FIELD
      = "update " +FIELDS_TABLE
      + " set fieldValue=? where recordId=? and fieldName=?";

  static final private String DELETE_TEMPLATE_RECORDS_FIELDS
      = "delete from " +FIELDS_TABLE
      + " where recordId in"
		+ " (select recordId from SB_FormTemplate_Record where templateId=?)";

  static final private String DELETE_RECORD_FIELDS
      = "delete from " +FIELDS_TABLE
      + " where recordId=?";
}
