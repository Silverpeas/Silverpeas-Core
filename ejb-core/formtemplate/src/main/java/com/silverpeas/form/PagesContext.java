...
public class PagesContext
{
	...
	public PagesContext(String formName, String formIndex, String language, String userId)
	{
		setFormIndex(formIndex);
		setFormName(formName);
		setLanguage(language);
	...
	public PagesContext(String formName, String formIndex, String language, boolean printTitle)
	{
		setFormIndex(formIndex);
		setFormName(formName);
		setLanguage(language);
	...
	public PagesContext(String formName, String formIndex, String language, boolean printTitle, String componentId, String userId)
	{
		setFormIndex(formIndex);
		setFormName(formName);
		setLanguage(language);
	...
	public PagesContext(String formName, String formIndex, String language, boolean printTitle, String componentId, String userId, String nodeId)
	{
		setFormIndex(formIndex);
		setFormName(formName);
		setLanguage(language);
