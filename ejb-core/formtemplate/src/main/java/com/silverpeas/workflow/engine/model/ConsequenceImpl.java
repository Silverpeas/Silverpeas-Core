 ...
 */
public class ConsequenceImpl extends AbstractReferrableObject implements Consequence, AbstractDescriptor, Serializable 
{
    private String         item;
    ...
    public State getTargetState(String strStateName)
    {
        for ( int i = 0; i < targetStateList.size(); i++ )
            if ( ( (StateSetter)targetStateList.get(i) ).getState().getName().equals(strStateName) )
    ...
    /* (non-Javadoc)
     * @see com.silverpeas.workflow.api.model.Consequence#addTargetState(com.silverpeas.workflow.api.model.StateSetter)
     */
    ...
    public State getUnsetState(String strStateName)
    {
        for ( int i = 0; i < unsetStateList.size(); i++ )
            if ( ( (StateSetter)unsetStateList.get(i) ).getState().getName().equals(strStateName) )
    ...
    /* (non-Javadoc)
     * @see com.silverpeas.workflow.api.model.Consequence#addUnsetState(com.silverpeas.workflow.api.model.StateSetter)
     */
