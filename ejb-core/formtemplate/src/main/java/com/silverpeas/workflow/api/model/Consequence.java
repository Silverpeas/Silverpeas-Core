...
/**
 * Interface describing a representation of the &lt;consequence&gt; element of a
 * Process Model.
 */
public interface Consequence {
   ...
   * 
   * @return QualifiedUsers object containing notified users or an empty
   *         QualifiedUsers object but never a <code>null</code>
   */
   ...
   * Get all the users that have to be notified
   * 
   * @return QualifiedUsers object containing notified users or a
