...
public class StateImpl extends AbstractReferrableObject implements State, AbstractDescriptor,
   ...
   * (non-Javadoc)
   * @see
   * com.silverpeas.workflow.api.model.State#setAllowedActions(com.silverpeas.workflow.api.model
   * .AllowedActions)
   */
   ...
   * (non-Javadoc)
   * @see
   * com.silverpeas.workflow.api.model.State#setTimeoutAction(com.silverpeas.workflow.api.model.
   * Action)
   */
   ...
   * (non-Javadoc)
   * @see
   * com.silverpeas.workflow.api.model.AbstractDescriptor#setParent(com.silverpeas.workflow.api.
