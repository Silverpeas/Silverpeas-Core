 ...
 * workflow. All the public methods are static, so only one thread runs and processes the requests.
 * This Thread is managed by the container so it shares the same context than the container.
 * @author ebonnet
 */
