...
public class QualifiedUsersImpl implements QualifiedUsers, Serializable 
{
	...
	/* (non-Javadoc)
     * @see com.silverpeas.workflow.api.model.QualifiedUsers#addUserInRole(com.silverpeas.workflow.api.model.UserInRole)
     */
    ...
    /* (non-Javadoc)
     * @see com.silverpeas.workflow.api.model.QualifiedUsers#getRelatedUser(com.silverpeas.workflow.api.model.RelatedUser)
     */
    ...
    /* (non-Javadoc)
     * @see com.silverpeas.workflow.api.model.QualifiedUsers#addRelatedUser(com.silverpeas.workflow.api.model.RelatedUser)
     */
