...
public interface State
{
     ...
     * @return        wanted activity as a String object. 
     *                If activity is not found, search activity with given role and default language,
     *                if not found again, return the default activity in given language,
     *                if not found again, return the default activity in default language,
     *                if not found again, return empty string.
     */
     ...
     * 
     * @return QualifiedUsers object containing interested users,
     *         or an empty QualifiedUsers object but never <code>null</code>  
     */
     ...
     * @return QualifiedUsers object containing theses users,
     *         or an empty QualifiedUsers object but never <code>null</code>  
     */
     ...
     * Action that will played if timeout is trigerred
     * @return timeout action
     */
    public Action getTimeoutAction();

    /**
     * Set the timeout action of this state
     * Action that will played if timeout is trigerred
