 ...
 *
 * This is a proxy class to the WorkflowHub class
 * which gives all the workflow services.
 */
public final class Workflow 
{
   ...
   static public String getLabel(String labelName, String lang)
   {
	 ...
	 * the Workflow inspector will verify periodically the timeout on 
	 */
	static public void initialize()
	{
		...
		{
			SilverTrace.error("workflowEngine", "Workflow.initialize", "workflowEngine.EX_ERR_INITIALIZE", we);
		}
	}
