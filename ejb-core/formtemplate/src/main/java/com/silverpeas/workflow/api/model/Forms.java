...
/**
 * Interface describing a representation of the &lt;forms&gt; element of a
 * Process Model.
 */
public interface Forms {
  ...
  /**
   * Get the form definition with given name for the given role, will return the
   * form dedicated to that role or, if the former has not been found, a generic
   * form with this name
   * 
   * @param name
   *          action form
