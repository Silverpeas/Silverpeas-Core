...
public interface Form
{
	 ...
	 * @return		wanted title as a String object. 
	 *				If title is not found, search title with given role and default language,
	 *				if not found again, return the default title in given language,
	 *				if not found again, return the default title in default language,
	 ...
	 * @return the resulting RecordTemplate
	 */
	public RecordTemplate toRecordTemplate(String  roleName,
	                                       String  language,
										   boolean readOnly)
	   throws WorkflowException;
}
