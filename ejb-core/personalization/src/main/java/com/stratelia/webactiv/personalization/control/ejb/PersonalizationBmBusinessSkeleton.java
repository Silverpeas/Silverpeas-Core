...
public interface PersonalizationBmBusinessSkeleton {
  ...
  public void setThesaurusStatus(boolean thesaurusStatus) throws RemoteException;

  public boolean getThesaurusStatus() throws RemoteException;

  public void setDragAndDropStatus(boolean dragAndDropStatus) throws RemoteException;

  public boolean getDragAndDropStatus() throws RemoteException;

  public void setOnlineEditingStatus(boolean onlineEditingStatus) throws RemoteException;

  public boolean getOnlineEditingStatus() throws RemoteException;

 public void setWebdavEditingStatus(boolean webdavEditingStatus) throws RemoteException;
