...
public class CalendarBmEJB implements CalendarBmBusinessSkeleton, SessionBean
{
	 ...
	 */
	public boolean hasTentativeSchedulablesForUser(String userId) throws RemoteException
	{
		SilverTrace.info(
			"calendar",
		...
		catch (Exception e)
		{
			throw new CalendarRuntimeException(
				...
				SilverpeasException.ERROR,
				"calendar.MSG_CANT_GET_JOURNALS",
				"userId=" + userId,
				e);
	...
	public Collection getTentativeSchedulablesForUser(String userId) throws RemoteException
	{
		SilverTrace.info(
			"calendar",
		...
		try
		{
			Collection result = JournalDAO.getTentativeJournalHeadersForUser(con, userId);
			return result;
		}
		catch (Exception e)
		{
	 ...
	 */
	public Collection getNotCompletedToDosForUser(String userId) throws RemoteException
	{
		SilverTrace.info(
			"calendar",
		...
		try
		{
			Collection result = ToDoDAO.getNotCompletedToDoHeadersForUser(con, userId);
			return result;
		}
		catch (Exception e)
		{
	...
	public Collection getOrganizerToDos(String organizerId) throws RemoteException
	{
		SilverTrace.info(
			"calendar",
	...
	public Collection getClosedToDos(String organizerId) throws RemoteException
	{
		SilverTrace.info(
			"calendar",
			"CalendarBmEJB.getClosedToDos(organizerId)",
			"root.MSG_GEN_ENTER_METHOD",
			"organizerId=" + organizerId);
		Connection con = getConnection();
		try
	...
	public Collection getExternalTodos(String spaceId, String componentId, String externalId) throws RemoteException
	{
		SilverTrace.info(
			"calendar",
			"getExternalTodos(String spaceId, String componentId, String externalId)",
			"root.MSG_GEN_ENTER_METHOD",
			"space=" + spaceId + ", component=" + componentId + ", externalId=" + externalId);
		Connection con = getConnection();
		try
		{
			Collection result = ToDoDAO.getToDoHeadersByExternalId(con, spaceId, componentId, externalId);
			return result;
		}
		catch (Exception e)
		{
	...
	private Collection getToDoHeadersByInstanceId(String instanceId) throws RemoteException
	{
		SilverTrace.info(
			"calendar",
	...
	public void updateToDo(ToDoHeader todo) throws RemoteException, CalendarException
	{
		SilverTrace.info("calendar", "CalendarBmEJB. updateToDo(ToDoHeader todo)", "root.MSG_GEN_ENTER_METHOD");

		if (todo.getName() == null)
			throw new CalendarException("calendar", SilverpeasException.ERROR, "calendar.EX_PARAM_NULL");
		...
		if ((todo.getEndDate() != null) && (todo.getStartDate() != null))
			if (todo.getStartDate().compareTo(todo.getEndDate()) > 0)
				throw new CalendarException("calendar", SilverpeasException.ERROR, "calendar.EX_DATE_FIN_ERROR");
		...
		try
		{
			...
			// } 
			// catch (Exception e) {
			//   SilverTrace.warn("calendar", "CalendarBmEJB.updateToDo(ToDoHeader todo)", "root.EX_INDEX_FAILED","",e);
			// }
		}
		catch (Exception e)
		{
	...
	public String addToDo(ToDoHeader todo) throws RemoteException, CalendarException
	{
		SilverTrace.info("calendar", "CalendarBmEJB. addToDo(ToDoHeader todo)", "root.MSG_GEN_ENTER_METHOD");
		if (todo.getName() == null)
			throw new CalendarException("calendar", SilverpeasException.ERROR, "calendar.EX_PARAM_NULL");
		if (todo.getDelegatorId() == null)
			throw new CalendarException("calendar", SilverpeasException.ERROR, "calendar.EX_PARAM_NULL");
		...
		{
			throw new CalendarRuntimeException(
				"CalendarBmEJB.addToDo(ToDoHeader todo)",
				SilverpeasException.ERROR,
				"calendar.MSG_CANT_CREATE_TODO",
				e);
		}
		finally
		{
	...
	{
		SilverTrace.info("calendar", "CalendarBmEJB. removeToDo(String id)", "root.MSG_GEN_ENTER_METHOD", "id=" + id);
		Connection con = getConnection();
		try
		{
			...
			{
				SilverTrace.warn("calendar", "CalendarBmEJB.removeToDo(String id)", "root.EX_INDEX_FAILED", "", e);
			}
		...
		{
			throw new CalendarRuntimeException(
				"CalendarBmEJB.removeToDo(String id)",
				SilverpeasException.ERROR,
				"calendar.MSG_CANT_CREATE_TODO",
				e);
		}
	...
	public Collection getDaySchedulablesForUser(String day, String userId, String categoryId, String participation)
		throws RemoteException
	{
		SilverTrace.info(
			...
			"CalendarBmEJB. removeToDo(String id)",
			"root.MSG_GEN_ENTER_METHOD",
			"day=" + day + "userId=" + userId + "categoryId=" + categoryId + "participation=" + participation);
		Connection con = getConnection();
		try
		{
			Collection result = JournalDAO.getDayJournalHeadersForUser(con, day, userId, categoryId, participation);
			return result;
		}
		catch (Exception e)
		{
	...
	public Collection getNextDaySchedulablesForUser(String day, String userId, String categoryId, String participation)
	throws RemoteException
{
	SilverTrace.info(
		"calendar",
	...
	try
	{
		Collection result = JournalDAO.getNextJournalHeadersForUser(con, day, userId, categoryId, participation);
		return result;
	}
	catch (Exception e)
	{
	...
	public Collection getPeriodSchedulablesForUser(
		String begin,
		String end,
		String userId,
		String categoryId,
		...
		throws RemoteException
	{
		...
		{
			Collection result =
				JournalDAO.getPeriodJournalHeadersForUser(con, begin, end, userId, categoryId, participation);
			return result;
		}
		catch (Exception e)
		{
	...
	public Collection countMonthSchedulablesForUser(
		String month,
		String userId,
		String categoryId,
		String participation)
		throws RemoteException
	{
		...
		try
		{
			Collection result = JournalDAO.countMonthJournalsForUser(con, month, userId, categoryId, participation);
			return result;
		}
		catch (Exception e)
		{
	...
	public String addJournal(JournalHeader journal) throws RemoteException, CalendarException
	{
		SilverTrace.info("calendar", "CalendarBmEJB.addJournal(JournalHeader journal)", "root.MSG_GEN_ENTER_METHOD");
		// verify the journal attributes are correctly set
		if (journal.getName() == null)
			throw new CalendarException("calendar", SilverpeasException.ERROR, "calendar.EX_PARAM_NULL", "name");
		if (journal.getStartDate() == null)
			throw new CalendarException("calendar", SilverpeasException.ERROR, "calendar.EX_PARAM_NULL", "startDate");
		if (journal.getDelegatorId() == null)
			throw new CalendarException("calendar", SilverpeasException.ERROR, "calendar.EX_PARAM_NULL", "delegatorId");
		if (journal.getStartDate().compareTo(journal.getEndDate()) > 0)
			throw new CalendarException("calendar", SilverpeasException.ERROR, "calendar.EX_DATE_FIN_ERROR");
		if (journal.getStartHour() != null)
			if (journal.getEndHour() == null)
				throw new CalendarException("calendar", SilverpeasException.ERROR, "calendar.EX_PARAM_NULL", "endHour");
		if (journal.getEndHour() != null)
			if (journal.getStartHour() == null)
		...
		if (journal.getStartDate().compareTo(journal.getEndDate()) == 0)
			if (journal.getStartHour() != null)
				if (journal.getStartHour().compareTo(journal.getEndHour()) > 0)
					throw new CalendarException("calendar", SilverpeasException.ERROR, "calendar.EX_HOUR_FIN_ERRORR");
		...
		catch (CalendarException ce)
		{
			throw new CalendarRuntimeException(
				"CalendarBmEJB.addJournal(JournalHeader journal)",
				SilverpeasException.ERROR,
				"calendar.EX_EXCUTE_INSERT_EMPTY",
				ce);
		}
		finally
		{
	...
	public void updateJournal(JournalHeader journal) throws RemoteException, CalendarException
	{
		SilverTrace.info("calendar", "CalendarBmEJB.updateJournal(JournalHeader journal)", "root.MSG_GEN_ENTER_METHOD");
		// verify the journal attributes are correctly set
		if (journal.getName() == null)
			throw new CalendarException("calendar", SilverpeasException.ERROR, "calendar.EX_PARAM_NULL", "name");
		if (journal.getStartDate() == null)
		...
		try
		{
			...
			// } catch (Exception e) {
			//     SilverTrace.warn("calendar", "CalendarBmEJB.updateJournal(JournalHeader journal)", "root.EX_INDEX_FAILED","",e);
			// }
		}
		catch (SQLException se)
		{
			throw new CalendarRuntimeException(
				...
				SilverpeasException.ERROR,
				"calendar.MSG_CANT_UPADATE_JOURNAL",
				se);
		}
		catch (CalendarException ce)
		{
	...
	public void removeJournal(String journalId) throws RemoteException
	{
		...
		catch (SQLException se)
		{
			throw new CalendarRuntimeException(
				"CalendarBmEJB.removeJournal(String journalId)",
				SilverpeasException.ERROR,
				"calendar.MSG_CANT_REMOVE_JOURNAL",
				se);
		}
		catch (CalendarException ce)
		{
	...
	/*
	  ...
	  {
		SilverTrace.info("calendar", "CalendarBmEJB.getJournalHeader(String journalId)","root.MSG_GEN_ENTER_METHOD","journalId="+journalId); 
		Connection con = getConnection();
		try {
			JournalHeader journal = JournalDAO.getJournalHeader(con, journalId);
			return journal;
		} catch (Exception e) {
			 throw new CalendarRuntimeException("CalendarBmEJB.getJournalHeader(String journalId)",SilverpeasException.ERROR, "calendar.MSG_CANT_GET_JOURNAL",e);       
		} finally {
			freeConnection(con);
		}
	  }
	...
	public JournalHeader getJournalHeader(String journalId) throws RemoteException
	{
		...
		catch (java.text.ParseException pe)
		{
			throw new CalendarRuntimeException(
				"CalendarBmEJB.getJournalHeader(String journalId)",
				SilverpeasException.ERROR,
				"calendar.EX_ERROR_PARSING_DATE",
				pe);
		}
		catch (CalendarException ce)
		{
	...
	public Collection getExternalJournalHeadersForUser(String userId) throws RemoteException
	{
		SilverTrace.info(
			"calendar",
		...
		try
		{
			Collection journals = JournalDAO.getOutlookJournalHeadersForUser(con, userId);
			return journals;
		}
		catch (SQLException se)
		{
	...
	public Collection getExternalJournalHeadersForUserAfterDate(String userId, java.util.Date startDate) throws RemoteException
	{
		SilverTrace.info(
			"calendar",
		...
		try
		{
			Collection journals = JournalDAO.getOutlookJournalHeadersForUserAfterDate(con, userId, startDate);
			return journals;
		}
		catch (SQLException se)
		{
	...
	public Collection getJournalHeadersForUserAfterDate(String userId, java.util.Date startDate, int nbReturned) throws RemoteException
	{
		SilverTrace.info(
			"calendar",
		...
		try
		{
			Collection journals = JournalDAO.getJournalHeadersForUserAfterDate(con, userId, startDate, nbReturned);
			return journals;
		}
		catch (SQLException se)
		{
	 ...
	 */
	public void addJournalAttendee(String journalId, Attendee attendee) throws RemoteException
	{
		SilverTrace.info("calendar", "CalendarBmEJB.addJournalAttendee()", "root.MSG_GEN_ENTER_METHOD");
		Connection con = getConnection();
		try
		{
			...
			// } catch (Exception e) {
			//     SilverTrace.warn("calendar", "CalendarBmEJB.addJournalAttendee()", "root.EX_INDEX_FAILED","",e);
			// }
		}
		catch (Exception e)
		{
			throw new CalendarRuntimeException(
				...
				SilverpeasException.ERROR,
				"calendar.MSG_CANT_CHANGE_JOURNAL_ATTENDEES",
				e);
		}
		finally
		{
	...
	public void removeJournalAttendee(String journalId, Attendee attendee) throws RemoteException
	{
		SilverTrace.info(
			"calendar",
	...
	public Collection getJournalAttendees(String journalId) throws RemoteException
	{
		SilverTrace.info(
			"calendar",
		...
		catch (Exception e)
		{
			throw new CalendarRuntimeException(
				"CalendarBmEJB.getJournalAttendees(String journalId)",
				SilverpeasException.ERROR,
				"calendar.MSG_CANT_GET_JOURNAL_ATTENDEES",
				e);
		}
		finally
		{
	...
	public void setJournalAttendees(String journalId, String[] userIds) throws RemoteException
	{
		SilverTrace.info(
			"calendar",
		...
		throws RemoteException
	{
		SilverTrace.info(
			...
			"root.MSG_GEN_ENTER_METHOD",
			"journalId=" + journalId + ", userId=" + userId + ", participation=" + participation);
		...
		catch (Exception e)
		{
			throw new CalendarRuntimeException(
				"CalendarBmEJB.setJournalParticipationStatus(String journalId,String userId,String participation)",
				SilverpeasException.ERROR,
				"calendar.MSG_CANT_UPDATE_JOURNAL",
				e);
		}
		finally
		{
	...
	public void addToDoAttendee(String todoId, Attendee attendee) throws RemoteException
	{
		SilverTrace.info(
			"calendar",
		...
		try
		{
			...
			// } catch (Exception e) {
			//     SilverTrace.warn("calendar", "CalendarBmEJB.addToDoAttendee(String todoId,Attendee attendee)", "root.EX_INDEX_FAILED","",e);
			//   }
		}
		catch (Exception e)
		{
			throw new CalendarRuntimeException(
				"CalendarBmEJB.addToDoAttendee(String todoId,Attendee attendee)",
				SilverpeasException.ERROR,
				"calendar.MSG_CANT_CHANGE_TODO_ATTENDEES",
				e);
		}
		finally
		{
	...
	public void removeToDoAttendee(String todoId, Attendee attendee) throws RemoteException
	{
		SilverTrace.info(
			"calendar",
	...
	public Collection getToDoAttendees(String todoId) throws RemoteException
	{
		...
		catch (Exception e)
		{
			throw new CalendarRuntimeException(
				"CalendarBmEJB.getToDoAttendees(String todoId)",
				SilverpeasException.ERROR,
				"calendar.MSG_CANT_GET_TODO_ATTENDEES",
				e);
		}
		finally
		{
	...
	public void setToDoAttendees(String todoId, String[] userIds) throws RemoteException
	{
		SilverTrace.info(
			"calendar",
		...
		if (userIds != null)
			for (int i = 0; i < userIds.length; i++)
			{
				...
				if (toAdd)
				{
					Attendee attendee;
					/*
					if (userIds[i].equals(todoHeader.getDelegatorId()))
						attendee = new Attendee(journalId, userIds[i], ParticipationStatus.ACCEPTED);
					else
					*/
					attendee = new Attendee(userIds[i]);
	...
	{
		SilverTrace.info("calendar", "CalendarBmEJB.getAllCategories()", "root.MSG_GEN_ENTER_METHOD");
		Connection con = getConnection();
		try
		{
		...
		{
			throw new CalendarRuntimeException(
				"CalendarBmEJB.getAllCategories()",
				SilverpeasException.ERROR,
				"calendar.MSG_CANT_GET_CATEGORIES",
				e);
		}
		finally
		{
	...
	public void addJournalCategory(String journalId, String categoryId) throws RemoteException
	{
		SilverTrace.info(
			"calendar",
			"CalendarBmEJB.addJournalCategory(String journalId,String categoryId)",
			"root.MSG_GEN_ENTER_METHOD",
			"journalId=" + journalId + ", categoryId=" + categoryId);
		Connection con = getConnection();
		try
		{
		...
		catch (Exception e)
		{
			throw new CalendarRuntimeException(
				"CalendarBmEJB.addJournalCategory(String journalId,String categoryId)",
				SilverpeasException.ERROR,
				"calendar.MSG_CANT_CHANGE_CATEGORIES",
				e);
	...
	public void removeJournalCategory(String journalId, String categoryId) throws RemoteException
	{
		SilverTrace.info(
			"calendar",
	...
	public Collection getJournalCategories(String journalId) throws RemoteException
	{
		SilverTrace.info(
			"calendar",
	...
	public void setJournalCategories(String journalId, String[] categoryIds) throws RemoteException
	{
		SilverTrace.info(
			"calendar",
	...
	public void indexAllTodo() throws RemoteException
	{
		...
		{
			SilverTrace.warn("calendar", "CalendarBmEJB.indexAllTodo()", "root.EX_INDEX_FAILED", "", se);
		}
		finally
		{
			try
			...
			{
				SilverTrace.warn("calendar", "CalendarBmEJB.indexAllTodo()", "root.EX_RESOURCE_CLOSE_FAILED", "", se);
			}
	...
	{
		SilverTrace.info("calendar", "calendarBmEJB.getHolidayDates()", "root.MSG_GEN_ENTER_METHOD", "userId="+userId);
		Connection con = getConnection();
		try
		{
		...
		{
			throw new CalendarRuntimeException("calendarBmEJB.getHolidayDates()", SilverpeasRuntimeException.ERROR, "calendar.GETTING_HOLIDAYDATES_FAILED", "userId = "+userId, re);
		}
		finally
		{
			freeConnection(con);
	...
	{
		SilverTrace.info("calendar", "calendarBmEJB.addHolidayDate()", "root.MSG_GEN_ENTER_METHOD", "holidayDate="+holiday.getDate().toString());
		Connection con = getConnection();
		try
		{
		...
		{
			throw new CalendarRuntimeException("calendarBmEJB.addHolidayDate()", SilverpeasRuntimeException.ERROR, "calendar.ADDING_HOLIDAYDATE_FAILED", "date = "+holiday.getDate().toString(), re);
		}
		finally
		{
			freeConnection(con);
	...
	{
		SilverTrace.info("calendar", "calendarBmEJB.addHolidayDates()", "root.MSG_GEN_ENTER_METHOD", "holidayDates.size()="+holidayDates.size());
		Connection con = getConnection();
		try
		{
		...
		{
			throw new CalendarRuntimeException("calendarBmEJB.addHolidayDates()", SilverpeasRuntimeException.ERROR, "calendar.ADDING_HOLIDAYDATES_FAILED", re);
		}
		finally
		{
			freeConnection(con);
	...
	{
		SilverTrace.info("calendar", "calendarBmEJB.removeHolidayDate()", "root.MSG_GEN_ENTER_METHOD", "holidayDate="+holiday.getDate().toString());
		Connection con = getConnection();
		try
		{
		...
		{
			throw new CalendarRuntimeException("calendarBmEJB.removeHolidayDate()", SilverpeasRuntimeException.ERROR, "calendar.REMOVING_HOLIDAYDATE_FAILED", "date = "+holiday.getDate().toString(), re);
		}
		finally
		{
			freeConnection(con);
	...
	{
		SilverTrace.info("calendar", "calendarBmEJB.removeHolidayDates()", "root.MSG_GEN_ENTER_METHOD", "holidayDates.size()="+holidayDates.size());
		Connection con = getConnection();
		try
		{
			HolidayDetail holiday = null;
		...
		{
			throw new CalendarRuntimeException("CalendarBmEJB.removeHolidayDates()", SilverpeasRuntimeException.ERROR, "calendar.REMOVING_HOLIDAYDATES_FAILED", re);
		}
		finally
		{
			freeConnection(con);
	...
	public boolean isHolidayDate(HolidayDetail date) throws RemoteException
	{
		...
		{
			throw new CalendarRuntimeException("CalendarBmEJB.isHolidayDate()", SilverpeasRuntimeException.ERROR, "calendar.GETTING_HOLIDAYDATE_FAILED", re);
		}
		finally
		{
			freeConnection(con);
	...
	public void indexAllJournal() throws RemoteException
	{
		...
		{
			SilverTrace.warn("calendar", "CalendarBmEJB.indexAllJournal()", "root.EX_INDEX_FAILED", "", se);
		}
		finally
		{
			try
	...
	{
		//Debug.debug(700, "CalendarBmEJB.setSessionContext()", "enter", null, null);
	}
}
