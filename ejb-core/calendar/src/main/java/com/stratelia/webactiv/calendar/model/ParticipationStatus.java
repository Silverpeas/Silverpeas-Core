...
public class ParticipationStatus implements Serializable {
  ...
  public boolean isTentative() {
    return (participation.equals(TENTATIVE)); // has the object is Serializable, this has to be an equals() method
  }
  
  public boolean isAccepted() {
    return (participation.equals(ACCEPTED)); // has the object is Serializable, this has to be an equals() method
  }
  
  public boolean isDeclined() {
    return (participation.equals(DECLINED)); // has the object is Serializable, this has to be an equals() method
  }
