...
public class HolidaysDAO {
	...
	{
		SilverTrace.info("calendar", "HolidaysDAO.addHolidayDate()", "root.MSG_GEN_ENTER_METHOD", holiday.getDate().toString());
	...
	public static boolean isHolidayDate(Connection con, HolidayDetail holiday) throws SQLException
	{
		...
		SilverTrace.info("calendar", "HolidaysDAO.isHolidayDate()", "root.MSG_GEN_PARAM_VALUE", "date = "+holiday.getDate().toString());
	...
	public static List getHolidayDates(Connection con, String userId) throws SQLException
	{
		...
		SilverTrace.info("calendar", "HolidaysDAO.getHolidayDates()", "root.MSG_GEN_PARAM_VALUE", "userId = "+userId);
...
//				holidayDates.add(dbDate2Date(rs.getString("holidayDate"), "holidayDate"));
	...
	public static List getHolidayDates(Connection con, String userId, Date beginDate, Date endDate) throws SQLException
	{
		...
		SilverTrace.info("calendar", "HolidaysDAO.getHolidayDates()", "root.MSG_GEN_PARAM_VALUE", "userId = "+userId+", beginDate="+beginDate.toString()+", endDate="+endDate.toString());
