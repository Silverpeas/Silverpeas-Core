...
public class AttendeeDAO
{
	...
	public static Collection getJournalAttendees(Connection con, String journalId) throws SQLException
	{
		return getAttendees(
			con,
			journalId,
			AttendeeDAO.JOURNALCOLUMNNAMES,
			AttendeeDAO.JOURNALTABLENAME,
			AttendeeDAO.JOURNALIDNAME);
	}
	...
	public static Collection getToDoAttendees(Connection con, String todoId) throws SQLException
	{
		return getAttendees(
			con,
			todoId,
			AttendeeDAO.TODOCOLUMNNAMES,
			AttendeeDAO.TODOTABLENAME,
			AttendeeDAO.TODOIDNAME);
	}

	public static Collection getAttendees(Connection con, String id, String columns, String table, String idLabel)
		throws SQLException
	{
	...
	{
		removeAttendees(con, todoId, AttendeeDAO.TODOCOLUMNNAMES, AttendeeDAO.TODOTABLENAME, AttendeeDAO.TODOIDNAME);
	}

	public static void removeAttendees(Connection con, String id, String columns, String table, String idLabel)
		throws SQLException
	{
