...
public class CalendarEJB implements SilverpeasCalendar {
  ...
  public void removeTabToDo(String[] tabTodoId, String userId) {
    SilverTrace.info("calendar", "CalendarEJB. removeTabToDo(String[] tabTodoId, String userId)",
        "root.MSG_GEN_ENTER_METHOD");
    Connection con = getConnection();
    try {
      ToDoHeader todo;
      for(String todoId : tabTodoId) {
        ...
        try {
          ...
          SilverTrace.warn("calendar",
              "CalendarEJB.removeTabToDo(String[] tabTodoId, String userId)",
              "root.EX_INDEX_FAILED", "", e);
        }
      }
      AttendeeDAO.removeTabToDoAttendee(con, tabTodoId, userId);
    } catch (Exception e) {
      throw new CalendarRuntimeException("CalendarEJB.removeTabToDo(String[] tabTodoId, String userId)",
