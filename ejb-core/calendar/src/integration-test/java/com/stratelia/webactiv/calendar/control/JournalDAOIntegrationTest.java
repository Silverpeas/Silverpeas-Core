...
import com.stratelia.webactiv.calendar.test.WarBuilder4Calendar;
...
public class JournalDAOIntegrationTest {
  ...
  private static final String TABLE_CREATION_SCRIPT =
      "/com/stratelia/webactiv/calendar/create-database.sql";
  private static final String DATASET_SCRIPT =
      "/com/stratelia/webactiv/calendar/calendar-dataset.sql";
