...
public interface NotationBm extends EJBObject
{
	...
	public Collection getBestNotations(NotationPK pk, int notationsCount) throws RemoteException;
	
	public Collection getBestNotations(Collection pks, int notationsCount) throws RemoteException;
