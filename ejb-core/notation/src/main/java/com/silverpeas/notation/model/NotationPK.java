	...
	implements Serializable
{
	 ...
	 * Since various attributes of the both elements can be null, using toString() method to
	 * compare the elements avoids to check null cases for each attribute.
	 */
	public boolean equals(Object other) {
  		return ((other instanceof NotationPK)
  			&& (toString().equals(((NotationPK) other).toString())));
  	}
	...
	public String toString()
	{
		return new StringBuffer()
			...
			.append(", componentName = ").append(getComponentName())
