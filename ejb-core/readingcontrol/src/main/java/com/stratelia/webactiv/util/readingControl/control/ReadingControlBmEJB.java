...
public class ReadingControlBmEJB implements SessionBean {
  ...
  private Connection getConnection() {
    try {
      ...
      throw new ReadingControlRuntimeException(
          "ReadingControlBmEJB.getConnection()",
  ...
  private void freeConnection(Connection con) {
    if (con != null)
      try {
        ...
        SilverTrace.error("readingControl",
            "ReadingControlBmEJB.freeConnection()",
            "root.EX_EMERGENCY_CONNECTION_CLOSE_FAILED", e);
      }
  }
  ...
  public void addReadingControls(Collection userIds, PublicationPK pubPK) {
    ...
    try {
      con = getConnection();
      PublicationActorLinkDAO.addReadingControls(con, rootTableName, userIds,
          pubPK);
    } catch (Exception e) {
      throw new ReadingControlRuntimeException(
          "ReadingControlBmEJB.addReadingControls()",
          SilverpeasRuntimeException.ERROR,
          "readingControl.EX_ADD_READING_CONTROL_FAILED", e);
    } finally {
      freeConnection(con);
    }
    SilverTrace.info("readingControl",
        "ReadingControlBmEJB.addReadingControls()", "root.MSG_GEN_EXIT_METHOD");
  }
  ...
  public void removeReadingControlByUser(String userId) {
    SilverTrace.info("readingControl",
        "ReadingControlBmEJB.removeReadingControlByUser()",
        "root.MSG_GEN_ENTER_METHOD");
    Connection con = null;
    try {
      con = getConnection();
      ...
      throw new ReadingControlRuntimeException(
          "ReadingControlBmEJB.removeReadingControlByUser()",
          SilverpeasRuntimeException.ERROR,
          "readingControl.EX_REMOVE_READING_CONTROL_BY_USER_FAILED",
          "userId = " + userId, e);
    } finally {
      freeConnection(con);
    }
  ...
  public void removeReadingControlByPublication(PublicationPK pubPK) {
    SilverTrace.info("readingControl",
        "ReadingControlBmEJB.removeReadingControlByPublication()",
        "root.MSG_GEN_ENTER_METHOD");
    Connection con = null;
    try {
      con = getConnection();
      ...
      throw new ReadingControlRuntimeException(
          "ReadingControlBmEJB.removeReadingControlByPublication()",
          SilverpeasRuntimeException.ERROR,
          "readingControl.EX_REMOVE_READING_CONTROL_BY_PUBLICATION_FAILED",
  ...
  public Collection getReadingControls(PublicationPK pubPK) {
    ...
    try {
      con = getConnection();
      result = PublicationActorLinkDAO.getReadingControls(con, rootTableName,
          pubPK);
    } catch (Exception e) {
      throw new ReadingControlRuntimeException(
          "ReadingControlBmEJB.getReadingControls()",
          SilverpeasRuntimeException.ERROR,
          "readingControl.EX_GET_READING_CONTROL_BY_PUBLICATION_FAILED",
          "pubPK = " + pubPK.toString(), e);
    } finally {
      freeConnection(con);
    }
    SilverTrace.info("readingControl",
        "ReadingControlBmEJB.getReadingControls()", "root.MSG_GEN_EXIT_METHOD");
    return result;
  }

  public Hashtable getReadingStates(PublicationPK pubPK) {
    SilverTrace.info("readingControl",
        "ReadingControlBmEJB.getReadingStates()", "root.MSG_GEN_ENTER_METHOD");
    ...
    try {
      ...
      throw new ReadingControlRuntimeException(
          "ReadingControlBmEJB.getReadingStates()",
          SilverpeasRuntimeException.ERROR,
          "root.EX_GET_READING_STATES_FAILED", e);
    }
    ...
    SilverTrace.info("readingControl",
        "ReadingControlBmEJB.getReadingStates()", "root.MSG_GEN_EXIT_METHOD");
    return result;
  }
