...
public class PublicationActorLinkDAO {
  ...
  public static void add(Connection con, String tableName, String userId,
    ...
    try {
      ...
      SilverTrace.error("readingControl", "PublicationActorLinkDAO.add()",
          "root.EX_RECORD_INSERTION_FAILED", "pubPK = " + pubPK.toString(), se);
      throw se;
    } finally {
  ...
  public static Collection getReadingControlDetails(ResultSet rs)
      throws SQLException {
    ...
    while (rs.next()) {
      ...
      PublicationActorLinkDetail detail = new PublicationActorLinkDetail(
          actorId, pubPK);
      list.add(detail);
    }
    return list;
  ...
  public static Collection getReadingControls(Connection con, String tableName,
      PublicationPK pubPK) throws SQLException {
    ...
    try {
      ...
      SilverTrace.error("readingControl",
          "PublicationActorLinkDAO.getReadingControls()",
          "root.EX_RECORD_NOT_FOUND", "pubPK = " + pubPK.toString(), se);
      throw se;
    } finally {
  ...
  public static void addReadingControls(Connection con, String tableName,
      Collection userIds, PublicationPK pubPK) throws SQLException {
    SilverTrace.info("readingControl",
        "PublicationActorLinkDAO.addReadingControls()",
        "root.MSG_GEN_ENTER_METHOD");
  ...
  public static void remove(Connection con, String tableName,
      Collection userIds, PublicationPK pubPK) throws SQLException {
    SilverTrace.info("readingControl", "PublicationActorLinkDAO.remove()",
        "root.MSG_GEN_ENTER_METHOD");
    SilverTrace.info("readingControl", "PublicationActorLinkDAO.remove()",
        "root.MSG_GEN_EXIT_METHOD");
  }
  ...
  public static void removeByUser(Connection con, String tableName,
    ...
    SilverTrace.info("readingControl",
        "PublicationActorLinkDAO.removeByUser()", "root.MSG_GEN_ENTER_METHOD");
    ...
    try {
      ...
      SilverTrace.error("readingControl",
          ...
          "root.EX_RECORD_DELETE_FAILED", "userId = " + userId, se);
      throw se;
    } finally {
      DBUtil.close(prepStmt);
    }
    SilverTrace.info("readingControl",
        "PublicationActorLinkDAO.removeByUser()", "root.MSG_GEN_EXIT_METHOD");
  }

  public static void removeByPublication(Connection con, String tableName,
      PublicationPK pubPK) throws SQLException {
    SilverTrace.info("readingControl",
    ...
    try {
      ...
      SilverTrace.error("readingControl",
          "PublicationActorLinkDAO.removeByPublication()",
          "root.EX_RECORD_DELETE_FAILED", "pubPK = " + pubPK.toString(), se);
      throw se;
    } finally {
      DBUtil.close(prepStmt);
    }
