...
<%
    ...
    buttonPane.addButton((Button) gef.getFormButton(resource.getString("thesaurus.affecter"), "CreateJargonsUser", false));
    buttonPane.addButton((Button) gef.getFormButton(resource.getString("GML.cancel"), "EditAssignments", false));
