    ...
    var doLocalVideo = function doLocalVideo(view, room, url, label)
    {
        ...
        if (modal)
        {
            ...
            if (div)
            {
                ...
                //div.innerHTML = '<iframe src="' + url + '" id="jitsimeet" allow="microphone; camera;" frameborder="0" seamless="seamless" allowfullscreen="true" scrolling="no" style="z-index: 2147483647;width:100%;height:100%;"></iframe>';
