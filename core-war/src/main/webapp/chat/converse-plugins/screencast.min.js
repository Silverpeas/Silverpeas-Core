(function (root, factory) {
    ...
    converse.plugins.add("screencast", {
        ...
        'initialize': function () {
            ...
            __ = function(key) {
              switch (key) {
                case 'ScreenCast. Click to start and stop':
                  return sp.i18n.get('chat.client.web.screencast.button');
                default:
            ...
            _converse.api.listen.on('getToolbarButtons', function(toolbar_el, buttons)
            {
                ...
                buttons.push(html`
                    <button class="plugin-screencast" title="${__('ScreenCast. Click to start and stop')}" @click=${performScreenCast}/>
            ...
            sp.log.debug("screencast plugin is ready");
        }
    });

    function getChatViewFromElement($el) {
      const $chatbox = $el.closest('converse-chat.chatbox') || $el.closest('converse-muc.chatbox');
      const jid = $chatbox.getAttribute('jid');
    ...
    var performScreenCast = function(ev)
    {
        ...
        const view = getChatViewFromElement(ev.currentTarget);
    ...
    var handleAudioStream = function handleStream (stream, audioStream, view)
    {
        ...
        setTimeout(function()
        {
            ...
            videoRecorder.ondataavailable = function(e)
            {
                if (e.data.size > 0)
                {
                    sp.log.debug("screencast - ondataavailable", e.data);
            ...
            {
                sp.log.debug("screencast - onstop", e);
