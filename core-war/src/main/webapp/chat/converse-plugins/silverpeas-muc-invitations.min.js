(function(root, factory) {
  ...
  converse.plugins.add("silverpeas-muc-invitations", {
    ...
    initialize : function() {
       ...
       */
      MucInvitationDialog = BootstrapModal.extend({
        id: "muc-invite-modal",
        initialize : function() {
          this.invitee_jids = [];
        ...
        initInviteWidget : function() {
          this.invitee_jids = [];
          autoCompleteManager.init(this.el);
          autoCompleteManager.addEventListener('select', function(e) {
            ...
            if (this.isSelectedContact(selectedJid)) {
              ...
              this.el.querySelector('button.plus').click();
            }
          }.bind(this), 'select');
        ...
        isSelectedContact : function(jid) {
        ...
        addContactFromFormData : function(data) {
        ...
        performInvitations : function(ev) {
          ev.preventDefault();
  ...
  function performMucInvitation(ev) {
    ...
    _converse.api.modal.show(MucInvitationDialog, {
