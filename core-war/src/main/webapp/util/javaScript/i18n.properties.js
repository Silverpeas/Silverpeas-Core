/******************************************************************************
 * i18n.properties modified from jquery.i18n.properties
 * It doesn't depend anymore on JQuery in order to avoid collusion with other JQuery i18n plugins.
 *
 ...
 * });
   ...
   */
  window.i18n.properties = function (settings) {
    // set up settings
    var defaults = {
      name: 'Messages',
      language: '',
...
// TODO key parts that start with numbers quietly fail. i.e. month.short.1=Jan
  ...
  window.i18n.normaliseLanguageCode = function (lang) {
