 ...
 * YAHOO.widget.SilverpeasCalendar as an in-line editor, if available
 * If SilverpeasCalendar is not available, it behaves as a plain TextNode.
 * @namespace YAHOO.widget
 * @class DateNode
 * @extends YAHOO.widget.TextNode
 * @param oData {object} a string or object containing the data that will
...
YAHOO.extend(YAHOO.widget.DateNode, YAHOO.widget.TextNode, {
    ...
    /**
    * Configuration object for the SilverpeasCalendar editor, if used.
    ...
    */
    ...
    /**
     *  If YAHOO.widget.SilverpeasCalendar is available, it will pop up a SilverpeasCalendar to enter a new date.  Otherwise, it falls back to a plain &lt;input&gt;  textbox
...
(function () {
    ...
    * @method destroyEditorContents
    ...
    Nproto.destroyEditorContents = function (editorData) {
        // In the worst case, if the input editor (such as the SilverpeasCalendar) has no destroy method
