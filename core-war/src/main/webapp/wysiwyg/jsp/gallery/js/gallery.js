      ...
      <div class="SpCarGal-overlay">
        <div class="SpCarGal-container">
          ...
          <div class="SpCarGal-content">
            <img class="SpCarGal-image" src="${imagesSpGallery[currentIndex].src}" alt="${imagesSpGallery[currentIndex].alt}">
            <div class="SpCarGal-alt">${imagesSpGallery[currentIndex].alt}</div>
