...
<head>
  ...
  <script type="module">
    ...
    parent.document.addEventListener('webviewerloaded', function(e) {
      ...
      ['PDFViewerApplication', 'PDFViewerApplicationConstants', 'PDFViewerApplicationOptions'].forEach(function(varName) {
        if (window[varName]) {
      ...
      viewerAppOptions.set("standardFontDataUrl", PdfViewerSettings.get('p.s.f.p'));
      viewerAppOptions.set("wasmUrl", PdfViewerSettings.get('p.wa.p'));
      viewerAppOptions.set("iccUrl", PdfViewerSettings.get('p.ic.p'));
      viewerAppOptions.set("defaultUrl", '${silfn:escapeJs(contentUrl)}');
      viewerAppOptions.set("localeProperties", {lang : '${userLanguage}'});
      ...
      // AnnotationEditorType.DISABLE, the viewer hides itself the whole editor tool group
      viewerAppOptions.set("annotationEditorMode", -1);
      </c:if>
      ...
      <div id="toolbarContainer">
        <div id="toolbarViewer" class="toolbarHorizontalGroup">
          <div id="toolbarViewerLeft" class="toolbarHorizontalGroup">
            <button id="viewsManagerToggleButton" class="toolbarButton" type="button" tabindex="0" data-l10n-id="pdfjs-toggle-views-manager-button1" aria-expanded="false" aria-haspopup="true" aria-controls="viewsManager">
              <span data-l10n-id="pdfjs-toggle-views-manager-button1-label"></span>
            </button>
            <div id="viewsManager" class="menuContainer sidebar" hidden="true" role="dialog" aria-describedby="viewsManagerHeaderLabel" data-l10n-id="pdfjs-views-manager-sidebar">
              <div id="viewsManagerHeader">
                <div id="viewsManagerTitle">
                  <div id="viewsManagerSelector">
                    <button class="toolbarButton viewsManagerButton hasPopupMenu" type="button" id="viewsManagerSelectorButton" tabindex="0" data-l10n-id="pdfjs-views-manager-view-selector-button" aria-expanded="false" aria-haspopup="listbox" aria-controls="viewsManagerSelectorOptions">
                  ...
                  <button id="viewsManagerAddFileButton" class="toolbarButton viewsManagerButton" type="button" tabindex="0" data-l10n-id="pdfjs-views-manager-add-file-button" hidden="true">
                  ...
                  <button id="viewsManagerCurrentOutlineButton" class="toolbarButton viewsManagerButton" type="button" tabindex="0" data-l10n-id="pdfjs-current-outline-item-button" hidden="true">
                ...
                <div id="viewsManagerStatus">
                  <div id="viewsManagerStatusAction">
                    <span id="viewsManagerStatusActionLabelContainer" class="viewsManagerStatusLabel">
                      <button id="viewsManagerStatusActionDeselectButton" class="hidden" type="button" tabindex="0" role="checkbox" aria-checked="true" aria-labelledby="viewsManagerStatusActionLabel"></button>
                      <span id="viewsManagerStatusActionLabel" class="viewsManagerStatusLabel" data-l10n-id="pdfjs-views-manager-pages-status-none-action-label"></span>
                    </span>
                    <div id="actionSelector">
                      <button id="viewsManagerStatusActionButton" class="viewsManagerButton hasPopupMenu" type="button" tabindex="0" aria-haspopup="menu" aria-controls="viewsManagerStatusActionOptions" aria-expanded="false">
                  ...
                  <div id="viewsManagerStatusUndo" class="hidden">
                    ...
                    <div>
                      ...
                      <button id="viewsManagerStatusUndoCloseButton" class="toolbarButton viewsManagerButton viewsCloseButton" type="button" tabindex="0" data-l10n-id="pdfjs-views-manager-status-close-button">
                  ...
                  <div id="viewsManagerStatusWarning" class="hidden">
                    ...
                    <button id="viewsManagerStatusWarningCloseButton" class="toolbarButton viewsManagerButton viewsCloseButton" type="button" tabindex="0" data-l10n-id="pdfjs-views-manager-status-close-button">
                      <span data-l10n-id="pdfjs-views-manager-status-close-button-label"></span>
                    </button>
                  </div>
                  <div id="viewsManagerStatusWaiting" class="hidden">
                    <span id="viewsManagerStatusWaitingLabel" class="viewsManagerStatusLabel"></span>
                    <button id="viewsManagerStatusWaitingCloseButton" class="toolbarButton viewsManagerButton viewsCloseButton" type="button" tabindex="0" data-l10n-id="pdfjs-views-manager-status-close-button">
                      <span data-l10n-id="pdfjs-views-manager-status-close-button-label"></span>
                    </button>
                  </div>
                </div>
              ...
              <div id="viewsManagerResizer" class="sidebarResizer" role="separator" aria-controls="viewsManager" tabindex="0" data-l10n-id="pdfjs-views-manager-sidebar-resizer"></div>
            </div>  <!-- viewsManager -->
          ...
          <div id="toolbarViewerRight" class="toolbarHorizontalGroup">
            <div id="editorModeButtons" class="toolbarHorizontalGroup">
              <div id="signatureProperties" class="toolbarButtonWithContainer" hidden="true">
                <button id="signaturePropertiesButton" class="toolbarButton" type="button" tabindex="0" aria-expanded="false" aria-haspopup="true" aria-controls="signaturePropertiesPanel" data-l10n-id="pdfjs-digital-signature-properties-button">
