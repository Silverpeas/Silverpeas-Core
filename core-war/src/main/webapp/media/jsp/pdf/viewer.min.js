...
class GenericL10n extends _l10n_js__WEBPACK_IMPORTED_MODULE_3__.L10n {
  ...
  static async #createBundle(lang, baseURL, paths) {
    ...
    const text = await window.SP_PDF_VIEWER_L10N_TEXT_MODIFIER(
        await (0, pdfjs_lib__WEBPACK_IMPORTED_MODULE_2__.fetchData)(url, "text"));
...
function webViewerLoad() {
  ...
  const event = new CustomEvent("webviewerloaded", {
    ...
    detail: {
      source: window,
      viewerConfiguration : config,
      viewerApp : window.PDFViewerApplication,
      viewerAppOptions : window.PDFViewerApplicationOptions
    }
  });
  try {
  ...
  _app_js__WEBPACK_IMPORTED_MODULE_5__.PDFViewerApplication.run(config).then(function() {
    window.SP_PDF_VIEWER_DEFERRED.resolve();
  });
}
