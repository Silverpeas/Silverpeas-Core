...
public class SocialNetworkHelper {
  ...
  public void getAllMyNetworks(MyProfilSessionController ctrl, HttpServletRequest request) {
    request.setAttribute("userNetworks", ctrl.getAllMyNetworks());
  }

  public void setupJSAttributes(MyProfilSessionController ctrl, HttpServletRequest request) {
    Map<SocialNetworkID, ExternalAccount> allMyNetworks = ctrl.getAllMyNetworks();
  ...
  public String buildAuthenticationURL(HttpServletRequest request, MyProfileRoutes route) {
    SocialNetworkID networkId = SocialNetworkID.valueOf(request.getParameter(NETWORK_ID));
  ...
  public void linkToSilverpeas(MyProfilSessionController ctrl, HttpServletRequest request) {
    ...
    socialNetworkService.createExternalAccount(negociation.networkId, ctrl.getUserId(), profileId);
  }
