 ...
 * @author silveryocha
 */
public interface ComponentInstanceRoutingMapProvider {
   ...
   */
  ComponentInstanceRoutingMap relative();
   ...
   * @return the {@link ComponentInstanceRoutingMap} instance.
   */
  ComponentInstanceRoutingMap relativeToSilverpeas();
   ...
   * @return the {@link ComponentInstanceRoutingMap} instance.
   */
  ComponentInstanceRoutingMap absolute();
}
