...
public interface SilverpeasBeanDAO<T extends SilverpeasBeanIntf> {
   ...
   *
   * @param pk the SilverpeasBeanIntf to update, with a primaryKey initialized with only spaceId and
   * componentId.
   ...
   * @throws PersistenceException if the deletion fails.
   */
  void removeWhere(WAPrimaryKey pk, BeanCriteria criteria) throws PersistenceException;
   ...
   * @throws PersistenceException if the deletion fails.
   */
  void removeWhere(Connection con, WAPrimaryKey pk, BeanCriteria criteria)
