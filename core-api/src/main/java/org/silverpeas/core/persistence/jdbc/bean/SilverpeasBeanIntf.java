...
/**
 * A persistent bean in Silverpeas taken in charge by a {@link SilverpeasBeanDAO} DAO.
 * <p>
...
public interface SilverpeasBeanIntf {
  ...
  /**
   * Sets the primary key of this bean. The primary key is set by the {@link SilverpeasBeanDAO}
   * once the bean saved the first time into the database.
