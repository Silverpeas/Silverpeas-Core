 ...
 * listeners and so on. All synchronous notifiers should extend this class; they have just to
 * little parametrization, the notification itself is performed by this abstract class.
 * @param <T> the type of the handled {@link ServerEvent}.
