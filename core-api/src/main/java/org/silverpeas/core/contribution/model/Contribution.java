...
/**
 * A contribution in Silverpeas. A contribution is an identifiable resource that is pushed by a user
 * onto Silverpeas and that is manageable by the users within Silverpeas. A contribution has always
 * a content that can be of any type (simple text, WYSIWYG, form, image, ...).
 *
 * @author mmoquillon
 */
public interface Contribution extends SilverpeasResource, Serializable, Securable,
   ...
   *
   * @return the contribution's title in the specified language. Can be empty if no title was set or
   * no title is defined for a such contribution.
   */
   ...
   * contribution handled by a Silverpeas application. By default, this method returns the simple
