...
public interface CalendarEventView {
   ...
   * @return a map in which the occurrences are grouped by a specific property.
   */
  Map<?, List<CalendarEventOccurrence>> apply(final List<CalendarEventOccurrence> occurrences);
}
