 ...
 */
public class DurationConversionBoardKey {
  private final DurationUnit smallestUnit;
  private final DurationUnit largestUnit;

  DurationConversionBoardKey(DurationUnit from, DurationUnit to) {
